...
const CalmTeacherBadge = () => {
  ...
  // Required game IDs for Calm Teacher Badge (5 calming activities)
  ...
  const gameIcons = {
    ...
    'teacher-education-14': '🌬️',
    'teacher-education-17': '📝',
    'teacher-education-18': '⏸️',
  ...
  const checkGamesCompletion = async () => {
    try {
      ...
      if (!allCompletedCheck) {
        setTimeout(() => {
          toast.info('Complete all 5 calming activities first to unlock this badge!');
        }, 1000);
      }
    } catch (error) {
  ...
  const checkBadgeStatus = async () => {
    try {
      const result = await teacherBadgeService.getCalmBadgeStatus();
      if (result.hasBadge) {
  ...
  const handleCollectBadge = async () => {
    try {
      ...
      const response = await api.post('/api/school/teacher/badge/calm-teacher/collect');
  ...
  if (loading) {
    return (
      <TeacherGameShell
        title={gameData?.title || "Calm Teacher Badge"}
  ...
  if (!allCompleted) {
    return (
      <TeacherGameShell
        title={gameData?.title || "Calm Teacher Badge"}
        subtitle="Locked - Complete all calming activities to unlock"
        showGameOver={false}
        score={0}
        gameId={gameId}
        gameType="teacher-education"
          ...
          <div className="bg-white rounded-2xl shadow-lg p-8">
            <div className="text-center mb-8">
              ...
              <p className="text-lg text-gray-600">
                Complete all 5 calming activities to unlock this badge
              </p>
            </div>

            {/* Progress Tracker */}
            <div className="space-y-4 mb-6">
              <h3 className="text-xl font-bold text-gray-800 mb-4">Daily Stress Management Activities:</h3>
            ...
            <div className="bg-blue-50 rounded-xl p-4 border border-blue-200 text-center">
              <p className="text-sm text-blue-700">
                Complete all 5 calming activities to earn the Calm Teacher Badge!
              </p>
            </div>
          </div>
        </div>
  ...
  return (
    <TeacherGameShell
      title={gameData?.title || "Calm Teacher Badge"}
      subtitle="Celebrate consistent daily stress management practice"
      showGameOver={false}
      score={0}
      gameId={gameId}
      gameType="teacher-education"
      ...
      <div className="w-full max-w-4xl mx-auto px-4">
        {badgeCollected ? (
          ...
          <div className="bg-white rounded-2xl shadow-lg p-12 text-center">
            ...
            <p className="text-2xl text-blue-600 font-medium italic mb-6">
              "Consistent daily stress management practice."
            </p>
              ...
              <button
                onClick={() => {
                  if (isPlayingAudio) {
                    ...
                    playAffirmation("Congratulations! You have earned the Calm Teacher Badge. Your consistent practice of stress management techniques shows your commitment to wellbeing. You have mastered breathing, pausing, journaling, body awareness, and quick calming strategies. Your calm presence benefits not only you but also your students and colleagues. Well done!");
                  }
                }}
                className="flex items-center gap-2 mx-auto px-6 py-3 bg-blue-100 hover:bg-blue-200 text-blue-700 rounded-xl font-semibold transition-all"
              >
                {isPlayingAudio ? (
                  <>
            ...
            <div className="bg-amber-50 rounded-xl p-4 border border-amber-200">
              ...
              <p className="text-sm text-amber-700">
                Highlight Calm Badge earners in internal wellbeing bulletin. Display the names of teachers who have earned the Calm Teacher Badge in your school's internal wellbeing bulletin or newsletter. This recognition celebrates individual achievement in stress management and encourages other teachers to practice daily calming techniques. It creates a culture of wellbeing and self-care within your school community.
              </p>
            </div>
          </div>
        ) : (
          ...
          <div className="bg-white rounded-2xl shadow-lg p-12 text-center">
            ...
            <p className="text-xl text-gray-600 mb-8">
              You have successfully completed all 5 calming activities
            </p>
            ...
            <motion.button
              ...
              className="bg-gradient-to-r from-blue-500 via-cyan-500 to-teal-500 text-white px-12 py-4 rounded-full font-bold text-lg shadow-lg hover:shadow-xl transform transition-all duration-200"
            >
              Collect Badge
            </motion.button>
          </div>
        ...
        {showCollectionModal && (
          <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50 p-4">
            ...
            >
              <div className="inline-flex items-center justify-center w-20 h-20 rounded-full bg-gradient-to-br from-blue-400 via-cyan-400 to-teal-400 mb-4">
              ...
              <p className="text-gray-600 mb-6">
                Are you ready to collect your Calm Teacher Badge? You'll hear a positive affirmation when you collect it!
              </p>
              <div className="flex gap-4 justify-center">
                ...
                <button
                  ...
                  disabled={isCollecting}
                  className="bg-gradient-to-r from-blue-500 to-cyan-500 text-white px-6 py-3 rounded-full font-semibold shadow-lg hover:shadow-xl transform hover:scale-105 transition-all duration-200 disabled:opacity-50"
                >
