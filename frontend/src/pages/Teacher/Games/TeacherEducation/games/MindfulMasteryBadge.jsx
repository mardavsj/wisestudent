...
const MindfulMasteryBadge = () => {
  ...
  // Required game IDs for Mindful Mastery Badge (5 mindfulness activities)
  ...
  const checkGamesCompletion = async () => {
    try {
      ...
      if (!allCompletedCheck) {
        setTimeout(() => {
          toast.info('Complete all 5 mindfulness activities first to unlock this badge!');
        }, 1000);
      }
    } catch (error) {
  ...
  const checkBadgeStatus = async () => {
    try {
      const result = await teacherBadgeService.getMindfulMasteryBadgeStatus();
      if (result.hasBadge) {
  ...
  const handleCollectBadge = async () => {
    try {
      ...
      const response = await api.post('/api/school/teacher/badge/mindful-mastery/collect');
  ...
  if (loading) {
    return (
      <TeacherGameShell
        title={gameData?.title || "Mindful Mastery Badge"}
        ...
        <div className="w-full max-w-4xl mx-auto px-4">
          <div className="bg-white rounded-2xl shadow-lg p-8">
            ...
            <div className="space-y-4 mb-6">
              <h3 className="text-xl font-bold text-gray-800 mb-4">Mindfulness Activities:</h3>
            ...
            <div className="bg-blue-50 rounded-xl p-4 border border-blue-200 text-center">
              <p className="text-sm text-blue-700">
                Complete all 5 mindfulness activities to earn the Mindful Mastery Badge!
              </p>
            </div>
          </div>
        </div>
  ...
  return (
    <TeacherGameShell
      title={gameData?.title || "Mindful Mastery Badge"}
      subtitle="Celebrate teachers who sustain mindful habits daily"
      showGameOver={false}
      score={0}
      gameId={gameId}
      gameType="teacher-education"
        ...
        {badgeCollected ? (
          ...
          <div className="bg-white rounded-2xl shadow-lg p-12 text-center">
              ...
              <button
                onClick={() => {
                  if (isPlayingAudio) {
                    ...
                    playAffirmation("Your calm inspires clarity. Congratulations! You have earned the Mindful Mastery Badge. Your commitment to daily mindfulness practices sustains your focus, reduces stress, and brings presence to your teaching. You are a Mindfulness Mentor, inspiring clarity and calm in your classroom and beyond. Well done!");
                  }
                }}
            ...
            <div className="bg-amber-50 rounded-xl p-4 border border-amber-200">
              ...
              <p className="text-sm text-amber-700">
                Display badge holders as "Mindfulness Mentors" for others. Create a "Mindfulness Mentors" board in your staffroom or school newsletter featuring teachers who have earned the Mindful Mastery Badge. This recognition celebrates individual achievement while inspiring others to develop their own mindfulness practices. Badge holders can serve as peer mentors, sharing mindfulness techniques and supporting colleagues in building their practice. This creates a culture of mindfulness and self-care within your school community, where teachers support each other's wellbeing. Consider forming a "Mindfulness Mentors" group that meets monthly to share practices, discuss challenges, and support one another in sustaining mindful habits.
              </p>
            </div>
          </div>
        ) : (
          ...
          <div className="bg-white rounded-2xl shadow-lg p-12 text-center">
            ...
            <p className="text-xl text-gray-600 mb-8">
              You have successfully completed all 5 mindfulness activities
            </p>
          ...
          <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50 p-4">
            ...
            >
              ...
              <p className="text-gray-600 mb-6">
                Are you ready to collect your Mindful Mastery Badge? You'll hear the affirmation "Your calm inspires clarity" when you collect it!
              </p>
