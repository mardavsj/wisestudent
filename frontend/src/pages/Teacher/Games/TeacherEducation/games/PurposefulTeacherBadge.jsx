...
import { Award, CheckCircle, Target, Heart, Sparkles, BookOpen, Star, TrendingUp, Lock, Volume2, VolumeX } from "lucide-react";
...
const PurposefulTeacherBadge = () => {
  ...
  const checkGamesCompletion = async () => {
    try {
      ...
      if (!allCompletedCheck) {
        setTimeout(() => {
          toast.info('Complete all 5 purpose-related activities first to unlock this badge!');
        }, 1000);
      }
    } catch (error) {
  ...
  const checkBadgeStatus = async () => {
    try {
      const result = await teacherBadgeService.getPurposefulTeacherBadgeStatus();
      if (result.hasBadge) {
  ...
  const handleCollectBadge = async () => {
    try {
      ...
      if (result.success && (result.newlyEarned || result.badgeEarned)) {
        setBadgeCollected(true);
        setShowCollectionModal(false);
        toast.success('🎉 Badge collected successfully!');

        // Play positive audio affirmation
        const affirmation = "Your purpose lights paths. Congratulations! You have earned the Purposeful Teacher Badge. Your commitment to sustaining joy, gratitude, and meaning in your work demonstrates purpose-driven teaching. You are a Purposeful Educator, lighting paths for generations to come. Well done!";
        ...
        window.dispatchEvent(new CustomEvent('teacherBadgeEarned', {
          detail: {
            ...
            message: 'Your purpose lights paths.',
            badge: result.badge
          }
        }));
  ...
  if (!allCompleted) {
    return (
      <TeacherGameShell
        title={gameData?.title || "Purposeful Teacher Badge"}
        subtitle="Locked - Complete all purpose-related activities to unlock"
        showGameOver={false}
        score={0}
        gameId={gameId}
        gameType="teacher-education"
          ...
          <div className="bg-white rounded-2xl shadow-lg p-8">
            <div className="text-center mb-8">
              ...
              <p className="text-lg text-gray-600">
                Complete all 5 purpose-related activities to unlock this badge
              </p>
            </div>

            {/* Progress Tracker */}
            <div className="space-y-4 mb-6">
              <h3 className="text-xl font-bold text-gray-800 mb-4">Purpose-Related Activities:</h3>
            ...
            <div className="bg-blue-50 rounded-xl p-4 border border-blue-200 text-center">
              <p className="text-sm text-blue-700">
                Complete all 5 purpose-related activities to earn the Purposeful Teacher Badge!
              </p>
            </div>
          </div>
        </div>
  ...
  return (
    <TeacherGameShell
      title={gameData?.title || "Purposeful Teacher Badge"}
      subtitle="Reward teachers who sustain joy, gratitude, and meaning in their work"
      showGameOver={false}
      score={0}
      gameId={gameId}
      gameType="teacher-education"
        ...
        {badgeCollected ? (
          ...
          <div className="bg-white rounded-2xl shadow-lg p-12 text-center">
            ...
            <div className="bg-gradient-to-br from-purple-50 via-indigo-50 to-pink-50 rounded-xl p-6 border-2 border-purple-200 mb-6">
              <p className="text-gray-700 text-lg">
                Congratulations! You have successfully completed all purpose-related activities and earned the Purposeful Teacher Badge. Your commitment to sustaining joy, gratitude, and meaning in your work demonstrates purpose-driven teaching.
              </p>
            </div>
              ...
              <button
                onClick={() => {
                  if (isPlayingAudio) {
                    ...
                    playAffirmation("Your purpose lights paths. Congratulations! You have earned the Purposeful Teacher Badge. Your commitment to sustaining joy, gratitude, and meaning in your work demonstrates purpose-driven teaching. You are a Purposeful Educator, lighting paths for generations to come. Well done!");
                  }
                }}
            ...
            <div className="bg-amber-50 rounded-xl p-4 border border-amber-200">
              ...
              <p className="text-sm text-amber-700">
                Showcase Purpose Badge earners during Teacher Appreciation Week. Celebrating teachers who sustain purpose creates inspiration and recognition: Create display: Display badges and names of Purpose Badge earners in a prominent location during Teacher Appreciation Week. Visual recognition celebrates achievements. Share stories: Invite badge earners to share brief stories about their purpose journey. Stories inspire others and create connection. Highlight impact: Emphasize how purpose-driven teaching creates positive impact. Impact recognition reinforces value. Celebrate diversity: Recognize that purpose looks different for each teacher. Diversity celebration honors unique paths. Inspire others: Use badge earners as examples of purpose-sustained teaching. Inspiration encourages others to explore purpose. Create traditions: Make showcasing Purpose Badge earners a yearly tradition. Traditions create anticipation and continuity. Include students: Consider sharing with students (when appropriate) how teachers sustain purpose. Student inclusion builds connection. Document journey: Document the purpose journey through photos, quotes, or reflections. Documentation preserves impact. Network opportunities: Create opportunities for badge earners to connect and share. Networking strengthens community. Ongoing recognition: Continue recognizing purpose throughout the year, not just during one week. Ongoing recognition sustains motivation. When you showcase Purpose Badge earners during Teacher Appreciation Week, you're creating a practice that celebrates purpose, inspires others, recognizes impact, builds community, and reinforces the value of sustaining joy, gratitude, and meaning in teaching. This recognition transforms individual achievement into collective inspiration that benefits the entire school community.
              </p>
            </div>
          </div>
        ) : (
          ...
          <div className="bg-white rounded-2xl shadow-lg p-12 text-center">
            ...
            <p className="text-xl text-gray-600 mb-8">
              You have successfully completed all 5 purpose-related activities
            </p>
          ...
          <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50 p-4">
            ...
            >
              ...
              <p className="text-gray-600 mb-6">
                Are you ready to collect your Purposeful Teacher Badge? You'll hear the affirmation "Your purpose lights paths" when you collect it!
              </p>
