...
const ClearCommunicatorBadge = () => {
      ...
      if (result.success && (result.badgeEarned || result.newlyEarned)) {
        ...
        window.dispatchEvent(new CustomEvent('teacherBadgeEarned', {
          detail: {
            ...
            message: 'You speak with calm clarity.',
            badge: result.badge
          }
        }));
        ...
        <div className="w-full max-w-4xl mx-auto px-4">
          <div className="bg-white rounded-2xl shadow-lg p-8">
            ...
            <div className="space-y-4 mb-6">
              <h3 className="text-xl font-bold text-gray-800 mb-4">Communication Activities:</h3>
            ...
            <div className="bg-blue-50 rounded-xl p-4 border border-blue-200 text-center">
              <p className="text-sm text-blue-700">
                Complete all 5 communication activities to earn the Clear Communicator Badge!
              </p>
            </div>
          </div>
        </div>
  ...
  return (
    <TeacherGameShell
      title={gameData?.title || "Clear Communicator Badge"}
      subtitle="Reward consistent use of assertive, empathetic communication"
      showGameOver={false}
      score={0}
      gameId={gameId}
      gameType="teacher-education"
        ...
        <div className="bg-white rounded-2xl shadow-lg p-12 text-center">
          {badgeCollected ? (
            ...
            <div>
              ...
              <div className="bg-gradient-to-br from-indigo-50 via-purple-50 to-blue-50 rounded-xl p-6 border-2 border-indigo-200 mb-6">
                <p className="text-gray-700 text-lg">
                  Congratulations! You have successfully completed all communication activities and earned the Clear Communicator Badge. Your consistent use of assertive, empathetic communication sustains clarity and respect in your interactions.
                </p>
              </div>
                ...
                <button
                  onClick={() => {
                    if (isPlayingAudio) {
                      ...
                      playAffirmation("You speak with calm clarity. Congratulations! You have earned the Clear Communicator Badge. Your consistent use of assertive, empathetic communication sustains clarity and respect in your interactions. You are a Communication Champion, modeling calm clarity in your classroom and beyond. Well done!");
                    }
                  }}
              ...
              <div className="bg-blue-50 rounded-xl p-4 border border-blue-200">
                <p className="text-sm font-semibold text-blue-800 mb-2">💡 Teacher Tip:</p>
                <p className="text-sm text-blue-700">
                  Highlight badge earners during staff communication workshops. Recognizing teachers who have earned the Clear Communicator Badge creates positive reinforcement, inspires others, and builds a culture of effective communication. Share their achievements, invite them to share insights, and celebrate their commitment to assertive, empathetic communication.
                </p>
              </div>
            </div>
          ) : (
            ...
            <div>
              ...
              <p className="text-xl text-gray-600 mb-8">
                You have successfully completed all 5 communication activities
              </p>
              ...
              <motion.button
                ...
                className="bg-gradient-to-r from-blue-400 via-indigo-400 to-purple-400 text-white px-12 py-4 rounded-full font-bold text-lg shadow-lg hover:shadow-xl transform transition-all duration-200"
              >
                Collect Badge
              </motion.button>
            </div>
            ...
            <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50 p-4">
              ...
              >
                ...
                <p className="text-gray-600 mb-6">
                  Are you ready to collect your Clear Communicator Badge? You'll hear the affirmation "You speak with calm clarity" when you collect it!
                </p>
                <div className="flex gap-4 justify-center">
                  ...
                  <button
                    ...
                    disabled={isCollecting}
                    className="bg-gradient-to-r from-blue-400 to-purple-400 text-white px-6 py-3 rounded-full font-semibold shadow-lg hover:shadow-xl transform hover:scale-105 transition-all duration-200 disabled:opacity-50"
                  >
