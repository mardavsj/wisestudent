...
const ReflexPubertyHealthTeen = () => {
    const navigate = useNavigate();

    // Get game data from game category folder (source of truth)
    const gameId = "health-male-teen-33";
  ...
  },
  {
    ...
    const handleNext = () => {
        navigate("/student/health-male/teens/puberty-health-puzzle-teen");
    };
    ...
    return (
        <GameShell
            ...
            subtitle={gameState === "playing" ? `Round ${currentRound}/${TOTAL_ROUNDS}: Stay healthy!` : "Stay healthy!"}
            onNext={handleNext}
                ...
                {gameState === "ready" && (
                    <div className="bg-white/10 backdrop-blur-md rounded-2xl p-8 border border-white/20 text-center">
                        ...
                        <p className="text-white/90 text-lg mb-6">
                            Make healthy choices quickly!<br />
...
export default ReflexPubertyHealthTeen;
