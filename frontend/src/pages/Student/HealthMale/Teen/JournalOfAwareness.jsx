...
const JournalOfAwareness = () => {
  ...
  const prompts = [
    {
      ...
      text: "Substance I will never try is ___."
    },
    {
      id: 2,
      title: "Peer Pressure Response",
      text: "When friends pressure me to try substances, I will ___."
    },
    {
      id: 3,
      title: "Health Priority",
      text: "My health is more important than ___."
    },
    {
      id: 4,
      title: "Future Goals",
      text: "I want to achieve ___ without substance use."
    },
    {
      id: 5,
      title: "Support System",
      text: "I can talk to ___ about substance pressure."
    }
  ];
  ...
  useEffect(() => {
    if (gameFinished) {
      console.log(`🎮 Journal of Awareness game completed! Score: ${responses.length}/${prompts.length}, gameId: health-male-teen-87`);
    }
  ...
  const handleNext = () => {
    navigate("/student/health-male/teens/peer-pressure-simulation");
  };
