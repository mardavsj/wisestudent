...
const ReflexMasculinityCheck = () => {
  const navigate = useNavigate();

  // Get game data from game category folder (source of truth)
  const gameId = "health-male-teen-63";
  ...
  // Debug logging
  useEffect(() => {
    console.log('🎮 ReflexMasculinityCheck debug:', {
      correctAnswers,
      score,
      coinsPerLevel,
      totalCoins,
  ...
  const handleNext = () => {
    navigate("/student/health-male/teens/masculinity-myths-puzzle");
  };
  ...
  return (
    <GameShell
      ...
      score={correctAnswers}
      gameId={gameId}
      nextGamePathProp="/student/health-male/teens/masculinity-myths-puzzle"
      nextGameIdProp="health-male-teen-64"
        ...
        {gameState === "ready" && (
          <div className="bg-white/10 backdrop-blur-md rounded-2xl p-8 border border-white/20 text-center">
            ...
            <p className="text-white/90 text-lg mb-6">
              Make smart masculinity decisions quickly!<br />
        ...
        {gameState === "finished" && (
          <div className="bg-white/10 backdrop-blur-md rounded-2xl p-8 border border-white/20 text-center">
            ...
            <p className="text-white/80 mb-8">
              Great job checking your masculinity perspectives!
            </p>
            <button
              onClick={handleNext}
...
export default ReflexMasculinityCheck;
