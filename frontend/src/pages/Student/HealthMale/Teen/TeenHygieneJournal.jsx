...
const TeenHygieneJournal = () => {
    const navigate = useNavigate();

    // Get game data from game category folder (source of truth)
    const gameId = "health-male-teen-37";
    ...
    const journalPrompts = [
        ...
        "To take care of my skin, I will...",
        "Shaving makes me feel...",
        "One healthy habit I want to start is..."
    ];
    ...
    useEffect(() => {
        if (gameFinished) {
            console.log(`🎮 Teen Hygiene Journal game completed! Score: ${coins}/${journalPrompts.length}, gameId: ${gameId}`);
        }
    ...
    const handleNext = () => {
        navigate("/student/health-male/teens/teen-shaving-simulation");
    };
