...
const JournalOfStress = () => {
  ...
  const prompts = [
    {
      id: 1,
      title: "Stress Relief",
      text: "One way I reduce stress is ___."
    },
    {
      id: 2,
      title: "Stress Triggers",
      text: "Something that causes me stress is ___."
    },
    {
      id: 3,
  ...
  useEffect(() => {
    if (gameFinished) {
      console.log(`🎮 Journal of Stress game completed! Score: ${responses.length}/${prompts.length}, gameId: health-male-teen-57`);
    }
  ...
  const handleNext = () => {
    navigate("/student/health-male/teens/teen-stress-day-simulation");
  };
  ...
  return (
    <GameShell
      ...
      nextGamePathProp="/student/health-male/teens/teen-stress-day-simulation"
      nextGameIdProp="health-male-teen-58"
...
export default JournalOfStress;
