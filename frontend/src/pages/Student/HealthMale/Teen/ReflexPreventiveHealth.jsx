...
const ReflexPreventiveHealth = () => {
  const navigate = useNavigate();

  // Get game data from game category folder (source of truth)
  const gameId = "health-male-teen-73";
  ...
  // Debug logging
  useEffect(() => {
    console.log('🎮 ReflexPreventiveHealth debug:', {
      correctAnswers,
      coins,
      coinsPerLevel,
      totalCoins,
  ...
  const handleNext = () => {
    navigate("/student/health-male/teens/doctor-tools-puzzle");
  };
  ...
  return (
    <GameShell
      ...
      score={correctAnswers}
      gameId={gameId}
      nextGamePathProp="/student/health-male/teens/doctor-tools-puzzle"
      nextGameIdProp="health-male-teen-74"
        ...
        {gameState === "ready" && (
          <div className="bg-white/10 backdrop-blur-md rounded-2xl p-8 border border-white/20 text-center">
            ...
            <p className="text-white/90 text-lg mb-6">
              Make healthy decisions quickly!<br />
        ...
        {gameState === "finished" && (
          <div className="bg-white/10 backdrop-blur-md rounded-2xl p-8 border border-white/20 text-center">
            ...
            <p className="text-white/80 mb-8">
              Great job practicing preventive health habits!
            </p>
            <button
              onClick={handleNext}
...
export default ReflexPreventiveHealth;
