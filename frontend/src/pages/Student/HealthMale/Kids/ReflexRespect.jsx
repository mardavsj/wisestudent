...
const ReflexRespect = () => {
  ...
  const gameId = "health-male-kids-69";
  ...
  const handleNext = () => {
    navigate("/student/health-male/kids/peer-pressure-fighter-badge");
  };
      ...
      <div className="space-y-8">
        {gameState === "ready" && (
          <div className="bg-white/10 backdrop-blur-md rounded-2xl p-8 border border-white/20 text-center">
            ...
            <p className="text-white/80 mb-6 text-lg">Choose the respectful option quickly! You have {ROUND_TIME} seconds per round</p>
            <button
              onClick={startGame}
