...
const ReflexHygieneCheck = () => {
  ...
  const gameId = "health-male-kids-43";
  ...
  return (
    <GameShell
      ...
      score={score}
      gameId={gameId}
      nextGamePathProp="/student/health-male/kids/hygiene-match-puzzle"
      nextGameIdProp="health-male-kids-44"
      ...
      <div className="space-y-8">
        {gameState === "ready" && (
          <div className="bg-white/10 backdrop-blur-md rounded-2xl p-8 border border-white/20 text-center">
            ...
            <p className="text-white/80 mb-6 text-lg">Choose the hygienic option quickly! You have {ROUND_TIME} seconds per round</p>
            <button
              onClick={startGame}
