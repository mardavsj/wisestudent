...
const RefusalJournal = () => {
  ...
  const journalPrompts = [
    { 
      prompt: "I say NO to smoking because...", 
      minLength: 10,
      guidance: "Think about why smoking is harmful and how saying no protects your health."
    },
    { 
      prompt: "If a friend offers me alcohol, I will...", 
      minLength: 10,
      guidance: "Consider how you would handle this situation respectfully but firmly."
    },
    { 
      prompt: "I keep my body healthy by...", 
      minLength: 10,
      guidance: "Think about positive choices you make to take care of yourself."
    },
    { 
      prompt: "My favorite healthy drink is...", 
      minLength: 10,
      guidance: "Water and other healthy drinks help your body work properly."
    },
    { 
      prompt: "I am strong enough to say NO because...", 
      minLength: 10,
      guidance: "Remember that you have the power to make good choices for yourself."
    }
  ];
