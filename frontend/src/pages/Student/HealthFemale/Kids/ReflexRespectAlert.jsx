...
const ReflexRespectAlert = () => {
  ...
  const totalXp = 10;
  const maxScore = 5;
  const gameId = "health-female-kids-69";
  ...
  const questions = [
    {
      ...
      options: [
        ...
        { text: "Listening", isCorrect: true, emoji: "👂" },
        { text: "Ignoring", isCorrect: false, emoji: "😒" }
      ]
    },
    {
      id: 2,
    ...
    },
    {
      ...
      options: [
        { text: "Fairly", isCorrect: true, emoji: "⚖️" },
        { text: "Meanly", isCorrect: false, emoji: "😈" },
        { text: "Badly", isCorrect: false, emoji: "👎" },
        { text: "Roughly", isCorrect: false, emoji: "🥊" }
      ]
    },
    {
      id: 4,
      question: "What to do with toys?",
      correctAnswer: "Share",
      options: [
        { text: "Hoard", isCorrect: false, emoji: "🧱" },
        { text: "Break", isCorrect: false, emoji: "🔨" },
  ...
  return (
    <GameShell
      ...
      subtitle={gameState === "playing" ? `Round ${currentRound}/${TOTAL_ROUNDS}` : "Respect Blitz!"}
      coins={score}
      ...
      nextGamePathProp="/student/health-female/kids/peer-pressure-fighter-badge"
      nextGameIdProp="health-female-kids-70">
      <div className="space-y-8">
        {gameState === "ready" && (
          <div className="bg-white/10 backdrop-blur-md rounded-2xl p-8 border border-white/20 text-center">
            <div className="text-6xl mb-6">🤝</div>
            <h3 className="text-2xl font-bold text-white mb-4">Respect Blitz!</h3>
            <p className="text-white/90 text-lg mb-6">
              You have {ROUND_TIME} seconds to choose respect!
            </p>
            <button
              onClick={startGame}
...
export default ReflexRespectAlert;