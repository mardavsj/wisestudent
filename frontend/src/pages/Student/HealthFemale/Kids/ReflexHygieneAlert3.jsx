...
const ReflexHygieneAlert3 = () => {
  ...
  const totalXp = 10;
  const maxScore = 5;
  const gameId = "health-female-kids-43";
  ...
  const questions = [
    ...
    {
      id: 2,
      question: "When to brush?",
      correctAnswer: "Morning",
      options: [
        { text: "Never", isCorrect: false, emoji: "❌" },
        { text: "Morning", isCorrect: true, emoji: "🌅" },
        { text: "Once a year", isCorrect: false, emoji: "📅" },
        { text: "Noon", isCorrect: false, emoji: "🕛" }
      ]
    },
    {
      id: 3,
      question: "What wipes sweat?",
      correctAnswer: "Towel",
      options: [
        { text: "Towel", isCorrect: true, emoji: "🧖‍♀️" },
        { text: "Paper", isCorrect: false, emoji: "📄" },
        { text: "Leaf", isCorrect: false, emoji: "🍃" },
        { text: "Rock", isCorrect: false, emoji: "🪨" }
      ]
    },
    {
      id: 4,
      question: "Clean clothes stop...",
  ...
  return (
    <GameShell
      ...
      nextGamePathProp="/student/health-female/kids/hygiene-match-puzzle"
      nextGameIdProp="health-female-kids-44">
        ...
        {gameState === "ready" && (
          <div className="bg-white/10 backdrop-blur-md rounded-2xl p-8 border border-white/20 text-center">
            ...
            <p className="text-white/90 text-lg mb-6">
              You have {ROUND_TIME} seconds to spot the hygiene tool!
            </p>
            <button
              onClick={startGame}
...
export default ReflexHygieneAlert3;