...
const JournalOfSafety = () => {
  ...
  const gameId = "health-female-kids-77";
  ...
  const stages = [
    {
      question: 'Write: "I wash my hands before ___.',
      minLength: 10,
    },
    {
      question: 'Write: "I wear a helmet when I ___.',
      minLength: 10,
    },
    {
      question: 'Write: "When I cross the street, I look ___.',
      minLength: 10,
    },
    {
      question: 'Write: "My doctor helps me ___.',
      minLength: 10,
    },
    {
      question: 'Write: "To keep my teeth clean, I ___.',
      minLength: 10,
    },
  ];
  ...
  useEffect(() => {
    if (showResult) {
      console.log(`🎮 Journal of Safety game completed! Score: ${finalScore}/${stages.length}, gameId: ${gameId}`);
    }
  ...
  return (
    <GameShell
      ...
      subtitle={!showResult ? `Question ${currentStage + 1} of ${stages.length}: Staying Safe` : "Journal Complete!"}
      ...
      nextGamePathProp="/student/health-female/kids/period-hygiene-story"
      nextGameIdProp="health-female-kids-78">
      <div className="min-h-[calc(100vh-200px)] flex flex-col justify-center text-center text-white space-y-6 md:space-y-8 max-w-4xl mx-auto px-4 py-4">
        ...
        {showResult && (
          <div className="bg-white/10 backdrop-blur-md p-6 md:p-8 rounded-xl md:rounded-2xl border border-white/20 text-center">
            ...
            <h2 className="text-2xl font-bold text-white mb-6">Safety Journal Complete!</h2>
            
            <div className="bg-gradient-to-r from-blue-500/20 to-indigo-500/20 rounded-xl p-4 border border-blue-400/30 mb-6">
              <p className="text-blue-300 font-bold">
                🎉 Great job! You've completed your safety journal!
              </p>
              <p className="text-blue-300 mt-2">
                Recording your thoughts about safety helps you stay protected!
              </p>
            </div>
