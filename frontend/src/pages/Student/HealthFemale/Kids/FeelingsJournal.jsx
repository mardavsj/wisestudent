...
const FeelingsJournal = () => {
  ...
  const gameId = "health-female-kids-57";
  ...
  const stages = [
    {
      question: 'Write: "My favorite thing to do is ___.',
      minLength: 10,
    },
    {
      question: 'Write: "When I am sad, I hug ___.',
      minLength: 10,
    },
    {
      question: 'Write: "I feel brave when I ___.',
      minLength: 10,
    },
    {
      question: 'Write: "A good friend is ___.',
      minLength: 10,
    },
    {
      question: 'Write: "I am special because ___.',
      minLength: 10,
    },
  ];
  ...
  useEffect(() => {
    if (showResult) {
      console.log(`🎮 Feelings Journal game completed! Score: ${finalScore}/${stages.length}, gameId: ${gameId}`);
    }
  ...
  return (
    <GameShell
      ...
      subtitle={!showResult ? `Question ${currentStage + 1} of ${stages.length}: My Feelings` : "Journal Complete!"}
      ...
      nextGamePathProp="/student/health-female/kids/anger-story"
      nextGameIdProp="health-female-kids-58">
      <div className="min-h-[calc(100vh-200px)] flex flex-col justify-center text-center text-white space-y-6 md:space-y-8 max-w-4xl mx-auto px-4 py-4">
        ...
        {showResult && (
          <div className="bg-white/10 backdrop-blur-md p-6 md:p-8 rounded-xl md:rounded-2xl border border-white/20 text-center">
            ...
            <h2 className="text-2xl font-bold text-white mb-6">Feelings Journal Complete!</h2>
            ...
            <div className="bg-gradient-to-r from-purple-500/20 to-indigo-500/20 rounded-xl p-4 border border-purple-400/30 mb-6">
              <p className="text-purple-300 font-bold">
                🎉 Great job! You've completed your feelings journal!
              </p>
              <p className="text-purple-300 mt-2">
                Recording your feelings helps you understand yourself better!
              </p>
            </div>
