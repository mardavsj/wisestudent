...
const ReflexDangerAlert = () => {
  ...
  const questions = [
    {
      ...
      options: [
        { text: "Milk", isCorrect: false, emoji: "🥛" },
        { text: "Bleach", isCorrect: true, emoji: "☠️" },
  ...
  return (
    <GameShell
      ...
      nextGamePathProp="/student/health-female/kids/safe-girl-badge"
      nextGameIdProp="health-female-kids-90">
