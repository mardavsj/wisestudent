...
const ReflexGrowthCheck = () => {
  ...
  const totalXp = 10;
  const maxScore = 5;
  const gameId = "health-female-kids-23";
  ...
  const questions = [
    ...
    {
      id: 2,
      question: "To grow big...",
      correctAnswer: "Eat well",
      options: [
        { text: "Eat well", isCorrect: true, emoji: "🍲" },
        { text: "Eat nothing", isCorrect: false, emoji: "🤐" },
        { text: "Sit still", isCorrect: false, emoji: "🪑" },
        { text: "Yell", isCorrect: false, emoji: "📢" }
      ]
    },
    {
      id: 3,
      question: "If clothes are tight...",
  ...
  return (
    <GameShell
      ...
      subtitle={gameState === "playing" ? `Round ${currentRound}/${TOTAL_ROUNDS}` : "Growth Blitz!"}
      coins={score}
      ...
      nextGamePathProp="/student/health-female/kids/growth-helpers-puzzle"
      nextGameIdProp="health-female-kids-24">
      <div className="space-y-8">
        {gameState === "ready" && (
          <div className="bg-white/10 backdrop-blur-md rounded-2xl p-8 border border-white/20 text-center">
            <div className="text-6xl mb-6">🌱</div>
            <h3 className="text-2xl font-bold text-white mb-4">Growth Blitz!</h3>
            <p className="text-white/90 text-lg mb-6">
              You have {ROUND_TIME} seconds to spot the growth facts!
            </p>
            <button
              onClick={startGame}
