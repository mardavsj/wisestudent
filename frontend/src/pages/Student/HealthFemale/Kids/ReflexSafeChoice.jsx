...
const ReflexSafeChoice = () => {
  ...
  const questions = [
    {
      ...
      options: [
        { text: "Alcohol", isCorrect: false, emoji: "🍺" },
        { text: "Soda", isCorrect: false, emoji: "🥤" },
        { text: "Juice", isCorrect: true, emoji: "🧃" },
    ...
    {
      id: 3,
      question: "Healthy drink for bones?",
      options: [
    ...
    {
      id: 4,
      question: "Best food for energy?",
      options: [
        { text: "Salad", isCorrect: true, emoji: "🥗" },
  ...
  return (
    <GameShell
      ...
      subtitle={gameState === "playing" ? `Round ${currentRound}/${TOTAL_ROUNDS}` : "Safe Choice Blitz!"}
      coins={score}
      ...
      nextGamePathProp="/student/health-female/kids/healthy-vs-harmful-puzzle"
      nextGameIdProp="health-female-kids-84">
      <div className="space-y-8">
        {gameState === "ready" && (
          <div className="bg-white/10 backdrop-blur-md rounded-2xl p-8 border border-white/20 text-center">
            <div className="text-6xl mb-6">🍎</div>
            <h3 className="text-2xl font-bold text-white mb-4">Safe Choice Blitz!</h3>
            <p className="text-white/90 text-lg mb-6">
              You have {ROUND_TIME} seconds to pick the healthy choice!
            </p>
            <button
              onClick={startGame}
