...
const ReflexHealthyFood = () => {
  ...
  const totalXp = 10;
  const maxScore = 5;
  const gameId = "health-female-kids-13";
  ...
  const questions = [
    {
      ...
      options: [
        ...
        { text: "Broccoli", isCorrect: true, emoji: "🥦" },
  ...
  return (
    <GameShell
      ...
      subtitle={gameState === "playing" ? `Round ${currentRound}/${TOTAL_ROUNDS}` : "Healthy Food Blitz!"}
      coins={score}
      ...
      nextGamePathProp="/student/health-female/kids/nutrition-match-puzzle"
      nextGameIdProp="health-female-kids-14">
      <div className="space-y-8">
        {gameState === "ready" && (
          <div className="bg-white/10 backdrop-blur-md rounded-2xl p-8 border border-white/20 text-center">
            <div className="text-6xl mb-6">🥗</div>
            <h3 className="text-2xl font-bold text-white mb-4">Healthy Food Blitz!</h3>
            <p className="text-white/90 text-lg mb-6">
              You have {ROUND_TIME} seconds to spot the healthy choice!
            </p>
            <button
              onClick={startGame}
...
export default ReflexHealthyFood;