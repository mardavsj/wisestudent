...
const ReflexHygieneAlert2 = () => {
    ...
    const questions = [
        {
            id: 1,
            question: "Pad is full...",
            correctAnswer: "Change it",
            options: [
                { text: "Keep it", isCorrect: false, emoji: "🚫" },
                { text: "Hide it", isCorrect: false, emoji: "🙈" },
                { text: "Change it", isCorrect: true, emoji: "✅" },
                { text: "Ignore", isCorrect: false, emoji: "🤷‍♀️" }
            ]
        },
        {
            id: 2,
            question: "Before removing pad...",
            correctAnswer: "Wash Hands",
            options: [
                { text: "Wash Hands", isCorrect: true, emoji: "🧼" },
                { text: "Clap", isCorrect: false, emoji: "👏" },
        ...
        {
            id: 3,
            question: "Old pad goes in...",
            correctAnswer: "Bin",
            options: [
                { text: "Toilet", isCorrect: false, emoji: "🚽" },
                { text: "Bin", isCorrect: true, emoji: "🗑️" },
                { text: "Floor", isCorrect: false, emoji: "👇" },
                { text: "Pocket", isCorrect: false, emoji: "👖" }
            ]
        },
        {
            id: 4,
            ...
            options: [
                ...
                { text: "Daily", isCorrect: true, emoji: "🚿" },
                { text: "Monthly", isCorrect: false, emoji: "🗓️" },
                { text: "Yearly", isCorrect: false, emoji: "📅" }
            ]
        },
        {
            id: 5,
            question: "Underwear...",
            correctAnswer: "Clean Pair",
            options: [
    ...
    return (
        <GameShell
            ...
            subtitle={gameState === "playing" ? `Round ${currentRound}/${TOTAL_ROUNDS}` : "Hygiene Fast!"}
            coins={score}
          ...
          nextGamePathProp="/student/health-female/kids/period-ready-badge"
          nextGameIdProp="health-female-kids-100">
            <div className="space-y-8">
                {gameState === "ready" && (
                    <div className="bg-white/10 backdrop-blur-md rounded-2xl p-8 border border-white/20 text-center">
                        <div className="text-6xl mb-6">🧼</div>
                        <h3 className="text-2xl font-bold text-white mb-4">Hygiene Fast!</h3>
                        <p className="text-white/90 text-lg mb-6">
                            You have {ROUND_TIME} seconds to choose the clean habit!
                        </p>
                        <button
                            onClick={startGame}
                ...
                {gameState === "finished" && (
                    <div className="bg-white/10 backdrop-blur-md rounded-2xl p-8 border border-white/20 text-center">
                        <div className="text-6xl mb-6">🏆</div>
                        <h2 className="text-3xl font-bold text-white mb-4">Clean & Fast!</h2>
...
export default ReflexHygieneAlert2;