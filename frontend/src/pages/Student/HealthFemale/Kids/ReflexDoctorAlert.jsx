...
const ReflexDoctorAlert = () => {
  ...
  const questions = [
    {
      id: 1,
      question: "Which one helps you see?",
      correctAnswer: "Eye Doctor",
      options: [
        { text: "Eye Doctor", isCorrect: true, emoji: "👁️" },
        { text: "Vet", isCorrect: false, emoji: "🐶" },
        { text: "Chef", isCorrect: false, emoji: "👨‍🍳" },
        { text: "Pilot", isCorrect: false, emoji: "✈️" }
      ]
    },
    {
      id: 2,
      question: "Who checks your teeth?",
    ...
    {
      id: 3,
      question: "When you have a fever...",
      correctAnswer: "Rest",
      options: [
  ...
  return (
    <GameShell
      ...
      subtitle={gameState === "playing" ? `Round ${currentRound}/${TOTAL_ROUNDS}` : "Doctor Blitz!"}
      coins={score}
      ...
      nextGamePathProp="/student/health-female/kids/safety-smart-girl-badge"
      nextGameIdProp="health-female-kids-80">
      <div className="space-y-8">
        {gameState === "ready" && (
          <div className="bg-white/10 backdrop-blur-md rounded-2xl p-8 border border-white/20 text-center">
            <div className="text-6xl mb-6">🩺</div>
            <h3 className="text-2xl font-bold text-white mb-4">Doctor Blitz!</h3>
            <p className="text-white/90 text-lg mb-6">
              You have {ROUND_TIME} seconds to spot the right helper!
            </p>
            <button
              onClick={startGame}
...
export default ReflexDoctorAlert;