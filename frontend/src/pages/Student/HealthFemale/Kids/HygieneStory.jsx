...
const HygieneStory = () => {
    ...
    return (
        <GameShell
            ...
            totalXp={totalXp}
          nextGamePathProp="/student/health-female/kids/reflex-hygiene-alert-2"
          nextGameIdProp="health-female-kids-99">
                        ...
                        {finalScore >= 3 ? (
                            <div>
                                ...
                                <p className="text-white/90 text-base md:text-lg mb-4">
                                    ...
                                    You understand good hygiene practices!
                                </p>
                                <div className="bg-gradient-to-r from-yellow-500 to-orange-500 text-white py-2 md:py-3 px-4 md:px-6 rounded-full inline-flex items-center gap-2 mb-4 text-sm md:text-base">
                                    <span>+{coins} Coins</span>
                                </div>
                                <p className="text-white/80 text-sm md:text-base">
                                    Great job! You know that changing pads regularly, washing hands, and proper disposal are important for staying healthy and confident!
                                </p>
                            </div>
                        ) : (
                            <div>
                                ...
                                <p className="text-white/80 text-xs md:text-sm">
                                    Try to choose the option that shows good hygiene practices.
                                </p>
                            </div>
                        )}
                    </div>
