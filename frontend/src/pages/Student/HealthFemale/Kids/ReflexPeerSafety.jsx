...
const ReflexPeerSafety = () => {
  ...
  const totalXp = 10;
  const maxScore = 5;
  const gameId = "health-female-kids-63";
  ...
  const questions = [
    {
      id: 1,
      question: "Which friend is SAFE?",
      correctAnswer: "Helps you",
      options: [
        { text: "Pushes you", isCorrect: false, emoji: "😤" },
        { text: "Steals toy", isCorrect: false, emoji: "🧸" },
        { text: "Helps you", isCorrect: true, emoji: "🤝" },
        { text: "Lies to you", isCorrect: false, emoji: "🤥" }
      ]
    },
    {
      id: 2,
      question: "Which choice is SMART?",
      correctAnswer: "Doing homework",
      options: [
        { text: "Doing homework", isCorrect: true, emoji: "📚" },
        { text: "Skipping school", isCorrect: false, emoji: "🏃" },
        { text: "Punching", isCorrect: false, emoji: "👊" },
        { text: "Breaking glass", isCorrect: false, emoji: "🔨" }
      ]
    },
    {
      id: 3,
      question: "What to say to a bad dare?",
      correctAnswer: "No!",
      options: [
        { text: "Okay", isCorrect: false, emoji: "👌" },
  ...
  return (
    <GameShell
      ...
      subtitle={gameState === "playing" ? `Round ${currentRound}/${TOTAL_ROUNDS}` : "Peer Safety Blitz!"}
      coins={score}
      ...
      nextGamePathProp="/student/health-female/kids/peer-choices-puzzle"
      nextGameIdProp="health-female-kids-64">
      <div className="space-y-8">
        {gameState === "ready" && (
          <div className="bg-white/10 backdrop-blur-md rounded-2xl p-8 border border-white/20 text-center">
            <div className="text-6xl mb-6">🤝</div>
            <h3 className="text-2xl font-bold text-white mb-4">Peer Safety Blitz!</h3>
            <p className="text-white/90 text-lg mb-6">
              You have {ROUND_TIME} seconds to find the safe choice!
            </p>
            <button
              onClick={startGame}
...
export default ReflexPeerSafety;