...
const ReflexHabitAlert = () => {
  ...
  const questions = [
    {
      id: 1,
      question: "Which habit helps your body stay hydrated?",
      correctAnswer: "Drink Water",
      options: [
        { text: "Skip Water", isCorrect: false, emoji: "❌" },
        { text: "Drink Water", isCorrect: true, emoji: "💧" },
        { text: "Drink Soda", isCorrect: false, emoji: "🥤" },
        { text: "No Drinks", isCorrect: false, emoji: "🚫" }
      ]
    },
    {
      id: 2,
      question: "Which habit provides vitamins and nutrients?",
      correctAnswer: "Eat Fruit",
      options: [
        { text: "Skip Fruit", isCorrect: false, emoji: "❌" },
        { text: "Eat Candy", isCorrect: false, emoji: "🍬" },
        { text: "Eat Fruit", isCorrect: true, emoji: "🍎" },
        { text: "No Snacks", isCorrect: false, emoji: "🚫" }
      ]
    },
    {
      id: 3,
      question: "Which habit helps your body recover?",
      correctAnswer: "Sleep Early",
      options: [
        { text: "Stay Up Late", isCorrect: false, emoji: "🌙" },
        { text: "Sleep Early", isCorrect: true, emoji: "🛌" },
        { text: "No Sleep", isCorrect: false, emoji: "❌" },
        { text: "Nap Only", isCorrect: false, emoji: "😪" }
      ]
    },
    {
      id: 4,
      question: "Which habit prevents germs and improves focus?",
      correctAnswer: "Clean Room",
      options: [
        { text: "Leave Messy", isCorrect: false, emoji: "🗑️" },
        { text: "Clean Room", isCorrect: true, emoji: "🧹" },
        { text: "Ask Others", isCorrect: false, emoji: "🙋" },
        { text: "Ignore Mess", isCorrect: false, emoji: "🙅" }
      ]
    },
    {
      id: 5,
      question: "Which habit improves your knowledge and mind?",
      correctAnswer: "Read Book",
      options: [
        { text: "Skip Reading", isCorrect: false, emoji: "❌" },
        { text: "Watch TV", isCorrect: false, emoji: "📺" },
        { text: "Play Games", isCorrect: false, emoji: "🎮" },
        { text: "Read Book", isCorrect: true, emoji: "📚" }
      ]
    }
  ];
  ...
  return (
    <GameShell
      ...
      subtitle={gameState === "playing" ? `Round ${currentRound}/${TOTAL_ROUNDS}` : "Habit Blitz!"}
      coins={score}
      ...
      nextGamePathProp="/student/health-female/kids/healthy-matches-puzzle"
      nextGameIdProp="health-female-kids-34">
      <div className="space-y-8">
        {gameState === "ready" && (
          <div className="bg-white/10 backdrop-blur-md rounded-2xl p-8 border border-white/20 text-center">
            <div className="text-6xl mb-6">🎯</div>
            <h3 className="text-2xl font-bold text-white mb-4">Habit Blitz!</h3>
            <p className="text-white/90 text-lg mb-6">
              You have {ROUND_TIME} seconds to choose healthy habits!
            </p>
            <button
              onClick={startGame}
