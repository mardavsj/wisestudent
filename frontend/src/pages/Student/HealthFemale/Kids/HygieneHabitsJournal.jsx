...
const HygieneHabitsJournal = () => {
  ...
  useEffect(() => {
    if (showResult) {
      console.log(`🎮 Hygiene Habits Journal game completed! Score: ${finalScore}/${stages.length}, gameId: ${gameId}`);
    }
  ...
  return (
    <GameShell
      ...
      subtitle={!showResult ? `Question ${currentStage + 1} of ${stages.length}: My Promise` : "Journal Complete!"}
      ...
      nextGamePathProp="/student/health-female/kids/skin-care-story"
      nextGameIdProp="health-female-kids-48">
