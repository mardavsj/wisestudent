...
const JournalOfHygiene = () => {
  ...
  useEffect(() => {
    if (showResult) {
      console.log(`🎮 Journal of Hygiene game completed! Score: ${finalScore}/${stages.length}, gameId: ${gameId}`);
    }
  ...
  return (
    <GameShell
      ...
      nextGamePathProp="/student/health-female/kids/hair-care-story"
      nextGameIdProp="health-female-kids-8">
      <div className="min-h-[calc(100vh-200px)] flex flex-col justify-center text-center text-white space-y-6 md:space-y-8 max-w-4xl mx-auto px-4 py-4">
        ...
        {showResult && (
          <div className="bg-white/10 backdrop-blur-md p-6 md:p-8 rounded-xl md:rounded-2xl border border-white/20 text-center">
            ...
            <h2 className="text-2xl font-bold text-white mb-6">Hygiene Journal Complete!</h2>
            ...
            <div className="bg-gradient-to-r from-emerald-500/20 to-teal-500/20 rounded-xl p-4 border border-emerald-400/30 mb-6">
              <p className="text-emerald-300 font-bold">
                🎉 Great job! You've completed your hygiene journal!
              </p>
...
export default JournalOfHygiene;