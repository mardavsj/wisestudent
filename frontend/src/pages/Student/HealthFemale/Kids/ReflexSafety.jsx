...
const ReflexSafety = () => {
  ...
  const questions = [
    {
      ...
      correctAnswer: "Stove",
      options: [
        { text: "Ice", isCorrect: false, emoji: "🧊" },
        { text: "Water", isCorrect: false, emoji: "💧" },
        { text: "Stove", isCorrect: true, emoji: "🔥" },
        { text: "Snow", isCorrect: false, emoji: "❄️" }
      ]
    },
    {
      id: 2,
      question: "Wear this in a car:",
      correctAnswer: "Seatbelt",
      options: [
        { text: "Helmet", isCorrect: false, emoji: "⛑️" },
        { text: "Seatbelt", isCorrect: true, emoji: "🚙" },
        { text: "Scarf", isCorrect: false, emoji: "🧣" },
        { text: "Cape", isCorrect: false, emoji: "🦸" }
      ]
    },
    {
      id: 3,
      question: "Safe to play with:",
      correctAnswer: "Ball",
      options: [
        { text: "Ball", isCorrect: true, emoji: "⚽" },
        { text: "Knife", isCorrect: false, emoji: "🔪" },
        { text: "Matches", isCorrect: false, emoji: "🔥" },
        { text: "Glass", isCorrect: false, emoji: "🍷" }
      ]
    },
    {
      id: 4,
      question: "Cross the street at:",
      correctAnswer: "Crosswalk",
      options: [
        { text: "Anywhere", isCorrect: false, emoji: "🤷" },
        { text: "Crosswalk", isCorrect: true, emoji: "🦓" },
        { text: "Corner", isCorrect: false, emoji: "📐" },
        { text: "Middle", isCorrect: false, emoji: "🛣️" }
      ]
    },
    {
      id: 5,
      question: "Before eating:",
  ...
  return (
    <GameShell
      ...
      nextGamePathProp="/student/health-female/kids/safety-tools-puzzle"
      nextGameIdProp="health-female-kids-74">
        ...
        {gameState === "ready" && (
          <div className="bg-white/10 backdrop-blur-md rounded-2xl p-8 border border-white/20 text-center">
            ...
            <p className="text-white/90 text-lg mb-6">
              You have {ROUND_TIME} seconds to spot the safe choice!
            </p>
            <button
              onClick={startGame}
