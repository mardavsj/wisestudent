...
const QuizOnEmotions = () => {
  ...
  const questions = [
    {
      ...
      emoji: "😢",
      options: [
        { id: "a", text: "No, never", emoji: "🙅‍♀️", isCorrect: false },
        { id: "b", text: "Yes, it is normal", emoji: "✅", isCorrect: true },
        { id: "c", text: "Only if you fall down", emoji: "🤕", isCorrect: false }
      ]
    },
    {
      id: 2,
      ...
      emoji: "😠",
      options: [
        { id: "a", text: "Taking deep breaths", emoji: "🌬️", isCorrect: true },
        { id: "b", text: "Screaming at a friend", emoji: "📢", isCorrect: false },
        { id: "c", text: "Breaking a toy", emoji: "🔨", isCorrect: false }
      ]
    },
    {
      id: 3,
      ...
      emoji: "🤔",
      options: [
        { id: "a", text: "Guess", emoji: "🤔", isCorrect: false },
        { id: "b", text: "Look at their face or ask them", emoji: "👀", isCorrect: true },
  ...
  return (
    <GameShell
      ...
      nextGamePathProp="/student/health-female/kids/reflex-emotion-basics"
      nextGameIdProp="health-female-kids-53">
