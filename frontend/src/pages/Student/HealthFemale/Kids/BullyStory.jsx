...
const BullyStory = () => {
  ...
  return (
    <GameShell
      ...
      totalXp={totalXp}
      nextGamePathProp="/student/health-female/kids/power-of-no-poster"
      nextGameIdProp="health-female-kids-66">
            ...
            {finalScore >= 3 ? (
              <div>
                ...
                <p className="text-white/80 text-sm md:text-base">
                  Great job! You know that reporting bullying and standing up for others are the right things to do!
                </p>
              </div>
            ) : (
              <div>
                ...
                <p className="text-white/90 text-base md:text-lg mb-4">
                  You got {finalScore} out of {questions.length} questions correct.
                  Remember, bullying is never okay and there are always adults who can help!
                </p>
                <button
                ...
                <p className="text-white/80 text-xs md:text-sm">
                  Try to choose the option that shows how to handle bullying appropriately.
                </p>
              </div>
            )}
          </div>
