...
const ReflexTeenAlert = () => {
  ...
  const maxScore = 5;
  const gameId = "health-female-teen-79";
  ...
  const questions = [
    {
      id: 1,
      question: "What should you do with prescribed medication?",
      options: [
        { text: "Skip Dose", emoji: "❌", isCorrect: false },
        { text: "Take Medicine as Advised", emoji: "💊", isCorrect: true },
    ...
    {
      id: 4,
      question: "How should you monitor your health?",
      options: [
        { text: "Disregard Changes", emoji: "🤔", isCorrect: false },
        { text: "Track Symptoms", emoji: "📊", isCorrect: true },
        { text: "Skip Dose", emoji: "❌", isCorrect: false },
        { text: "Stop Early", emoji: "🛑", isCorrect: false }
      ]
    },
  ...
  const handleNext = () => {
    navigate("/student/health-female/teens/preventive-care-teen-badge");
  };
  ...
  return (
    <GameShell
      ...
      subtitle={gameState === "playing" ? `Round ${currentRound}/${TOTAL_ROUNDS}` : "Teen Alert Blitz!"}
      coins={score}
      ...
      nextGamePathProp="/student/health-female/teens/preventive-care-teen-badge"
      nextGameIdProp="health-female-teen-80">
      <div className="space-y-8">
        {gameState === "ready" && (
          <div className="bg-white/10 backdrop-blur-md rounded-2xl p-8 border border-white/20 text-center">
            <div className="text-6xl mb-6">💊</div>
            <h3 className="text-2xl font-bold text-white mb-4">Teen Alert Blitz!</h3>
            <p className="text-white/90 text-lg mb-6">
              You have {ROUND_TIME} seconds to choose the positive medication habit!
            </p>
            <button
              onClick={startGame}
