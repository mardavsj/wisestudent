...
const FoodChoicesJournal = () => {
  const location = useLocation();
  
  // Get game data from game category folder (source of truth)
  const gameId = "health-female-teen-17";
  ...
  const stages = [
    {
      question: 'Write: "One change I made in my eating habits is ___.',
      minLength: 10,
    },
    {
      question: 'Write: "I learned that ___ food gives me more energy for sports."',
      minLength: 10,
    },
    {
      question: 'Write: "A challenge I faced with healthy eating was ___.',
      minLength: 10,
    },
    {
      question: 'Write: "One healthy food choice that made me feel good is ___.',
      minLength: 10,
    },
    {
      question: 'Write: "In the future, I want to improve my ___ eating habit."',
      minLength: 10,
    },
  ];
  ...
  useEffect(() => {
    if (showResult) {
      console.log(`🎮 Journal of Food Choices game completed! Score: ${finalScore}/${stages.length}, gameId: ${gameId}`);
    }
  ...
  return (
    <GameShell
      ...
      subtitle={!showResult ? `Question ${currentStage + 1} of ${stages.length}: Reflect on your nutrition journey!` : "Journal Complete!"}
      ...
      nextGamePathProp="/student/health-female/teens/weekly-meals-simulation"
      nextGameIdProp="health-female-teen-18">
...
export default FoodChoicesJournal;