...
const BalancedDietStory = () => {
  ...
  return (
    <GameShell
      ...
      totalXp={totalXp}
      nextGamePathProp="/student/health-female/teens/quiz-nutrition"
      nextGameIdProp="health-female-teen-12">
          ...
          <div className="bg-white/10 backdrop-blur-md rounded-xl md:rounded-2xl p-6 md:p-8 border border-white/20 text-center flex-1 flex flex-col justify-center">
            {finalScore >= 3 ? (
              <div>
                ...
                <h3 className="text-xl md:text-2xl font-bold text-white mb-4">Balanced Diet Expert!</h3>
                ...
                <p className="text-white/80 text-sm md:text-base">
                  Great job! You know that balanced meals with traditional foods, occasional treats, and proper nutrition during stressful times support your health and growth!
                </p>
              </div>
            ) : (
              <div>
                ...
                <p className="text-white/90 text-base md:text-lg mb-4">
                  You got {finalScore} out of {questions.length} questions correct.
                  Learning about balanced nutrition takes practice!
                </p>
                <button
                ...
                <p className="text-white/80 text-xs md:text-sm">
                  Try to choose the option that shows the best balanced diet practices.
                </p>
              </div>
            )}
          </div>
