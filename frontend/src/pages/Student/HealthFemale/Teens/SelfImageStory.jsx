...
const SelfImageStory = () => {
  ...
  return (
    <GameShell
      ...
      totalXp={totalXp}
      nextGamePathProp="/student/health-female/teens/quiz-self-esteem"
      nextGameIdProp="health-female-teen-62">
          ...
          <div className="bg-white/10 backdrop-blur-md rounded-xl md:rounded-2xl p-6 md:p-8 border border-white/20 text-center flex-1 flex flex-col justify-center">
            {finalScore >= 3 ? (
              <div>
                ...
                <h3 className="text-xl md:text-2xl font-bold text-white mb-4">Self-Image Expert!</h3>
                <p className="text-white/90 text-base md:text-lg mb-4">
                  You got {finalScore} out of {questions.length} questions correct!
                  You understand the importance of healthy self-image!
                </p>
                <div className="bg-gradient-to-r from-yellow-500 to-orange-500 text-white py-2 md:py-3 px-4 md:px-6 rounded-full inline-flex items-center gap-2 mb-4 text-sm md:text-base">
                  <span>+{coins} Coins</span>
                </div>
                <p className="text-white/80 text-sm md:text-base">
                  Great job! You know that valuing yourself, embracing uniqueness, focusing on personal growth, understanding social media effects, and seeking guidance are all key to maintaining a healthy self-image!
                </p>
              </div>
            ) : (
              <div>
                ...
                <p className="text-white/90 text-base md:text-lg mb-4">
                  You got {finalScore} out of {questions.length} questions correct.
                  Building a healthy self-image takes time and understanding!
                </p>
                <button
                ...
                <p className="text-white/80 text-xs md:text-sm">
                  Try to choose the option that shows the healthiest approach to self-image and personal growth.
                </p>
              </div>
            )}
          </div>
