...
const ReflexTeenHealth = () => {
  ...
  const maxScore = 5;
  const gameId = "health-female-teen-29";
  ...
  return (
    <GameShell
      ...
      subtitle={gameState === "playing" ? `Round ${currentRound}/${TOTAL_ROUNDS}` : "Preventive Care Blitz!"}
      coins={score}
      ...
      nextGamePathProp="/student/health-female/teens/puberty-smart-girl-badge"
      nextGameIdProp="health-female-teen-30">
      <div className="space-y-8">
        {gameState === "ready" && (
          <div className="bg-white/10 backdrop-blur-md rounded-2xl p-8 border border-white/20 text-center">
            <div className="text-6xl mb-6">🏥</div>
            <h3 className="text-2xl font-bold text-white mb-4">Preventive Care Blitz!</h3>
            <p className="text-white/90 text-lg mb-6">
              You have {ROUND_TIME} seconds to choose the positive health option!
            </p>
            <button
              onClick={startGame}
...
export default ReflexTeenHealth;