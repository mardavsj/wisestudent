...
const ReflexTeenFreshness = () => {
  ...
  const maxScore = 5;
  const gameId = "health-female-teen-49";
  ...
  const questions = [
    {
      id: 1,
      question: "Which item promotes personal hygiene?",
      options: [
    ...
    {
      id: 2,
      question: "What's best for cleanliness during menstruation?",
      options: [
        { text: "Used Towel", emoji: "🧴", isCorrect: false },
        { text: "Clean Towel", emoji: "🧻", isCorrect: true },
        { text: "Dirty Clothes", emoji: "👕", isCorrect: false },
        { text: "Old Pad", emoji: "📎", isCorrect: false }
      ]
    },
    {
      id: 3,
      question: "Which product ensures menstrual hygiene?",
      options: [
        { text: "New Pad", emoji: "🩹", isCorrect: true },
        { text: "Old Pad", emoji: "📎", isCorrect: false },
        { text: "Dirty Clothes", emoji: "👕", isCorrect: false },
        { text: "Used Towel", emoji: "🧴", isCorrect: false }
      ]
  ...
  const handleNext = () => {
    navigate("/student/health-female/teens/badge-hygiene-pro-girl");
  };
  ...
  return (
    <GameShell
      ...
      subtitle={gameState === "playing" ? `Round ${currentRound}/${TOTAL_ROUNDS}` : "Hygiene Freshness Blitz!"}
      coins={score}
      ...
      nextGamePathProp="/student/health-female/teens/badge-hygiene-pro-girl"
      nextGameIdProp="health-female-teen-50">
      <div className="space-y-8">
        {gameState === "ready" && (
          <div className="bg-white/10 backdrop-blur-md rounded-2xl p-8 border border-white/20 text-center">
            <div className="text-6xl mb-6">👚</div>
            <h3 className="text-2xl font-bold text-white mb-4">Hygiene Freshness Blitz!</h3>
            <p className="text-white/90 text-lg mb-6">
              You have {ROUND_TIME} seconds to choose the fresh option!
            </p>
            <button
              onClick={startGame}
              className="bg-gradient-to-r from-blue-500 to-teal-600 hover:from-blue-600 hover:to-teal-700 text-white py-4 px-8 rounded-full text-xl font-bold shadow-lg transition-all transform hover:scale-105"
            >
              Start Game
            </button>
          </div>
        ...
        {gameState === "finished" && (
          <div className="bg-white/10 backdrop-blur-md rounded-2xl p-8 border border-white/20 text-center">
            ...
            <div className="flex justify-center gap-4">
              ...
              <button
                onClick={handleNext}
                className="bg-gradient-to-r from-blue-500 to-teal-600 hover:from-blue-600 hover:to-teal-700 text-white font-bold py-3 px-6 rounded-full transition-all shadow-lg"
              >
                Next Game
              </button>
            </div>
...
export default ReflexTeenFreshness;