...
const SweatControlStory = () => {
  ...
  const questions = [
    ...
    },
    {
      ...
      options: [
        ...
        {
          id: "c",
          text: "Wear breathable, moisture-wicking clothing",
          emoji: "👕",
          isCorrect: true
        }
      ]
  ...
  return (
    <GameShell
      ...
      totalXp={totalXp}
      nextGamePathProp="/student/health-female/teens/quiz-teen-hygiene"
      nextGameIdProp="health-female-teen-42">
            ...
            {finalScore >= 3 ? (
              <div>
                ...
                <p className="text-white/90 text-base md:text-lg mb-4">
                  ...
                  You understand effective sweat management techniques!
                </p>
                <div className="bg-gradient-to-r from-yellow-500 to-orange-500 text-white py-2 md:py-3 px-4 md:px-6 rounded-full inline-flex items-center gap-2 mb-4 text-sm md:text-base">
                  <span>+{coins} Coins</span>
                </div>
                <p className="text-white/80 text-sm md:text-base">
                  Great job! You know that showering immediately removes bacteria, patting skin gently with a clean towel prevents irritation, washing sports clothes after each use prevents buildup, moisture-wicking fabrics keep you dry, and wearing breathable clothing manages sweat during activities!
                </p>
              </div>
            ) : (
              <div>
                ...
                <p className="text-white/90 text-base md:text-lg mb-4">
                  You got {finalScore} out of {questions.length} questions correct.
                  Managing sweat properly is important for hygiene and comfort!
                </p>
                <button
                ...
                <p className="text-white/80 text-xs md:text-sm">
                  Try to choose the option that shows the best approach to sweat control.
                </p>
              </div>
            )}
          </div>
