...
const ReflexTeenAlertHabits = () => {
  ...
  const maxScore = 5;
  const gameId = "health-female-teen-99";
  ...
  const questions = [
    ...
    {
      id: 5,
      question: "Which approach builds lasting habits?",
      options: [
        { text: "Random Actions", emoji: "🔀", isCorrect: false },
        { text: "Daily Practice", emoji: "📅", isCorrect: true },
        { text: "Skipping Habits", emoji: "❌", isCorrect: false },
  ...
  const handleNext = () => {
    navigate("/student/health-female/teens/lifelong-healthy-girl-badge");
  };
  ...
  return (
    <GameShell
      ...
      subtitle={gameState === "playing" ? `Round ${currentRound}/${TOTAL_ROUNDS}` : "Habit Alert Blitz!"}
      coins={score}
      ...
      <div className="space-y-8">
        {gameState === "ready" && (
          <div className="bg-white/10 backdrop-blur-md rounded-2xl p-8 border border-white/20 text-center">
            ...
            <h3 className="text-2xl font-bold text-white mb-4">Habit Alert Blitz!</h3>
            <p className="text-white/90 text-lg mb-6">
              You have {ROUND_TIME} seconds to choose the consistency habit!
            </p>
            <button
              onClick={startGame}
...
export default ReflexTeenAlertHabits;