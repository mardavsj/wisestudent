...
const ReflexStressCheck = () => {
  ...
  const maxScore = 5;
  const gameId = "health-female-teen-53";
  ...
  const questions = [
    {
      id: 1,
      question: "What's a healthy way to handle stress?",
      options: [
        { text: "Bottle Emotions", emoji: "❌", isCorrect: false },
        { text: "Talk to Friend", emoji: "💬", isCorrect: true },
    ...
    {
      id: 3,
      question: "What's a good way to clear your mind?",
      options: [
        { text: "Take a Walk", emoji: "🚶", isCorrect: true },
  ...
  const handleNext = () => {
    navigate("/student/health-female/teens/puzzle-mind-body-match");
  };
  ...
  return (
    <GameShell
      ...
      subtitle={gameState === "playing" ? `Round ${currentRound}/${TOTAL_ROUNDS}` : "Stress Check Blitz!"}
      coins={score}
      ...
      nextGamePathProp="/student/health-female/teens/puzzle-mind-body-match"
      nextGameIdProp="health-female-teen-54">
      <div className="space-y-8">
        {gameState === "ready" && (
          <div className="bg-white/10 backdrop-blur-md rounded-2xl p-8 border border-white/20 text-center">
            <div className="text-6xl mb-6">💬</div>
            <h3 className="text-2xl font-bold text-white mb-4">Stress Check Blitz!</h3>
            <p className="text-white/90 text-lg mb-6">
              You have {ROUND_TIME} seconds to choose the healthy stress response!
            </p>
            <button
              onClick={startGame}
