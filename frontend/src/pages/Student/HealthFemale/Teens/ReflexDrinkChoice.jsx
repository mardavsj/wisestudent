...
const ReflexDrinkChoice = () => {
  ...
  const maxScore = 5;
  const gameId = "health-female-teen-19";
  ...
  const questions = [
    {
      ...
      options: [
        { text: "Cola", emoji: "🥤", isCorrect: false },
        { text: "Water", emoji: "💧", isCorrect: true },
        { text: "Energy Drink", emoji: "🔋", isCorrect: false },
        { text: "Fruit Drink", emoji: "🍹", isCorrect: false }
      ]
    },
    {
      id: 2,
      question: "Which drink helps with hydration?",
      options: [
        { text: "Soda", emoji: "🥤", isCorrect: false },
        { text: "Coconut Water", emoji: "🥥", isCorrect: true },
        { text: "Cola", emoji: "🥤", isCorrect: false },
        { text: "Energy Drink", emoji: "🔋", isCorrect: false }
      ]
    },
    {
      id: 3,
      question: "Which drink provides calcium?",
      options: [
    ...
    {
      id: 4,
      question: "Which is a natural source of vitamins?",
      options: [
        { text: "Energy Drink", emoji: "🔋", isCorrect: false },
        { text: "Fresh Juice", emoji: "🧃", isCorrect: true },
        { text: "Fruit Drink", emoji: "🍹", isCorrect: false },
        { text: "Soda", emoji: "🥤", isCorrect: false }
      ]
    },
    {
      id: 5,
      question: "Which drink should you choose for daily hydration?",
      options: [
        { text: "Cola", emoji: "🥤", isCorrect: false },
        { text: "Soda", emoji: "🥤", isCorrect: false },
        { text: "Water", emoji: "💧", isCorrect: true },
  ...
  const handleNext = () => {
    navigate("/student/health-female/teens/nutrition-pro-girl-badge");
  };
  ...
  return (
    <GameShell
      ...
      subtitle={gameState === "playing" ? `Round ${currentRound}/${TOTAL_ROUNDS}` : "Drink Choice Blitz!"}
      coins={score}
      ...
      nextGamePathProp="/student/health-female/teens/nutrition-pro-girl-badge"
      nextGameIdProp="health-female-teen-20">
      <div className="space-y-8">
        {gameState === "ready" && (
          <div className="bg-white/10 backdrop-blur-md rounded-2xl p-8 border border-white/20 text-center">
            <div className="text-6xl mb-6">🥤</div>
            <h3 className="text-2xl font-bold text-white mb-4">Drink Choice Blitz!</h3>
            <p className="text-white/90 text-lg mb-6">
              You have {ROUND_TIME} seconds to choose the healthy drink!
            </p>
            <button
              onClick={startGame}
...
export default ReflexDrinkChoice;