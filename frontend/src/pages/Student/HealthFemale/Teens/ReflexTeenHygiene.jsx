...
const ReflexTeenHygiene = () => {
  ...
  const maxScore = 5;
  const gameId = "health-female-teen-43";
  ...
  options: [
    ...
    {
      id: 5,
      question: "What's essential for personal hygiene?",
      options: [
        { text: "Skip Deodorant", emoji: "👕", isCorrect: false },
  ...
  const handleNext = () => {
    navigate("/student/health-female/teens/puzzle-hygiene-tools");
  };
  ...
  return (
    <GameShell
      ...
      subtitle={gameState === "playing" ? `Round ${currentRound}/${TOTAL_ROUNDS}` : "Smart Hygiene Blitz!"}
      coins={score}
      ...
      nextGamePathProp="/student/health-female/teens/puzzle-hygiene-tools"
      nextGameIdProp="health-female-teen-44">
      <div className="space-y-8">
        {gameState === "ready" && (
          <div className="bg-white/10 backdrop-blur-md rounded-2xl p-8 border border-white/20 text-center">
            <div className="text-6xl mb-6">🧼</div>
            <h3 className="text-2xl font-bold text-white mb-4">Smart Hygiene Blitz!</h3>
...
export default ReflexTeenHygiene;