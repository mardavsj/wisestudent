...
const PuzzleHygieneTools = () => {
  ...
  const correctMatches = [
    { toolId: 1, useId: 1 }, // Face Wash → Cleans facial skin and prevents acne
    { toolId: 2, useId: 2 }, // Pad → Manages menstrual blood flow
    { toolId: 3, useId: 3 }, // Soap → Cleans body and removes germs
    { toolId: 4, useId: 4 }, // Deodorant → Reduces underarm body odor
    { toolId: 5, useId: 5 }  // Shampoo → Cleanses hair and scalp
  ];
  ...
  return (
    <GameShell
      ...
      totalXp={totalXp}
      nextGamePathProp="/student/health-female/teens/period-routine-story"
      nextGameIdProp="health-female-teen-45">
            ...
            {score >= 3 ? (
              <div>
                ...
                <p className="text-white/90 text-lg mb-4">
                  You correctly matched {score} out of {tools.length} hygiene tools with their uses!
                </p>
                <div className="bg-gradient-to-r from-yellow-500 to-orange-500 text-white py-3 px-6 rounded-full inline-flex items-center gap-2 mb-4">
                  <span>+{score} Coins</span>
                </div>
                <p className="text-white/80">
                  Lesson: Understanding hygiene tools and their specific uses helps maintain better personal health!
                </p>
              </div>
            ) : (
              <div>
