...
const JournalOfTeenHygiene = () => {
  ...
  const gameId = "health-female-teen-47";
  ...
  const stages = [
    {
      question: 'Write: "One hygiene challenge I overcame is ___.',
      minLength: 10,
    },
    {
      question: 'Write: "A new hygiene routine I started is ___.',
      minLength: 10,
    },
    {
      question: 'Write: "Something I learned about my body during puberty is ___.',
      minLength: 10,
    },
    {
      question: 'Write: "How I handle hygiene when traveling or away from home is ___.',
      minLength: 10,
    },
    {
      question: 'Write: "One product that helped me with hygiene is ___.',
      minLength: 10,
    },
  ];
  ...
  useEffect(() => {
    if (showResult) {
      console.log(`🎮 Journal of Teen Hygiene game completed! Score: ${finalScore}/${stages.length}, gameId: ${gameId}`);
    }
  ...
  return (
    <GameShell
      ...
      subtitle={!showResult ? `Question ${currentStage + 1} of ${stages.length}: Reflect on your hygiene journey!` : "Journal Complete!"}
      ...
      nextGamePathProp="/student/health-female/teens/simulation-daily-routine"
      nextGameIdProp="health-female-teen-48">
      <div className="min-h-[calc(100vh-200px)] flex flex-col justify-center text-center text-white space-y-6 md:space-y-8 max-w-4xl mx-auto px-4 py-4">
        ...
        {showResult && (
          <div className="bg-white/10 backdrop-blur-md p-6 md:p-8 rounded-xl md:rounded-2xl border border-white/20 text-center">
            ...
            <h2 className="text-2xl font-bold text-white mb-6">Teen Hygiene Journal Complete!</h2>
            ...
            <div className="bg-gradient-to-r from-pink-500/20 to-rose-500/20 rounded-xl p-4 border border-pink-400/30 mb-6">
              <p className="text-pink-300 font-bold">
                🎉 Great job! You've completed your teen hygiene journal!
              </p>
              <p className="text-pink-300 mt-2">
                Recording your thoughts about hygiene helps you stay healthy!
              </p>
            </div>
            ...
            >
              Continue to Daily Routine Simulation
            </button>
          </div>
        )}
      </div>
