...
const ReflexTeenSafety = () => {
  ...
  const maxScore = 5;
  const gameId = "health-female-teen-89";
  ...
  const questions = [
    ...
    {
      id: 5,
      question: "What's essential when facing danger?",
      options: [
        { text: "Stay in Danger", emoji: "⚠️", isCorrect: false },
        { text: "Seek Help", emoji: "🆘", isCorrect: true },
        { text: "Risk Safety", emoji: "❗", isCorrect: false },
  ...
  const handleNext = () => {
    navigate("/student/health-female/teens/drug-free-teen-girl-badge");
  };
  ...
  return (
    <GameShell
      ...
      subtitle={gameState === "playing" ? `Round ${currentRound}/${TOTAL_ROUNDS}` : "Safety Response Blitz!"}
      coins={score}
      ...
      nextGamePathProp="/student/health-female/teens/drug-free-teen-girl-badge"
      nextGameIdProp="health-female-teen-90">
      <div className="space-y-8">
        {gameState === "ready" && (
          <div className="bg-white/10 backdrop-blur-md rounded-2xl p-8 border border-white/20 text-center">
            <div className="text-6xl mb-6">🆘</div>
            <h3 className="text-2xl font-bold text-white mb-4">Safety Response Blitz!</h3>
            <p className="text-white/90 text-lg mb-6">
              You have {ROUND_TIME} seconds to choose the safe action!
            </p>
            <button
              onClick={startGame}
              className="bg-gradient-to-r from-red-500 to-orange-600 hover:from-red-600 hover:to-orange-700 text-white py-4 px-8 rounded-full text-xl font-bold shadow-lg transition-all transform hover:scale-105"
            >
              Start Game
            </button>
          </div>
        ...
        {gameState === "finished" && (
          <div className="bg-white/10 backdrop-blur-md rounded-2xl p-8 border border-white/20 text-center">
            ...
            <div className="flex justify-center gap-4">
              ...
              <button
                onClick={handleNext}
                className="bg-gradient-to-r from-red-500 to-orange-600 hover:from-red-600 hover:to-orange-700 text-white font-bold py-3 px-6 rounded-full transition-all shadow-lg"
              >
                Next Game
              </button>
            </div>
