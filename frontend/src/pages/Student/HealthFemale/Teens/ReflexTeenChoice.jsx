...
const ReflexTeenChoice = () => {
  ...
  const maxScore = 5;
  const gameId = "health-female-teen-83";
  ...
  const handleNext = () => {
    navigate("/student/health-female/teens/puzzle-substance-effects");
  };
  ...
  return (
    <GameShell
      ...
      subtitle={gameState === "playing" ? `Round ${currentRound}/${TOTAL_ROUNDS}` : "Healthy Choices Blitz!"}
      coins={score}
      ...
      nextGamePathProp="/student/health-female/teens/puzzle-substance-effects"
      nextGameIdProp="health-female-teen-84">
      <div className="space-y-8">
        {gameState === "ready" && (
          <div className="bg-white/10 backdrop-blur-md rounded-2xl p-8 border border-white/20 text-center">
            <div className="text-6xl mb-6">⚽</div>
            <h3 className="text-2xl font-bold text-white mb-4">Healthy Choices Blitz!</h3>
            <p className="text-white/90 text-lg mb-6">
              You have {ROUND_TIME} seconds to choose the healthy activity!
            </p>
            <button
              onClick={startGame}
