...
const ReflexTeenHabits = () => {
  ...
  const maxScore = 5;
  const gameId = "health-female-teen-93";
  ...
  const questions = [
    {
      id: 1,
      question: "What's the best approach to physical fitness?",
      options: [
        { text: "Ignore Health", emoji: "❌", isCorrect: false },
        { text: "Exercise Daily", emoji: "🏃‍♀️", isCorrect: true },
    ...
    {
      id: 3,
      question: "What promotes better rest and recovery?",
      options: [
        { text: "Early Sleep", emoji: "😴", isCorrect: true },
        { text: "All Nighter", emoji: "🌙", isCorrect: false },
        { text: "Ignore Health", emoji: "❌", isCorrect: false },
        { text: "Skip Meals", emoji: "🍽️", isCorrect: false }
      ]
    ...
    {
      id: 4,
      question: "Which habit supports academic achievement?",
      options: [
        { text: "Procrastinate", emoji: "⏰", isCorrect: false },
        { text: "Study Time", emoji: "📚", isCorrect: true },
        { text: "All Nighter", emoji: "🌙", isCorrect: false },
        { text: "Ignore Health", emoji: "❌", isCorrect: false }
      ]
    },
  ...
  const handleNext = () => {
    navigate("/student/health-female/teens/puzzle-habit-builder");
  };
  ...
  return (
    <GameShell
      ...
      subtitle={gameState === "playing" ? `Round ${currentRound}/${TOTAL_ROUNDS}` : "Healthy Habits Blitz!"}
      coins={score}
      ...
      nextGamePathProp="/student/health-female/teens/puzzle-habit-builder"
      nextGameIdProp="health-female-teen-94">
      <div className="space-y-8">
        {gameState === "ready" && (
          <div className="bg-white/10 backdrop-blur-md rounded-2xl p-8 border border-white/20 text-center">
            <div className="text-6xl mb-6">🏃‍♀️</div>
            <h3 className="text-2xl font-bold text-white mb-4">Healthy Habits Blitz!</h3>
            <p className="text-white/90 text-lg mb-6">
              You have {ROUND_TIME} seconds to choose the healthy habit!
            </p>
            <button
              onClick={startGame}
...
export default ReflexTeenHabits;