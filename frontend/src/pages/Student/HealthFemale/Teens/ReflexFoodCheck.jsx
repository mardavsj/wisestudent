...
const ReflexFoodCheck = () => {
  ...
  const maxScore = 5;
  const gameId = "health-female-teen-13";
  ...
  const handleNext = () => {
    navigate("/student/health-female/teens/nutrients-match-puzzle");
  };
  ...
  return (
    <GameShell
      ...
      subtitle={gameState === "playing" ? `Round ${currentRound}/${TOTAL_ROUNDS}` : "Food Choice Blitz!"}
      coins={score}
      ...
      <div className="space-y-8">
        {gameState === "ready" && (
          <div className="bg-white/10 backdrop-blur-md rounded-2xl p-8 border border-white/20 text-center">
            ...
            <h3 className="text-2xl font-bold text-white mb-4">Food Choice Blitz!</h3>
            <p className="text-white/90 text-lg mb-6">
              You have {ROUND_TIME} seconds to choose the healthy food option!
            </p>
            <button
              onClick={startGame}
...
export default ReflexFoodCheck;