...
const ReflexHygieneAlert = () => {
  ...
  const maxScore = 5;
  const gameId = "health-female-teen-9";
  ...
  const questions = [
    {
      id: 1,
      question: "What's the best practice for personal cleanliness?",
      options: [
        { text: "Repeat Dirty", emoji: "👕", isCorrect: false },
        { text: "Fresh Clothes", emoji: "👚", isCorrect: true },
        { text: "Skip Washing", emoji: "💧", isCorrect: false },
        { text: "Skip Brushing", emoji: "🦷", isCorrect: false }
      ]
    },
    {
      id: 2,
      question: "How should you manage menstrual hygiene?",
      options: [
        { text: "Reuse Product", emoji: "❌", isCorrect: false },
        { text: "Use Sanitary Pad", emoji: "🧻", isCorrect: true },
        { text: "Repeat Dirty", emoji: "👕", isCorrect: false },
        { text: "Skip Washing", emoji: "💧", isCorrect: false }
      ]
    },
    {
      id: 3,
      question: "What's essential for hand hygiene?",
      options: [
    ...
    {
      id: 4,
      question: "What's important for oral hygiene?",
      options: [
        { text: "Skip Brushing", emoji: "🦷", isCorrect: false },
    ...
    {
      id: 5,
      question: "Which is a key hygiene habit?",
      options: [
        { text: "Skip Washing", emoji: "💧", isCorrect: false },
        { text: "Reuse Product", emoji: "❌", isCorrect: false },
        { text: "Fresh Clothes", emoji: "👚", isCorrect: true },
  ...
  const handleNext = () => {
    navigate("/student/health-female/teens/hygiene-pro-girl-badge");
  };
  ...
  return (
    <GameShell
      ...
      subtitle={gameState === "playing" ? `Round ${currentRound}/${TOTAL_ROUNDS}` : "Hygiene Alert Blitz!"}
      coins={score}
      ...
      nextGamePathProp="/student/health-female/teens/hygiene-pro-girl-badge"
      nextGameIdProp="health-female-teen-10">
      <div className="space-y-8">
        {gameState === "ready" && (
          <div className="bg-white/10 backdrop-blur-md rounded-2xl p-8 border border-white/20 text-center">
            <div className="text-6xl mb-6">🧼</div>
            <h3 className="text-2xl font-bold text-white mb-4">Hygiene Alert Blitz!</h3>
