...
const ReflexHygieneCheck = () => {
  ...
  const maxScore = 5;
  const gameId = "health-female-teen-3";
  ...
  const questions = [
    {
      id: 1,
      question: "What's the best way to stay fresh throughout the day?",
      options: [
        { text: "Ignore Sweat", emoji: "❌", isCorrect: false },
        { text: "Use Deodorant", emoji: "🧴", isCorrect: true },
        { text: "Skip Cleansing", emoji: "💧", isCorrect: false },
        { text: "Wear Dirty", emoji: "👚", isCorrect: false }
      ]
    },
    {
      id: 2,
      question: "How should you care for your skin?",
      options: [
        { text: "Skip Cleansing", emoji: "💧", isCorrect: false },
        { text: "Wash Face", emoji: "🧼", isCorrect: true },
        { text: "Ignore Sweat", emoji: "❌", isCorrect: false },
        { text: "Wear Dirty", emoji: "👚", isCorrect: false }
      ]
    },
    {
      id: 3,
      question: "What's important for clothing hygiene?",
      options: [
        { text: "Change Clothes", emoji: "👕", isCorrect: true },
        { text: "Wear Dirty", emoji: "👚", isCorrect: false },
        { text: "Ignore Sweat", emoji: "❌", isCorrect: false },
        { text: "Skip Cleansing", emoji: "💧", isCorrect: false }
      ]
    ...
    {
      id: 4,
      question: "What's essential for oral health?",
      options: [
    ...
    {
      id: 5,
      question: "Which is a key hygiene practice?",
      options: [
        { text: "Skip Brushing", emoji: "🦷", isCorrect: false },
        { text: "Use Deodorant", emoji: "🧴", isCorrect: true },
        { text: "Skip Cleansing", emoji: "💧", isCorrect: false },
  ...
  const handleNext = () => {
    navigate("/student/health-female/teens/hygiene-tools-puzzle");
  };
  ...
  return (
    <GameShell
      ...
      subtitle={gameState === "playing" ? `Round ${currentRound}/${TOTAL_ROUNDS}` : "Hygiene Check Blitz!"}
      coins={score}
      ...
      nextGamePathProp="/student/health-female/teens/hygiene-tools-puzzle"
      nextGameIdProp="health-female-teen-4">
      <div className="space-y-8">
        {gameState === "ready" && (
          <div className="bg-white/10 backdrop-blur-md rounded-2xl p-8 border border-white/20 text-center">
            <div className="text-6xl mb-6">🧴</div>
            <h3 className="text-2xl font-bold text-white mb-4">Hygiene Check Blitz!</h3>
            <p className="text-white/90 text-lg mb-6">
              You have {ROUND_TIME} seconds to choose the smart hygiene option!
            </p>
            <button
              onClick={startGame}
...
export default ReflexHygieneCheck;