...
const ReflexEmotionalHealth = () => {
  ...
  const maxScore = 5;
  const gameId = "health-female-teen-59";
  ...
  const questions = [
    ...
    {
      id: 3,
      question: "Who should you talk to when feeling overwhelmed?",
      options: [
        { text: "Isolate Self", emoji: "🚪", isCorrect: false },
        { text: "Stay Silent", emoji: "🤐", isCorrect: false },
    ...
    {
      id: 4,
      question: "What helps maintain emotional wellness?",
      options: [
        { text: "Bottle Up", emoji: "🔒", isCorrect: false },
        { text: "Isolate Self", emoji: "🚪", isCorrect: false },
        { text: "Neglect Needs", emoji: "⛔", isCorrect: false },
    ...
    {
      id: 5,
      question: "What's a healthy way to express sadness?",
      options: [
        { text: "Express Feelings", emoji: "💬", isCorrect: true },
        { text: "Stay Silent", emoji: "🤐", isCorrect: false },
        { text: "Bottle Up", emoji: "🔒", isCorrect: false },
  ...
  return (
    <GameShell
      ...
      subtitle={gameState === "playing" ? `Round ${currentRound}/${TOTAL_ROUNDS}` : "Emotional Health Blitz!"}
      coins={score}
      ...
      nextGamePathProp="/student/health-female/teens/badge-emotion-smart-teen-girl"
      nextGameIdProp="health-female-teen-60">
      <div className="space-y-8">
        {gameState === "ready" && (
          <div className="bg-white/10 backdrop-blur-md rounded-2xl p-8 border border-white/20 text-center">
            <div className="text-6xl mb-6">🧘</div>
            <h3 className="text-2xl font-bold text-white mb-4">Emotional Health Blitz!</h3>
            <p className="text-white/90 text-lg mb-6">
              You have {ROUND_TIME} seconds to choose the healthy emotional response!
            </p>
            <button
              onClick={startGame}
