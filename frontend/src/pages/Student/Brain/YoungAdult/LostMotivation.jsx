...
const choices = [
  ...
  {
    id: "c",
    title: "Abandon the goal temporarily",
...
const LostMotivation = () => {
  const location = useLocation();
  const gameId = "brain-young-adult-61"; // Assuming next ID after current games
        ...
        skillUnlocked
          ...
          : showSecondReflection && !secondReflectionCompleted
            ...
            : showFirstReflection && !firstReflectionCompleted
              ...
              : "Decide how to respond to lost motivation"
      }
      score={score}
      currentLevel={1}
      totalLevels={1}
