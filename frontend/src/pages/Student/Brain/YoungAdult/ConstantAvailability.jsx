...
const choices = [
  {
    id: "a",
    title: "Stay always available",
    outcome: "Burnout risk increases.",
  },
  {
    id: "b",
    title: "Set availability limits",
    outcome: "Balance improves.",
  },
  {
    id: "c",
    title: "Disappear without notice",
...
const ConstantAvailability = () => {
  const location = useLocation();
  const gameId = "brain-young-adult-59"; // Assuming next ID after current games
  ...
  useEffect(() => {
    if (skillUnlocked) {
      console.log("Skill unlocked: Availability awareness");
    }
  }, [skillUnlocked]);
        ...
        skillUnlocked
          ...
          : showSecondReflection && !secondReflectionCompleted
            ...
            : showFirstReflection && !firstReflectionCompleted
              ...
              : "Decide how to manage availability"
      }
      score={score}
      currentLevel={1}
      totalLevels={1}
    ...
    >
      <div className="space-y-6 max-w-4xl mx-auto p-4">
        ...
        <Section title="Decision Moment">
          The person must decide how to manage availability.
...
export default ConstantAvailability;