...
const choices = [
  {
    id: "a",
    title: "Respond to all notifications immediately",
...
const NotificationOverload = () => {
  ...
  const gameId = "brain-young-adult-52"; // Assuming next ID after current games
        ...
        skillUnlocked
          ...
          : showSecondReflection && !secondReflectionCompleted
            ...
            : showFirstReflection && !firstReflectionCompleted
              ...
              : "Decide how to manage notifications"
      }
      score={score}
      currentLevel={1}
      totalLevels={1}
