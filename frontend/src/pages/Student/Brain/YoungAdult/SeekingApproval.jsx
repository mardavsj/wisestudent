...
const choices = [
  {
    id: "a",
    title: "Follow others' expectations",
    outcome: "Self-doubt increases.",
  },
  {
    id: "b",
    title: "Consider personal values",
...
const SeekingApproval = () => {
  const location = useLocation();
  const gameId = "brain-young-adult-33";
  ...
  useEffect(() => {
    if (skillUnlocked) {
      console.log("Skill unlocked: Self-trust awareness");
    }
  }, [skillUnlocked]);
        ...
        skillUnlocked
          ...
          : showSecondReflection && !secondReflectionCompleted
            ...
            : showFirstReflection && !firstReflectionCompleted
              ...
              : "Decide whose opinion to prioritise"
      }
      score={score}
      currentLevel={1}
      totalLevels={1}
    ...
    >
      <div className="space-y-6 max-w-4xl mx-auto p-4">
        ...
        <Section title="Decision Moment">
          The person must decide whose opinion to prioritise.
        ...
        {skillUnlocked && (
          <Section title="Skill / Insight Unlocked">
            <strong>Self-trust awareness</strong>
          </Section>
        )}
      </div>
    </GameShell>
...
export default SeekingApproval;