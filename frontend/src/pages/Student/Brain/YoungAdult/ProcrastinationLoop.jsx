...
const choices = [
  ...
  {
    id: "c",
    title: "Distract with other activities",
...
const ProcrastinationLoop = () => {
  ...
  const gameId = "brain-young-adult-64"; // Assuming next ID after current games
        ...
        skillUnlocked
          ...
          : showSecondReflection && !secondReflectionCompleted
            ...
            : showFirstReflection && !firstReflectionCompleted
              ...
              : "Decide how to respond to the postponement of tasks"
      }
      score={score}
      currentLevel={1}
      totalLevels={1}
