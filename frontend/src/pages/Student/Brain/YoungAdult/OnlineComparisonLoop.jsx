...
const choices = [
  ...
  {
    id: "c",
    title: "Avoid social media completely",
...
const OnlineComparisonLoop = () => {
  const location = useLocation();
  const gameId = "brain-young-adult-53"; // Assuming next ID after current games
        ...
        skillUnlocked
          ...
          : showSecondReflection && !secondReflectionCompleted
            ...
            : showFirstReflection && !firstReflectionCompleted
              ...
              : "Decide how to respond to comparison feelings"
      }
      score={score}
      currentLevel={1}
      totalLevels={1}
...
export default OnlineComparisonLoop;