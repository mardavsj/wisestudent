...
const choices = [
  {
    id: "a",
    title: "Maintain a perfect image",
    outcome: "Anxiety increases.",
  },
  {
    id: "b",
    title: "Be more authentic",
    outcome: "Relief and confidence improve.",
  },
  {
    id: "c",
    title: "Avoid posting altogether",
...
const SocialMediaIdentity = () => {
  const location = useLocation();
  const gameId = "brain-young-adult-32";
  ...
  useEffect(() => {
    if (skillUnlocked) {
      console.log("Skill unlocked: Identity awareness");
    }
  }, [skillUnlocked]);
    ...
    >
      <div className="space-y-6 max-w-4xl mx-auto p-4">
        ...
        <Section title="Decision Moment">
          The person must choose how to engage online.
        ...
        {skillUnlocked && (
          <Section title="Skill / Insight Unlocked">
            <strong>Identity awareness</strong>
          </Section>
        )}
      </div>
    </GameShell>
...
export default SocialMediaIdentity;