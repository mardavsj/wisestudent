...
const FinancialMistake = () => {
  const location = useLocation();
  const gameId = "brain-young-adult-79";
        ...
        skillUnlocked
          ...
          : showSecondReflection && !secondReflectionCompleted
            ...
            : showFirstReflection && !firstReflectionCompleted
              ...
              : "Decide how to respond to a poor financial decision"
      }
      score={score}
      currentLevel={1}
      totalLevels={1}
...
export default FinancialMistake;