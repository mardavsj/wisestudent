...
const choices = [
  ...
  {
    id: "c",
    title: "Forcefully quit without reflection",
...
const EndlessScrolling = () => {
  ...
  const gameId = "brain-young-adult-51"; // Assuming next ID after current games
  ...
  useEffect(() => {
    if (skillUnlocked) {
      console.log("Skill unlocked: Digital awareness");
    }
  }, [skillUnlocked]);
        ...
        skillUnlocked
          ...
          : showSecondReflection && !secondReflectionCompleted
            ...
            : showFirstReflection && !firstReflectionCompleted
              ...
              : "Decide how to handle the scrolling"
      }
      score={score}
      currentLevel={1}
      totalLevels={1}
    ...
    >
      <div className="space-y-6 max-w-4xl mx-auto p-4">
        ...
        <Section title="Trigger / Stress Point">
          Difficulty stopping despite feeling tired.
        </Section>
