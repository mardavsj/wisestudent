...
const choices = [
  ...
  {
    id: "c",
    title: "Withdraw from social interactions",
...
const FeelingNotGoodEnough = () => {
  const location = useLocation();
  const gameId = "brain-young-adult-31";
        ...
        skillUnlocked
          ...
          : showSecondReflection && !secondReflectionCompleted
            ...
            : showFirstReflection && !firstReflectionCompleted
              ...
              : "Decide how to respond internally"
      }
      score={score}
      currentLevel={1}
      totalLevels={1}
    ...
    >
      <div className="space-y-6 max-w-4xl mx-auto p-4">
        ...
        <Section title="Trigger / Stress Point">
          Seeing others achieve milestones faster.
        </Section>
...
export default FeelingNotGoodEnough;