...
const choices = [
  {
    id: "a",
    title: "Panic and worry constantly",
    outcome: "Anxiety increases.",
  },
  {
    id: "b",
    title: "Review expenses calmly",
    outcome: "Control improves.",
  },
  {
    id: "c",
    title: "Ignore the concern",
...
const MoneyWorry = () => {
  ...
  const gameId = "brain-young-adult-71"; // Assuming next ID after current games
        ...
        skillUnlocked
          ...
          : showSecondReflection && !secondReflectionCompleted
            ...
            : showFirstReflection && !firstReflectionCompleted
              ...
              : "Decide how to respond to money worries"
      }
      score={score}
      currentLevel={1}
      totalLevels={1}
    ...
    >
      <div className="space-y-6 max-w-4xl mx-auto p-4">
        ...
        <Section title="Decision Moment">
          The person must decide how to respond emotionally.
