...
const ProductivityGuilt = () => {
  const location = useLocation();
  const gameId = "brain-young-adult-68"; // Assuming next ID after current games
        ...
        skillUnlocked
          ...
          : showSecondReflection && !secondReflectionCompleted
            ...
            : showFirstReflection && !firstReflectionCompleted
              ...
              : "Decide how to respond to productivity guilt"
      }
      score={score}
      currentLevel={1}
      totalLevels={1}
...
export default ProductivityGuilt;