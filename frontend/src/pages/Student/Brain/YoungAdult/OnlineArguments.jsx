...
const choices = [
  ...
  {
    id: "c",
    title: "Continue silently reading",
...
const OnlineArguments = () => {
  ...
  const gameId = "brain-young-adult-58"; // Assuming next ID after current games
        ...
        skillUnlocked
          ...
          : showSecondReflection && !secondReflectionCompleted
            ...
            : showFirstReflection && !firstReflectionCompleted
              ...
              : "Decide how to respond to the heated discussion"
      }
      score={score}
      currentLevel={1}
      totalLevels={1}
