...
const choices = [
  ...
  {
    id: "c",
    title: "Withdraw from discussion",
...
const EmotionalReactionChoice = () => {
  const location = useLocation();
  const gameId = "brain-young-adult-82";
  ...
  useEffect(() => {
    if (skillUnlocked) {
      console.log("Skill unlocked: Response awareness");
    }
  }, [skillUnlocked]);
        ...
        skillUnlocked
          ...
          : showSecondReflection && !secondReflectionCompleted
            ...
            : showFirstReflection && !firstReflectionCompleted
              ...
              : "Choose how to respond during an emotional disagreement"
      }
      score={score}
      currentLevel={1}
      totalLevels={1}
    ...
    >
      <div className="space-y-6 max-w-4xl mx-auto p-4">
        ...
        <Section title="Decision Moment">
          The person must choose a response.
        ...
        {skillUnlocked && (
          <Section title="Skill / Insight Unlocked">
            <strong>Response awareness</strong>
          </Section>
        )}
      </div>
    </GameShell>
...
export default EmotionalReactionChoice;