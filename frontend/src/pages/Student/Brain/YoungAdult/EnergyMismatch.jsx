...
const EnergyMismatch = () => {
  ...
  const gameId = "brain-young-adult-69"; // Assuming next ID after current games
        ...
        skillUnlocked
          ...
          : showSecondReflection && !secondReflectionCompleted
            ...
            : showFirstReflection && !firstReflectionCompleted
              ...
              : "Decide how to work with your energy patterns"
      }
      score={score}
      currentLevel={1}
      totalLevels={1}
    ...
    >
      <div className="space-y-6 max-w-4xl mx-auto p-4">
        ...
        <Section title="Trigger / Stress Point">
          Trying to work against energy patterns.
        </Section>
