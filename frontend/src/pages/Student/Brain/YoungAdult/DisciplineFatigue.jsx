...
const DisciplineFatigue = () => {
  const location = useLocation();
  const gameId = "brain-young-adult-67"; // Assuming next ID after current games
        ...
        skillUnlocked
          ...
          : showSecondReflection && !secondReflectionCompleted
            ...
            : showFirstReflection && !firstReflectionCompleted
              ...
              : "Decide how to respond to discipline fatigue"
      }
      score={score}
      currentLevel={1}
      totalLevels={1}
...
export default DisciplineFatigue;