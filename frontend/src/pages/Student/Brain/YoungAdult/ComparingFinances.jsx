...
const ComparingFinances = () => {
  ...
  const gameId = "brain-young-adult-73"; // Assuming next ID after current games
        ...
        skillUnlocked
          ...
          : showSecondReflection && !secondReflectionCompleted
            ...
            : showFirstReflection && !firstReflectionCompleted
              ...
              : "Decide how to respond to financial comparison feelings"
      }
      score={score}
      currentLevel={1}
      totalLevels={1}
    ...
    >
      <div className="space-y-6 max-w-4xl mx-auto p-4">
        ...
        <Section title="Trigger / Stress Point">
          Feeling inadequate financially.
        </Section>
