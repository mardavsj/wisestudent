...
const choices = [
  ...
  {
    id: "b",
    title: "Reduce screen time gradually",
...
const LateNightScreenUse = () => {
  const location = useLocation();
  const gameId = "brain-young-adult-55"; // Assuming next ID after current games
  ...
  useEffect(() => {
    if (skillUnlocked) {
      console.log("Skill unlocked: Sleep hygiene awareness");
    }
  }, [skillUnlocked]);
      ...
      <div className="space-y-6 max-w-4xl mx-auto p-4">
        ...
        {skillUnlocked && (
          <Section title="Skill / Insight Unlocked">
            <strong>Sleep hygiene awareness</strong>
          </Section>
        )}
      </div>
    </GameShell>
...
export default LateNightScreenUse;