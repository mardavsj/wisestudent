...
const choices = [
  ...
  {
    id: "b",
    title: "Reframe experience",
    outcome: "Perspective improves.",
  },
  {
    id: "c",
    title: "Avoid future risks",
...
const RecoveryAfterLoss = () => {
  const location = useLocation();
  const gameId = "brain-young-adult-96";
  ...
  useEffect(() => {
    if (skillUnlocked) {
      console.log("Skill unlocked: Recovery mindset awareness");
    }
  }, [skillUnlocked]);
        ...
        skillUnlocked
          ...
          : showSecondReflection && !secondReflectionCompleted
            ...
            : showFirstReflection && !firstReflectionCompleted
              ...
              : "Decide how to recover when loss of an opportunity affects confidence"
      }
      score={score}
      currentLevel={1}
      totalLevels={1}
    ...
    >
      <div className="space-y-6 max-w-4xl mx-auto p-4">
        ...
        <Section title="Decision Moment">
          The person must choose how to recover.
        ...
        {skillUnlocked && (
          <Section title="Skill / Insight Unlocked">
            <strong>Recovery mindset awareness</strong>
          </Section>
        )}
      </div>
    </GameShell>
...
export default RecoveryAfterLoss;