...
const SocialEnergyDrain = () => {
  ...
  const gameId = "brain-young-adult-45";
    ...
    >
      <div className="space-y-6 max-w-4xl mx-auto p-4">
        ...
        <Section title="Trigger / Stress Point">
          Over-socialising without rest.
        </Section>

        {/* Decision */}
        <Section title="Decision Moment">
          The person must decide how to manage energy.
