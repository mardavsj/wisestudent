...
const choices = [
  {
    id: "a",
    title: "Change behaviour to match others",
    outcome: "Internal discomfort increases.",
  },
  {
    id: "b",
    title: "Stay true to personal comfort",
    outcome: "Self-respect improves.",
  },
  {
    id: "c",
    title: "Withdraw from social situations",
...
const PressureToFitIn = () => {
  const location = useLocation();
  const gameId = "brain-young-adult-41";
  ...
  useEffect(() => {
    if (skillUnlocked) {
      console.log("Skill unlocked: Authenticity awareness");
    }
  }, [skillUnlocked]);
    ...
    >
      <div className="space-y-6 max-w-4xl mx-auto p-4">
        ...
        <Section title="Trigger / Stress Point">
          Fear of being excluded socially.
        </Section>
        ...
        {skillUnlocked && (
          <Section title="Skill / Insight Unlocked">
            <strong>Authenticity awareness</strong>
          </Section>
        )}
      </div>
    </GameShell>
...
export default PressureToFitIn;