...
const RainyDayStory = () => {
  ...
  const gameContent = t("brain-health.kids.rainy-day-story", { returnObjects: true });
  ...
  return (
    <GameShell
      title={gameContent?.title || "Rainy Day Story"}
      subtitle={
        !showResult 
          ? t("brain-health.kids.rainy-day-story.subtitlePlaying", {
            ...
            <div className="bg-white/10 backdrop-blur-md rounded-2xl p-6 border border-white/20">
              <div className="flex justify-between items-center mb-4">
                <span className="text-white/80">
                  {t("brain-health.kids.rainy-day-story.questionLabel", {
                    current: currentQuestion + 1,
                    total: questions.length,
                ...
                <span className="text-yellow-400 font-bold">
                  {t("brain-health.kids.rainy-day-story.scoreLabel", {
                    score,
                    total: questions.length,
