...
const IdeasJournal = () => {
  ...
  const gameContent = t("brain-health.kids.ideas-journal", { returnObjects: true });
  ...
  return (
    <GameShell
      title={gameContent?.title || "Journal of Ideas"}
      subtitle={
        !showResult
          ? t("brain-health.kids.ideas-journal.subtitleProgress", {
            ...
            <div className="bg-white/10 backdrop-blur-md rounded-2xl p-6 border border-white/20">
              <div className="flex justify-between items-center mb-4">
                <span className="text-white/80">
                  {t("brain-health.kids.ideas-journal.entryLabel", {
                    current: currentStage + 1,
                    total: stages.length,
                ...
                <span className="text-yellow-400 font-bold">
                  {t("brain-health.kids.ideas-journal.scoreLabel", {
                    score,
                    total: stages.length,
              ...
              <div className="mb-6">
                ...
                <div className="mt-2 flex justify-between items-center">
                  <span className={`text-sm ${characterCount >= minLength ? 'text-green-400' : 'text-red-400'}`}>
                    {t("brain-health.kids.ideas-journal.minLengthLabel", {
                  ...
                  <span className="text-white/60 text-sm">
                    {t("brain-health.kids.ideas-journal.charCountLabel", {
                      count: characterCount,
