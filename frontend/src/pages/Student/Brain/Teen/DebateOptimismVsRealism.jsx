...
const DebateOptimismVsRealism = () => {
  ...
  const questions = [
    ...
    },
    {
      ...
      correct: 'a',
      explanation: 'Balanced optimism helps you stay motivated while being prepared for obstacles!'
    },
    {
      id: 3,
  ...
  useEffect(() => {
    if (levelCompleted) {
      console.log(`🎮 Debate: Optimism vs Realism game completed! Score: ${score}/${questions.length}, gameId: ${gameId}, nextGamePath: ${nextGamePath}, nextGameId: ${nextGameId}`);
