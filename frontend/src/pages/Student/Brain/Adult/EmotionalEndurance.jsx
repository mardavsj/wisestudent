...
const choices = [
  {
    id: "a",
    title: "Push without rest.",
    outcome: "Burnout increases.",
  },
  {
    id: "b",
    title: "Balance effort and rest.",
...
const EmotionalEndurance = () => {
  const location = useLocation();
  const gameId = "brain-adults-97"; // Next in sequence
  ...
  useEffect(() => {
    if (skillUnlocked) {
      console.log("Skill unlocked: Endurance awareness");
    }
  }, [skillUnlocked]);

  useEffect(() => {
    if (skillUnlocked) {
      console.log("Completed Emotional Endurance", { score });
    }
  }, [skillUnlocked, score]);
        ...
        skillUnlocked
          ...
          : showSecondReflection && !secondReflectionCompleted
            ...
            : showFirstReflection && !firstReflectionCompleted
              ...
              : "Choose how to respond to long-term pressure"
      }
      score={score}
      currentLevel={1}
      totalLevels={1}
      ...
      <div className="space-y-6 max-w-4xl mx-auto p-4">
        ...
        {skillUnlocked && (
          <Section title="Skill / Insight Unlocked">
            <strong>Endurance awareness</strong>
          </Section>
        )}
...
export default EmotionalEndurance;