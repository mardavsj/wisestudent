...
const choices = [
  ...
  {
    id: "c",
    title: "Distract with other tasks.",
...
const ProcrastinationLoop = () => {
  const location = useLocation();
  const gameId = "brain-adults-64"; // New game ID for procrastination loop
  ...
  useEffect(() => {
    if (skillUnlocked) {
      console.log("Skill unlocked: Action initiation awareness");
    }
  }, [skillUnlocked]);

  useEffect(() => {
    if (skillUnlocked) {
      console.log("Completed Procrastination Loop", { score });
    }
  }, [skillUnlocked, score]);
        ...
        skillUnlocked
          ...
          : showSecondReflection && !secondReflectionCompleted
            ...
            : showFirstReflection && !firstReflectionCompleted
              ...
              : "Choose how you respond to repeatedly postponing tasks"
      }
      score={score}
      currentLevel={1}
      totalLevels={1}
      ...
      <div className="space-y-6 max-w-4xl mx-auto p-4">
        ...
        {skillUnlocked && (
          <Section title="Skill / Insight Unlocked">
            <strong>Action initiation awareness</strong>
          </Section>
        )}
...
export default ProcrastinationLoop;