...
const choices = [
  {
    id: "a",
    title: "Continue socialising.",
    outcome: "Fatigue increases.",
  },
  {
    id: "b",
    title: "Take personal space.",
    outcome: "Energy recovers.",
  },
  {
    id: "c",
    title: "Avoid all interactions.",
...
const SocialEnergyDrain = () => {
  const location = useLocation();
  const gameId = "brain-adults-45"; // Forty-fifth brain-adults game
  ...
  useEffect(() => {
    if (skillUnlocked) {
      console.log("Skill unlocked: Social energy awareness");
    }
  }, [skillUnlocked]);

  useEffect(() => {
    if (skillUnlocked) {
      console.log("Completed Social Energy Drain", { score });
    }
  }, [skillUnlocked, score]);
        ...
        skillUnlocked
          ...
          : showSecondReflection && !secondReflectionCompleted
            ...
            : showFirstReflection && !firstReflectionCompleted
              ...
              : "Choose how you manage social energy"
      }
      score={score}
      currentLevel={1}
      totalLevels={1}
    ...
    >
      <div className="space-y-6 max-w-4xl mx-auto p-4">
        ...
        <Section title="Stress Point">
          Over-engagement without rest.
        </Section>

        {/* Decision */}
        <Section title="Decision Moment">
          The person must choose how to manage energy.
        ...
        {skillUnlocked && (
          <Section title="Skill / Insight Unlocked">
            <strong>Social energy awareness</strong>
          </Section>
        )}
...
export default SocialEnergyDrain;