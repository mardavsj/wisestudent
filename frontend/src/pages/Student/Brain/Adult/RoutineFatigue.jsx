...
const choices = [
  {
    id: "a",
    title: "Abandon routines.",
    outcome: "Structure collapses.",
  },
  {
    id: "b",
    title: "Simplify routines.",
...
const RoutineFatigue = () => {
  const location = useLocation();
  const gameId = "brain-adults-67"; // New game ID for routine fatigue
  ...
  useEffect(() => {
    if (skillUnlocked) {
      console.log("Skill unlocked: Routine sustainability awareness");
    }
  }, [skillUnlocked]);

  useEffect(() => {
    if (skillUnlocked) {
      console.log("Completed Routine Fatigue", { score });
    }
  }, [skillUnlocked, score]);
        ...
        skillUnlocked
          ...
          : showSecondReflection && !secondReflectionCompleted
            ...
            : showFirstReflection && !firstReflectionCompleted
              ...
              : "Choose how you respond to maintaining routines feeling exhausting"
      }
      score={score}
      currentLevel={1}
      totalLevels={1}
      ...
      <div className="space-y-6 max-w-4xl mx-auto p-4">
        ...
        {skillUnlocked && (
          <Section title="Skill / Insight Unlocked">
            <strong>Routine sustainability awareness</strong>
          </Section>
        )}
