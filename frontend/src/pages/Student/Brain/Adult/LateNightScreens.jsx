...
const choices = [
  {
    id: "a",
    title: "Continue screen use.",
    outcome: "Rest quality reduces.",
  },
  {
    id: "b",
    title: "Reduce usage gradually.",
...
const LateNightScreens = () => {
  const location = useLocation();
  const gameId = "brain-adults-55"; // New game ID for late-night screens
  ...
  useEffect(() => {
    if (skillUnlocked) {
      console.log("Skill unlocked: Rest readiness awareness");
    }
  }, [skillUnlocked]);

  useEffect(() => {
    if (skillUnlocked) {
      console.log("Completed Late-Night Screens", { score });
    }
  }, [skillUnlocked, score]);
        ...
        skillUnlocked
          ...
          : showSecondReflection && !secondReflectionCompleted
            ...
            : showFirstReflection && !firstReflectionCompleted
              ...
              : "Choose how you respond to late-night screen use"
      }
      score={score}
      currentLevel={1}
      totalLevels={1}
    ...
    >
      <div className="space-y-6 max-w-4xl mx-auto p-4">
        ...
        <Section title="Decision Moment">
          The person must choose how to end the day.
        ...
        {skillUnlocked && (
          <Section title="Skill / Insight Unlocked">
            <strong>Rest readiness awareness</strong>
          </Section>
        )}
...
export default LateNightScreens;