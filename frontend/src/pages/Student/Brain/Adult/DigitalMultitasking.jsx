...
const DigitalMultitasking = () => {
  const location = useLocation();
  const gameId = "brain-adults-54"; // New game ID for digital multitasking
  ...
  useEffect(() => {
    if (skillUnlocked) {
      console.log("Skill unlocked: Focus awareness");
    }
  }, [skillUnlocked]);

  useEffect(() => {
    if (skillUnlocked) {
      console.log("Completed Digital Multitasking", { score });
    }
  }, [skillUnlocked, score]);
        ...
        skillUnlocked
          ...
          : showSecondReflection && !secondReflectionCompleted
            ...
            : showFirstReflection && !firstReflectionCompleted
              ...
              : "Choose how you respond to multiple apps and tasks simultaneously"
      }
      score={score}
      currentLevel={1}
      totalLevels={1}
    ...
    >
      <div className="space-y-6 max-w-4xl mx-auto p-4">
        ...
        <Section title="Stress Point">
          Reduced focus and mental clutter.
        </Section>

        {/* Decision */}
        <Section title="Decision Moment">
          The person must choose how to work.
...
export default DigitalMultitasking;