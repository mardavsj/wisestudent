...
const choices = [
  {
    id: "a",
    title: "Use others as benchmarks.",
    outcome: "Pressure increases.",
  },
  {
    id: "b",
    title: "Define personal success.",
    outcome: "Motivation stabilises.",
  },
  {
    id: "c",
    title: "Avoid setting goals.",
...
const ExternalSuccessPressure = () => {
  const location = useLocation();
  const gameId = "brain-adults-38"; // Thirty-eighth brain-adults game
  ...
  useEffect(() => {
    if (skillUnlocked) {
      console.log("Skill unlocked: Personal success awareness");
    }
  }, [skillUnlocked]);

  useEffect(() => {
    if (skillUnlocked) {
      console.log("Completed External Success Pressure", { score });
    }
  }, [skillUnlocked, score]);
    ...
    >
      <div className="space-y-6 max-w-4xl mx-auto p-4">
        ...
        <Section title="Decision Moment">
          The person must choose how to define success.
        ...
        {skillUnlocked && (
          <Section title="Skill / Insight Unlocked">
            <strong>Personal success awareness</strong>
          </Section>
        )}
...
export default ExternalSuccessPressure;