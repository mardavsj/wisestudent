...
const choices = [
  {
    id: "a",
    title: "Seek constant reassurance.",
    outcome: "Dependence increases.",
  },
  {
    id: "b",
    title: "Build inner stability.",
    outcome: "Calm improves.",
  },
  {
    id: "c",
    title: "Avoid uncertainty.",
...
const InnerStability = () => {
  const location = useLocation();
  const gameId = "brain-adults-98"; // Next in sequence
  ...
  useEffect(() => {
    if (skillUnlocked) {
      console.log("Skill unlocked: Inner stability awareness");
    }
  }, [skillUnlocked]);

  useEffect(() => {
    if (skillUnlocked) {
      console.log("Completed Inner Stability", { score });
    }
  }, [skillUnlocked, score]);
        ...
        skillUnlocked
          ...
          : showSecondReflection && !secondReflectionCompleted
            ...
            : showFirstReflection && !firstReflectionCompleted
              ...
              : "Choose how to respond to uncertainty"
      }
      score={score}
      currentLevel={1}
      totalLevels={1}
      ...
      <div className="space-y-6 max-w-4xl mx-auto p-4">
        ...
        {skillUnlocked && (
          <Section title="Skill / Insight Unlocked">
            <strong>Inner stability awareness</strong>
          </Section>
        )}
