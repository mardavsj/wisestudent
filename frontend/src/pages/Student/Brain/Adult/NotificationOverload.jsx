...
const choices = [
  {
    id: "a",
    title: "Respond to every alert immediately.",
    outcome: "Focus reduces.",
  },
  {
    id: "b",
    title: "Limit notification access.",
    outcome: "Mental clarity improves.",
  },
  {
    id: "c",
    title: "Ignore all alerts.",
...
const NotificationOverload = () => {
  const location = useLocation();
  const gameId = "brain-adults-52"; // New game ID for notification overload
  ...
  useEffect(() => {
    if (skillUnlocked) {
      console.log("Skill unlocked: Attention control awareness");
    }
  }, [skillUnlocked]);

  useEffect(() => {
    if (skillUnlocked) {
      console.log("Completed Notification Overload", { score });
    }
  }, [skillUnlocked, score]);
        ...
        skillUnlocked
          ...
          : showSecondReflection && !secondReflectionCompleted
            ...
            : showFirstReflection && !firstReflectionCompleted
              ...
              : "Choose how you respond to multiple alerts interrupting your time"
      }
      score={score}
      currentLevel={1}
      totalLevels={1}
    ...
    >
      <div className="space-y-6 max-w-4xl mx-auto p-4">
        ...
        <Section title="Decision Moment">
          The person must choose how to manage notifications.
        ...
        {skillUnlocked && (
          <Section title="Skill / Insight Unlocked">
            <strong>Attention control awareness</strong>
          </Section>
        )}
...
export default NotificationOverload;