...
const choices = [
  {
    id: "a",
    title: "Suppress emotions.",
    outcome: "Emotional strain increases.",
  },
  {
    id: "b",
    title: "Acknowledge emotions and continue.",
...
const EmotionalStrength = () => {
  ...
  const gameId = "brain-adults-95"; // Next in sequence
  ...
  useEffect(() => {
    if (skillUnlocked) {
      console.log("Skill unlocked: Mental strength awareness");
    }
  }, [skillUnlocked]);

  useEffect(() => {
    if (skillUnlocked) {
      console.log("Completed Emotional Strength", { score });
    }
  }, [skillUnlocked, score]);
        ...
        skillUnlocked
          ...
          : showSecondReflection && !secondReflectionCompleted
            ...
            : showFirstReflection && !firstReflectionCompleted
              ...
              : "Choose how to cope with emotional challenges"
      }
      score={score}
      currentLevel={1}
      totalLevels={1}
    ...
    >
      <div className="space-y-6 max-w-4xl mx-auto p-4">
        ...
        <Section title="Decision Moment">
          The person must choose how to cope.
        ...
        {skillUnlocked && (
          <Section title="Skill / Insight Unlocked">
            <strong>Mental strength awareness</strong>
          </Section>
        )}
...
export default EmotionalStrength;