...
const choices = [
  {
    id: "a",
    title: "React to every mood.",
    outcome: "Emotional exhaustion increases.",
  },
  {
    id: "b",
    title: "Observe mood patterns.",
    outcome: "Understanding improves.",
  },
  {
    id: "c",
    title: "Ignore mood changes.",
...
const MoodShifts = () => {
  ...
  const gameId = "brain-adults-26"; // Twenty-sixth brain-adults game
  ...
  useEffect(() => {
    if (skillUnlocked) {
      console.log("Skill unlocked: Mood pattern awareness");
    }
  }, [skillUnlocked]);

  useEffect(() => {
    if (skillUnlocked) {
      console.log("Completed Mood Shifts", { score });
    }
  }, [skillUnlocked, score]);
        ...
        skillUnlocked
          ...
          : showSecondReflection && !secondReflectionCompleted
            ...
            : showFirstReflection && !firstReflectionCompleted
              ...
              : "Choose how you respond to mood changes"
      }
      score={score}
      currentLevel={1}
      totalLevels={1}
      ...
      <div className="space-y-6 max-w-4xl mx-auto p-4">
        ...
        {skillUnlocked && (
          <Section title="Skill / Insight Unlocked">
            <strong>Mood pattern awareness</strong>
          </Section>
        )}
