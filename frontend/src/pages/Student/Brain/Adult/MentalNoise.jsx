...
const choices = [
  {
    id: "a",
    title: "Consume more content.",
    outcome: "Overload increases.",
  },
  {
    id: "b",
    title: "Create quiet time.",
    outcome: "Mental calm improves.",
  },
  {
    id: "c",
    title: "Ignore the feeling.",
...
const MentalNoise = () => {
  ...
  const gameId = "brain-adults-56"; // New game ID for mental noise
  ...
  useEffect(() => {
    if (skillUnlocked) {
      console.log("Skill unlocked: Mental clarity awareness");
    }
  }, [skillUnlocked]);

  useEffect(() => {
    if (skillUnlocked) {
      console.log("Completed Mental Noise", { score });
    }
  }, [skillUnlocked, score]);
        ...
        skillUnlocked
          ...
          : showSecondReflection && !secondReflectionCompleted
            ...
            : showFirstReflection && !firstReflectionCompleted
              ...
              : "Choose how you respond to constant information intake"
      }
      score={score}
      currentLevel={1}
      totalLevels={1}
      ...
      <div className="space-y-6 max-w-4xl mx-auto p-4">
        ...
        {skillUnlocked && (
          <Section title="Skill / Insight Unlocked">
            <strong>Mental clarity awareness</strong>
          </Section>
        )}
