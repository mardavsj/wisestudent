...
const choices = [
  {
    id: "a",
    title: "Keep emotions inside.",
    outcome: "Stress builds.",
  },
  {
    id: "b",
    title: "Express calmly.",
    outcome: "Understanding improves.",
  },
  {
    id: "c",
    title: "Express emotionally.",
...
const ExpressingFeelings = () => {
  const location = useLocation();
  const gameId = "brain-adults-29"; // Twenty-ninth brain-adults game
  ...
  useEffect(() => {
    if (skillUnlocked) {
      console.log("Skill unlocked: Emotional expression awareness");
    }
  }, [skillUnlocked]);

  useEffect(() => {
    if (skillUnlocked) {
      console.log("Completed Expressing Feelings", { score });
    }
  }, [skillUnlocked, score]);
        ...
        skillUnlocked
          ...
          : showSecondReflection && !secondReflectionCompleted
            ...
            : showFirstReflection && !firstReflectionCompleted
              ...
              : "Choose how you express your emotions"
      }
      score={score}
      currentLevel={1}
      totalLevels={1}
    ...
    >
      <div className="space-y-6 max-w-4xl mx-auto p-4">
        ...
        <Section title="Decision Moment">
          The person must choose how to express emotions.
        ...
        {skillUnlocked && (
          <Section title="Skill / Insight Unlocked">
            <strong>Emotional expression awareness</strong>
          </Section>
        )}
...
export default ExpressingFeelings;