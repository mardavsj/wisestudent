...
const choices = [
  {
    id: "a",
    title: "Spend to fit in.",
    outcome: "Financial stress increases.",
  },
  {
    id: "b",
    title: "Respect spending limits.",
    outcome: "Balance improves.",
  },
  {
    id: "c",
    title: "Avoid social events.",
...
const SpendingToBelong = () => {
  const location = useLocation();
  const gameId = "brain-adults-76"; // Next in sequence
  ...
  useEffect(() => {
    if (skillUnlocked) {
      console.log("Skill unlocked: Spending boundary awareness");
    }
  }, [skillUnlocked]);

  useEffect(() => {
    if (skillUnlocked) {
      console.log("Completed Spending to Belong", { score });
    }
  }, [skillUnlocked, score]);
        ...
        skillUnlocked
          ...
          : showSecondReflection && !secondReflectionCompleted
            ...
            : showFirstReflection && !firstReflectionCompleted
              ...
              : "Choose how you respond to social pressure"
      }
      score={score}
      currentLevel={1}
      totalLevels={1}
      ...
      <div className="space-y-6 max-w-4xl mx-auto p-4">
        ...
        {skillUnlocked && (
          <Section title="Skill / Insight Unlocked">
            <strong>Spending boundary awareness</strong>
          </Section>
        )}
...
export default SpendingToBelong;