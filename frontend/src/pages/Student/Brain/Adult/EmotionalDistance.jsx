...
const choices = [
  {
    id: "a",
    title: "Ignore the distance.",
    outcome: "Disconnection grows.",
  },
  {
    id: "b",
    title: "Acknowledge and reflect.",
    outcome: "Clarity improves.",
  },
  {
    id: "c",
    title: "Withdraw further.",
...
const EmotionalDistance = () => {
  ...
  const gameId = "brain-adults-43"; // Forty-third brain-adults game
  ...
  useEffect(() => {
    if (skillUnlocked) {
      console.log("Skill unlocked: Relationship awareness");
    }
  }, [skillUnlocked]);

  useEffect(() => {
    if (skillUnlocked) {
      console.log("Completed Emotional Distance", { score });
    }
  }, [skillUnlocked, score]);
        ...
        skillUnlocked
          ...
          : showSecondReflection && !secondReflectionCompleted
            ...
            : showFirstReflection && !firstReflectionCompleted
              ...
              : "Choose how you respond to emotional distance"
      }
      score={score}
      currentLevel={1}
      totalLevels={1}
      ...
      <div className="space-y-6 max-w-4xl mx-auto p-4">
        ...
        {skillUnlocked && (
          <Section title="Skill / Insight Unlocked">
            <strong>Relationship awareness</strong>
          </Section>
        )}
...
export default EmotionalDistance;