...
const BurnoutReset = () => {
  ...
  const gameId = "brain-adults-70"; // New game ID for burnout reset
  ...
  useEffect(() => {
    if (skillUnlocked) {
      console.log("Skill unlocked: Burnout recovery awareness");
    }
  }, [skillUnlocked]);

  useEffect(() => {
    if (skillUnlocked) {
      console.log("Completed Burnout Reset", { score });
    }
  }, [skillUnlocked, score]);
        ...
        skillUnlocked
          ...
          : showSecondReflection && !secondReflectionCompleted
            ...
            : showFirstReflection && !firstReflectionCompleted
              ...
              : "Choose how you respond to noticing burnout signs"
      }
      score={score}
      currentLevel={1}
      totalLevels={1}
      ...
      <div className="space-y-6 max-w-4xl mx-auto p-4">
        ...
        {skillUnlocked && (
          <Section title="Skill / Insight Unlocked">
            <strong>Burnout recovery awareness</strong>
          </Section>
        )}
