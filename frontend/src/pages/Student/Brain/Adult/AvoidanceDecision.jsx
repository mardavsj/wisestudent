...
const choices = [
  ...
  {
    id: "b",
    title: "Face the decision gradually.",
    outcome: "Confidence improves.",
  },
  {
    id: "c",
    title: "Delegate the decision.",
...
const AvoidanceDecision = () => {
  ...
  const gameId = "brain-adults-88"; // Next in sequence
  ...
  useEffect(() => {
    if (skillUnlocked) {
      console.log("Skill unlocked: Responsibility awareness");
    }
  }, [skillUnlocked]);

  useEffect(() => {
    if (skillUnlocked) {
      console.log("Completed Avoidance Decision", { score });
    }
  }, [skillUnlocked, score]);
        ...
        skillUnlocked
          ...
          : showSecondReflection && !secondReflectionCompleted
            ...
            : showFirstReflection && !firstReflectionCompleted
              ...
              : "Choose how to handle responsibility"
      }
      score={score}
      currentLevel={1}
      totalLevels={1}
      ...
      <div className="space-y-6 max-w-4xl mx-auto p-4">
        ...
        {skillUnlocked && (
          <Section title="Skill / Insight Unlocked">
            <strong>Responsibility awareness</strong>
          </Section>
        )}
...
export default AvoidanceDecision;