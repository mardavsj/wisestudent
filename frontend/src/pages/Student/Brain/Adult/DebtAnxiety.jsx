...
const choices = [
  {
    id: "a",
    title: "Avoid thinking about debt.",
...
const DebtAnxiety = () => {
  ...
  const gameId = "brain-adults-77"; // Next in sequence
  ...
  useEffect(() => {
    if (skillUnlocked) {
      console.log("Skill unlocked: Debt awareness");
    }
  }, [skillUnlocked]);

  useEffect(() => {
    if (skillUnlocked) {
      console.log("Completed Debt Anxiety", { score });
    }
  }, [skillUnlocked, score]);
        ...
        skillUnlocked
          ...
          : showSecondReflection && !secondReflectionCompleted
            ...
            : showFirstReflection && !firstReflectionCompleted
              ...
              : "Choose how you respond to debt emotionally"
      }
      score={score}
      currentLevel={1}
      totalLevels={1}
