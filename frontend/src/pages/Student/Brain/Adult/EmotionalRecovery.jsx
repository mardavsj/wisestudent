...
const EmotionalRecovery = () => {
  const location = useLocation();
  const gameId = "brain-adults-92"; // Next in sequence
  ...
  useEffect(() => {
    if (skillUnlocked) {
      console.log("Skill unlocked: Recovery awareness");
    }
  }, [skillUnlocked]);

  useEffect(() => {
    if (skillUnlocked) {
      console.log("Completed Emotional Recovery", { score });
    }
  }, [skillUnlocked, score]);
        ...
        skillUnlocked
          ...
          : showSecondReflection && !secondReflectionCompleted
            ...
            : showFirstReflection && !firstReflectionCompleted
              ...
              : "Choose how to recover emotionally"
      }
      score={score}
      currentLevel={1}
      totalLevels={1}
...
export default EmotionalRecovery;