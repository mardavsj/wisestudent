...
const ImpulsiveChoice = () => {
  const location = useLocation();
  const gameId = "brain-adults-83"; // Next in sequence
  ...
  useEffect(() => {
    if (skillUnlocked) {
      console.log("Skill unlocked: Impulse control awareness");
    }
  }, [skillUnlocked]);

  useEffect(() => {
    if (skillUnlocked) {
      console.log("Completed Impulsive Choice", { score });
    }
  }, [skillUnlocked, score]);
        ...
        skillUnlocked
          ...
          : showSecondReflection && !secondReflectionCompleted
            ...
            : showFirstReflection && !firstReflectionCompleted
              ...
              : "Choose how to respond to impulse"
      }
      score={score}
      currentLevel={1}
      totalLevels={1}
    ...
    >
      <div className="space-y-6 max-w-4xl mx-auto p-4">
        ...
        <Section title="Decision Moment">
          The person must decide how to act.
        ...
        {skillUnlocked && (
          <Section title="Skill / Insight Unlocked">
            <strong>Impulse control awareness</strong>
          </Section>
        )}
...
export default ImpulsiveChoice;