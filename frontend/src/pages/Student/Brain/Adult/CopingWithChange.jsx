...
const CopingWithChange = () => {
  const location = useLocation();
  const gameId = "brain-adults-94"; // Next in sequence
  ...
  useEffect(() => {
    if (skillUnlocked) {
      console.log("Completed Coping with Change", { score });
    }
  }, [skillUnlocked, score]);
        ...
        skillUnlocked
          ...
          : showSecondReflection && !secondReflectionCompleted
            ...
            : showFirstReflection && !firstReflectionCompleted
              ...
              : "Choose how to respond to change"
      }
      score={score}
      currentLevel={1}
      totalLevels={1}
...
export default CopingWithChange;