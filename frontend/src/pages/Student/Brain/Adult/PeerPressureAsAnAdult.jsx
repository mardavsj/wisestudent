...
const choices = [
  {
    id: "a",
    title: "Follow the group.",
    outcome: "Regret may appear.",
  },
  {
    id: "b",
    title: "Stand by personal comfort.",
    outcome: "Self-respect improves.",
  },
  {
    id: "c",
    title: "Avoid the group.",
...
const PeerPressureAsAnAdult = () => {
  const location = useLocation();
  const gameId = "brain-adults-47"; // Forty-seventh brain-adults game
  ...
  useEffect(() => {
    if (skillUnlocked) {
      console.log("Skill unlocked: Value-based decision awareness");
    }
  }, [skillUnlocked]);

  useEffect(() => {
    if (skillUnlocked) {
      console.log("Completed Peer Pressure as an Adult", { score });
    }
  }, [skillUnlocked, score]);
        ...
        skillUnlocked
          ...
          : showSecondReflection && !secondReflectionCompleted
            ...
            : showFirstReflection && !firstReflectionCompleted
              ...
              : "Choose how you respond to peer pressure"
      }
      score={score}
      currentLevel={1}
      totalLevels={1}
      ...
      <div className="space-y-6 max-w-4xl mx-auto p-4">
        ...
        {skillUnlocked && (
          <Section title="Skill / Insight Unlocked">
            <strong>Value-based decision awareness</strong>
          </Section>
        )}
...
export default PeerPressureAsAnAdult;