...
const choices = [
  {
    id: "a",
    title: "Let fear decide.",
    outcome: "Opportunities reduce.",
  },
  {
    id: "b",
    title: "Evaluate the present situation.",
...
const PastExperienceBias = () => {
  const location = useLocation();
  const gameId = "brain-adults-84"; // Next in sequence
  ...
  useEffect(() => {
    if (skillUnlocked) {
      console.log("Skill unlocked: Bias awareness");
    }
  }, [skillUnlocked]);

  useEffect(() => {
    if (skillUnlocked) {
      console.log("Completed Past Experience Bias", { score });
    }
  }, [skillUnlocked, score]);
        ...
        skillUnlocked
          ...
          : showSecondReflection && !secondReflectionCompleted
            ...
            : showFirstReflection && !firstReflectionCompleted
              ...
              : "Choose how to decide with past bias"
      }
      score={score}
      currentLevel={1}
      totalLevels={1}
...
export default PastExperienceBias;