...
const choices = [
  {
    id: "a",
    title: "Decide to please others.",
    outcome: "Regret may follow.",
  },
  {
    id: "b",
    title: "Consider personal limits.",
...
const PressureDrivenChoice = () => {
  const location = useLocation();
  const gameId = "brain-adults-85"; // Next in sequence
  ...
  useEffect(() => {
    if (skillUnlocked) {
      console.log("Skill unlocked: Pressure awareness");
    }
  }, [skillUnlocked]);

  useEffect(() => {
    if (skillUnlocked) {
      console.log("Completed Pressure-Driven Choice", { score });
    }
  }, [skillUnlocked, score]);
        ...
        skillUnlocked
          ...
          : showSecondReflection && !secondReflectionCompleted
            ...
            : showFirstReflection && !firstReflectionCompleted
              ...
              : "Choose how to respond to pressure"
      }
      score={score}
      currentLevel={1}
      totalLevels={1}
      ...
      <div className="space-y-6 max-w-4xl mx-auto p-4">
        ...
        {skillUnlocked && (
          <Section title="Skill / Insight Unlocked">
            <strong>Pressure awareness</strong>
          </Section>
        )}
...
export default PressureDrivenChoice;