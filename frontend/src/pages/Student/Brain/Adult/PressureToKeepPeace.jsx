...
const choices = [
  {
    id: "a",
    title: "Stay silent to keep peace.",
    outcome: "Resentment builds slowly.",
  },
  {
    id: "b",
    title: "Express feelings calmly.",
    outcome: "Understanding improves.",
  },
  {
    id: "c",
    title: "React emotionally later.",
...
const PressureToKeepPeace = () => {
  const location = useLocation();
  const gameId = "brain-adults-41"; // Forty-first brain-adults game
  ...
  useEffect(() => {
    if (skillUnlocked) {
      console.log("Skill unlocked: Conflict awareness");
    }
  }, [skillUnlocked]);

  useEffect(() => {
    if (skillUnlocked) {
      console.log("Completed Pressure to Keep Peace", { score });
    }
  }, [skillUnlocked, score]);
        ...
        skillUnlocked
          ...
          : showSecondReflection && !secondReflectionCompleted
            ...
            : showFirstReflection && !firstReflectionCompleted
              ...
              : "Choose how you respond to pressure for harmony"
      }
      score={score}
      currentLevel={1}
      totalLevels={1}
      ...
      <div className="space-y-6 max-w-4xl mx-auto p-4">
        ...
        {skillUnlocked && (
          <Section title="Skill / Insight Unlocked">
            <strong>Conflict awareness</strong>
          </Section>
        )}
...
export default PressureToKeepPeace;