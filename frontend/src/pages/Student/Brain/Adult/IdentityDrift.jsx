...
const choices = [
  {
    id: "a",
    title: "Copy others' identities.",
    outcome: "Dissatisfaction increases.",
  },
  {
    id: "b",
    title: "Explore interests gradually.",
    outcome: "Clarity improves.",
  },
  {
    id: "c",
    title: "Avoid self-reflection.",
...
const IdentityDrift = () => {
  ...
  const gameId = "brain-adults-37"; // Thirty-seventh brain-adults game
  ...
  useEffect(() => {
    if (skillUnlocked) {
      console.log("Skill unlocked: Identity exploration awareness");
    }
  }, [skillUnlocked]);

  useEffect(() => {
    if (skillUnlocked) {
      console.log("Completed Identity Drift", { score });
    }
  }, [skillUnlocked, score]);
        ...
        skillUnlocked
          ...
          : showSecondReflection && !secondReflectionCompleted
            ...
            : showFirstReflection && !firstReflectionCompleted
              ...
              : "Choose how you respond to identity uncertainty"
      }
      score={score}
      currentLevel={1}
      totalLevels={1}
    ...
    >
      <div className="space-y-6 max-w-4xl mx-auto p-4">
        ...
        <Section title="Stress Point">
          Changing values and responsibilities.
        </Section>
        ...
        {skillUnlocked && (
          <Section title="Skill / Insight Unlocked">
            <strong>Identity exploration awareness</strong>
          </Section>
        )}
