...
const choices = [
  {
    id: "a",
    title: "React emotionally everywhere.",
    outcome: "Stress spreads.",
  },
  {
    id: "b",
    title: "Identify the source of stress.",
...
const EmotionalSpillover = () => {
  const location = useLocation();
  const gameId = "brain-adults-27"; // Twenty-seventh brain-adults game
  ...
  useEffect(() => {
    if (skillUnlocked) {
      console.log("Skill unlocked: Emotional spillover awareness");
    }
  }, [skillUnlocked]);

  useEffect(() => {
    if (skillUnlocked) {
      console.log("Completed Emotional Spillover", { score });
    }
  }, [skillUnlocked, score]);
        ...
        skillUnlocked
          ...
          : showSecondReflection && !secondReflectionCompleted
            ...
            : showFirstReflection && !firstReflectionCompleted
              ...
              : "Choose how you respond to emotional spillover"
      }
      score={score}
      currentLevel={1}
      totalLevels={1}
    ...
    >
      <div className="space-y-6 max-w-4xl mx-auto p-4">
        ...
        <Section title="Stress Point">
          Unresolved emotions carry over.
        </Section>
        ...
        {skillUnlocked && (
          <Section title="Skill / Insight Unlocked">
            <strong>Emotional spillover awareness</strong>
          </Section>
        )}
...
export default EmotionalSpillover;