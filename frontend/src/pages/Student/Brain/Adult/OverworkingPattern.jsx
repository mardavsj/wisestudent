...
const choices = [
  {
    id: "a",
    title: "Continue overworking.",
    outcome: "Burnout risk rises.",
  },
  {
    id: "b",
    title: "Schedule rest intentionally.",
...
const OverworkingPattern = () => {
  const location = useLocation();
  const gameId = "brain-adults-65"; // New game ID for overworking pattern
  ...
  useEffect(() => {
    if (skillUnlocked) {
      console.log("Skill unlocked: Work-rest balance awareness");
    }
  }, [skillUnlocked]);

  useEffect(() => {
    if (skillUnlocked) {
      console.log("Completed Overworking Pattern", { score });
    }
  }, [skillUnlocked, score]);
        ...
        skillUnlocked
          ...
          : showSecondReflection && !secondReflectionCompleted
            ...
            : showFirstReflection && !firstReflectionCompleted
              ...
              : "Choose how you manage working excessively without rest"
      }
      score={score}
      currentLevel={1}
      totalLevels={1}
    ...
    >
      <div className="space-y-6 max-w-4xl mx-auto p-4">
        ...
        <Section title="Decision Moment">
          The person must choose how to manage work.
        ...
        {skillUnlocked && (
          <Section title="Skill / Insight Unlocked">
            <strong>Work-rest balance awareness</strong>
          </Section>
        )}
...
export default OverworkingPattern;