...
const choices = [
  {
    id: "a",
    title: "Seek reassurance repeatedly.",
    outcome: "Dependence increases.",
  },
  {
    id: "b",
    title: "Build inner reassurance.",
    outcome: "Stability improves.",
  },
  {
    id: "c",
    title: "Withdraw emotionally.",
...
const EmotionalDependence = () => {
  const location = useLocation();
  const gameId = "brain-adults-48"; // Forty-eighth brain-adults game
  ...
  useEffect(() => {
    if (skillUnlocked) {
      console.log("Skill unlocked: Emotional independence awareness");
    }
  }, [skillUnlocked]);

  useEffect(() => {
    if (skillUnlocked) {
      console.log("Completed Emotional Dependence", { score });
    }
  }, [skillUnlocked, score]);
        ...
        skillUnlocked
          ...
          : showSecondReflection && !secondReflectionCompleted
            ...
            : showFirstReflection && !firstReflectionCompleted
              ...
              : "Choose how you respond to emotional dependence"
      }
      score={score}
      currentLevel={1}
      totalLevels={1}
      ...
      <div className="space-y-6 max-w-4xl mx-auto p-4">
        ...
        {skillUnlocked && (
          <Section title="Skill / Insight Unlocked">
            <strong>Emotional independence awareness</strong>
          </Section>
        )}
...
export default EmotionalDependence;