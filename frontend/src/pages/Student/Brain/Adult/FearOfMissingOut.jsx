...
const choices = [
  {
    id: "a",
    title: "Join everything.",
    outcome: "Exhaustion increases.",
  },
  {
    id: "b",
    title: "Choose selectively.",
    outcome: "Satisfaction improves.",
  },
  {
    id: "c",
    title: "Withdraw completely.",
...
const FearOfMissingOut = () => {
  const location = useLocation();
  const gameId = "brain-adults-57"; // New game ID for fear of missing out
  ...
  useEffect(() => {
    if (skillUnlocked) {
      console.log("Skill unlocked: Selective engagement awareness");
    }
  }, [skillUnlocked]);

  useEffect(() => {
    if (skillUnlocked) {
      console.log("Completed Fear of Missing Out", { score });
    }
  }, [skillUnlocked, score]);
        ...
        skillUnlocked
          ...
          : showSecondReflection && !secondReflectionCompleted
            ...
            : showFirstReflection && !firstReflectionCompleted
              ...
              : "Choose how you respond to seeing others' activities online"
      }
      score={score}
      currentLevel={1}
      totalLevels={1}
      ...
      <div className="space-y-6 max-w-4xl mx-auto p-4">
        ...
        {skillUnlocked && (
          <Section title="Skill / Insight Unlocked">
            <strong>Selective engagement awareness</strong>
          </Section>
        )}
...
export default FearOfMissingOut;