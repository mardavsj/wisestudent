...
const choices = [
  {
    id: "a",
    title: "Worry constantly.",
    outcome: "Stress increases.",
  },
  {
    id: "b",
    title: "Create flexible expectations.",
    outcome: "Stability improves.",
  },
  {
    id: "c",
    title: "Ignore uncertainty.",
...
const IncomeUncertainty = () => {
  const location = useLocation();
  const gameId = "brain-adults-75"; // New game ID for income uncertainty
  ...
  useEffect(() => {
    if (skillUnlocked) {
      console.log("Skill unlocked: Adaptability awareness");
    }
  }, [skillUnlocked]);

  useEffect(() => {
    if (skillUnlocked) {
      console.log("Completed Income Uncertainty", { score });
    }
  }, [skillUnlocked, score]);
        ...
        skillUnlocked
          ...
          : showSecondReflection && !secondReflectionCompleted
            ...
            : showFirstReflection && !firstReflectionCompleted
              ...
              : "Choose how you respond to irregular or unpredictable income"
      }
      score={score}
      currentLevel={1}
      totalLevels={1}
      ...
      <div className="space-y-6 max-w-4xl mx-auto p-4">
        ...
        {skillUnlocked && (
          <Section title="Skill / Insight Unlocked">
            <strong>Adaptability awareness</strong>
          </Section>
        )}
...
export default IncomeUncertainty;