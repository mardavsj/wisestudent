...
const choices = [
  {
    id: "a",
    title: "Accept the negative label.",
    outcome: "Confidence drops.",
  },
  {
    id: "b",
    title: "Separate action from identity.",
    outcome: "Perspective improves.",
  },
  {
    id: "c",
    title: "Avoid reflecting.",
...
const LabelingYourself = () => {
  const location = useLocation();
  const gameId = "brain-adults-34"; // Thirty-fourth brain-adults game
  ...
  useEffect(() => {
    if (skillUnlocked) {
      console.log("Skill unlocked: Identity separation awareness");
    }
  }, [skillUnlocked]);

  useEffect(() => {
    if (skillUnlocked) {
      console.log("Completed Labeling Yourself", { score });
    }
  }, [skillUnlocked, score]);
        ...
        skillUnlocked
          ...
          : showSecondReflection && !secondReflectionCompleted
            ...
            : showFirstReflection && !firstReflectionCompleted
              ...
              : "Choose how you interpret self-labeling"
      }
      score={score}
      currentLevel={1}
      totalLevels={1}
    ...
    >
      <div className="space-y-6 max-w-4xl mx-auto p-4">
        ...
        <Section title="Decision Moment">
          The person must choose how to interpret the event.
        ...
        {skillUnlocked && (
          <Section title="Skill / Insight Unlocked">
            <strong>Identity separation awareness</strong>
          </Section>
        )}
...
export default LabelingYourself;