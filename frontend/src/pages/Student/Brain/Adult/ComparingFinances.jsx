...
const choices = [
  ...
  {
    id: "b",
    title: "Focus on personal situation.",
    outcome: "Confidence stabilises.",
  },
  {
    id: "c",
    title: "Avoid money thoughts.",
...
const ComparingFinances = () => {
  const location = useLocation();
  const gameId = "brain-adults-73"; // New game ID for comparing finances
  ...
  useEffect(() => {
    if (skillUnlocked) {
      console.log("Skill unlocked: Financial comparison awareness");
    }
  }, [skillUnlocked]);

  useEffect(() => {
    if (skillUnlocked) {
      console.log("Completed Comparing Finances", { score });
    }
  }, [skillUnlocked, score]);
        ...
        skillUnlocked
          ...
          : showSecondReflection && !secondReflectionCompleted
            ...
            : showFirstReflection && !firstReflectionCompleted
              ...
              : "Choose how you respond to financial comparisons with peers"
      }
      score={score}
      currentLevel={1}
      totalLevels={1}
      ...
      <div className="space-y-6 max-w-4xl mx-auto p-4">
        ...
        {skillUnlocked && (
          <Section title="Skill / Insight Unlocked">
            <strong>Financial comparison awareness</strong>
          </Section>
        )}
...
export default ComparingFinances;