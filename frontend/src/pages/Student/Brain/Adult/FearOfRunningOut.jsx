...
const FearOfRunningOut = () => {
  const location = useLocation();
  const gameId = "brain-adults-74"; // New game ID for fear of running out
  ...
  useEffect(() => {
    if (skillUnlocked) {
      console.log("Skill unlocked: Security awareness");
    }
  }, [skillUnlocked]);

  useEffect(() => {
    if (skillUnlocked) {
      console.log("Completed Fear of Running Out", { score });
    }
  }, [skillUnlocked, score]);
        ...
        skillUnlocked
          ...
          : showSecondReflection && !secondReflectionCompleted
            ...
            : showFirstReflection && !firstReflectionCompleted
              ...
              : "Choose how you respond to feeling savings are insufficient for future needs"
      }
      score={score}
      currentLevel={1}
      totalLevels={1}
...
export default FearOfRunningOut;