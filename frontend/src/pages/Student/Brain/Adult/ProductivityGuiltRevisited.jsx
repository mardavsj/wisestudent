...
const ProductivityGuiltRevisited = () => {
  const location = useLocation();
  const gameId = "brain-adults-68"; // New game ID for productivity guilt revisited
  ...
  useEffect(() => {
    if (skillUnlocked) {
      console.log("Skill unlocked: Self-compassion awareness");
    }
  }, [skillUnlocked]);

  useEffect(() => {
    if (skillUnlocked) {
      console.log("Completed Productivity Guilt Revisited", { score });
    }
  }, [skillUnlocked, score]);
  ...
  return (
    <GameShell
      title="Productivity Guilt Revisited"
      subtitle={
        skillUnlocked
          ? "Insight unlocked"
          : showSecondReflection && !secondReflectionCompleted
            ...
            : showFirstReflection && !firstReflectionCompleted
              ...
              : "Choose how you respond to feeling guilty for not being productive"
      }
      score={score}
      currentLevel={1}
      totalLevels={1}
      ...
      <div className="space-y-6 max-w-4xl mx-auto p-4">
        ...
        {skillUnlocked && (
          <Section title="Skill / Insight Unlocked">
            <strong>Self-compassion awareness</strong>
          </Section>
        )}
...
export default ProductivityGuiltRevisited;