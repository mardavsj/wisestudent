...
const EmotionalSpending = () => {
  const location = useLocation();
  const gameId = "brain-adults-72"; // New game ID for emotional spending
  ...
  useEffect(() => {
    if (skillUnlocked) {
      console.log("Skill unlocked: Impulse awareness");
    }
  }, [skillUnlocked]);

  useEffect(() => {
    if (skillUnlocked) {
      console.log("Completed Emotional Spending", { score });
    }
  }, [skillUnlocked, score]);
        ...
        skillUnlocked
          ...
          : showSecondReflection && !secondReflectionCompleted
            ...
            : showFirstReflection && !firstReflectionCompleted
              ...
              : "Choose how you respond to emotional discomfort with spending"
      }
      score={score}
      currentLevel={1}
      totalLevels={1}
      ...
      <div className="space-y-6 max-w-4xl mx-auto p-4">
        ...
        {skillUnlocked && (
          <Section title="Skill / Insight Unlocked">
            <strong>Impulse awareness</strong>
          </Section>
        )}
