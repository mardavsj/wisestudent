...
const choices = [
  {
    id: "a",
    title: "Internalise failure.",
    outcome: "Confidence reduces.",
  },
  {
    id: "b",
    title: "Extract learning.",
    outcome: "Growth improves.",
  },
  {
    id: "c",
    title: "Avoid future attempts.",
...
const LearningFromFailure = () => {
  const location = useLocation();
  const gameId = "brain-adults-93"; // Next in sequence
  ...
  useEffect(() => {
    if (skillUnlocked) {
      console.log("Skill unlocked: Growth mindset awareness");
    }
  }, [skillUnlocked]);

  useEffect(() => {
    if (skillUnlocked) {
      console.log("Completed Learning from Failure", { score });
    }
  }, [skillUnlocked, score]);
        ...
        skillUnlocked
          ...
          : showSecondReflection && !secondReflectionCompleted
            ...
            : showFirstReflection && !firstReflectionCompleted
              ...
              : "Choose how to respond to failure"
      }
      score={score}
      currentLevel={1}
      totalLevels={1}
      ...
      <div className="space-y-6 max-w-4xl mx-auto p-4">
        ...
        {skillUnlocked && (
          <Section title="Skill / Insight Unlocked">
            <strong>Growth mindset awareness</strong>
          </Section>
        )}
...
export default LearningFromFailure;