...
const choices = [
  {
    id: "a",
    title: "Criticise self harshly.",
    outcome: "Self-esteem reduces.",
  },
  {
    id: "b",
    title: "Acknowledge personal journey.",
...
const FeelingBehindInLife = () => {
  const location = useLocation();
  const gameId = "brain-adults-31"; // Thirty-first brain-adults game
  ...
  useEffect(() => {
    if (skillUnlocked) {
      console.log("Skill unlocked: Self-worth awareness");
    }
  }, [skillUnlocked]);

  useEffect(() => {
    if (skillUnlocked) {
      console.log("Completed Feeling Behind in Life", { score });
    }
  }, [skillUnlocked, score]);
        ...
        skillUnlocked
          ...
          : showSecondReflection && !secondReflectionCompleted
            ...
            : showFirstReflection && !firstReflectionCompleted
              ...
              : "Choose how you respond to feeling behind"
      }
      score={score}
      currentLevel={1}
      totalLevels={1}
    ...
    >
      <div className="space-y-6 max-w-4xl mx-auto p-4">
        ...
        <Section title="Stress Point">
          Seeing others reach milestones earlier.
        </Section>

        {/* Decision */}
        <Section title="Decision Moment">
          The person must choose how to respond internally.
        ...
        {skillUnlocked && (
          <Section title="Skill / Insight Unlocked">
            <strong>Self-worth awareness</strong>
          </Section>
        )}
...
export default FeelingBehindInLife;