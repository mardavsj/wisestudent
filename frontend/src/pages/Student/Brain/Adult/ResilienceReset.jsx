...
const choices = [
  {
    id: "a",
    title: "Ignore fatigue.",
    outcome: "Burnout deepens.",
  },
  {
    id: "b",
    title: "Pause and rebuild gradually.",
...
const ResilienceReset = () => {
  const location = useLocation();
  const gameId = "brain-adults-100"; // Next in sequence
  ...
  useEffect(() => {
    if (skillUnlocked) {
      console.log("Skill unlocked: Resilience reset awareness");
    }
  }, [skillUnlocked]);

  useEffect(() => {
    if (skillUnlocked) {
      console.log("Completed Resilience Reset", { score });
    }
  }, [skillUnlocked, score]);
        ...
        skillUnlocked
          ...
          : showSecondReflection && !secondReflectionCompleted
            ...
            : showFirstReflection && !firstReflectionCompleted
              ...
              : "Choose how to reset after prolonged challenges"
      }
      score={score}
      currentLevel={1}
      totalLevels={1}
      ...
      <div className="space-y-6 max-w-4xl mx-auto p-4">
        ...
        {skillUnlocked && (
          <Section title="Skill / Insight Unlocked">
            <strong>Resilience reset awareness</strong>
          </Section>
        )}
...
export default ResilienceReset;