...
const choices = [
  {
    id: "a",
    title: "Follow emotion only.",
    outcome: "Regret increases.",
  },
  {
    id: "b",
    title: "Balance emotion and logic.",
    outcome: "Balanced outcomes improve.",
  },
  {
    id: "c",
    title: "Suppress emotion.",
...
const EmotionVsLogic = () => {
  const location = useLocation();
  const gameId = "brain-adults-87"; // Next in sequence
  ...
  useEffect(() => {
    if (skillUnlocked) {
      console.log("Skill unlocked: Balanced decision awareness");
    }
  }, [skillUnlocked]);

  useEffect(() => {
    if (skillUnlocked) {
      console.log("Completed Emotion vs Logic", { score });
    }
  }, [skillUnlocked, score]);
        ...
        skillUnlocked
          ...
          : showSecondReflection && !secondReflectionCompleted
            ...
            : showFirstReflection && !firstReflectionCompleted
              ...
              : "Choose how to balance emotion and logic"
      }
      score={score}
      currentLevel={1}
      totalLevels={1}
      ...
      <div className="space-y-6 max-w-4xl mx-auto p-4">
        ...
        {skillUnlocked && (
          <Section title="Skill / Insight Unlocked">
            <strong>Balanced decision awareness</strong>
          </Section>
        )}
