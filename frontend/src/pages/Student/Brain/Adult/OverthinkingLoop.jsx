...
const choices = [
  {
    id: "a",
    title: "Continue overthinking.",
    outcome: "Mental fatigue increases.",
  },
  {
    id: "b",
    title: "Set a decision point.",
...
const OverthinkingLoop = () => {
  const location = useLocation();
  const gameId = "brain-adults-86"; // Next in sequence
  ...
  useEffect(() => {
    if (skillUnlocked) {
      console.log("Skill unlocked: Decision clarity awareness");
    }
  }, [skillUnlocked]);

  useEffect(() => {
    if (skillUnlocked) {
      console.log("Completed Overthinking Loop", { score });
    }
  }, [skillUnlocked, score]);
        ...
        skillUnlocked
          ...
          : showSecondReflection && !secondReflectionCompleted
            ...
            : showFirstReflection && !firstReflectionCompleted
              ...
              : "Choose how to respond to overthinking"
      }
      score={score}
      currentLevel={1}
      totalLevels={1}
      ...
      <div className="space-y-6 max-w-4xl mx-auto p-4">
        ...
        {skillUnlocked && (
          <Section title="Skill / Insight Unlocked">
            <strong>Decision clarity awareness</strong>
          </Section>
        )}
...
export default OverthinkingLoop;