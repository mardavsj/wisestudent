...
const choices = [
  ...
  {
    id: "b",
    title: "Limit comparison exposure.",
    outcome: "Balance improves.",
  },
  {
    id: "c",
    title: "Avoid social media entirely.",
...
const ComparisonScroll = () => {
  ...
  const gameId = "brain-adults-53"; // New game ID for comparison scroll
  ...
  useEffect(() => {
    if (skillUnlocked) {
      console.log("Skill unlocked: Comparison awareness");
    }
  }, [skillUnlocked]);

  useEffect(() => {
    if (skillUnlocked) {
      console.log("Completed Comparison Scroll", { score });
    }
  }, [skillUnlocked, score]);
        ...
        skillUnlocked
          ...
          : showSecondReflection && !secondReflectionCompleted
            ...
            : showFirstReflection && !firstReflectionCompleted
              ...
              : "Choose how you respond to online content that triggers comparison"
      }
      score={score}
      currentLevel={1}
      totalLevels={1}
      ...
      <div className="space-y-6 max-w-4xl mx-auto p-4">
        ...
        {skillUnlocked && (
          <Section title="Skill / Insight Unlocked">
            <strong>Comparison awareness</strong>
          </Section>
        )}
