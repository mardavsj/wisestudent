...
const choices = [
  ...
  {
    id: "b",
    title: "Balance saving and spending.",
    outcome: "Satisfaction improves.",
  },
  {
    id: "c",
    title: "Avoid spending completely.",
...
const SavingVsLiving = () => {
  const location = useLocation();
  const gameId = "brain-adults-78"; // Next in sequence
  ...
  useEffect(() => {
    if (skillUnlocked) {
      console.log("Skill unlocked: Balance awareness");
    }
  }, [skillUnlocked]);

  useEffect(() => {
    if (skillUnlocked) {
      console.log("Completed Saving vs Living", { score });
    }
  }, [skillUnlocked, score]);
        ...
        skillUnlocked
          ...
          : showSecondReflection && !secondReflectionCompleted
            ...
            : showFirstReflection && !firstReflectionCompleted
              ...
              : "Choose how you respond to financial balance"
      }
      score={score}
      currentLevel={1}
      totalLevels={1}
      ...
      <div className="space-y-6 max-w-4xl mx-auto p-4">
        ...
        {skillUnlocked && (
          <Section title="Skill / Insight Unlocked">
            <strong>Balance awareness</strong>
          </Section>
        )}
