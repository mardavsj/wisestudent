...
const DecisionUnderStress = () => {
  const location = useLocation();
  const gameId = "brain-adults-81"; // Next in sequence
  ...
  useEffect(() => {
    if (skillUnlocked) {
      console.log("Skill unlocked: Decision pause awareness");
    }
  }, [skillUnlocked]);

  useEffect(() => {
    if (skillUnlocked) {
      console.log("Completed Decision Under Stress", { score });
    }
  }, [skillUnlocked, score]);
        ...
        skillUnlocked
          ...
          : showSecondReflection && !secondReflectionCompleted
            ...
            : showFirstReflection && !firstReflectionCompleted
              ...
              : "Choose how to decide under stress"
      }
      score={score}
      currentLevel={1}
      totalLevels={1}
    ...
    >
      <div className="space-y-6 max-w-4xl mx-auto p-4">
        ...
        <Section title="Stress Point">
          Strong emotions cloud thinking.
        </Section>

        {/* Decision */}
        <Section title="Decision Moment">
          The person must choose how to decide.
        ...
        {skillUnlocked && (
          <Section title="Skill / Insight Unlocked">
            <strong>Decision pause awareness</strong>
          </Section>
        )}
...
export default DecisionUnderStress;