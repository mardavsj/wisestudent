...
const EarlyBurnoutSigns = () => {
  const location = useLocation();
  const gameId = "brain-adults-63"; // New game ID for early burnout signs
  ...
  useEffect(() => {
    if (skillUnlocked) {
      console.log("Skill unlocked: Burnout signal awareness");
    }
  }, [skillUnlocked]);

  useEffect(() => {
    if (skillUnlocked) {
      console.log("Completed Early Burnout Signs", { score });
    }
  }, [skillUnlocked, score]);
        ...
        skillUnlocked
          ...
          : showSecondReflection && !secondReflectionCompleted
            ...
            : showFirstReflection && !firstReflectionCompleted
              ...
              : "Choose how you respond to fatigue appearing even after rest"
      }
      score={score}
      currentLevel={1}
      totalLevels={1}
      ...
      <div className="space-y-6 max-w-4xl mx-auto p-4">
        ...
        {skillUnlocked && (
          <Section title="Skill / Insight Unlocked">
            <strong>Burnout signal awareness</strong>
          </Section>
        )}
...
export default EarlyBurnoutSigns;