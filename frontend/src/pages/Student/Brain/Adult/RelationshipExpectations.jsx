...
const choices = [
  {
    id: "a",
    title: "Suppress feelings.",
    outcome: "Stress builds.",
  },
  {
    id: "b",
    title: "Acknowledge expectations.",
    outcome: "Awareness improves.",
  },
  {
    id: "c",
    title: "Avoid discussion.",
...
const RelationshipExpectations = () => {
  ...
  const gameId = "brain-adults-49"; // Forty-ninth brain-adults game
  ...
  useEffect(() => {
    if (skillUnlocked) {
      console.log("Skill unlocked: Expectation awareness");
    }
  }, [skillUnlocked]);

  useEffect(() => {
    if (skillUnlocked) {
      console.log("Completed Relationship Expectations", { score });
    }
  }, [skillUnlocked, score]);
        ...
        skillUnlocked
          ...
          : showSecondReflection && !secondReflectionCompleted
            ...
            : showFirstReflection && !firstReflectionCompleted
              ...
              : "Choose how you respond to relationship expectations"
      }
      score={score}
      currentLevel={1}
      totalLevels={1}
      ...
      <div className="space-y-6 max-w-4xl mx-auto p-4">
        ...
        {skillUnlocked && (
          <Section title="Skill / Insight Unlocked">
            <strong>Expectation awareness</strong>
          </Section>
        )}
