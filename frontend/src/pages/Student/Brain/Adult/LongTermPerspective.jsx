...
const choices = [
  {
    id: "a",
    title: "Focus only on now.",
    outcome: "Stress increases.",
  },
  {
    id: "b",
    title: "Consider long-term view.",
...
const LongTermPerspective = () => {
  ...
  const gameId = "brain-adults-99"; // Next in sequence
  ...
  useEffect(() => {
    if (skillUnlocked) {
      console.log("Skill unlocked: Perspective awareness");
    }
  }, [skillUnlocked]);

  useEffect(() => {
    if (skillUnlocked) {
      console.log("Completed Long-Term Perspective", { score });
    }
  }, [skillUnlocked, score]);
        ...
        skillUnlocked
          ...
          : showSecondReflection && !secondReflectionCompleted
            ...
            : showFirstReflection && !firstReflectionCompleted
              ...
              : "Choose perspective during short-term setbacks"
      }
      score={score}
      currentLevel={1}
      totalLevels={1}
    ...
    >
      <div className="space-y-6 max-w-4xl mx-auto p-4">
        ...
        <Section title="Decision Moment">
          The person must choose perspective.
        ...
        {skillUnlocked && (
          <Section title="Skill / Insight Unlocked">
            <strong>Perspective awareness</strong>
          </Section>
        )}
...
export default LongTermPerspective;