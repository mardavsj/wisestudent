...
const AlwaysAvailable = () => {
  ...
  const gameId = "brain-adults-59"; // New game ID for always available
  ...
  useEffect(() => {
    if (skillUnlocked) {
      console.log("Completed Always Available", { score });
    }
  }, [skillUnlocked, score]);
        ...
        skillUnlocked
          ...
          : showSecondReflection && !secondReflectionCompleted
            ...
            : showFirstReflection && !firstReflectionCompleted
              ...
              : "Choose how you manage being reachable at all times"
      }
      score={score}
      currentLevel={1}
      totalLevels={1}
