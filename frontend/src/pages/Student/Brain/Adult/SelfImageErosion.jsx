...
const choices = [
  {
    id: "a",
    title: "Continue self-criticism.",
    outcome: "Confidence reduces.",
  },
  {
    id: "b",
    title: "Notice and question thoughts.",
    outcome: "Self-image improves.",
  },
  {
    id: "c",
    title: "Ignore self-image concerns.",
...
const SelfImageErosion = () => {
  const location = useLocation();
  const gameId = "brain-adults-39"; // Thirty-ninth brain-adults game
  ...
  useEffect(() => {
    if (skillUnlocked) {
      console.log("Skill unlocked: Self-image awareness");
    }
  }, [skillUnlocked]);

  useEffect(() => {
    if (skillUnlocked) {
      console.log("Completed Self-Image Erosion", { score });
    }
  }, [skillUnlocked, score]);
        ...
        skillUnlocked
          ...
          : showSecondReflection && !secondReflectionCompleted
            ...
            : showFirstReflection && !firstReflectionCompleted
              ...
              : "Choose how you respond to self-image erosion"
      }
      score={score}
      currentLevel={1}
      totalLevels={1}
      ...
      <div className="space-y-6 max-w-4xl mx-auto p-4">
        ...
        {skillUnlocked && (
          <Section title="Skill / Insight Unlocked">
            <strong>Self-image awareness</strong>
          </Section>
        )}
...
export default SelfImageErosion;