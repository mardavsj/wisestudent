...
const choices = [
  {
    id: "a",
    title: "Work only when motivated.",
    outcome: "Inconsistency increases.",
  },
  {
    id: "b",
    title: "Follow a simple routine.",
...
const DisciplineVsMood = () => {
  const location = useLocation();
  const gameId = "brain-adults-62"; // New game ID for discipline vs mood
  ...
  useEffect(() => {
    if (skillUnlocked) {
      console.log("Skill unlocked: Discipline awareness");
    }
  }, [skillUnlocked]);

  useEffect(() => {
    if (skillUnlocked) {
      console.log("Completed Discipline vs Mood", { score });
    }
  }, [skillUnlocked, score]);
        ...
        skillUnlocked
          ...
          : showSecondReflection && !secondReflectionCompleted
            ...
            : showFirstReflection && !firstReflectionCompleted
              ...
              : "Choose how you respond to daily mood shifts affecting productivity"
      }
      score={score}
      currentLevel={1}
      totalLevels={1}
    ...
    >
      <div className="space-y-6 max-w-4xl mx-auto p-4">
        ...
        <Section title="Decision Moment">
          The person must choose how to act.
        ...
        {skillUnlocked && (
          <Section title="Skill / Insight Unlocked">
            <strong>Discipline awareness</strong>
          </Section>
        )}
...
export default DisciplineVsMood;