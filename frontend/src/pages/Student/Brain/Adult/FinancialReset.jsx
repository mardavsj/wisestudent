...
const choices = [
  ...
  {
    id: "b",
    title: "Review finances calmly.",
    outcome: "Clarity improves.",
  },
  {
    id: "c",
    title: "Avoid money discussions.",
...
const FinancialReset = () => {
  const location = useLocation();
  const gameId = "brain-adults-80"; // Next in sequence
  ...
  useEffect(() => {
    if (skillUnlocked) {
      console.log("Skill unlocked: Financial reset awareness");
    }
  }, [skillUnlocked]);

  useEffect(() => {
    if (skillUnlocked) {
      console.log("Completed Financial Reset", { score });
    }
  }, [skillUnlocked, score]);
        ...
        skillUnlocked
          ...
          : showSecondReflection && !secondReflectionCompleted
            ...
            : showFirstReflection && !firstReflectionCompleted
              ...
              : "Choose how to reset financially"
      }
      score={score}
      currentLevel={1}
      totalLevels={1}
      ...
      <div className="space-y-6 max-w-4xl mx-auto p-4">
        ...
        {skillUnlocked && (
          <Section title="Skill / Insight Unlocked">
            <strong>Financial reset awareness</strong>
          </Section>
        )}
