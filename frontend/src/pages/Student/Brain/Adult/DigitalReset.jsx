...
const choices = [
  ...
  {
    id: "b",
    title: "Take intentional digital breaks.",
    outcome: "Mental freshness improves.",
  },
  {
    id: "c",
    title: "Avoid devices completely.",
...
const DigitalReset = () => {
  ...
  const gameId = "brain-adults-60"; // New game ID for digital reset
  ...
  useEffect(() => {
    if (skillUnlocked) {
      console.log("Skill unlocked: Digital balance awareness");
    }
  }, [skillUnlocked]);

  useEffect(() => {
    if (skillUnlocked) {
      console.log("Completed Digital Reset", { score });
    }
  }, [skillUnlocked, score]);
        ...
        skillUnlocked
          ...
          : showSecondReflection && !secondReflectionCompleted
            ...
            : showFirstReflection && !firstReflectionCompleted
              ...
              : "Choose how you respond to prolonged digital use causing mental fatigue"
      }
      score={score}
      currentLevel={1}
      totalLevels={1}
    ...
    >
      <div className="space-y-6 max-w-4xl mx-auto p-4">
        ...
        <Section title="Decision Moment">
          The person must choose how to reset.
        ...
        {skillUnlocked && (
          <Section title="Skill / Insight Unlocked">
            <strong>Digital balance awareness</strong>
          </Section>
        )}
