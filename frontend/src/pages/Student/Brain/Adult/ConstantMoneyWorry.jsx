...
const choices = [
  {
    id: "a",
    title: "Worry continuously.",
    outcome: "Anxiety increases.",
  },
  {
    id: "b",
    title: "Review the situation calmly.",
    outcome: "Sense of control improves.",
  },
  {
    id: "c",
    title: "Avoid thinking about money.",
...
const ConstantMoneyWorry = () => {
  const location = useLocation();
  const gameId = "brain-adults-71"; // New game ID for constant money worry
  ...
  useEffect(() => {
    if (skillUnlocked) {
      console.log("Skill unlocked: Financial stress awareness");
    }
  }, [skillUnlocked]);

  useEffect(() => {
    if (skillUnlocked) {
      console.log("Completed Constant Money Worry", { score });
    }
  }, [skillUnlocked, score]);
        ...
        skillUnlocked
          ...
          : showSecondReflection && !secondReflectionCompleted
            ...
            : showFirstReflection && !firstReflectionCompleted
              ...
              : "Choose how you respond to frequent financial worries"
      }
      score={score}
      currentLevel={1}
      totalLevels={1}
    ...
    >
      <div className="space-y-6 max-w-4xl mx-auto p-4">
        ...
        <Section title="Decision Moment">
          The person must choose how to respond emotionally.
        ...
        {skillUnlocked && (
          <Section title="Skill / Insight Unlocked">
            <strong>Financial stress awareness</strong>
          </Section>
        )}
...
export default ConstantMoneyWorry;