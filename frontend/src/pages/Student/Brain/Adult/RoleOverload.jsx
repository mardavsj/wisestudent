...
const choices = [
  {
    id: "a",
    title: "Try to excel in all roles equally.",
    outcome: "Exhaustion increases.",
  },
  {
    id: "b",
    title: "Accept shifting priorities.",
    outcome: "Balance improves.",
  },
  {
    id: "c",
    title: "Ignore identity conflict.",
...
const RoleOverload = () => {
  ...
  const gameId = "brain-adults-32"; // Thirty-second brain-adults game
  ...
  useEffect(() => {
    if (skillUnlocked) {
      console.log("Skill unlocked: Role balance awareness");
    }
  }, [skillUnlocked]);

  useEffect(() => {
    if (skillUnlocked) {
      console.log("Completed Role Overload", { score });
    }
  }, [skillUnlocked, score]);
        ...
        skillUnlocked
          ...
          : showSecondReflection && !secondReflectionCompleted
            ...
            : showFirstReflection && !firstReflectionCompleted
              ...
              : "Choose how you respond to role overload"
      }
      score={score}
      currentLevel={1}
      totalLevels={1}
    ...
    >
      <div className="space-y-6 max-w-4xl mx-auto p-4">
        ...
        <Section title="Decision Moment">
          The person must decide how to respond internally.
        ...
        {skillUnlocked && (
          <Section title="Skill / Insight Unlocked">
            <strong>Role balance awareness</strong>
          </Section>
        )}
