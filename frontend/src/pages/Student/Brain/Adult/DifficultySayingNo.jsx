...
const choices = [
  {
    id: "a",
    title: "Agree despite exhaustion.",
...
const DifficultySayingNo = () => {
  const location = useLocation();
  const gameId = "brain-adults-42"; // Forty-second brain-adults game
  ...
  useEffect(() => {
    if (skillUnlocked) {
      console.log("Skill unlocked: Boundary setting awareness");
    }
  }, [skillUnlocked]);

  useEffect(() => {
    if (skillUnlocked) {
      console.log("Completed Difficulty Saying No", { score });
    }
  }, [skillUnlocked, score]);
        ...
        skillUnlocked
          ...
          : showSecondReflection && !secondReflectionCompleted
            ...
            : showFirstReflection && !firstReflectionCompleted
              ...
              : "Choose how you respond to constant requests"
      }
      score={score}
      currentLevel={1}
      totalLevels={1}
      ...
      <div className="space-y-6 max-w-4xl mx-auto p-4">
        ...
        {skillUnlocked && (
          <Section title="Skill / Insight Unlocked">
            <strong>Boundary setting awareness</strong>
          </Section>
        )}
...
export default DifficultySayingNo;