...
const choices = [
  {
    id: "a",
    title: "Wait for motivation to return.",
    outcome: "Progress stalls.",
  },
  {
    id: "b",
    title: "Take small consistent actions.",
...
const LossOfMotivation = () => {
  const location = useLocation();
  const gameId = "brain-adults-61"; // New game ID for loss of motivation
  ...
  useEffect(() => {
    if (skillUnlocked) {
      console.log("Skill unlocked: Motivation awareness");
    }
  }, [skillUnlocked]);

  useEffect(() => {
    if (skillUnlocked) {
      console.log("Completed Loss of Motivation", { score });
    }
  }, [skillUnlocked, score]);
        ...
        skillUnlocked
          ...
          : showSecondReflection && !secondReflectionCompleted
            ...
            : showFirstReflection && !firstReflectionCompleted
              ...
              : "Choose how you respond to feeling unmotivated despite responsibilities"
      }
      score={score}
      currentLevel={1}
      totalLevels={1}
      ...
      <div className="space-y-6 max-w-4xl mx-auto p-4">
        ...
        {skillUnlocked && (
          <Section title="Skill / Insight Unlocked">
            <strong>Motivation awareness</strong>
          </Section>
        )}
...
export default LossOfMotivation;