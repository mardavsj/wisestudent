...
const QuizOnService = () => {
  ...
  const questions = [
    {
      ...
      options: [
        {
          id: "a",
          text: "Getting paid for work",
          emoji: "💰",
          isCorrect: false
        },
        {
          id: "b",
          text: "Helping others without expecting payment",
          emoji: "🤝",
          isCorrect: true
        },
        {
  ...
  return (
    <GameShell
      ...
      nextGamePathProp="/student/civic-responsibility/kids/reflex-service-basics"
      nextGameIdProp="civic-responsibility-kids-53">
