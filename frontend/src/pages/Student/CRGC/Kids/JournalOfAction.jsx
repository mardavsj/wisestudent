...
const JournalOfAction = () => {
  ...
  const gameId = "civic-responsibility-kids-97";
  ...
  const stages = [
    {
      question: 'Write: "One civic action I took is ___"',
      minLength: 10,
    },
    {
      question: 'Write: "I helped my community by ___"',
      minLength: 10,
    },
    {
      question: 'Write: "I made a difference by ___"',
      minLength: 10,
    },
    {
      question: 'Write: "I participated in a civic activity by ___"',
      minLength: 10,
    },
    {
      question: 'Write: "I showed responsibility by ___"',
      minLength: 10,
    },
  ];
  ...
  useEffect(() => {
    if (showResult) {
      console.log(`🎮 Journal of Action game completed! Score: ${finalScore}/${stages.length}, gameId: ${gameId}`);
    }
  ...
  return (
    <GameShell
      ...
      subtitle={!showResult ? `Question ${currentStage + 1} of ${stages.length}: Share Your Civic Actions!` : "Journal Complete!"}
      ...
      nextGamePathProp="/student/civic-responsibility/kids/team-story"
      nextGameIdProp="civic-responsibility-kids-98">
      <div className="min-h-[calc(100vh-200px)] flex flex-col justify-center text-center text-white space-y-6 md:space-y-8 max-w-4xl mx-auto px-4 py-4">
        ...
        {showResult && (
          <div className="bg-white/10 backdrop-blur-md p-6 md:p-8 rounded-xl md:rounded-2xl border border-white/20 text-center">
            ...
            <h2 className="text-2xl font-bold text-white mb-6">Action Complete!</h2>
            
            <div className="bg-gradient-to-r from-green-500/20 to-emerald-500/20 rounded-xl p-4 border border-green-400/30 mb-6">
              <p className="text-green-300 font-bold">
                🎉 Excellent! You've completed your action journal!
              </p>
              <p className="text-green-300 mt-2">
                Recording your civic actions helps develop your active citizenship!
              </p>
            </div>
