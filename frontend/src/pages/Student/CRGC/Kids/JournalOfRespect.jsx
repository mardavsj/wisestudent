...
const JournalOfRespect = () => {
  ...
  const gameId = "civic-responsibility-kids-17";
  ...
  const stages = [
    {
      question: 'Write: "I showed respect today by ___"',
      minLength: 10,
    },
    {
      question: 'Write: "I treated someone fairly by ___"',
      minLength: 10,
    },
    {
      question: 'Write: "I listened to someone with respect when ___"',
      minLength: 10,
    },
    {
    ...
    {
      question: 'Write: "I respected someone\'s opinion even though I disagreed by ___"',
      minLength: 10,
    },
  ];
  ...
  useEffect(() => {
    if (showResult) {
      console.log(`🎮 Journal of Respect game completed! Score: ${finalScore}/${stages.length}, gameId: ${gameId}`);
    }
  ...
  return (
    <GameShell
      ...
      subtitle={!showResult ? `Question ${currentStage + 1} of ${stages.length}: Share Your Respect!` : "Journal Complete!"}
      ...
      nextGamePathProp="/student/civic-responsibility/kids/disability-story"
      nextGameIdProp="civic-responsibility-kids-18">
      <div className="min-h-[calc(100vh-200px)] flex flex-col justify-center text-center text-white space-y-6 md:space-y-8 max-w-4xl mx-auto px-4 py-4">
        ...
        {showResult && (
          <div className="bg-white/10 backdrop-blur-md p-6 md:p-8 rounded-xl md:rounded-2xl border border-white/20 text-center">
            ...
            <h2 className="text-2xl font-bold text-white mb-6">Respect Complete!</h2>
            
            <div className="bg-gradient-to-r from-green-500/20 to-emerald-500/20 rounded-xl p-4 border border-green-400/30 mb-6">
              <p className="text-green-300 font-bold">
                🎉 Excellent! You've completed your respect journal!
              </p>
              <p className="text-green-300 mt-2">
                Recording your acts of respect helps develop your character!
              </p>
            </div>
