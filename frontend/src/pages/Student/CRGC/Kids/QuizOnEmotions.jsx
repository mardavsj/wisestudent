...
const QuizOnEmotions = () => {
  ...
  const questions = [
    ...
    },
    {
      ...
      options: [
        ...
        {
          id: "c",
          text: "They are sleeping peacefully",
          emoji: "😴",
          isCorrect: false
        },
        {
          id: "b",
          text: "They are fidgeting or seem restless",
          emoji: "😬",
          isCorrect: true
        },
      ]
  ...
  return (
    <GameShell
      ...
      nextGamePathProp="/student/civic-responsibility/kids/reflex-feelings"
      nextGameIdProp="civic-responsibility-kids-43">
