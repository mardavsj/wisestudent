...
const QuizOnBullying = () => {
  ...
  const questions = [
    {
      id: 1,
      text: "What does bullying mean?",
      emoji: "💢",
      options: [
        {
          id: "a",
          text: "Hurting others on purpose",
          emoji: "😠",
          isCorrect: true
        },
        {
        ...
        {
          id: "c",
          text: "Playing nicely with friends",
          emoji: "😊",
          isCorrect: false
        }
      ]
    },
    {
      ...
      options: [
        {
          id: "a",
          text: "Teasing someone repeatedly",
          emoji: "😤",
          isCorrect: false
        },
        {
          id: "b",
          text: "Accidentally bumping into someone",
          emoji: "😅",
          isCorrect: true
        },
        {
  ...
  return (
    <GameShell
      ...
      nextGamePathProp="/student/civic-responsibility/kids/reflex-bully-alert"
      nextGameIdProp="civic-responsibility-kids-33">
