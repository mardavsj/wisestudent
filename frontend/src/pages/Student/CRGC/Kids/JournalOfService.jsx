...
const JournalOfService = () => {
  ...
  const gameId = "civic-responsibility-kids-57";
  ...
  const stages = [
    {
      question: 'Write: "One way I helped in my community is ___"',
      minLength: 10,
    },
    {
      question: 'Write: "I volunteered to help others by ___"',
      minLength: 10,
    },
    {
      question: 'Write: "I made my neighborhood better by ___"',
      minLength: 10,
    },
    {
      question: 'Write: "I supported a friend in need by ___"',
      minLength: 10,
    },
    {
      question: 'Write: "I contributed to a group effort by ___"',
      minLength: 10,
    },
  ];
  ...
  useEffect(() => {
    if (showResult) {
      console.log(`🎮 Journal of Service game completed! Score: ${finalScore}/${stages.length}, gameId: ${gameId}`);
    }
  ...
  return (
    <GameShell
      ...
      subtitle={!showResult ? `Question ${currentStage + 1} of ${stages.length}: Share Your Service!` : "Journal Complete!"}
      ...
      nextGamePathProp="/student/civic-responsibility/kids/old-age-home-story"
      nextGameIdProp="civic-responsibility-kids-58">
          ...
          <div className="bg-white/10 backdrop-blur-md p-6 md:p-8 rounded-xl md:rounded-2xl border border-white/20 text-center">
            ...
            <div className="bg-gradient-to-r from-green-500/20 to-emerald-500/20 rounded-xl p-4 border border-green-400/30 mb-6">
              ...
              <p className="text-green-300 mt-2">
                Recording your acts of service helps develop your community spirit!
              </p>
            </div>
