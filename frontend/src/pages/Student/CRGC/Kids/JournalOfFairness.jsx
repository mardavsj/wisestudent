...
const JournalOfFairness = () => {
  ...
  const gameId = "civic-responsibility-kids-67";
  ...
  const stages = [
    {
      question: 'Write: "One right I am thankful for is ___"',
      minLength: 10,
    },
    {
      question: 'Write: "I stood up for someone\'s rights by ___"',
      minLength: 10,
    },
    {
      question: 'Write: "I treated everyone fairly by ___"',
      minLength: 10,
    },
    {
      question: 'Write: "I made sure rules were followed by ___"',
      minLength: 10,
    },
    {
      question: 'Write: "I helped create a fair situation by ___"',
      minLength: 10,
    },
  ];
  ...
  useEffect(() => {
    if (showResult) {
      console.log(`🎮 Journal of Fairness game completed! Score: ${finalScore}/${stages.length}, gameId: ${gameId}`);
    }
  ...
  return (
    <GameShell
      ...
      subtitle={!showResult ? `Question ${currentStage + 1} of ${stages.length}: Share Your Fairness!` : "Journal Complete!"}
      ...
      nextGamePathProp="/student/civic-responsibility/kids/disabled-child-story"
      nextGameIdProp="civic-responsibility-kids-68">
      <div className="min-h-[calc(100vh-200px)] flex flex-col justify-center text-center text-white space-y-6 md:space-y-8 max-w-4xl mx-auto px-4 py-4">
        ...
        {showResult && (
          <div className="bg-white/10 backdrop-blur-md p-6 md:p-8 rounded-xl md:rounded-2xl border border-white/20 text-center">
            ...
            <h2 className="text-2xl font-bold text-white mb-6">Fairness Complete!</h2>
            
            <div className="bg-gradient-to-r from-green-500/20 to-emerald-500/20 rounded-xl p-4 border border-green-400/30 mb-6">
              <p className="text-green-300 font-bold">
                🎉 Excellent! You've completed your fairness journal!
              </p>
              <p className="text-green-300 mt-2">
                Recording your acts of fairness helps build a more just world!
              </p>
            </div>
