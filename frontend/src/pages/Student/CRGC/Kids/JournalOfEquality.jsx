...
const JournalOfEquality = () => {
  const navigate = useNavigate();
  const location = useLocation();
  
  // Get game data from game category folder (source of truth)
  const gameId = "civic-responsibility-kids-27";
  ...
  const stages = [
    {
      question: 'Write: "One time I treated boys and girls equally was ___"',
      minLength: 10,
    },
    {
      question: 'Write: "I made sure everyone got a fair chance by ___"',
      minLength: 10,
    },
    {
      question: 'Write: "I stood up for someone who was being treated unfairly by ___"',
      minLength: 10,
    },
    {
      question: 'Write: "I shared resources equally with everyone by ___"',
      minLength: 10,
    },
    {
      question: 'Write: "I treated someone with respect regardless of their background by ___"',
      minLength: 10,
    },
  ];
  ...
  useEffect(() => {
    if (showResult) {
      console.log(`🎮 Journal of Equality game completed! Score: ${finalScore}/${stages.length}, gameId: ${gameId}`);
    }
  ...
  return (
    <GameShell
      ...
      subtitle={!showResult ? `Question ${currentStage + 1} of ${stages.length}: Share Your Equality Actions!` : "Journal Complete!"}
      ...
      nextGamePathProp="/student/civic-responsibility/kids/classroom-story-2"
      nextGameIdProp="civic-responsibility-kids-28">
          ...
          <div className="bg-white/10 backdrop-blur-md p-6 md:p-8 rounded-xl md:rounded-2xl border border-white/20 text-center">
            ...
            <div className="bg-gradient-to-r from-green-500/20 to-emerald-500/20 rounded-xl p-4 border border-green-400/30 mb-6">
              ...
              <p className="text-green-300 mt-2">
                Recording your acts of fairness helps build a more equal world!
              </p>
            </div>
...
export default JournalOfEquality;