...
const JournalOfFeelings = () => {
  const navigate = useNavigate();
  const location = useLocation();
  
  // Get game data from game category folder (source of truth)
  const gameId = "civic-responsibility-kids-47";
  ...
  const stages = [
    {
      question: 'Write: "Today I managed my feelings by ___"',
      minLength: 10,
    },
    {
      question: 'Write: "I helped someone else with their feelings by ___"',
      minLength: 10,
    },
    {
      question: 'Write: "I recognized how I was feeling when ___"',
      minLength: 10,
    },
    {
      question: 'Write: "I calmed down when I felt upset by ___"',
      minLength: 10,
    },
    {
      question: 'Write: "I expressed my feelings in a healthy way by ___"',
      minLength: 10,
    },
  ];
  ...
  useEffect(() => {
    if (showResult) {
      console.log(`🎮 Journal of Feelings game completed! Score: ${finalScore}/${stages.length}, gameId: ${gameId}`);
    }
  ...
  return (
    <GameShell
      ...
      subtitle={!showResult ? `Question ${currentStage + 1} of ${stages.length}: Share Your Feelings!` : "Journal Complete!"}
      ...
      nextGamePathProp="/student/civic-responsibility/kids/fight-story"
      nextGameIdProp="civic-responsibility-kids-48">
      <div className="min-h-[calc(100vh-200px)] flex flex-col justify-center text-center text-white space-y-6 md:space-y-8 max-w-4xl mx-auto px-4 py-4">
        ...
        {showResult && (
          <div className="bg-white/10 backdrop-blur-md p-6 md:p-8 rounded-xl md:rounded-2xl border border-white/20 text-center">
            ...
            <h2 className="text-2xl font-bold text-white mb-6">Feelings Complete!</h2>
            
            <div className="bg-gradient-to-r from-green-500/20 to-emerald-500/20 rounded-xl p-4 border border-green-400/30 mb-6">
              <p className="text-green-300 font-bold">
                🎉 Excellent! You've completed your feelings journal!
              </p>
              <p className="text-green-300 mt-2">
                Recording your emotional experiences helps develop your emotional intelligence!
              </p>
            </div>
...
export default JournalOfFeelings;