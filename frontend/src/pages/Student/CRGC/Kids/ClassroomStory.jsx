...
const ClassroomStory = () => {
  ...
  const questions = [
    ...
    },
    {
      ...
      options: [
        ...
        {
          id: "c",
          text: "Make fun of his confusion",
          emoji: "😆",
          isCorrect: false
        }
      ]
    },
    {
      ...
      options: [
        ...
        {
          id: "c",
          text: "Tell others not to sit with him",
          emoji: "🙅",
          isCorrect: false
        },
        {
  ...
  return (
    <GameShell
      ...
      totalXp={totalXp}
      nextGamePathProp="/student/civic-responsibility/kids/quiz-on-respect"
      nextGameIdProp="civic-responsibility-kids-12">
            ...
            {finalScore >= 3 ? (
              <div>
                ...
                <p className="text-white/90 text-base md:text-lg mb-4">
                  ...
                  You understand how to create an inclusive classroom!
                </p>
                <div className="bg-gradient-to-r from-yellow-500 to-orange-500 text-white py-2 md:py-3 px-4 md:px-6 rounded-full inline-flex items-center gap-2 mb-4 text-sm md:text-base">
                  <span>+{coins} Coins</span>
                </div>
                <p className="text-white/80 text-sm md:text-base">
                  Great job! You know how to make everyone feel welcome and valued!
                </p>
              </div>
            ) : (
              <div>
                ...
                <p className="text-white/90 text-base md:text-lg mb-4">
                  You got {finalScore} out of {questions.length} questions correct.
                  Remember, everyone deserves to feel included and respected!
                </p>
                <button
                ...
                <p className="text-white/80 text-xs md:text-sm">
                  Try to choose the option that shows how to include and respect everyone.
                </p>
              </div>
            )}
          </div>
