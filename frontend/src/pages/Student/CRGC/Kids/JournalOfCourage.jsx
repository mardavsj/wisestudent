...
const JournalOfCourage = () => {
  ...
  const gameId = "civic-responsibility-kids-37";
  ...
  const stages = [
    {
      question: 'Write: "One time I stood up for someone was ___"',
      minLength: 10,
    },
    {
      question: 'Write: "I showed courage by helping someone who needed it by ___"',
      minLength: 10,
    },
    {
      question: 'Write: "I did the right thing even when it was difficult by ___"',
      minLength: 10,
    },
    {
      question: 'Write: "I included someone who was being left out by ___"',
      minLength: 10,
    },
    {
      question: 'Write: "I spoke up against something unfair by ___"',
      minLength: 10,
    },
  ];
  ...
  useEffect(() => {
    if (showResult) {
      console.log(`🎮 Journal of Courage game completed! Score: ${finalScore}/${stages.length}, gameId: ${gameId}`);
    }
  ...
  return (
    <GameShell
      ...
      subtitle={!showResult ? `Question ${currentStage + 1} of ${stages.length}: Share Your Courage!` : "Journal Complete!"}
      ...
      nextGamePathProp="/student/civic-responsibility/kids/name-calling-story"
      nextGameIdProp="civic-responsibility-kids-38">
      <div className="min-h-[calc(100vh-200px)] flex flex-col justify-center text-center text-white space-y-6 md:space-y-8 max-w-4xl mx-auto px-4 py-4">
        ...
        {showResult && (
          <div className="bg-white/10 backdrop-blur-md p-6 md:p-8 rounded-xl md:rounded-2xl border border-white/20 text-center">
            ...
            <h2 className="text-2xl font-bold text-white mb-6">Courage Complete!</h2>
            
            <div className="bg-gradient-to-r from-green-500/20 to-emerald-500/20 rounded-xl p-4 border border-green-400/30 mb-6">
              <p className="text-green-300 font-bold">
                🎉 Excellent! You've completed your courage journal!
              </p>
              <p className="text-green-300 mt-2">
                Recording your brave actions helps develop your heroic spirit!
              </p>
            </div>
