...
const RefugeeStory = () => {
  ...
  const questions = [
    {
      ...
      options: [
        ...
        {
          id: "c",
          text: "Make fun of her for being different",
          emoji: "😂",
          isCorrect: false
        }
      ]
    ...
    },
    {
      ...
      options: [
        ...
        {
          id: "c",
          text: "Ask her to help you with your homework instead",
          emoji: "📝",
          isCorrect: false
        }
      ]
  ...
  return (
    <GameShell
      ...
      totalXp={totalXp}
      nextGamePathProp="/student/civic-responsibility/teens/debate-kindness"
      nextGameIdProp="civic-responsibility-teens-6">
            ...
            {finalScore >= 3 ? (
              <div>
                ...
                <p className="text-white/90 text-base md:text-lg mb-4">
                  ...
                  You understand how to show kindness and inclusion to refugees!
                </p>
                <div className="bg-gradient-to-r from-yellow-500 to-orange-500 text-white py-2 md:py-3 px-4 md:px-6 rounded-full inline-flex items-center gap-2 mb-4 text-sm md:text-base">
                  <span>+{coins} Coins</span>
                </div>
                <p className="text-white/80 text-sm md:text-base">
                  Great job! You know how to treat refugees with dignity and respect!
                </p>
              </div>
            ) : (
              <div>
                ...
                <p className="text-white/90 text-base md:text-lg mb-4">
                  You got {finalScore} out of {questions.length} questions correct.
                  Remember, refugees deserve the same kindness and respect as everyone else!
                </p>
                <button
                ...
                <p className="text-white/80 text-xs md:text-sm">
                  Try to choose the option that shows how to treat refugees with kindness and inclusion.
                </p>
              </div>
            )}
          </div>
