...
const JournalOfGlobalValues = () => {
  ...
  const gameId = "civic-responsibility-teens-87";
  ...
  const stages = [
    {
      question: 'Write: "One way I can act like a global citizen is ___"',
      minLength: 10,
    },
    {
      question: 'Write: "A global issue I care about is ___"',
      minLength: 10,
    },
    {
      question: 'Write: "How I can promote cultural understanding is ___"',
      minLength: 10,
    },
    {
      question: 'Write: "One thing I learned about another culture is ___"',
      minLength: 10,
    },
    {
      question: 'Write: "How I can contribute to global peace is ___"',
      minLength: 10,
    },
  ];
  ...
  useEffect(() => {
    if (showResult) {
      console.log(`🎮 Journal of Global Values game completed! Score: ${finalScore}/${stages.length}, gameId: ${gameId}`);
    }
  ...
  return (
    <GameShell
      ...
      subtitle={!showResult ? `Question ${currentStage + 1} of ${stages.length}: Reflect on Global Values!` : "Journal Complete!"}
      ...
      nextGamePathProp="/student/civic-responsibility/teens/simulation-global-project"
      nextGameIdProp="civic-responsibility-teens-88">
      <div className="min-h-[calc(100vh-200px)] flex flex-col justify-center text-center text-white space-y-6 md:space-y-8 max-w-4xl mx-auto px-4 py-4">
        ...
        {showResult && (
          <div className="bg-white/10 backdrop-blur-md p-6 md:p-8 rounded-xl md:rounded-2xl border border-white/20 text-center">
            ...
            <h2 className="text-2xl font-bold text-white mb-6">Global Values Complete!</h2>
            
            <div className="bg-gradient-to-r from-green-500/20 to-emerald-500/20 rounded-xl p-4 border border-green-400/30 mb-6">
              <p className="text-green-300 font-bold">
                🎉 Excellent! You've completed your global values journal!
              </p>
              <p className="text-green-300 mt-2">
                Recording your thoughts on global values helps develop your world citizenship!
              </p>
            </div>
