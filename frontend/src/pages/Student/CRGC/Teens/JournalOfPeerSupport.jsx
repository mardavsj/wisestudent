...
const JournalOfPeerSupport = () => {
  ...
  const gameId = "civic-responsibility-teens-37";
  ...
  const stages = [
    {
      question: 'Write: "I helped a bullied friend by ___"',
      minLength: 10,
    },
    {
      question: 'Write: "A time I stood up to a bully was ___"',
      minLength: 10,
    },
    {
      question: 'Write: "I created a more inclusive environment by ___"',
      minLength: 10,
    },
    {
      question: 'Write: "I learned about being a better friend through ___"',
      minLength: 10,
    },
    {
      question: 'Write: "One way I can prevent bullying in the future is ___"',
      minLength: 10,
    },
  ];
  ...
  useEffect(() => {
    if (showResult) {
      console.log(`🎮 Journal of Peer Support game completed! Score: ${finalScore}/${stages.length}, gameId: ${gameId}`);
    }
  ...
  return (
    <GameShell
      ...
      subtitle={!showResult ? `Question ${currentStage + 1} of ${stages.length}: Reflect on Peer Support!` : "Journal Complete!"}
      ...
      nextGamePathProp="/student/civic-responsibility/teens/simulation-teen-bully-scene"
      nextGameIdProp="civic-responsibility-teens-38">
      <div className="min-h-[calc(100vh-200px)] flex flex-col justify-center text-center text-white space-y-6 md:space-y-8 max-w-4xl mx-auto px-4 py-4">
        ...
        {showResult && (
          <div className="bg-white/10 backdrop-blur-md p-6 md:p-8 rounded-xl md:rounded-2xl border border-white/20 text-center">
            ...
            <h2 className="text-2xl font-bold text-white mb-6">Peer Support Complete!</h2>
            
            <div className="bg-gradient-to-r from-green-500/20 to-emerald-500/20 rounded-xl p-4 border border-green-400/30 mb-6">
              <p className="text-green-300 font-bold">
                🎉 Excellent! You've completed your peer support journal!
              </p>
              <p className="text-green-300 mt-2">
                Recording your supportive actions helps develop your leadership skills!
              </p>
            </div>
