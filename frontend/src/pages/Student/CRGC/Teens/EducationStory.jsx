...
const EducationStory = () => {
  ...
  const questions = [
    {
      ...
      options: [
        ...
        {
          id: "c",
          text: "Tell her to study something easier",
          emoji: "📝",
          isCorrect: false
        }
      ]
    },
    {
      ...
      options: [
        ...
        {
          id: "c",
          text: "Ignore her academic performance",
          emoji: "😴",
          isCorrect: false
        }
      ]
    },
    {
      ...
      options: [
        ...
        {
          id: "c",
          text: "It depends on the school's budget",
          emoji: "💰",
          isCorrect: false
        }
      ]
    ...
    },
    {
      ...
      options: [
        ...
        {
          id: "c",
          text: "Only if boys have lower grades",
          emoji: "📉",
          isCorrect: false
        }
      ]
  ...
  return (
    <GameShell
      ...
      totalXp={totalXp}
      nextGamePathProp="/student/civic-responsibility/teens/quiz-on-teen-rights"
      nextGameIdProp="civic-responsibility-teens-22">
          ...
          <div className="bg-white/10 backdrop-blur-md rounded-xl md:rounded-2xl p-6 md:p-8 border border-white/20 text-center flex-1 flex flex-col justify-center">
            {finalScore >= 3 ? (
              <div>
                ...
                <h3 className="text-xl md:text-2xl font-bold text-white mb-4">Educational Equality Champion!</h3>
                <p className="text-white/90 text-base md:text-lg mb-4">
                  You got {finalScore} out of {questions.length} questions correct!
                  You understand the importance of equal educational opportunities for all!
                </p>
                <div className="bg-gradient-to-r from-yellow-500 to-orange-500 text-white py-2 md:py-3 px-4 md:px-6 rounded-full inline-flex items-center gap-2 mb-4 text-sm md:text-base">
                  <span>+{coins} Coins</span>
                </div>
                <p className="text-white/80 text-sm md:text-base">
                  Great job! You know that everyone deserves equal access to education regardless of gender!
                </p>
              </div>
            ) : (
              <div>
                ...
                <p className="text-white/90 text-base md:text-lg mb-4">
                  You got {finalScore} out of {questions.length} questions correct.
                  Remember, equal educational opportunities help everyone reach their potential!
                </p>
                <button
                ...
                <p className="text-white/80 text-xs md:text-sm">
                  Try to choose the option that shows how to promote equal educational opportunities.
                </p>
              </div>
            )}
          </div>
