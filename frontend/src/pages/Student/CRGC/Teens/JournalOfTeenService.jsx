...
const JournalOfTeenService = () => {
  ...
  const gameId = "civic-responsibility-teens-57";
  ...
  const stages = [
    {
      question: 'Write: "One volunteer activity I want to try is ___"',
      minLength: 10,
    },
    {
      question: 'Write: "A community issue I care about is ___"',
      minLength: 10,
    },
    {
      question: 'Write: "A skill I could use to help others is ___"',
      minLength: 10,
    },
    {
      question: 'Write: "One way I can volunteer with my friends is ___"',
      minLength: 10,
    },
    {
      question: 'Write: "The most rewarding part of volunteering might be ___"',
      minLength: 10,
    },
  ];
  ...
  useEffect(() => {
    if (showResult) {
      console.log(`🎮 Journal of Teen Service game completed! Score: ${finalScore}/${stages.length}, gameId: ${gameId}`);
    }
  ...
  return (
    <GameShell
      ...
      subtitle={!showResult ? `Question ${currentStage + 1} of ${stages.length}: Reflect on Service!` : "Journal Complete!"}
      ...
      nextGamePathProp="/student/civic-responsibility/teens/simulation-clean-up-drive"
      nextGameIdProp="civic-responsibility-teens-58">
      <div className="min-h-[calc(100vh-200px)] flex flex-col justify-center text-center text-white space-y-6 md:space-y-8 max-w-4xl mx-auto px-4 py-4">
        ...
        {showResult && (
          <div className="bg-white/10 backdrop-blur-md p-6 md:p-8 rounded-xl md:rounded-2xl border border-white/20 text-center">
            ...
            <h2 className="text-2xl font-bold text-white mb-6">Service Complete!</h2>
            
            <div className="bg-gradient-to-r from-green-500/20 to-emerald-500/20 rounded-xl p-4 border border-green-400/30 mb-6">
              <p className="text-green-300 font-bold">
                🎉 Excellent! You've completed your service journal!
              </p>
              <p className="text-green-300 mt-2">
                Recording your service ideas helps develop your community engagement!
              </p>
            </div>
