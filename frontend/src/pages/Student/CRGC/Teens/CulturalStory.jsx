...
const CulturalStory = () => {
  ...
  const questions = [
    ...
    },
    {
      ...
      options: [
        ...
        {
          id: "c",
          text: "Attend but complain about the food",
          emoji: "🤢",
          isCorrect: false
        }
      ]
    },
    {
      ...
      options: [
        ...
        {
          id: "c",
          text: "Finish their sentences for them",
          emoji: "🤐",
          isCorrect: false
        }
      ]
    },
    {
      ...
      options: [
        ...
        {
          id: "c",
          text: "Make faces at the unfamiliar dishes",
          emoji: "🤢",
          isCorrect: false
        }
      ]
  ...
  return (
    <GameShell
      ...
      totalXp={totalXp}
      nextGamePathProp="/student/civic-responsibility/teens/quiz-on-inclusion"
      nextGameIdProp="civic-responsibility-teens-12">
            ...
            {finalScore >= 3 ? (
              <div>
                ...
                <p className="text-white/90 text-base md:text-lg mb-4">
                  ...
                  You understand how to respect and appreciate different cultures!
                </p>
                <div className="bg-gradient-to-r from-yellow-500 to-orange-500 text-white py-2 md:py-3 px-4 md:px-6 rounded-full inline-flex items-center gap-2 mb-4 text-sm md:text-base">
                  <span>+{coins} Coins</span>
                </div>
                <p className="text-white/80 text-sm md:text-base">
                  Great job! You know how to embrace cultural diversity with respect and openness!
                </p>
              </div>
            ) : (
              <div>
                ...
                <p className="text-white/90 text-base md:text-lg mb-4">
                  You got {finalScore} out of {questions.length} questions correct.
                  Remember, respecting different cultures helps build a more inclusive world!
                </p>
                <button
                ...
                <p className="text-white/80 text-xs md:text-sm">
                  Try to choose the option that shows how to respect and appreciate different cultures.
                </p>
              </div>
            )}
          </div>
