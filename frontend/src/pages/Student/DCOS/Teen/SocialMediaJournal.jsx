...
const SocialMediaJournal = () => {
  ...
  const stages = [
    {
      question: 'Write: "What information about me is okay to share online?"',
      minLength: 10,
    },
    {
      question: 'Write: "What personal details should I never share?"',
      minLength: 10,
    },
    {
      question: 'Write: "How can I protect my privacy on social media?"',
      minLength: 10,
    },
    {
      question: 'Write: "What should I do if someone asks for my personal information?"',
      minLength: 10,
    },
    {
      question: 'Write: "Why is it important to think before sharing online?"',
      minLength: 10,
    },
  ];
  ...
  return (
    <GameShell
      ...
      subtitle={!showResult ? `Question ${currentStage + 1} of ${stages.length}: Reflect on your privacy!` : "Journal Complete!"}
