...
const ProductivityPuzzle = () => {
  ...
  useEffect(() => {
    if (showResult) {
      console.log(`🎮 Productivity Puzzle game completed! Score: ${finalScore}/${leftItems.length}, gameId: ${gameId}, nextGamePath: ${nextGamePath}, nextGameId: ${nextGameId}`);
  ...
  return (
    <GameShell
      ...
      score={coins}
      subtitle={showResult ? "Game Complete!" : "Match activities to their productivity level"}
            ...
            {finalScore >= 3 ? (
              <div>
                ...
                <p className="text-white/90 text-lg mb-4">
                  You correctly matched {finalScore} out of {leftItems.length} activities!
                  You understand productive vs wasteful screen time!
                </p>
                <div className="bg-gradient-to-r from-yellow-500 to-orange-500 text-white py-3 px-6 rounded-full inline-flex items-center gap-2 mb-4">
                  <span>+{coins} Coins</span>
                </div>
                <p className="text-white/80">
                  Study apps, online courses, and educational videos are productive. Endless scrolling and mindless gaming are wasteful. Use your screen time wisely!
                </p>
              </div>
            ) : (
              <div>
                ...
                <p className="text-white/90 text-lg mb-4">
                  You matched {finalScore} out of {leftItems.length} activities correctly.
                  Remember, study apps and educational content are productive, while endless scrolling is wasteful!
                </p>
                <button
                ...
                <p className="text-white/80 text-sm">
                  Try to match each activity with its appropriate productivity level.
                </p>
              </div>
            )}
          </div>
