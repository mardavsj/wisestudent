...
const EmpathyJournal = () => {
  ...
  const stages = [
    {
      question: 'Write: "How would I feel if I was trolled online?"',
      minLength: 10,
    },
    {
      question: 'Write: "What emotions would I experience if someone cyberbullied me?"',
      minLength: 10,
    },
    {
      question: 'Write: "How would online harassment affect my self-esteem?"',
      minLength: 10,
    },
    {
      question: 'Write: "What would it feel like to be excluded from online groups?"',
      minLength: 10,
    },
    {
      question: 'Write: "How can I show empathy to victims of cyberbullying?"',
      minLength: 10,
    },
  ];
  ...
  return (
    <GameShell
      ...
      subtitle={!showResult ? `Question ${currentStage + 1} of ${stages.length}: Reflect on empathy!` : "Journal Complete!"}
