...
const TruthJournal2 = () => {
  ...
  const stages = [
    {
      question: 'Write: "One fake news I spotted recently was ___."',
      minLength: 10,
    },
    {
      question: 'Write: "How did I identify it as fake?"',
      minLength: 10,
    },
    {
      question: 'Write: "What sources did I check to verify?"',
      minLength: 10,
    },
    {
      question: 'Write: "What did I do when I found it was fake?"',
      minLength: 10,
    },
    {
      question: 'Write: "How can I help others spot fake news?"',
      minLength: 10,
    },
  ];
  ...
  return (
    <GameShell
      title="Truth Journal"
      subtitle={!showResult ? `Question ${currentStage + 1} of ${stages.length}: Reflect on truth!` : "Journal Complete!"}
