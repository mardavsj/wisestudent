...
const FraudJournal = () => {
  ...
  const stages = [
    {
      question: 'Write: "A scam I saw online was ___."',
      minLength: 10,
    },
    {
      question: 'Write: "How did I identify it as a scam?"',
      minLength: 10,
    },
    {
      question: 'Write: "What red flags did I notice?"',
      minLength: 10,
    },
    {
      question: 'Write: "What did I do to protect myself?"',
      minLength: 10,
    },
    {
      question: 'Write: "How can I help others avoid scams?"',
      minLength: 10,
    },
  ];
  ...
  return (
    <GameShell
      title="Fraud Journal"
      subtitle={!showResult ? `Question ${currentStage + 1} of ${stages.length}: Reflect on fraud awareness!` : "Journal Complete!"}
