...
const ReflexRecruiter = () => {
  ...
  const gameData = getGameDataById("dcos-teen-69");
  const gameId = gameData?.id || "dcos-teen-69";
  
  // Ensure gameId is always set correctly
  if (!gameData || !gameData.id) {
    console.warn("Game data not found for ReflexRecruiter, using fallback ID");
  }
  ...
  return (
    <GameShell
      ...
      subtitle={gameState === "playing" ? `Round ${currentRound}/${TOTAL_ROUNDS}: Test your recruiter mindset reflexes!` : "Test your recruiter mindset reflexes!"}
        ...
        {gameState === "ready" && (
          <div className="bg-white/10 backdrop-blur-md rounded-2xl p-8 border border-white/20 text-center">
            ...
            <p className="text-white/90 text-lg mb-6">
              Answer questions about recruiter mindset!<br />
