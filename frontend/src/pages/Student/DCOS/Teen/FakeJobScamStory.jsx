...
const FakeJobScamStory = () => {
  const navigate = useNavigate();
  const location = useLocation();
  
  // Get game data from game category folder (source of truth)
  const gameId = "dcos-teen-37";
  ...
  const questions = [
    ...
    {
      id: 2,
      text: "A message offers 'Easy money - just pay ₹3000 to start.' What's your response?",
      options: [
        { 
          id: "pay-start", 
  ...
  const handleNext = () => {
    navigate("/student/dcos/teen/fact-check-badge");
  };
            ...
            {finalScore >= 3 ? (
              <div>
                ...
                <p className="text-white/90 text-lg mb-4">
                  ...
                  You understand how to spot job scams!
                </p>
                <div className="bg-gradient-to-r from-yellow-500 to-orange-500 text-white py-3 px-6 rounded-full inline-flex items-center gap-2 mb-4">
                  <span>+{coins} Coins</span>
                </div>
                <p className="text-white/80">
                  Remember: Real jobs pay you, not the other way around. Never pay for a job!
                </p>
              </div>
            ) : (
              <div>
                ...
                <p className="text-white/90 text-lg mb-4">
                  You got {finalScore} out of {questions.length} questions correct.
                  Remember, legitimate jobs never ask you to pay money!
                </p>
                <button
                ...
                <p className="text-white/80 text-sm">
                  Try to choose the option that recognizes job scams and avoids paying money.
                </p>
              </div>
            )}
          </div>
