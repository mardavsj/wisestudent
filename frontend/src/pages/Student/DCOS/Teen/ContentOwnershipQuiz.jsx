...
const ContentOwnershipQuiz = () => {
  ...
  const gameData = getGameDataById("dcos-teen-59");
  const gameId = gameData?.id || "dcos-teen-59";
  
  // Ensure gameId is always set correctly
  if (!gameData || !gameData.id) {
    console.warn("Game data not found for ContentOwnershipQuiz, using fallback ID");
  }
