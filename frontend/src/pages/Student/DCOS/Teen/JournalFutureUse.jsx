...
const JournalFutureUse = () => {
  const location = useLocation();
  
  // Get game data from game category folder (source of truth)
  const gameId = "dcos-teen-96";
  ...
  const stages = [
    {
      question: 'Write: "One way I will use tech in my career is ___."',
      minLength: 10,
    },
    {
      question: 'Write: "What tech skills do I want to develop?"',
      minLength: 10,
    },
    {
      question: 'Write: "How can technology help me achieve my goals?"',
      minLength: 10,
    },
    {
      question: 'Write: "What role will technology play in my future?"',
      minLength: 10,
    },
    {
      question: 'Write: "How will I use tech responsibly in my career?"',
      minLength: 10,
    },
  ];
  ...
  return (
    <GameShell
      ...
      subtitle={!showResult ? `Question ${currentStage + 1} of ${stages.length}: Reflect on your future!` : "Journal Complete!"}
