            ...
            {finalScore >= 3 ? (
              <div>
                ...
                <p className="text-white/90 text-lg mb-4">
                  ...
                  You understand how to identify fake job ads!
                </p>
                <div className="bg-gradient-to-r from-yellow-500 to-orange-500 text-white py-3 px-6 rounded-full inline-flex items-center gap-2 mb-4">
                  <span>+{coins} Coins</span>
                </div>
                <p className="text-white/80">
                  Remember: Legitimate job ads never ask you to pay money upfront!
                </p>
              </div>
            ) : (
              <div>
                ...
                <p className="text-white/90 text-lg mb-4">
                  You got {finalScore} out of {questions.length} questions correct.
                  Remember, real jobs don't ask you to pay money!
                </p>
                <button
                ...
                <p className="text-white/80 text-sm">
                  Try to choose the option that recognizes fake job ads and avoids paying money.
                </p>
              </div>
            )}
          </div>
