...
const BalanceJournal = () => {
  const location = useLocation();
  
  // Get game data from game category folder (source of truth)
  const gameId = "dcos-teen-25";
  ...
  const stages = [
    {
      question: 'Write: "How many hours did I spend offline today?"',
      minLength: 10,
    },
    {
      question: 'Write: "What offline activities did I do today?"',
      minLength: 10,
    },
    {
      question: 'Write: "How can I balance screen time better?"',
      minLength: 10,
    },
    {
      question: 'Write: "What activities make me feel good offline?"',
      minLength: 10,
    },
    {
      question: 'Write: "How will I limit my screen time tomorrow?"',
      minLength: 10,
    },
  ];
  ...
  return (
    <GameShell
      ...
      subtitle={!showResult ? `Question ${currentStage + 1} of ${stages.length}: Reflect on your balance!` : "Journal Complete!"}
