...
const JournalOnlineRespect = () => {
  const location = useLocation();
  
  // Get game data from game category folder (source of truth)
  const gameId = "dcos-teen-87";
  ...
  const stages = [
    {
      question: 'Write: "One way I showed respect online this week was ___."',
      minLength: 10,
    },
    {
      question: 'Write: "How do I treat others with kindness online?"',
      minLength: 10,
    },
    {
      question: 'Write: "What does respect mean to me in online spaces?"',
      minLength: 10,
    },
    {
      question: 'Write: "How can I continue to show respect online?"',
      minLength: 10,
    },
    {
      question: 'Write: "Why is showing respect online important?"',
      minLength: 10,
    },
  ];
  ...
  return (
    <GameShell
      ...
      subtitle={!showResult ? `Question ${currentStage + 1} of ${stages.length}: Reflect on respect!` : "Journal Complete!"}
