...
const ReflexFlag1 = () => {
  ...
  const gameData = getGameDataById("dcos-teen-89");
  const gameId = gameData?.id || "dcos-teen-89";
  
  // Ensure gameId is always set correctly
  if (!gameData || !gameData.id) {
    console.warn("Game data not found for ReflexFlag1, using fallback ID");
  }
  ...
  const questions = [
    ...
    {
      id: 2,
      question: "A comment says 'Great work on your project!'. What should you do?",
  ...
  return (
    <GameShell
      title="Reflex Flag"
      subtitle={gameState === "playing" ? `Round ${currentRound}/${TOTAL_ROUNDS}: Test your hate comment flagging reflexes!` : "Test your hate comment flagging reflexes!"}
        ...
        {gameState === "ready" && (
          <div className="bg-white/10 backdrop-blur-md rounded-2xl p-8 border border-white/20 text-center">
            ...
            <p className="text-white/90 text-lg mb-6">
              Answer questions about flagging hate comments!<br />
