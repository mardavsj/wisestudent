...
const SafetyReflex = () => {
  ...
  const gameData = getGameDataById("dcos-teen-8");
  const gameId = gameData?.id || "dcos-teen-8";
  
  // Ensure gameId is always set correctly
  if (!gameData || !gameData.id) {
    console.warn("Game data not found for SafetyReflex, using fallback ID");
  }
  ...
  const questions = [
    {
      id: 1,
      question: "An ad says 'WIN $10,000! Click NOW!'. What should you do?",
    ...
    {
      id: 2,
      question: "A notification says 'Amazon: Your order shipped'. What should you do?",
      correctAnswer: "Check Order",
      options: [
        { text: "Report as Scam", isCorrect: false, emoji: "🚫" },
        { text: "Check Order", isCorrect: true, emoji: "📦" },
        { text: "Delete Immediately", isCorrect: false, emoji: "🗑️" },
        { text: "Forward to Others", isCorrect: false, emoji: "➡️" }
      ]
    },
    {
      id: 3,
      question: "An ad says 'FREE iPhone! Claim yours!'. What should you do?",
      correctAnswer: "Report Scam",
      options: [
    ...
    {
      id: 4,
      question: "A notification says 'Netflix: New episodes available'. What should you do?",
  ...
  return (
    <GameShell
      title="Safety Reflex"
      subtitle={gameState === "playing" ? `Round ${currentRound}/${TOTAL_ROUNDS}: Test your scam ad detection reflexes!` : "Test your scam ad detection reflexes!"}
        ...
        {gameState === "ready" && (
          <div className="bg-white/10 backdrop-blur-md rounded-2xl p-8 border border-white/20 text-center">
            ...
            <p className="text-white/90 text-lg mb-6">
              Answer questions about scam ad detection!<br />
