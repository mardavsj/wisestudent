...
const JournalAiRule = () => {
  ...
  const stages = [
    {
      question: 'Write: "One ethical rule I follow when using AI is ___."',
      minLength: 10,
    },
    {
      question: 'Write: "How do I ensure AI is used responsibly?"',
      minLength: 10,
    },
    {
      question: 'Write: "What should I avoid when using AI?"',
      minLength: 10,
    },
    {
      question: 'Write: "How can I use AI to help others?"',
      minLength: 10,
    },
    {
      question: 'Write: "Why is ethical AI use important to me?"',
      minLength: 10,
    },
  ];
  ...
  return (
    <GameShell
      ...
      subtitle={!showResult ? `Question ${currentStage + 1} of ${stages.length}: Reflect on AI ethics!` : "Journal Complete!"}
