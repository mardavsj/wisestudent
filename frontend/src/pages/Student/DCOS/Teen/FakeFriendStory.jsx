...
const FakeFriendStory = () => {
  ...
  const questions = [
    ...
    {
      id: 2,
      text: 'Someone sends a friend request saying: "We have 5 mutual friends! Let\'s connect!"',
      options: [
        { 
          id: "accept", 
    ...
    {
      id: 3,
      text: 'Someone messages: "Your friend Mike is in trouble! Add me to help him!"',
      options: [
        { 
          id: "help", 
    ...
    {
      id: 5,
      text: 'Someone offers: "I can help you with homework! Just add me as a friend first."',
      options: [
        { 
          id: "add-help", 
            ...
            {finalScore >= 3 ? (
              <div>
                ...
                <p className="text-white/90 text-lg mb-4">
                  ...
                  You understand how to verify online friends!
                </p>
                <div className="bg-gradient-to-r from-yellow-500 to-orange-500 text-white py-3 px-6 rounded-full inline-flex items-center gap-2 mb-4">
                  <span>+{coins} Coins</span>
                </div>
                <p className="text-white/80">
                  Always verify with your friend directly before accepting friend requests from strangers!
                </p>
              </div>
            ) : (
              <div>
                ...
                <p className="text-white/90 text-lg mb-4">
                  You got {finalScore} out of {questions.length} questions correct.
                  Remember, always verify before trusting online strangers!
                </p>
                <button
                ...
                <p className="text-white/80 text-sm">
                  Try to choose the option that verifies identity before trusting strangers.
                </p>
              </div>
            )}
          </div>
