...
const JournalMyIdentity = () => {
  ...
  const stages = [
    {
      question: 'Write: "One way I want others to see me online is ___."',
      minLength: 10,
    },
    {
      question: 'Write: "What values do I want my online identity to reflect?"',
      minLength: 10,
    },
    {
      question: 'Write: "How can I build a positive online presence?"',
      minLength: 10,
    },
    {
      question: 'Write: "What kind of posts help build my positive identity?"',
      minLength: 10,
    },
    {
      question: 'Write: "How do I want to be remembered online?"',
      minLength: 10,
    },
  ];
  ...
  return (
    <GameShell
      ...
      subtitle={!showResult ? `Question ${currentStage + 1} of ${stages.length}: Reflect on your identity!` : "Journal Complete!"}
