...
const AntiBullyReflex = () => {
  ...
  const gameData = getGameDataById("dcos-teen-18");
  const gameId = gameData?.id || "dcos-teen-18";
  
  // Ensure gameId is always set correctly
  if (!gameData || !gameData.id) {
    console.warn("Game data not found for AntiBullyReflex, using fallback ID");
  }
  ...
  const questions = [
    {
      id: 1,
      question: "A message says 'You're so dumb, nobody likes you'. What should you do?",
      correctAnswer: "Stand Up and Report",
      options: [
        { text: "Stand Up and Report", isCorrect: true, emoji: "💪" },
        { text: "Join the Trolling", isCorrect: false, emoji: "😈" },
    ...
    {
      id: 2,
      question: "A message says 'Great job on your presentation!'. What should you do?",
      correctAnswer: "Appreciate Positivity",
      options: [
        { text: "Report as Trolling", isCorrect: false, emoji: "🚫" },
        { text: "Appreciate Positivity", isCorrect: true, emoji: "👏" },
        { text: "Block User", isCorrect: false, emoji: "🚫" },
        { text: "Delete Message", isCorrect: false, emoji: "🗑️" }
      ]
    },
    {
      id: 3,
  ...
  return (
    <GameShell
      ...
      subtitle={gameState === "playing" ? `Round ${currentRound}/${TOTAL_ROUNDS}: Test your anti-bullying reflexes!` : "Test your anti-bullying reflexes!"}
      ...
      score={finalScore}
      gameId={gameId}
      nextGamePathProp="/student/dcos/teens/upstander-simulation"
      nextGameIdProp="dcos-teen-19"
      gameType="dcos"
        ...
        {gameState === "ready" && (
          <div className="bg-white/10 backdrop-blur-md rounded-2xl p-8 border border-white/20 text-center">
            ...
            <p className="text-white/90 text-lg mb-6">
              Answer questions about standing up against trolling!<br />
