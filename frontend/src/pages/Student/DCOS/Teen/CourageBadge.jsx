...
const CourageBadge = () => {
  ...
  const gameData = getGameDataById("dcos-teen-20");
  const gameId = gameData?.id || "dcos-teen-20";
          ...
          <div className="bg-white/10 backdrop-blur-md rounded-2xl p-8 border border-white/20 text-center">
            {score >= 3 ? (
              <div>
                ...
                <h3 className="text-2xl font-bold text-white mb-4">Courage Badge Earned!</h3>
                <p className="text-white/90 text-lg mb-4">
                  You got {score} out of {challenges.length} challenges correct!
                  You're a true Courage Hero!
                </p>
                <div className="bg-gradient-to-r from-yellow-500 to-orange-500 text-white py-3 px-6 rounded-full inline-flex items-center gap-2 mb-4">
                  <span>+{score} Coins</span>
                </div>
                <p className="text-white/80">
                  Lesson: Standing up against bullying, discrimination, and hate makes the internet a safer and kinder place!
                </p>
              </div>
            ) : (
              <div>
                ...
                <p className="text-white/90 text-lg mb-4">
                  You got {score} out of {challenges.length} challenges correct.
                  Practice makes perfect with courage!
                </p>
                <button
                ...
                <p className="text-white/80 text-sm">
                  Tip: Block and report bullying, refuse to join trolling groups, stop gossip chains, defend others, and be an upstander!
                </p>
              </div>
            )}
          </div>
