...
const ClassroomStory3 = () => {
  ...
  const questions = [
    {
      id: 1,
      text: "You're in class taking a test. You notice an AI app on your tablet that can give answers instantly. The teacher isn't watching. What should you do?",
      options: [
        { 
          id: "a", 
          text: "Use AI App", 
    ...
    {
      id: 2,
      text: "Your teacher assigns an essay. You find an AI tool that can write it for you. What's the best action?",
      options: [
        { 
          id: "a", 
    ...
    {
      id: 4,
      text: "AI gives you an answer that looks wrong, but it sounds confident. What should you do?",
      options: [
        { 
          id: "a", 
          text: "Fact-Check", 
