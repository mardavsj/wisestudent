...
const PlaygroundBystander = () => {
  ...
  const gameData = getGameDataById("dcos-kids-15");
  const gameId = gameData?.id || "dcos-kids-15";
  
  // Ensure gameId is always set correctly
  if (!gameData || !gameData.id) {
    console.warn("Game data not found for PlaygroundBystander, using fallback ID");
  }
