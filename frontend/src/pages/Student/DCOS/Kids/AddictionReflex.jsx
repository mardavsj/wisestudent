...
const AddictionReflex = () => {
  ...
  const questions = [
    ...
    {
      id: 3,
      question: "Your friend calls you outside to play football! What should you do?",
      correctAnswer: "Go play with friend",
      options: [
        { text: "Go play with friend", isCorrect: true, emoji: "⚽" },
        { text: "Stay on device", isCorrect: false, emoji: "📱" },
        { text: "Tell them later", isCorrect: false, emoji: "⏰" },
  ...
  return (
    <GameShell
      ...
      subtitle={gameState === "playing" ? `Round ${currentRound}/${TOTAL_ROUNDS}: Test your screen addiction reflexes!` : "Test your screen addiction reflexes!"}
        ...
        {gameState === "ready" && (
          <div className="bg-white/10 backdrop-blur-md rounded-2xl p-8 border border-white/20 text-center">
            ...
            <p className="text-white/90 text-lg mb-6">
              Answer questions about screen addiction!<br />
