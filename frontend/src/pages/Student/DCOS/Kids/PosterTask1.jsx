...
const PosterTask1 = () => {
  ...
  const gameData = getGameDataById("dcos-kids-67");
  const gameId = gameData?.id || "dcos-kids-67";
  
  // Ensure gameId is always set correctly
  if (!gameData || !gameData.id) {
    console.warn("Game data not found for PosterTask1, using fallback ID");
  }
  ...
  const stages = [
    ...
    {
      question: 'Which poster would best show "Ask Before You Share"?',
      choices: [
        { text: "Poster showing asking permission before sharing photos 📸", correct: true },
