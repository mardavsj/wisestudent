...
const JournalOfPosts = () => {
  ...
  const gameData = getGameDataById("dcos-kids-68");
  const gameId = gameData?.id || "dcos-kids-68";
  
  // Ensure gameId is always set correctly
  if (!gameData || !gameData.id) {
    console.warn("Game data not found for JournalOfPosts, using fallback ID");
  }
  ...
  const stages = [
    { 
      id: 1, 
      prompt: "Write: \"One good thing I can share online is my art ___.\"", 
      minLength: 10,
      guidance: "Think about creative work like drawings, stories, or projects you're proud of."
    },
    { 
      id: 2, 
      prompt: "Describe: \"One good thing I can share online is kindness ___.\"", 
      minLength: 10,
      guidance: "Consider positive messages, encouragement, or acts of kindness you want to spread."
    },
    { 
      id: 3, 
      prompt: "Write about: \"One good thing I can share online is helpful advice ___.\"", 
      minLength: 10,
      guidance: "Reflect on useful tips, knowledge, or guidance that could help others."
    },
    { 
      id: 4, 
      prompt: "Describe: \"One good thing I can share online is my learning journey ___.\"", 
      minLength: 10,
      guidance: "Think about sharing what you're learning, your progress, or educational content."
    },
    { 
      id: 5, 
      prompt: "Write: \"One good thing I can share online is positive news ___.\"", 
      minLength: 10,
      guidance: "Consider uplifting stories, achievements, or positive events worth sharing."
    }
  ];
