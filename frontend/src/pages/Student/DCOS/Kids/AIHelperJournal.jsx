...
const AIHelperJournal = () => {
  ...
  const gameData = getGameDataById("dcos-kids-78");
  const gameId = gameData?.id || "dcos-kids-78";
  
  // Ensure gameId is always set correctly
  if (!gameData || !gameData.id) {
    console.warn("Game data not found for AIHelperJournal, using fallback ID");
  }
  ...
  const stages = [
    { 
      ...
      minLength: 10,
      guidance: "Think about how AI helps you understand your schoolwork better."
    },
    { 
      id: 2, 
      prompt: "One safe way I use AI is when I ask it to help me learn something new.", 
      minLength: 10,
      guidance: "Consider how AI can be a learning tool for exploring new topics."
    },
    { 
      id: 3, 
      prompt: "One safe way I use AI is when I use it to check my grammar or spelling.", 
      minLength: 10,
      guidance: "Think about using AI to improve your writing skills."
    },
    { 
      id: 4, 
      prompt: "One safe way I use AI is when I use it to create art or stories responsibly.", 
      minLength: 10,
      guidance: "Consider how AI can help you be creative while being responsible."
    },
    { 
      id: 5, 
      prompt: "One safe way I use AI is when I ask it to give me study tips.", 
      minLength: 10,
      guidance: "Think about how AI can help you study more effectively."
    }
  ];
