...
const JournalOfSmartUse = () => {
  ...
  const gameData = getGameDataById("dcos-kids-98");
  const gameId = gameData?.id || "dcos-kids-98";
  ...
  const stages = [
    { 
      id: 1, 
      prompt: "Write: \"Today I used tech to learn about ___.\"", 
      minLength: 10,
      guidance: "Think about educational apps, videos, or websites that helped you learn something new."
    },
    { 
      id: 2, 
      prompt: "Describe: \"I discovered something new online about ___.\"", 
      minLength: 10,
      guidance: "Consider interesting facts, skills, or knowledge you gained from the internet."
    },
    { 
      id: 3, 
      prompt: "Write about: \"I watched an educational video about ___.\"", 
      minLength: 10,
      guidance: "Reflect on videos that taught you something useful or interesting."
    },
    { 
      id: 4, 
      prompt: "Describe: \"I used a learning app or website to study ___.\"", 
      minLength: 10,
      guidance: "Think about apps or websites that helped you practice or learn new skills."
    },
    { 
      id: 5, 
      prompt: "Write: \"Technology helped me understand ___ better today.\"", 
      minLength: 10,
      guidance: "Consider how technology made a concept or topic clearer for you."
    }
  ];
  ...
  return (
    <GameShell
      ...
      totalXp={totalXp}
      nextGamePathProp="/student/dcos/kids/reflex-reading"
      nextGameIdProp="dcos-kids-99"
