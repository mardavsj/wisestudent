...
const StrangerChatStory = () => {
  ...
  const questions = [
    {
      id: 1,
      text: "A stranger online says: 'Hi! What is your name?' What should you do?",
      options: [
        { 
          id: "a", 
          text: "Don't Reply", 
    ...
    {
      id: 2,
      text: "A stranger asks: 'Where do you go to school?' What's the safe choice?",
      options: [
        { 
          id: "a", 
    ...
    {
      id: 3,
      text: "A stranger says: 'Can I have your phone number?' What should you do?",
      options: [
        { 
          id: "a", 
    ...
    {
      id: 4,
      text: "A stranger says: 'I have candy! Want to meet in person?' What's the right response?",
      options: [
        { 
          id: "a", 
          text: "Agree to Meet", 
    ...
    {
      id: 5,
      text: "A stranger asks: 'Send me a photo of yourself!' What should you do?",
      options: [
        { 
          id: "a", 
