...
const JournalOfTruth1 = () => {
  ...
  const gameData = getGameDataById("dcos-kids-38");
  const gameId = gameData?.id || "dcos-kids-38";
  
  // Ensure gameId is always set correctly
  if (!gameData || !gameData.id) {
    console.warn("Game data not found for JournalOfTruth1, using fallback ID");
  }
  ...
  const stages = [
    { 
      id: 1, 
      prompt: "Write: \"Today I fact-checked a fun story about ___.\"", 
      minLength: 10,
      guidance: "Think about stories or claims you verified by checking reliable sources or asking trusted adults."
    },
    { 
      id: 2, 
      prompt: "Describe: \"I checked if a picture I saw online was real or fake ___.\"", 
      minLength: 10,
      guidance: "Consider how you looked for clues like strange details, reverse image search, or asking for help."
    },
    { 
      id: 3, 
      prompt: "Write about: \"I asked a grown-up to confirm if ___.\"", 
      minLength: 10,
      guidance: "Reflect on times when you checked with parents, teachers, or trusted adults about information online."
    },
    { 
      id: 4, 
      prompt: "Describe: \"I looked up the truth about ___.\"", 
      minLength: 10,
      guidance: "Think about using reliable websites, encyclopedias, or educational resources to verify information."
    },
    { 
      id: 5, 
      prompt: "Write: \"I learned that not everything on the internet about ___ is true!\"", 
      minLength: 10,
      guidance: "Consider how you discovered that some online information can be misleading, fake, or exaggerated."
    }
  ];
