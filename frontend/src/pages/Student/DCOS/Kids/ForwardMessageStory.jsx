...
const ForwardMessageStory = () => {
  ...
  const questions = [
    {
      id: 1,
      text: "Your friend forwards a message that says, 'Magic medicine cures all diseases instantly!' What should you do?",
      options: [
        { 
          id: "a", 
    ...
    {
      id: 2,
      text: "A message says 'Click this link to get free smartphones!' and your classmates are sharing it. What should you do?",
      options: [
        { 
          id: "a", 
          text: "Click the Link", 
    ...
    {
      id: 3,
      text: "You get a forward: 'Don't go outside tonight, a new virus spreads in air!' What should you do?",
      options: [
        { 
          id: "a", 
