...
const EmojiReflex = () => {
  ...
  return (
    <GameShell
      title="Emoji Reflex"
      subtitle={gameState === "playing" ? `Round ${currentRound}/${TOTAL_ROUNDS}: Test your emoji knowledge reflexes!` : "Test your emoji knowledge reflexes!"}
      ...
      score={finalScore}
      gameId={gameId}
      nextGamePathProp="/student/dcos/kids/truth-badge"
      nextGameIdProp="dcos-kids-40"
      gameType="dcos"
        ...
        {gameState === "ready" && (
          <div className="bg-white/10 backdrop-blur-md rounded-2xl p-8 border border-white/20 text-center">
            ...
            <p className="text-white/90 text-lg mb-6">
              Answer questions about emoji meanings!<br />
