...
const CheatingStory = () => {
  ...
  const questions = [
    {
      id: 1,
      text: "Your friend is cheating during a test and asks you to join. What should you do?",
      options: [
        { 
          id: "join", 
    ...
    {
      id: 2,
      text: "You find a wallet with money at school. What's the right thing to do?",
      options: [
        { 
          id: "tell", 
    ...
    {
      id: 4,
      text: "Someone sends you a rumor about a classmate. What should you do?",
      options: [
        { 
          id: "delete", 
