            ...
            {score >= 3 ? (
              <div>
                ...
                <p className="text-white/80">
                  Peace means staying calm, helping others, and solving problems with kindness!
                </p>
              </div>
            ) : (
              <div>
                ...
                <p className="text-white/90 text-lg mb-4">
                  You got {score} out of {questions.length} questions correct.
                  Remember, peace means staying calm and helping others!
                </p>
                <button
                ...
                <p className="text-white/80 text-sm">
                  Try to choose the option that shows calmness, kindness, and helping others.
                </p>
              </div>
            )}
          </div>
