...
const JournalOfPeace = () => {
  ...
  const stages = [
    {
      question: 'Write: "One time I forgave someone was ___."',
      minLength: 10,
    },
    {
      question: 'Write: "Peace means ___ to me."',
      minLength: 10,
    },
    {
      question: 'Write: "A time I chose kindness instead of anger was ___."',
      minLength: 10,
    },
    {
      question: 'Write: "I feel peaceful when ___."',
      minLength: 10,
    },
    {
      question: 'Write: "Forgiving others helps because ___."',
      minLength: 10,
    },
  ];
  ...
  return (
    <GameShell
      ...
      subtitle={!showResult ? `Question ${currentStage + 1} of ${stages.length}: Reflect on forgiveness and calm!` : "Journal Complete!"}
