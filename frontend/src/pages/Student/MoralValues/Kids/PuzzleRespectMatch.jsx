...
const PuzzleRespectMatch = () => {
  ...
  const correctMatches = [
    ...
    { leftId: 3, rightId: 5 }, // Help → Care
    { leftId: 4, rightId: 4 }, // Ignore → Lonely
    { leftId: 5, rightId: 3 }  // Tell Truth → Trust
  ];
            ...
            {finalScore >= 3 ? (
              <div>
                ...
                <p className="text-white/90 text-lg mb-4">
                  ...
                  You understand how respect works!
                </p>
                <div className="bg-gradient-to-r from-yellow-500 to-orange-500 text-white py-3 px-6 rounded-full inline-flex items-center gap-2 mb-4">
                  <span>+{coins} Coins</span>
                </div>
                <p className="text-white/80">
                  Listening shows respect, while mocking hurts. Always choose kindness!
                </p>
              </div>
            ) : (
              <div>
                ...
                <p className="text-white/90 text-lg mb-4">
                  ...
                  Remember: Respectful actions bring positive outcomes!
                </p>
                <button
