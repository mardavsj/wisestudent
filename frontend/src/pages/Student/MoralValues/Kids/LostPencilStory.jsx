...
const LostPencilStory = () => {
  ...
  const questions = [
    {
      id: 1,
      text: "You find a nice pencil on the ground. What should you do?",
      options: [
        { 
          id: "keep", 
    ...
    {
      id: 2,
      text: "Your friend asks you for the answers to homework. What should you do?",
      options: [
        { 
          id: "share", 
    ...
    {
      id: 3,
      text: "Someone forgot their lunch box at school. What will you do?",
      options: [
        { 
          id: "tell", 
    ...
    {
      id: 4,
      text: "Everyone wants to play first on the swing. What should you do?",
      options: [
        { 
          id: "wait", 
    ...
    {
      id: 5,
      text: "You see trash on the classroom floor. What do you do?",
      options: [
        { 
          id: "ignore", 
