...
const PuzzlePeaceMatch = () => {
  ...
  const correctMatches = [
    { leftId: 1, rightId: 3 }, // Smile → Friendship
    { leftId: 2, rightId: 1 }, // Angry Face → Fight
    { leftId: 3, rightId: 4 }, // Help Others → Peace
    { leftId: 4, rightId: 5 }, // Shout → Noise
    { leftId: 5, rightId: 2 }  // Share Toys → Happiness
  ];
            ...
            {finalScore >= 3 ? (
              <div>
                ...
                <p className="text-white/90 text-lg mb-4">
                  ...
                  You understand peace!
                </p>
                <div className="bg-gradient-to-r from-yellow-500 to-orange-500 text-white py-3 px-6 rounded-full inline-flex items-center gap-2 mb-4">
                  <span>+{coins} Coins</span>
                </div>
                <p className="text-white/80">
                  Smiles and helping bring peace and friendship, while anger causes fights!
                </p>
              </div>
            ) : (
              <div>
                ...
                <p className="text-white/90 text-lg mb-4">
                  ...
                  Remember: Peaceful actions bring harmony!
                </p>
                <button
