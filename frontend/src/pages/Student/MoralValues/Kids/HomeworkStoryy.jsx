...
const HomeworkStoryy = () => {
  ...
  const questions = [
    ...
    {
      id: 2,
      text: "Your friend invites you to play outside but you have a homework due tomorrow. What do you do?",
      options: [
        { 
          id: "complete", 
    ...
    {
      id: 3,
      text: "You feel tired after school. Do you rest and delay homework or complete it now?",
      options: [
        { 
          id: "now", 
