...
const SchoolCleanUpStory = () => {
  ...
  const questions = [
    ...
    {
      id: 3,
      text: "Plants need water. Do you water them?",
      options: [
        { 
          id: "yes", 
          text: "Yes, carefully", 
  ...
  return (
    <GameShell
      ...
      gameId={gameId}
      nextGamePathProp="/student/moral-values/kids/poster-helping-hands"
      nextGameIdProp="moral-kids-76"
      gameType="moral"
