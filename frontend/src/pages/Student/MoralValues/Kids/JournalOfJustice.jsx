...
const JournalOfJustice = () => {
  ...
  const stages = [
    {
      question: 'Write: "One fair thing I did this week was ___."',
      minLength: 10,
    },
    {
      question: 'Write: "I helped someone equally by ___."',
      minLength: 10,
    },
    {
      question: 'Write: "I shared something without favoritism: ___."',
      minLength: 10,
    },
    {
      question: 'Write: "I treated everyone kindly by ___."',
      minLength: 10,
    },
    {
      question: 'Write: "I stood up for fairness when ___."',
      minLength: 10,
    },
  ];
  ...
  return (
    <GameShell
      ...
      subtitle={!showResult ? `Question ${currentStage + 1} of ${stages.length}: Reflect on fairness!` : "Journal Complete!"}
