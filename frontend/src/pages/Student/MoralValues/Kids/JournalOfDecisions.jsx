...
const JournalOfDecisions = () => {
  ...
  const stages = [
    {
      question: 'Write: "One right choice I made recently was ___."',
      minLength: 10,
    },
    {
      question: 'Write: "A time I helped someone the right way was ___."',
      minLength: 10,
    },
    {
      question: 'Write: "A decision I made that made me proud was ___."',
      minLength: 10,
    },
    {
      question: 'Write: "One choice where I did the right thing even when it was hard: ___."',
      minLength: 10,
    },
    {
      question: 'Write: "A time I chose honesty over convenience: ___."',
      minLength: 10,
    },
  ];
  ...
  return (
    <GameShell
      ...
      subtitle={!showResult ? `Question ${currentStage + 1} of ${stages.length}: Reflect on your right choices!` : "Journal Complete!"}
