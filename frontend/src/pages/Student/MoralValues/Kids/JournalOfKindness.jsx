...
const JournalOfKindness = () => {
  ...
  const stages = [
    {
      question: 'Write: "Today I was kind to ___ by ___."',
      minLength: 10,
    },
    {
      question: 'Write: "I made someone smile by ___."',
      minLength: 10,
    },
    {
      question: 'Write: "I helped ___ by ___."',
      minLength: 10,
    },
    {
      question: 'Write: "I shared something with ___."',
      minLength: 10,
    },
    {
      question: 'Write: "I said something nice to ___."',
      minLength: 10,
    },
  ];
  ...
  return (
    <GameShell
      ...
      score={finalScore}
      gameId={gameId}
      nextGamePathProp="/student/moral-values/kids/lost-ball-story"
      nextGameIdProp="moral-kids-28"
      gameType="moral"
      maxScore={5}
