...
const PuzzleDuties = () => {
  ...
  const correctMatches = [
    { leftId: 1, rightId: 3 }, // Homework → Student
    { leftId: 2, rightId: 1 }, // Cleaning Room → Self
    { leftId: 3, rightId: 4 }, // Feeding Dog → Owner
    { leftId: 4, rightId: 5 }, // Watering Plants → Gardener
    { leftId: 5, rightId: 2 }  // Helping Grandpa → Family
  ];
        ...
        {!showResult ? (
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            <div className="bg-white/10 backdrop-blur-md rounded-2xl p-6 border border-white/20">
              <h3 className="text-xl font-bold text-white mb-4 text-center">Duties</h3>
            ...
            <div className="bg-white/10 backdrop-blur-md rounded-2xl p-6 border border-white/20">
              <h3 className="text-xl font-bold text-white mb-4 text-center">Persons</h3>
              <div className="space-y-4">
                {rightItems.map(item => {
            ...
            {finalScore >= 3 ? (
              <div>
                ...
                <p className="text-white/90 text-lg mb-4">
                  You correctly matched {finalScore} out of {leftItems.length} duties!
                ...
                <p className="text-white/80">
                  Everyone has duties: students do homework, owners care for pets, and families help each other!
                </p>
              </div>
            ) : (
              <div>
                ...
                <p className="text-white/90 text-lg mb-4">
                  You matched {finalScore} out of {leftItems.length} duties correctly.
                  Remember: Each duty belongs to the right person!
                </p>
                <button
                ...
                <p className="text-white/80 text-sm">
                  Try to match each duty with its responsible person.
                </p>
              </div>
            )}
          </div>
