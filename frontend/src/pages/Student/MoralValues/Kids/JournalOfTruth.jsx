...
const JournalOfTruth = () => {
  ...
  const stages = [
    {
      question: 'Write: "One time I told the truth was ___."',
      minLength: 10,
    },
    {
      question: 'Write: "I felt proud when I was honest because ___."',
      minLength: 10,
    },
    {
      question: 'Write: "Telling the truth helps others by ___."',
      minLength: 10,
    },
    {
      question: 'Write: "A time I could have lied but didn\'t was ___."',
      minLength: 10,
    },
    {
      question: 'Write: "I think honesty is important because ___."',
      minLength: 10,
    },
  ];
  ...
  return (
    <GameShell
      ...
      subtitle={!showResult ? `Question ${currentStage + 1} of ${stages.length}: Reflect on honesty!` : "Journal Complete!"}
      ...
      score={finalScore}
      gameId={gameId}
      nextGamePathProp="/student/moral-values/kids/candy-shop-story"
      nextGameIdProp="moral-kids-8"
      gameType="moral"
      maxScore={5}
