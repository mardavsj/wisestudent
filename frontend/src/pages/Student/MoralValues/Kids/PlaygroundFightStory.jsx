...
const PlaygroundFightStory = () => {
  ...
  const questions = [
    ...
    {
      id: 3,
      text: "A new student is sitting alone at lunch. What will you do?",
      options: [
        { 
          id: "invite", 
  ...
  return (
    <GameShell
      ...
      gameId={gameId}
      nextGamePathProp="/student/moral-values/kids/quiz-peace"
      nextGameIdProp="moral-kids-82"
      gameType="moral"
