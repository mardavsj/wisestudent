...
const JournalDiscipline = () => {
  ...
  const stages = [
    {
      question: 'Write: "One self-discipline habit I\'m proud of is ___."',
      minLength: 10,
    },
    {
      question: 'Write: "A routine I stick to every day that builds my discipline is ___."',
      minLength: 10,
    },
    {
      question: 'Write: "One challenge I overcame through discipline was ___."',
      minLength: 10,
    },
    {
      question: 'Write: "A time I resisted temptation and stayed focused on my goal was when ___."',
      minLength: 10,
    },
    {
      question: 'Write: "One area I want to improve my self-discipline in is ___."',
      minLength: 10,
    },
  ];
  ...
  return (
    <GameShell
      ...
      subtitle={!showResult ? `Question ${currentStage + 1} of ${stages.length}: Reflect on self-discipline!` : "Journal Complete!"}
