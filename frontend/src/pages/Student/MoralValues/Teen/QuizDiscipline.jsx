...
const QuizDiscipline = () => {
  ...
  const gameData = getGameDataById("moral-teen-32");
  const gameId = gameData?.id || "moral-teen-32";
  
  // Ensure gameId is always set correctly
  if (!gameData || !gameData.id) {
    console.warn("Game data not found for QuizDiscipline, using fallback ID");
  }
