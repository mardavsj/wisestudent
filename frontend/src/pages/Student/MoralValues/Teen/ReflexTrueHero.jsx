...
const ReflexTrueHero = () => {
  ...
  return (
    <GameShell
      ...
      subtitle={gameState === "playing" ? `Round ${currentRound}/${TOTAL_ROUNDS}: Speak truth or hide wrong?` : "Speak truth or hide wrong?"}
      ...
      score={finalScore}
      gameId={gameId}
      nextGamePathProp="/student/moral-values/teen/badge-ethical-hero"
      nextGameIdProp="moral-teen-100"
      gameType="moral"
        ...
        {gameState === "ready" && (
          <div className="bg-white/10 backdrop-blur-md rounded-2xl p-8 border border-white/20 text-center">
            ...
            <p className="text-white/90 text-lg mb-6">
              Tap "Speak Truth" for honest actions, "Hide Wrong" for dishonest ones!<br />
