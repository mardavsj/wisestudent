...
const IntegrityJournal = () => {
  ...
  const stages = [
    {
      question: 'Write: "One time I told a hard truth was ___."',
      minLength: 10,
    },
    {
      question: 'Write: "A moment I admitted a mistake and took responsibility was ___."',
      minLength: 10,
    },
    {
      question: 'Write: "I stood up for honesty, even when others didn\'t, when ___."',
      minLength: 10,
    },
    {
      question: 'Write: "I could have cheated or lied but chose not to when ___."',
      minLength: 10,
    },
    {
      question: 'Write: "Being truthful made me feel respected or trusted when ___."',
      minLength: 10,
    },
  ];
  ...
  return (
    <GameShell
      ...
      subtitle={!showResult ? `Question ${currentStage + 1} of ${stages.length}: Reflect on honest choices!` : "Journal Complete!"}
