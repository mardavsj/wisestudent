...
const RespectJournal = () => {
  ...
  const stages = [
    {
      question: 'Write: "This week I showed respect by ___."',
      minLength: 10,
    },
    {
      question: 'Write: "A time I listened to someone even when I disagreed was when ___."',
      minLength: 10,
    },
    {
      question: 'Write: "One way I show respect at school is ___."',
      minLength: 10,
    },
    {
      question: 'Write: "I can show respect to my parents or elders by ___."',
      minLength: 10,
    },
    {
      question: 'Write: "When someone disrespected me, I responded respectfully by ___."',
      minLength: 10,
    },
  ];
  ...
  return (
    <GameShell
      ...
      subtitle={!showResult ? `Question ${currentStage + 1} of ${stages.length}: Reflect on respectful actions!` : "Journal Complete!"}
