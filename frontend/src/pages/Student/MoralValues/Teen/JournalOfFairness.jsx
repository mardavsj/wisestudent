...
const JournalOfFairness = () => {
  ...
  const stages = [
    {
      question: 'Write: "One injustice I noticed and wanted to fix was when ___."',
      minLength: 10,
    },
    {
      question: 'Write: "I saw someone treated unfairly. I responded by ___."',
      minLength: 10,
    },
    {
      question: 'Write: "A time I shared something equally with others was when ___."',
      minLength: 10,
    },
    {
      question: 'Write: "I stood up for fairness at school or home when ___."',
      minLength: 10,
    },
    {
      question: 'Write: "Being a fair person means ___ to me, and it\'s important because ___."',
      minLength: 10,
    },
  ];
  ...
  return (
    <GameShell
      ...
      subtitle={!showResult ? `Question ${currentStage + 1} of ${stages.length}: Reflect on justice and equality!` : "Journal Complete!"}
