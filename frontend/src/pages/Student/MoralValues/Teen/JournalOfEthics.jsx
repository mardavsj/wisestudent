...
const JournalOfEthics = () => {
  ...
  const stages = [
    {
      question: 'Write: "One hard but right choice I made was when ___."',
      minLength: 10,
    },
    {
      question: 'Write: "What made this choice difficult for me was ___."',
      minLength: 10,
    },
    {
      question: 'Write: "The value or principle that guided my decision was ___."',
      minLength: 10,
    },
    {
      question: 'Write: "Others reacted to my choice by ___."',
      minLength: 10,
    },
    {
      question: 'Write: "What I learned about ethics from that experience was ___."',
      minLength: 10,
    },
  ];
  ...
  return (
    <GameShell
      ...
      subtitle={!showResult ? `Question ${currentStage + 1} of ${stages.length}: Reflect on right choices!` : "Journal Complete!"}
      ...
      score={finalScore}
      gameId={gameId}
      nextGamePathProp="/student/moral-values/teen/roleplay-ethical-leader"
      nextGameIdProp="moral-teen-98"
      gameType="moral"
      maxScore={5}
