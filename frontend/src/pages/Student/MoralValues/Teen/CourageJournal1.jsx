...
const CourageJournal1 = () => {
  ...
  const stages = [
    {
      question: 'Write: "A time I stood up for someone being treated unfairly was when ___."',
      minLength: 10,
    },
    {
      question: 'Write: "I faced my fears and acted bravely when ___."',
      minLength: 10,
    },
    {
      question: 'Write: "I told the truth even though it was hard when ___."',
      minLength: 10,
    },
    {
      question: 'Write: "I tried something new that scared me at first. It was ___."',
      minLength: 10,
    },
    {
      question: 'Write: "I helped someone even though others didn\'t when ___."',
      minLength: 10,
    },
  ];
  ...
  return (
    <GameShell
      ...
      subtitle={!showResult ? `Question ${currentStage + 1} of ${stages.length}: Reflect on acts of bravery!` : "Journal Complete!"}
