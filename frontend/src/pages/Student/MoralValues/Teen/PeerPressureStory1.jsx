...
const PeerPressureStory1 = () => {
  ...
  const questions = [
    {
      id: 1,
      text: "Your friends say, 'Let's skip homework and play games instead!'",
      options: [
        { 
          id: "refuse", 
    ...
    {
      id: 2,
      text: "Your friends dare you to make fun of a quiet classmate.",
      options: [
        { 
          id: "cool", 
    ...
    {
      id: 3,
      text: "Your friend whispers answers during an exam.",
      options: [
        { 
          id: "copy", 
          text: "Copy quietly", 
    ...
    {
      id: 4,
      text: "Your group suggests sneaking out of school early.",
      options: [
        { 
          id: "say", 
    ...
    {
      id: 5,
      text: "Your friend asks to copy your homework.",
      options: [
        { 
          id: "let", 
          text: "Let them copy", 
            ...
            {finalScore >= 3 ? (
              <div>
                ...
                <p className="text-white/90 text-lg mb-4">
                  ...
                  You're learning to resist peer pressure!
                </p>
              ...
              <div>
                ...
                <p className="text-white/90 text-lg mb-4">
                  You got {finalScore} out of {questions.length} questions correct.
                  Remember, resisting peer pressure shows real strength!
                </p>
                <button
