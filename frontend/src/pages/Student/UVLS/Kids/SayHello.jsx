...
const SayHello = () => {
  ...
  const questions = [
    {
      id: 1,
      text: "You meet a new friend. What do you say?",
      options: [
        { 
          id: "a", 
          ...
          <div className="bg-white/10 backdrop-blur-md rounded-2xl p-8 border border-white/20 text-center">
            {score >= 3 ? (
              <div>
                ...
                <h3 className="text-2xl font-bold text-white mb-4">Greeting Pro!</h3>
                <p className="text-white/90 text-lg mb-4">
                  You got {score} out of {questions.length} correct!
                  You know how to greet people politely!
                </p>
                <div className="bg-gradient-to-r from-yellow-500 to-orange-500 text-white py-3 px-6 rounded-full inline-flex items-center gap-2 mb-4">
                  <span>+{score} Coins</span>
                </div>
                <p className="text-white/80">
                  Lesson: Greeting people politely with "Hello", "Hi", or "Good morning" shows respect and makes others feel welcome. Always greet teachers, family, friends, and new people with a friendly and polite greeting!
                </p>
              </div>
            ) : (
              <div>
                ...
                <p className="text-white/90 text-lg mb-4">
                  You got {score} out of {questions.length} correct.
                  Remember: Always greet people politely!
                </p>
                <button
                ...
                <p className="text-white/80 text-sm">
                  Tip: Use polite greetings like "Hello", "Hi", "Good morning", or "Nice to meet you" when you see people. It shows respect and makes others feel good!
                </p>
              </div>
            )}
          </div>
