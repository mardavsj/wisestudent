...
const RoleModelJournal = () => {
  ...
  const gameData = getGameDataById("uvls-kids-27");
  const gameId = gameData?.id || "uvls-kids-27";
  
  // Ensure gameId is always set correctly
  if (!gameData || !gameData.id) {
    console.warn("Game data not found for RoleModelJournal, using fallback ID");
  }
  ...
  const stages = [
    {
      question: 'Write: "A role model I admire is ___ because ___."',
      minLength: 10,
    },
    {
      question: 'Write: "This person shows equality by ___."',
      minLength: 10,
    },
    {
      question: 'Write: "I want to be like them by ___."',
      minLength: 10,
    },
    {
      question: 'Write: "They inspire me to ___."',
      minLength: 10,
    },
    {
      question: 'Write: "I will follow their example by ___."',
      minLength: 10,
    },
  ];
  ...
  return (
    <GameShell
      ...
      subtitle={!showResult ? `Question ${currentStage + 1} of ${stages.length}: Reflect on role models!` : "Journal Complete!"}
