  ...
  const questions = [
    {
      ...
      options: [
        ...
        { text: "Stay in bed", isCorrect: false, emoji: "😴" }
      ]
    },
    {
      id: 2,
      ...
      options: [
        ...
        { text: "Pack bag", isCorrect: true, emoji: "🎒" },
        { text: "Play outside", isCorrect: false, emoji: "⚽" },
        { text: "Forget homework", isCorrect: false, emoji: "🙈" }
      ]
    },
    {
      id: 3,
      ...
      options: [
        ...
        { text: "Only play", isCorrect: false, emoji: "🎮" },
        { text: "Skip chores", isCorrect: false, emoji: "🚫" },
        { text: "Watch all day", isCorrect: false, emoji: "📺" }
      ]
    },
    {
      id: 4,
      ...
      options: [
        ...
        { text: "Only sit", isCorrect: false, emoji: "🪑" },
        { text: "Eat junk food", isCorrect: false, emoji: "🍟" },
        { text: "Skip meals", isCorrect: false, emoji: "🚫" }
      ]
    },
    {
  id: 5,
