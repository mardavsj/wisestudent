...
const CalmReflexx = () => {
  ...
  const gameData = getGameDataById("uvls-kids-73");
  const gameId = gameData?.id || "uvls-kids-73";
  
  // Ensure gameId is always set correctly
  if (!gameData || !gameData.id) {
    console.warn("Game data not found for CalmReflexx, using fallback ID");
  }
  ...
  const questions = [
    {
      ...
      correctAnswer: "Breathe deep",
      options: [
        { text: "Breathe deep", isCorrect: true, emoji: "🫁" },
        { text: "Yell loud", isCorrect: false, emoji: "😠" },
        { text: "Hit something", isCorrect: false, emoji: "👊" },
        { text: "Throw things", isCorrect: false, emoji: "🗑️" }
      ]
    },
    {
      id: 2,
      ...
      options: [
        ...
        { text: "Yell at others", isCorrect: false, emoji: "😠" },
    ...
    },
    {
      ...
      correctAnswer: "Count to 10",
      options: [
        { text: "Count to 10", isCorrect: true, emoji: "🔢" },
        { text: "Throw toys", isCorrect: false, emoji: "🧸" },
  ...
  return (
    <GameShell
      title="Calm Reflex"
      subtitle={gameState === "playing" ? `Round ${currentRound}/${TOTAL_ROUNDS}: Stay calm quickly!` : "Stay calm quickly!"}
