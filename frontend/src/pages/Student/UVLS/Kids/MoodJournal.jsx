...
const MoodJournal = () => {
  ...
  const gameData = getGameDataById("uvls-kids-44");
  const gameId = gameData?.id || "uvls-kids-44";
  
  // Ensure gameId is always set correctly
  if (!gameData || !gameData.id) {
    console.warn("Game data not found for MoodJournal, using fallback ID");
  }
  ...
  const stages = [
    {
      question: 'Write: "How do you feel today? Why?"',
      minLength: 10,
    },
    {
      question: 'Write: "What made you happy or sad?"',
      minLength: 10,
    },
    {
      question: 'Write: "Describe your mood now."',
      minLength: 10,
    },
    {
      question: 'Write: "Something that frustrated you?"',
      minLength: 10,
    },
    {
      question: 'Write: "A calm moment today?"',
      minLength: 10,
    },
  ];
  ...
  return (
    <GameShell
      title="Mood Journal"
      subtitle={!showResult ? `Question ${currentStage + 1} of ${stages.length}: Reflect on your emotions!` : "Journal Complete!"}
