...
const WitnessJournal = () => {
  ...
  const gameData = getGameDataById("uvls-kids-37");
  const gameId = gameData?.id || "uvls-kids-37";
  
  // Ensure gameId is always set correctly
  if (!gameData || !gameData.id) {
    console.warn("Game data not found for WitnessJournal, using fallback ID");
  }
  ...
  const stages = [
    {
      question: 'Write: "I saw teasing. What did I do?"',
      minLength: 10,
    },
    {
      question: 'Write: "I witnessed exclusion. What was my action?"',
      minLength: 10,
    },
    {
      question: 'Write: "I heard name-calling. How did I help?"',
      minLength: 10,
    },
    {
      question: 'Write: "I saw online bullying. What was my response?"',
      minLength: 10,
    },
    {
      question: 'Write: "I saw physical pushing. How did I stand up?"',
      minLength: 10,
    },
  ];
  ...
  return (
    <GameShell
      ...
      subtitle={!showResult ? `Question ${currentStage + 1} of ${stages.length}: Reflect on standing up against bullying!` : "Journal Complete!"}
