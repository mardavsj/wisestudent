...
const DecisionJournal = () => {
  ...
  const gameData = getGameDataById("uvls-kids-57");
  const gameId = gameData?.id || "uvls-kids-57";
  
  // Ensure gameId is always set correctly
  if (!gameData || !gameData.id) {
    console.warn("Game data not found for DecisionJournal, using fallback ID");
  }
  ...
  const stages = [
    {
      question: 'Write: "I chose my snack today because ___."',
      minLength: 10,
    },
    {
      question: 'Write: "My decision on which game to play was based on ___."',
      minLength: 10,
    },
    {
      question: 'Write: "I chose which friend to help because ___."',
      minLength: 10,
    },
    {
      question: 'Write: "I picked a book to read based on ___."',
      minLength: 10,
    },
    {
      question: 'Write: "I chose my after-school activity because ___."',
      minLength: 10,
    },
  ];
  ...
  return (
    <GameShell
      ...
      subtitle={!showResult ? `Question ${currentStage + 1} of ${stages.length}: Reflect on your decisions!` : "Journal Complete!"}
