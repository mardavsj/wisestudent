          ...
          <div className="bg-white/10 backdrop-blur-md rounded-2xl p-8 border border-white/20 text-center">
            {score >= 3 ? (
              <div>
                ...
                <h3 className="text-2xl font-bold text-white mb-4">Active Listening Star!</h3>
                <p className="text-white/90 text-lg mb-4">
                  You got {score} out of {questions.length} correct!
                  You know how to listen actively!
                </p>
                <div className="bg-gradient-to-r from-yellow-500 to-orange-500 text-white py-3 px-6 rounded-full inline-flex items-center gap-2 mb-4">
                  <span>+{score} Coins</span>
                </div>
                <p className="text-white/80">
                  Lesson: Active listening means paying full attention, making eye contact, nodding to show understanding, and not interrupting. Put away distractions like phones when someone is talking!
                </p>
              </div>
            ) : (
              <div>
                ...
                <p className="text-white/90 text-lg mb-4">
                  You got {score} out of {questions.length} correct.
                  Remember: Active listening means paying full attention!
                </p>
                <button
                ...
                <p className="text-white/80 text-sm">
                  Tip: When someone is talking, look at them, nod to show you understand, and don't interrupt. Put away phones and other distractions!
                </p>
              </div>
            )}
          </div>
