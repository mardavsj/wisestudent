...
const DecisionPoster = () => {
  const location = useLocation();
  
  // Get game data from game category folder (source of truth)
  const gameData = getGameDataById("uvls-kids-56");
  const gameId = gameData?.id || "uvls-kids-56";
  
  // Ensure gameId is always set correctly
  if (!gameData || !gameData.id) {
    console.warn("Game data not found for DecisionPoster, using fallback ID");
  }
  ...
  const stages = [
    {
      ...
      choices: [
        ...
        { text: "Never Decide 🚫", correct: false },
      ],
    },
    {
      ...
      choices: [
        ...
        { text: "Decide Randomly 🎲", correct: false },
      ],
    },
    {
      ...
      choices: [
        ...
        { text: "Pick First Thing 🎯", correct: false },
      ],
    },
    {
    ...
    {
      question: 'Why do decision-making posters help kids?',
      choices: [
        { text: "Teach us to make good choices 📚", correct: true },
        { text: "Encourage bad decisions 😠", correct: false },
        { text: "Make us avoid decisions 🙈", correct: false },
      ],
    },
  ];
  ...
  return (
    <GameShell
      ...
      subtitle={!showResult ? `Question ${currentStage + 1} of ${stages.length}: Choose posters that promote good decisions!` : "Game Complete!"}
