...
const InclusionJournal = () => {
  ...
  const gameData = getGameDataById("uvls-kids-17");
  const gameId = gameData?.id || "uvls-kids-17";
  
  // Ensure gameId is always set correctly
  if (!gameData || !gameData.id) {
    console.warn("Game data not found for InclusionJournal, using fallback ID");
  }
  ...
  const stages = [
    {
      question: 'Write: "I included someone when I ___."',
      minLength: 10,
    },
    {
      question: 'Write: "I made someone feel welcome by ___."',
      minLength: 10,
    },
    {
      question: 'Write: "I helped someone feel included when I ___."',
      minLength: 10,
    },
    {
      question: 'Write: "Inclusion makes me feel ___."',
      minLength: 10,
    },
    {
      question: 'Write: "I will include others by ___."',
      minLength: 10,
    },
  ];
  ...
  return (
    <GameShell
      ...
      score={finalScore}
      gameId={gameId}
      nextGamePathProp="/student/uvls/kids/invite-roleplay"
      nextGameIdProp="uvls-kids-18"
      gameType="uvls"
      maxScore={5}
