...
const JournalOfSkills = () => {
  ...
  const stages = [
    {
      question: 'Write: "One skill I want to improve is ___.',
      minLength: 10,
    },
    {
      question: 'Write: "This skill will help me become ___.',
      minLength: 10,
    },
    {
      question: 'Write: "I can practice this skill by ___.',
      minLength: 10,
    },
    {
      question: 'Write: "A role model who has this skill is ___.',
      minLength: 10,
    },
    {
      question: 'Write: "By developing this skill, I will ___.',
      minLength: 10,
    },
  ];
  ...
  useEffect(() => {
    if (showResult) {
      console.log(`🎮 Journal of Skills game completed! Score: ${finalScore}/${stages.length}, gameId: ${gameId}`);
    }
  ...
  return (
    <GameShell
      ...
      subtitle={!showResult ? `Question ${currentStage + 1} of ${stages.length}: Develop your entrepreneurial skills!` : "Journal Complete!"}
      ...
      nextGamePathProp="/student/ehe/kids/risk-story"
      nextGameIdProp="ehe-kids-18">
      <div className="min-h-[calc(100vh-200px)] flex flex-col justify-center text-center text-white space-y-6 md:space-y-8 max-w-4xl mx-auto px-4 py-4">
        ...
        {showResult && (
          <div className="bg-white/10 backdrop-blur-md p-6 md:p-8 rounded-xl md:rounded-2xl border border-white/20 text-center">
            ...
            <h2 className="text-2xl font-bold text-white mb-6">Skill Development Complete!</h2>
            
            <div className="bg-gradient-to-r from-green-500/20 to-emerald-500/20 rounded-xl p-4 border border-green-400/30 mb-6">
              <p className="text-green-300 font-bold">
                🎉 Excellent! You've completed your skills journal entry!
              </p>
              <p className="text-green-300 mt-2">
                Focusing on skill improvement helps you grow as an entrepreneur!
              </p>
            </div>
