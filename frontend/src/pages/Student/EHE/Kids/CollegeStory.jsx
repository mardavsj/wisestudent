...
const CollegeStory = () => {
  ...
  return (
    <GameShell
      ...
      nextGamePathProp="/student/ehe/kids/quiz-on-pathways"
      nextGameIdProp="ehe-kids-52">
            ...
            {finalScore >= 3 ? (
              <div>
                ...
                <p className="text-white/80 text-sm md:text-base">
                  Great job! You know that college provides specialized knowledge, builds professional networks, and requires dedication to succeed!
                </p>
              </div>
            ) : (
              <div>
                ...
                <p className="text-white/80 text-xs md:text-sm">
                  Try to choose the option that shows the best approach to higher education.
                </p>
              </div>
            )}
          </div>
