...
const ReflexInnovation = () => {
  ...
  return (
    <GameShell
      ...
      subtitle={gameState === "playing" ? `Round ${currentRound}/${TOTAL_ROUNDS}: Quick innovation decisions!` : "Quick innovation decisions!"}
      onNext={handleNext}
      ...
      totalXp={totalXp}
      nextGamePathProp="/student/ehe/kids/badge-young-innovator"
      nextGameIdProp="ehe-kids-20">
          ...
          <div className="space-y-8">
            ...
            <div className="bg-white/10 backdrop-blur-md p-8 rounded-2xl border border-white/20 text-center">
              <h3 className="text-2xl md:text-3xl font-bold mb-6 text-white">
                Is "{currentQuestion.action}" good for innovation?
              </h3>
          ...
          <div className="bg-white/10 backdrop-blur-md rounded-2xl p-8 border border-white/20 text-center">
            ...
            <div className="bg-gradient-to-r from-purple-500/20 to-pink-500/20 rounded-xl p-4 border border-white/10">
              ...
              <p className="text-white/80">
                {finalScore >= 4 ? "Excellent! You understand innovation well!" : 
                 finalScore >= 3 ? "Good job! Keep learning about innovation!" : 
