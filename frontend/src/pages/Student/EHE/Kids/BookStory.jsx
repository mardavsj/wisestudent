  ...
  const questions = [
    {
      ...
      options: [
        ...
        {
          id: "c",
          text: "Only re-read the same book",
          emoji: "🔄",
          isCorrect: false
        }
      ]
    },
    {
      ...
      options: [
        ...
        {
          id: "c",
          text: "Stay ignorant about the world",
          emoji: "😵",
          isCorrect: false
        }
      ]
    },
    {
      ...
      options: [
        ...
        {
          id: "c",
          text: "Forget everything about the book",
          emoji: "💭",
          isCorrect: false
        }
      ]
    },
    {
      ...
      options: [
        ...
        {
          id: "c",
          text: "Argue with everyone about your opinions",
          emoji: "🙎‍♂️",
          isCorrect: false
        },
         {
    ...
    },
    {
      ...
      options: [
        ...
        {
          id: "c",
          text: "Read for hours without breaks",
          emoji: "⏰",
          isCorrect: false
        }
      ]
          ...
          <div className="bg-white/10 backdrop-blur-md rounded-xl md:rounded-2xl p-6 md:p-8 border border-white/20 text-center flex-1 flex flex-col justify-center">
            {finalScore >= 3 ? (
              <div>
                ...
                <h3 className="text-xl md:text-2xl font-bold text-white mb-4">Book Lover!</h3>
                <p className="text-white/90 text-base md:text-lg mb-4">
                  You got {finalScore} out of {questions.length} questions correct!
                  You understand the importance of developing good reading habits!
                </p>
                <div className="bg-gradient-to-r from-yellow-500 to-orange-500 text-white py-2 md:py-3 px-4 md:px-6 rounded-full inline-flex items-center gap-2 mb-4 text-sm md:text-base">
                  <span>+{coins} Coins</span>
                </div>
                <p className="text-white/80 text-sm md:text-base">
                  Great job! You know that reading more books helps you learn, finding books by authors you enjoy is a good strategy, reading different types of books broadens your perspective, and reading regularly builds knowledge over time!
                </p>
              </div>
            ) : (
              <div>
                ...
                <p className="text-white/90 text-base md:text-lg mb-4">
                  You got {finalScore} out of {questions.length} questions correct.
                  Remember, reading is a wonderful habit that helps you grow!
                </p>
                <button
                ...
                <p className="text-white/80 text-xs md:text-sm">
                  Try to choose the option that shows the best reading habits.
                </p>
              </div>
            )}
          </div>
