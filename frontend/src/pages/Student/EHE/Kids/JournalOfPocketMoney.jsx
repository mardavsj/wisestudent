...
const JournalOfPocketMoney = () => {
  ...
  const stages = [
    {
      question: 'Write: "I saved ___ from my allowance."',
      minLength: 10,
    },
    {
      question: 'Write: "I spent my money on ___ because ___.',
      minLength: 10,
    },
    {
      question: 'Write: "Next week, I will save ___ for ___.',
      minLength: 10,
    },
    {
      question: 'Write: "A smart way to use money is ___.',
      minLength: 10,
    },
    {
      question: 'Write: "Saving money helps me achieve ___.',
      minLength: 10,
    },
  ];
  ...
  useEffect(() => {
    if (showResult) {
      console.log(`🎮 Journal of Pocket Money game completed! Score: ${finalScore}/${stages.length}, gameId: ${gameId}`);
    }
  ...
  return (
    <GameShell
      ...
      subtitle={!showResult ? `Question ${currentStage + 1} of ${stages.length}: Manage your finances wisely!` : "Journal Complete!"}
      ...
      nextGamePathProp="/student/ehe/kids/shop-story"
      nextGameIdProp="ehe-kids-28">
      <div className="min-h-[calc(100vh-200px)] flex flex-col justify-center text-center text-white space-y-6 md:space-y-8 max-w-4xl mx-auto px-4 py-4">
        ...
        {showResult && (
          <div className="bg-white/10 backdrop-blur-md p-6 md:p-8 rounded-xl md:rounded-2xl border border-white/20 text-center">
            ...
            <h2 className="text-2xl font-bold text-white mb-6">Financial Wisdom Complete!</h2>
            
            <div className="bg-gradient-to-r from-green-500/20 to-emerald-500/20 rounded-xl p-4 border border-green-400/30 mb-6">
              <p className="text-green-300 font-bold">
                🎉 Excellent! You've completed your pocket money journal entry!
              </p>
