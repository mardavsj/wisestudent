...
const IceCreamKidStory = () => {
  ...
  return (
    <GameShell
      ...
      nextGamePathProp="/student/ehe/kids/quiz-on-young-entrepreneurs"
      nextGameIdProp="ehe-kids-42">
            ...
            {finalScore >= 3 ? (
              <div>
                ...
                <p className="text-white/80 text-sm md:text-base">
                  Great job! You know that running a business involves earning money, managing costs, providing good service, and tracking your success!
                </p>
              </div>
            ) : (
              <div>
                ...
                <p className="text-white/90 text-base md:text-lg mb-4">
                  You got {finalScore} out of {questions.length} questions correct.
                  Remember, running a successful business takes practice and learning!
                </p>
                <button
                ...
                <p className="text-white/80 text-xs md:text-sm">
                  Try to choose the option that shows the best business practices.
                </p>
              </div>
            )}
          </div>
