...
const ReflexJobMatch = () => {
  ...
  return (
    <GameShell
      ...
      subtitle={gameState === "playing" ? `Round ${currentRound}/${TOTAL_ROUNDS}: Match jobs to the right places!` : "Match jobs to the right places!"}
      onNext={handleNext}
      ...
      totalXp={totalXp}
      nextGamePathProp="/student/ehe/kids/puzzle-who-does-what"
      nextGameIdProp="ehe-kids-4">
        ...
        {gameState === "ready" && (
          <div className="bg-white/10 backdrop-blur-md rounded-2xl p-8 border border-white/20 text-center">
            ...
            <p className="text-white/90 text-lg mb-6">
              Match jobs to the right places!<br />
          ...
          <div className="space-y-8">
            ...
            <div className="bg-white/10 backdrop-blur-md p-8 rounded-2xl border border-white/20 text-center">
              <h3 className="text-2xl md:text-3xl font-bold mb-6 text-white">
                Where does a {currentQuestion.job} work?
              </h3>
          ...
          <div className="bg-white/10 backdrop-blur-md rounded-2xl p-8 border border-white/20 text-center">
            ...
            <div className="bg-gradient-to-r from-purple-500/20 to-pink-500/20 rounded-xl p-4 border border-white/10">
              ...
              <p className="text-white/80">
                {finalScore >= 4 ? "Excellent job! You're a job matching expert!" : 
