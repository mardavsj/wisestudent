...
const JournalOfDreams = () => {
  const navigate = useNavigate();
  const location = useLocation();
  
  // Get game data from game category folder (source of truth)
  const gameId = "ehe-kids-57";
  ...
  const stages = [
    {
      question: 'Write: "After school, I dream of becoming ___.',
      minLength: 10,
    },
    {
      question: 'Write: "To achieve this dream, I need to ___.',
      minLength: 10,
    },
    {
      question: 'Write: "A role model who achieved a similar dream is ___.',
      minLength: 10,
    },
    {
      question: 'Write: "One step I can take this year toward my dream is ___.',
      minLength: 10,
    },
    {
      question: 'Write: "My dream will help others by ___.',
      minLength: 10,
    },
  ];
  ...
  useEffect(() => {
    if (showResult) {
      console.log(`🎮 Journal of Dreams game completed! Score: ${finalScore}/${stages.length}, gameId: ${gameId}`);
    }
  ...
  return (
    <GameShell
      ...
      subtitle={!showResult ? `Question ${currentStage + 1} of ${stages.length}: Chase your aspirations!` : "Journal Complete!"}
      ...
      nextGamePathProp="/student/ehe/kids/apprenticeship-story"
      nextGameIdProp="ehe-kids-58">
      <div className="min-h-[calc(100vh-200px)] flex flex-col justify-center text-center text-white space-y-6 md:space-y-8 max-w-4xl mx-auto px-4 py-4">
        ...
        {showResult && (
          <div className="bg-white/10 backdrop-blur-md p-6 md:p-8 rounded-xl md:rounded-2xl border border-white/20 text-center">
            ...
            <h2 className="text-2xl font-bold text-white mb-6">Dreams Realization Complete!</h2>
            
            <div className="bg-gradient-to-r from-green-500/20 to-emerald-500/20 rounded-xl p-4 border border-green-400/30 mb-6">
              <p className="text-green-300 font-bold">
                🎉 Excellent! You've completed your dreams journal entry!
              </p>
              <p className="text-green-300 mt-2">
                Reflecting on your dreams helps clarify your goals and aspirations!
              </p>
            </div>
...
export default JournalOfDreams;