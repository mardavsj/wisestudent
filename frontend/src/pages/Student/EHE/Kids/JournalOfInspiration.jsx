...
const JournalOfInspiration = () => {
  ...
  const stages = [
    {
      question: 'Write: "The young entrepreneur I admire is ___.',
      minLength: 10,
    },
    {
      question: 'Write: "They inspire me because ___.',
      minLength: 10,
    },
    {
      question: 'Write: "One quality they have that I want to develop is ___.',
      minLength: 10,
    },
    {
      question: 'Write: "Their biggest achievement is ___.',
      minLength: 10,
    },
    {
      question: 'Write: "I can learn from them by ___.',
      minLength: 10,
    },
  ];
  ...
  useEffect(() => {
    if (showResult) {
      console.log(`🎮 Journal of Inspiration game completed! Score: ${finalScore}/${stages.length}, gameId: ${gameId}`);
    }
  ...
  return (
    <GameShell
      ...
      subtitle={!showResult ? `Question ${currentStage + 1} of ${stages.length}: Find your role models!` : "Journal Complete!"}
      ...
      nextGamePathProp="/student/ehe/kids/toy-repair-story"
      nextGameIdProp="ehe-kids-48">
      <div className="min-h-[calc(100vh-200px)] flex flex-col justify-center text-center text-white space-y-6 md:space-y-8 max-w-4xl mx-auto px-4 py-4">
        ...
        {showResult && (
          <div className="bg-white/10 backdrop-blur-md p-6 md:p-8 rounded-xl md:rounded-2xl border border-white/20 text-center">
            ...
            <h2 className="text-2xl font-bold text-white mb-6">Inspiration Complete!</h2>
