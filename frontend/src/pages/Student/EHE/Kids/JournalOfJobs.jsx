...
const JournalOfJobs = () => {
  ...
  const stages = [
    {
      question: 'Write: "When I grow up, I want to be ___.',
      minLength: 10,
    },
    {
      question: 'Write: "The job I find most interesting is ___.',
      minLength: 10,
    },
    {
      question: 'Write: "This job helps people by ___.',
      minLength: 10,
    },
    {
      question: 'Write: "To prepare for this job, I need to ___.',
      minLength: 10,
    },
    {
      question: 'Write: "My dream workplace would be ___.',
      minLength: 10,
    },
  ];
  ...
  useEffect(() => {
    if (showResult) {
      console.log(`🎮 Journal of Jobs game completed! Score: ${finalScore}/${stages.length}, gameId: ${gameId}`);
    }
  ...
  return (
    <GameShell
      ...
      subtitle={!showResult ? `Question ${currentStage + 1} of ${stages.length}: Explore your career dreams!` : "Journal Complete!"}
      ...
      nextGamePathProp="/student/ehe/kids/school-helper-story"
      nextGameIdProp="ehe-kids-8">
          ...
          <div className="bg-white/10 backdrop-blur-md p-6 md:p-8 rounded-xl md:rounded-2xl border border-white/20 text-center">
            ...
            <div className="bg-gradient-to-r from-green-500/20 to-emerald-500/20 rounded-xl p-4 border border-green-400/30 mb-6">
              <p className="text-green-300 font-bold">
                🎉 Excellent! You've completed your career goals journal entry!
              </p>
              <p className="text-green-300 mt-2">
                Writing about your goals helps you focus on what you want to achieve.
              </p>
            </div>
