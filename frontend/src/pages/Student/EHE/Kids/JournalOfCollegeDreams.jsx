...
const JournalOfCollegeDreams = () => {
  const navigate = useNavigate();
  const location = useLocation();
  
  // Get game data from game category folder (source of truth)
  const gameId = "ehe-kids-67";
  ...
  const stages = [
    {
      question: 'Write: "The college I dream of joining is ___.',
      minLength: 10,
    },
    {
      question: 'Write: "I want to study ___ at this college because ___.',
      minLength: 10,
    },
    {
      question: 'Write: "This college is special to me because ___.',
      minLength: 10,
    },
    {
      question: 'Write: "To get into this college, I need to ___.',
      minLength: 10,
    },
    {
      question: 'Write: "After graduating, I will use my degree to ___.',
      minLength: 10,
    },
  ];
  ...
  useEffect(() => {
    if (showResult) {
      console.log(`🎮 Journal of College Dreams game completed! Score: ${finalScore}/${stages.length}, gameId: ${gameId}`);
    }
  ...
  return (
    <GameShell
      ...
      subtitle={!showResult ? `Question ${currentStage + 1} of ${stages.length}: Plan your educational future!` : "Journal Complete!"}
      ...
      nextGamePathProp="/student/ehe/kids/scholarship-story"
      nextGameIdProp="ehe-kids-68">
      <div className="min-h-[calc(100vh-200px)] flex flex-col justify-center text-center text-white space-y-6 md:space-y-8 max-w-4xl mx-auto px-4 py-4">
        ...
        {showResult && (
          <div className="bg-white/10 backdrop-blur-md p-6 md:p-8 rounded-xl md:rounded-2xl border border-white/20 text-center">
            ...
            <h2 className="text-2xl font-bold text-white mb-6">Educational Goals Complete!</h2>
            
            <div className="bg-gradient-to-r from-green-500/20 to-emerald-500/20 rounded-xl p-4 border border-green-400/30 mb-6">
              <p className="text-green-300 font-bold">
                🎉 Excellent! You've completed your college dreams journal entry!
              </p>
              <p className="text-green-300 mt-2">
                Reflecting on your college dreams helps clarify your educational goals!
              </p>
            </div>
...
export default JournalOfCollegeDreams;