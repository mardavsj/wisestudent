...
const JournalOfDreamFutureJob = () => {
  const navigate = useNavigate();
  const location = useLocation();
  
  // Get game data from game category folder (source of truth)
  const gameId = "ehe-kids-77";
  ...
  const stages = [
    {
      question: 'Write: "One new career I want to explore is ___.',
      minLength: 10,
    },
    {
      question: 'Write: "This career appeals to me because ___.',
      minLength: 10,
    },
    {
      question: 'Write: "To prepare for this career, I need to ___.',
      minLength: 10,
    },
    {
      question: 'Write: "A role model in this field is ___.',
      minLength: 10,
    },
    {
      question: 'Write: "In 10 years, I see myself ___.',
      minLength: 10,
    },
  ];
  ...
  useEffect(() => {
    if (showResult) {
      console.log(`🎮 Journal of Dream Future Job game completed! Score: ${finalScore}/${stages.length}, gameId: ${gameId}`);
    }
  ...
  return (
    <GameShell
      ...
      subtitle={!showResult ? `Question ${currentStage + 1} of ${stages.length}: Explore career possibilities!` : "Journal Complete!"}
      ...
      nextGamePathProp="/student/ehe/kids/online-career-story"
      nextGameIdProp="ehe-kids-78">
      <div className="min-h-[calc(100vh-200px)] flex flex-col justify-center text-center text-white space-y-6 md:space-y-8 max-w-4xl mx-auto px-4 py-4">
        ...
        {showResult && (
          <div className="bg-white/10 backdrop-blur-md p-6 md:p-8 rounded-xl md:rounded-2xl border border-white/20 text-center">
            ...
            <h2 className="text-2xl font-bold text-white mb-6">Career Exploration Complete!</h2>
            
            <div className="bg-gradient-to-r from-green-500/20 to-emerald-500/20 rounded-xl p-4 border border-green-400/30 mb-6">
              <p className="text-green-300 font-bold">
                🎉 Excellent! You've completed your dream future job journal entry!
              </p>
              <p className="text-green-300 mt-2">
                Reflecting on future careers helps you plan for exciting possibilities!
              </p>
            </div>
...
export default JournalOfDreamFutureJob;