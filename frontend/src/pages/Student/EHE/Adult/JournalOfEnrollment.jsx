...
const PROMPTS = [
  "Why is it important to research the final outcomes of a course before committing time and money?",
  "How might a mismatch between your career goals and the course outcomes affect you?",
  "What specific details should you look for when researching advanced course outcomes?",
  "How can you verify if a course aligns with your desired career path?",
  "Write: \"Before I enroll in a new advanced course, I must research the final course outcomes to avoid a mismatch between ___ and ___.\"",
];

const MIN_LEN = 10;

const JournalOfEnrollment = () => {
  ...
  return (
    <GameShell
      ...
      subtitle={
        showResult
          ? "Journal complete! Thorough research ensures your education aligns with your career goals."
          : `Stage ${progressLabel}`
      }
...
export default JournalOfEnrollment;
