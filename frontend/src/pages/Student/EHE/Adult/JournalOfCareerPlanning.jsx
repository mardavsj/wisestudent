...
const PROMPTS = [
  "Scenario: You realize you have never defined a clear career direction. How does lacking a plan make you feel about your daily work?",
  "Because I never defined a career direction, the impact on my progression is ___ instead of clear advancement.",
  "What is one specific long-term career goal you would like to achieve in the next few years?",
  "How would having a defined career plan change the way you approach your current job?",
  "Reflect on why setting intentional career goals is crucial for continuous professional growth.",
];

const MIN_LEN = 10;

const JournalOfCareerPlanning = () => {
  ...
  return (
    <GameShell
      ...
      subtitle={
        showResult
          ? "Journal complete! Intentional planning leads to clear advancement."
          : `Stage ${progressLabel}`
      }
...
export default JournalOfCareerPlanning;
