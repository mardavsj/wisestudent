...
const LEFT_ITEMS = [
  { id: "low-demand-area", text: "Low Demand Area" },
  { id: "demand-analysis", text: "Demand Analysis" },
  { id: "ignoring-competitors", text: "Ignoring Competitors" },
  { id: "understanding-needs", text: "Understanding Customer Needs" },
  { id: "no-testing", text: "Rushing to Market Without Testing" },
];

const RIGHT_ITEMS = [
  { id: "losing-market-share", text: "Losing Market Share" },
  { id: "financial-risk", text: "Financial Risk" },
  { id: "smart-planning", text: "Smart Planning" },
  { id: "wasting-resources", text: "Wasting Resources" },
  { id: "product-market-fit", text: "Product-Market Fit" },
];

const SOLUTIONS = {
  "low-demand-area": "financial-risk",
  "demand-analysis": "smart-planning",
  "ignoring-competitors": "losing-market-share",
  "understanding-needs": "product-market-fit",
  "no-testing": "wasting-resources",
};

const PuzzleMarketResearch = () => {
  ...
  const handleRightSelect = (r) => {
    ...
    if (r.id === correctRight) {
      ...
      setOutcomeText("Mismatch! Think about how this action impacts business outcomes.");
    }
  ...
  return (
    <GameShell
      ...
      subtitle={
        showResult
          ? "Well done! You understand the importance of market research and planning."
...
export default PuzzleMarketResearch;
