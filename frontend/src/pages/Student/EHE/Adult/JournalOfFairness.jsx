...
const PROMPTS = [
  "When evaluating employees for promotion, I will ensure fairness by focusing on ___ rather than personal preference.",
  "Reflect on a time when you witnessed or experienced unfairness in the workplace. How did it affect team morale?",
  "Why is it important to use objective metrics and clear criteria when making performance evaluations?",
  "Describe a step you can take to recognize and overcome your own unconscious biases during decision-making.",
  "How does fostering a culture of fairness and equity contribute to the long-term success of an organization?",
];
...
const JournalOfFairness = () => {
  ...
  return (
    <GameShell
      ...
      subtitle={
        showResult
          ? "Journal complete! Fairness builds trust and drives team success."
          : `Stage ${progressLabel}`
      }
