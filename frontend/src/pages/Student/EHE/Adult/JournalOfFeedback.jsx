...
const PROMPTS = [
  "Scenario: Senior management highlights a weakness in your performance during an appraisal. What is the danger of becoming immediately defensive?",
  "When senior management highlights a weakness in my performance, my improvement plan will be ___.",
  "Identify one specific step you can take today to start addressing a recent piece of constructive criticism.",
  "How will treating critical feedback as a 'development roadmap' rather than a personal attack change your career trajectory?",
  "Reflect on why learning to process and act on harsh feedback is a core requirement for reaching leadership positions.",
];

const MIN_LEN = 10;

const JournalOfFeedback = () => {
  ...
  return (
    <GameShell
      ...
      subtitle={
        showResult
          ? "Journal complete! Acting on feedback drives continuous improvement."
          : `Stage ${progressLabel}`
      }
...
export default JournalOfFeedback;
