...
const LEFT_ITEMS = [
  { id: "brand-name-only", text: "Brand Name Only" },
  { id: "relevance-to-career", text: "Relevance to Career Demand" },
  { id: "collecting-certs", text: "Collecting Random Certificates" },
  { id: "theory-only", text: "Focusing Only on Theory" },
  { id: "practical-application", text: "Practical Application" },
];

const RIGHT_ITEMS = [
  { id: "vanity", text: "Vanity" },
  { id: "real-world-competence", text: "Real-world Competence" },
  { id: "true-value", text: "True Value" },
  { id: "lack-of-focus", text: "Lack of Focus in Career" },
  { id: "inability-to-execute", text: "Inability to Execute Real Work" },
];

const SOLUTIONS = {
  "brand-name-only": "vanity",
  "relevance-to-career": "true-value",
  "collecting-certs": "lack-of-focus",
  "theory-only": "inability-to-execute",
  "practical-application": "real-world-competence",
};

const PuzzleCertificationValue = () => {
  ...
  const handleRightSelect = (r) => {
    ...
    if (r.id === correctRight) {
      ...
      setOutcomeText("Mismatch! Think about the true value and impact of different learning paths.");
    }
  ...
  return (
    <GameShell
      ...
      subtitle={
        showResult
          ? "Well done! You understand the difference between vanity metrics and true value in skill building."
...
export default PuzzleCertificationValue;
