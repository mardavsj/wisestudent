...
const LEFT_ITEMS = [
  { id: "no-new-skills", text: "5 years + no new skills" },
  { id: "continuous-learning", text: "Continuous learning" },
  { id: "relying-on-tenure", text: "Relying only on tenure for promotion" },
  { id: "adapting-tech", text: "Adapting to new industry tools" },
  { id: "same-tasks", text: "Doing the exact same tasks repeatedly" },
];

const RIGHT_ITEMS = [
  { id: "faster-promotion", text: "Faster promotion" },
  { id: "market-alignment", text: "High market relevance" },
  { id: "risk-replacement", text: "Risk of being replaced" },
  { id: "career-stagnation", text: "Career stagnation" },
  { id: "limited-growth", text: "Limited professional growth" },
];

const SOLUTIONS = {
  "no-new-skills": "career-stagnation",
  "continuous-learning": "faster-promotion",
  "relying-on-tenure": "risk-replacement",
  "adapting-tech": "market-alignment",
  "same-tasks": "limited-growth",
};

const PuzzleSkillVsExperience = () => {
  ...
  const handleRightSelect = (r) => {
    ...
    if (r.id === correctRight) {
      ...
      setOutcomeText("Mismatch! Think about how this mindset shapes your career path over time.");
    }
  ...
  return (
    <GameShell
      ...
      subtitle={
        showResult
          ? "Well done! You understand the difference between years of experience and actual skill growth."
          : `Match mindsets to their career outcomes: ${score}/${totalPairs} matched`
      }
...
export default PuzzleSkillVsExperience;
