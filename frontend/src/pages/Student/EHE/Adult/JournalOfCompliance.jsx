...
const PROMPTS = [
  "If I skip basic business registration to save money, the long-term risk for my business will be ___.",
  "Consider a scenario where a business faces a lawsuit without proper legal structures. How does that impact personal assets?",
  "Why is maintaining accurate financial records from day one crucial for the survival of a new business?",
  "Describe one key compliance requirement in your industry and the potential consequences of ignoring it.",
  "How does operating with full legal and financial compliance build trust with customers and investors?",
];

const MIN_LEN = 10;

const JournalOfCompliance = () => {
  ...
  return (
    <GameShell
      ...
      subtitle={
        showResult
          ? "Journal complete! Compliance secures your business future."
          : `Stage ${progressLabel}`
      }
...
export default JournalOfCompliance;
