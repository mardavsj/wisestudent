...
const LEFT_ITEMS = [
  { id: "institution-advertising", text: "Institution Advertising" },
  { id: "faculty-quality", text: "Faculty Quality & Curriculum" },
  { id: "campus-aesthetics", text: "Campus Aesthetics Only" },
  { id: "strong-alumni", text: "Strong Alumni Network" },
  { id: "high-tuition", text: "High Tuition Fees Alone" },
];

const RIGHT_ITEMS = [
    { id: "distraction", text: "Distraction from Academics" },
  { id: "marketing", text: "Marketing" },
  { id: "real-learning", text: "Real Learning Outcomes" },
  { id: "no-guarantee", text: "No Guarantee of Quality" },
  { id: "career-connections", text: "Valuable Career Connections" },
];

const SOLUTIONS = {
  "institution-advertising": "marketing",
  "faculty-quality": "real-learning",
  "campus-aesthetics": "distraction",
  "strong-alumni": "career-connections",
  "high-tuition": "no-guarantee",
};

const PuzzleOfInstitutions = () => {
  ...
  const handleRightSelect = (r) => {
    ...
    if (r.id === correctRight) {
      ...
      setOutcomeText("Mismatch! Think about what truly delivers value in education.");
    }
  ...
  return (
    <GameShell
      ...
      subtitle={
        showResult
          ? "Well done! You correctly matched educational features with their actual value!"
...
export default PuzzleOfInstitutions;
