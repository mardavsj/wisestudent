...
const PROMPTS = [
  "To avoid audit complications and loss of clarity, I will manage my invoices and receipts by ___.",
  "Consider a time when disorganized records caused stress or financial loss. What was the impact?",
  "Why is maintaining a daily or weekly routine for logging expenses vital for business health?",
  "Describe the most effective system or tool you could use to ensure perfect financial tracking.",
  "How does clear and organized record-keeping enhance overall decision-making and business value?",
];
...
const JournalOfRecordKeeping = () => {
  ...
  return (
    <GameShell
      ...
      subtitle={
        showResult
          ? "Journal complete! Good records are the foundation of business stability."
          : `Stage ${progressLabel}`
      }
