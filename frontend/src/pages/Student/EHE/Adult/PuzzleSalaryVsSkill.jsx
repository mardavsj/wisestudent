...
const LEFT_ITEMS = [
  { id: "no-learning", text: "Small salary growth + no learning" },
  { id: "skill-building", text: "Skill-building opportunities" },
  { id: "jumping-jobs", text: "Jumping jobs only for small raises" },
  { id: "mentorship", text: "Prioritizing mentorship & growth" },
  { id: "ignoring-trends", text: "Ignoring industry trends" },
];

const RIGHT_ITEMS = [
  { id: "safer", text: "Safer long-term" },
  { id: "shallow-skills", text: "Fragmented resume, shallow skills" },
  { id: "earning-potential", text: "Higher future earning potential" },
  { id: "risky", text: "Immediate salary focus (Risky)" },
  { id: "obsolete", text: "Skills become obsolete" },
];

const SOLUTIONS = {
  "no-learning": "risky",
  "skill-building": "safer",
  "jumping-jobs": "shallow-skills",
  "mentorship": "earning-potential",
  "ignoring-trends": "obsolete",
};

const PuzzleSalaryVsSkill = () => {
  ...
  return (
    <GameShell
      ...
      subtitle={
        showResult
          ? "Well done! You understand the trade-offs between immediate salary and long-term skills."
...
export default PuzzleSalaryVsSkill;
