...
const PROMPTS = [
  "Scenario: You are considering a 6-month career break. Why is it critical to have a structured plan before handing in your resignation?",
  "Before taking a 6-month career break, my financial and skill plan will include ___.",
  "Identify one specific financial preparation you must secure to sustain yourself without stress during this break.",
  "How will you ensure your professional skills remain sharp and relevant while you are away from the industry?",
  "Reflect on why viewing a career break as a 'strategic pause' requires intentional planning to avoid becoming a career setback.",
];

const MIN_LEN = 10;

const JournalOfCareerBreak = () => {
  ...
  return (
    <GameShell
      ...
      subtitle={
        showResult
          ? "Journal complete! A planned break is a strategic advantage."
          : `Stage ${progressLabel}`
      }
...
export default JournalOfCareerBreak;
