...
const LEFT_ITEMS = [
  { id: "office-gossip", text: "Getting involved in office gossip" },
  { id: "neutrality", text: "Staying neutral and focusing on work" },
  { id: "taking-sides", text: "Taking sides in a leadership dispute" },
  { id: "positive-relations", text: "Building positive relationships with everyone" },
  { id: "public-complaints", text: "Complaining publicly about company policies" },
];

const RIGHT_ITEMS = [
  { id: "strong-network", text: "A strong professional network" },
  { id: "vulnerability", text: "Career vulnerability if your side loses" },
  { id: "negative-influence", text: "Viewed as a negative influence" },
  { id: "safe-strategy", text: "Safe strategy for performance" },
  { id: "distraction-risk", text: "Distraction and risk to reputation" },
];

const SOLUTIONS = {
  "office-gossip": "distraction-risk",
  "neutrality": "safe-strategy",
  "taking-sides": "vulnerability",
  "positive-relations": "strong-network",
  "public-complaints": "negative-influence",
};

const PuzzleOfficePolitics = () => {
  ...
  const handleRightSelect = (r) => {
    ...
    if (r.id === correctRight) {
      ...
      setOutcomeText("Mismatch! Think about how this action impacts your professional standing.");
    }
  ...
  return (
    <GameShell
      ...
      subtitle={
        showResult
          ? "Well done! You understand how to navigate office dynamics professionally."
          : `Match actions to their political outcomes: ${score}/${totalPairs} matched`
      }
...
export default PuzzleOfficePolitics;
