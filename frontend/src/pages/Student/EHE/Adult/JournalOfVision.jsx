...
const PROMPTS = [
  "To avoid directionless expansion, my defined 5-year plan for the business will focus on ___.",
  "Reflect on a time when lacking a clear vision caused confusion or missed opportunities. How did that impact growth?",
  "Why is it essential to align every new project or product with your core business vision?",
  "Describe one key milestone you aim to achieve within the next year to push your long-term plan forward.",
  "How does sharing your strategic vision with your team improve focus, motivation, and overall execution?",
];

const MIN_LEN = 10;

const JournalOfVision = () => {
  ...
  return (
    <GameShell
      ...
      subtitle={
        showResult
          ? "Journal complete! A clear vision drives purposeful growth."
          : `Stage ${progressLabel}`
      }
...
export default JournalOfVision;
