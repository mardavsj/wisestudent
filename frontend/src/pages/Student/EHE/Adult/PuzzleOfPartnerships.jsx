...
const LEFT_ITEMS = [
  { id: "verbal-promises", text: "Verbal Promises Only" },
  { id: "mutual-value", text: "Mutual Value & Legal Clarity" },
  { id: "unequal-effort", text: "Unequal Effort / Contribution" },
  { id: "clear-roles", text: "Defined Roles and Responsibilities" },
  { id: "ignoring-red-flags", text: "Ignoring Early Red Flags" },
];

const RIGHT_ITEMS = [
  { id: "safe-partnership", text: "Safe Partnership" },
  { id: "legal-risk", text: "Legal Risk" },
  { id: "future-disputes", text: "Future Disputes" },
  { id: "smooth-operations", text: "Smooth Operations" },
  { id: "resentment-conflict", text: "Resentment and Conflict" },
];

const SOLUTIONS = {
  "verbal-promises": "legal-risk",
  "mutual-value": "safe-partnership",
  "unequal-effort": "resentment-conflict",
  "clear-roles": "smooth-operations",
  "ignoring-red-flags": "future-disputes",
};

const PuzzleOfPartnerships = () => {
  ...
  const handleRightSelect = (r) => {
    ...
    if (r.id === correctRight) {
      ...
      setOutcomeText("Mismatch! Think about how different approaches impact a partnership's success.");
    }
  ...
  return (
    <GameShell
      ...
      subtitle={
        showResult
          ? "Well done! You understand the foundations of a safe and successful partnership."
          : `Match actions to their partnership outcomes: ${score}/${totalPairs} matched`
      }
...
export default PuzzleOfPartnerships;
