...
const LEFT_ITEMS = [
  { id: "contract-role", text: "Contract Role" },
  { id: "permanent-role", text: "Permanent Role" },
  { id: "freelance", text: "Freelance Consulting" },
  { id: "fixed-term", text: "Fixed-Term Project" },
  { id: "full-time", text: "Full-Time Employment" },
];

const RIGHT_ITEMS = [
  { id: "stability", text: "Stability and long-term benefits" },
  { id: "clear-end", text: "Clear end date with focused scope" },
  { id: "inconsistent", text: "Ultimate flexibility but inconsistent income" },
  { id: "high-risk", text: "Higher pay but high risk" },
  { id: "progression", text: "Predictable career progression" },
];

const SOLUTIONS = {
  "contract-role": "high-risk",
  "permanent-role": "stability",
  "freelance": "inconsistent",
  "fixed-term": "clear-end",
  "full-time": "progression",
};

const PuzzleContractVsPermanent = () => {
  ...
  const handleRightSelect = (r) => {
    ...
    if (r.id === correctRight) {
      ...
      setOutcomeText("Mismatch! Think about the specific trade-offs of this employment type.");
    }
  ...
  return (
    <GameShell
      ...
      subtitle={
        showResult
          ? "Well done! You understand the different employment types."
          : `Match roles to their key characteristics: ${score}/${totalPairs} matched`
      }
...
export default PuzzleContractVsPermanent;
