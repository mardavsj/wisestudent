...
const PROMPTS = [
  "Before investing in an advanced degree, what financial factors should you consider regarding the tuition fee?",
  "How can you evaluate the potential salary increase or career advancement an advanced degree might provide?",
  "What alternative ways could you achieve similar career growth without the high cost of a degree?",
  "Why is it important to calculate the return on investment (ROI) for educational expenses?",
  "Write: \"Before paying a high tuition fee for an advanced degree, I will calculate my expected return on education by looking at ___.\"",
];

const MIN_LEN = 10;

const JournalOfEducationROI = () => {
  ...
  return (
    <GameShell
      ...
      subtitle={
        showResult
          ? "Journal complete! Calculating ROI ensures your education investment makes financial sense."
          : `Stage ${progressLabel}`
      }
...
export default JournalOfEducationROI;
