...
const LEFT_ITEMS = [
  { id: "verbal-deal", text: "Verbal Deal" },
  { id: "written-contract", text: "Written Contract" },
  { id: "vague-terms", text: "Vague Terms and Conditions" },
  { id: "clear-scope", text: "Clear Scope of Work" },
  { id: "handshake-agreement", text: "Handshake Agreement for Payment" },
];

const RIGHT_ITEMS = [
  { id: "clear-expectations", text: "Clear Expectations & Safety" },
  { id: "legal-disputes", text: "Legal Disputes & Misunderstandings" },
  { id: "payment-delays", text: "High Risk of Payment Delays" },
  { id: "smooth-delivery", text: "Smooth Delivery and Payment" },
  { id: "scope-creep", text: "Scope Creep and Extra Unpaid Work" },
];

const SOLUTIONS = {
  "verbal-deal": "legal-disputes",
  "written-contract": "clear-expectations",
  "vague-terms": "scope-creep",
  "clear-scope": "smooth-delivery",
  "handshake-agreement": "payment-delays",
};

const PuzzleOfAgreements = () => {
  ...
  const handleRightSelect = (r) => {
    ...
    if (r.id === correctRight) {
      ...
      setOutcomeText("Mismatch! Think about how different types of agreements protect you.");
    }
  ...
  return (
    <GameShell
      ...
      subtitle={
        showResult
          ? "Well done! You understand the importance of clear, written contracts."
          : `Match agreement actions to their outcomes: ${score}/${totalPairs} matched`
      }
...
export default PuzzleOfAgreements;
