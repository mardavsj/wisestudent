...
const LEFT_ITEMS = [
  { id: "founder-approves", text: "Founder Approves Everything" },
  { id: "leadership-delegation", text: "Leadership Delegation" },
  { id: "micromanagement", text: "Constant Micromanagement" },
  { id: "building-systems", text: "Building Automated Systems" },
  { id: "hiring-experts", text: "Hiring Independent Experts" },
];

const RIGHT_ITEMS = [
  { id: "scalable-business", text: "Scalable Business" },
  { id: "team-burnout", text: "Team Burnout & Turnover" },
  { id: "efficient-operations", text: "Efficient Operations" },
  { id: "specialized-quality", text: "High Specialized Quality" },
  { id: "limits-growth", text: "Limits Business Growth" },
];

const SOLUTIONS = {
  "founder-approves": "limits-growth",
  "leadership-delegation": "scalable-business",
  "micromanagement": "team-burnout",
  "building-systems": "efficient-operations",
  "hiring-experts": "specialized-quality",
};

const PuzzleOfDelegation = () => {
  ...
  const handleRightSelect = (r) => {
    ...
    if (r.id === correctRight) {
      ...
      setOutcomeText("Mismatch! Think about how different leadership styles impact scalability and team well-being.");
    }
  ...
  return (
    <GameShell
      ...
      subtitle={
        showResult
          ? "Well done! You understand the foundational required for business scaling and delegation."
          : `Match actions to their scaling outcomes: ${score}/${totalPairs} matched`
      }
...
export default PuzzleOfDelegation;
