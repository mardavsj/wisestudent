...
const ReflexTeenCareer2 = () => {
  ...
  const handleNext = () => {
    navigate("/student/ehe/teens/puzzle-pathway-match");
  };
  ...
  return (
    <GameShell
      ...
      totalXp={totalXp}
      nextGamePathProp="/student/ehe/teens/puzzle-pathway-match"
      nextGameIdProp="ehe-teen-54">
          ...
          <div className="bg-white/10 backdrop-blur-md rounded-2xl p-8 border border-white/20 text-center">
            ...
            <div className="bg-gradient-to-r from-purple-500/20 to-pink-500/20 rounded-xl p-4 border border-white/10">
              ...
              <p className="text-white/80">
                {finalScore >= 4 ? "Excellent job! You have great career planning skills!" : 
                 finalScore >= 3 ? "Good work! Keep developing your career decision-making!" : 
                 "Keep learning about career planning to improve!"}
              </p>
            </div>
          </div>
        )}
...
export default ReflexTeenCareer2;