...
const JournalOfImpact = () => {
  ...
  const stages = [
    {
      question: 'Write: "The social problem I care most about is ___.',
      minLength: 10,
    },
    {
    ...
    {
      question: 'Write: "A solution to this problem would ___.',
      minLength: 10,
    },
    {
    ...
    {
      question: 'Write: "This solution could change lives by ___.',
      minLength: 10,
    },
  ];
  ...
  useEffect(() => {
    if (showResult) {
      console.log(`🎮 Journal of Impact game completed! Score: ${finalScore}/${stages.length}, gameId: ${gameId}`);
    }
  ...
  return (
    <GameShell
      ...
      subtitle={!showResult ? `Question ${currentStage + 1} of ${stages.length}: Create positive social change!` : "Journal Complete!"}
      ...
      nextGamePathProp="/student/ehe/teens/simulation-teen-startup"
      nextGameIdProp="ehe-teen-88">
      <div className="min-h-[calc(100vh-200px)] flex flex-col justify-center text-center text-white space-y-6 md:space-y-8 max-w-4xl mx-auto px-4 py-4">
        ...
        {showResult && (
          <div className="bg-white/10 backdrop-blur-md p-6 md:p-8 rounded-xl md:rounded-2xl border border-white/20 text-center">
            ...
            <h2 className="text-2xl font-bold text-white mb-6">Social Change Initiative Complete!</h2>
