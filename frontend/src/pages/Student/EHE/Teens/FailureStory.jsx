...
const FailureStory = () => {
  ...
  return (
    <GameShell
      ...
      nextGamePathProp="/student/ehe/teens/debate-born-or-made"
      nextGameIdProp="ehe-teen-16">
          ...
          <div className="bg-white/10 backdrop-blur-md rounded-xl md:rounded-2xl p-6 md:p-8 border border-white/20 text-center flex-1 flex flex-col justify-center">
            {finalScore >= 3 ? (
              <div>
                ...
                <h3 className="text-xl md:text-2xl font-bold text-white mb-4">Resilience Builder!</h3>
                <p className="text-white/90 text-base md:text-lg mb-4">
                  You got {finalScore} out of {questions.length} questions correct!
                  You understand how to turn failures into opportunities for growth!
                </p>
                <div className="bg-gradient-to-r from-yellow-500 to-orange-500 text-white py-2 md:py-3 px-4 md:px-6 rounded-full inline-flex items-center gap-2 mb-4 text-sm md:text-base">
                  <span>+{coins} Coins</span>
                </div>
                <p className="text-white/80 text-sm md:text-base">
                  Great job! You know that resilient entrepreneurs try again with lessons learned, analyzing failures helps identify improvements, failure builds problem-solving skills, creating improved plans increases success chances, and successful entrepreneurs view failure as part of the learning process!
                </p>
              </div>
            ) : (
              <div>
                ...
                <p className="text-white/90 text-base md:text-lg mb-4">
                  You got {finalScore} out of {questions.length} questions correct.
                  Remember, how you respond to failure determines your future success!
                </p>
                <button
                ...
                <p className="text-white/80 text-xs md:text-sm">
                  Try to choose the option that shows the best understanding of entrepreneurial resilience.
                </p>
              </div>
            )}
          </div>
