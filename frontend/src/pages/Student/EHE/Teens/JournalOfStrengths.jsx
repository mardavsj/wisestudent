...
const JournalOfStrengths = () => {
  ...
  const stages = [
    {
      question: 'Write: "One strength I have as a future entrepreneur is ___.',
      minLength: 10,
    },
    {
      question: 'Write: "This strength will help me by ___.',
      minLength: 10,
    },
    {
      question: 'Write: "I can improve this strength by ___.',
      minLength: 10,
    },
    {
      question: 'Write: "A role model who has this strength is ___.',
      minLength: 10,
    },
    {
      question: 'Write: "With this strength, I will ___.',
      minLength: 10,
    },
  ];
  ...
  useEffect(() => {
    if (showResult) {
      console.log(`🎮 Journal of Strengths game completed! Score: ${finalScore}/${stages.length}, gameId: ${gameId}`);
    }
  }, [showResult, finalScore, gameId, stages.length]);

  const handleNext = () => {
    navigate("/student/ehe/teens/simulation-team-project");
  };

  return (
    <GameShell
      title="Journal of Strengths"
      subtitle={!showResult ? `Question ${currentStage + 1} of ${stages.length}: Discover your entrepreneurial strengths!` : "Journal Complete!"}
      ...
      nextGamePathProp="/student/ehe/teens/simulation-team-project"
      nextGameIdProp="ehe-teen-18">
      <div className="min-h-[calc(100vh-200px)] flex flex-col justify-center text-center text-white space-y-6 md:space-y-8 max-w-4xl mx-auto px-4 py-4">
        ...
        {showResult && (
          <div className="bg-white/10 backdrop-blur-md p-6 md:p-8 rounded-xl md:rounded-2xl border border-white/20 text-center">
            ...
            <h2 className="text-2xl font-bold text-white mb-6">Strengths Discovery Complete!</h2>
            
            <div className="bg-gradient-to-r from-green-500/20 to-emerald-500/20 rounded-xl p-4 border border-green-400/30 mb-6">
              <p className="text-green-300 font-bold">
                🎉 Excellent! You've completed your entrepreneurial strengths journal entry!
              </p>
              <p className="text-green-300 mt-2">
                Recognizing your strengths helps you leverage them for future success!
              </p>
            </div>
