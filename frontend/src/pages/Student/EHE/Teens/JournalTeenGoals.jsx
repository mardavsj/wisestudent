...
const JournalTeenGoals = () => {
  ...
  const stages = [
    {
      question: 'Write: "One higher education goal I have is ___.',
      minLength: 10,
    },
    {
    ...
    {
      question: 'Write: "To achieve this goal, I need to ___.',
      minLength: 10,
    },
    {
      question: 'Write: "Challenges I might face include ___.',
      minLength: 10,
    },
    {
      question: 'Write: "I will overcome these challenges by ___.',
      minLength: 10,
    },
  ];
  ...
  useEffect(() => {
    if (showResult) {
      console.log(`🎮 Journal of Teen Goals game completed! Score: ${finalScore}/${stages.length}, gameId: ${gameId}`);
    }
  ...
  return (
    <GameShell
      ...
      subtitle={!showResult ? `Question ${currentStage + 1} of ${stages.length}: Define your educational aspirations!` : "Journal Complete!"}
      ...
      nextGamePathProp="/student/ehe/teens/simulation-entrance-prep"
      nextGameIdProp="ehe-teen-68">
      <div className="min-h-[calc(100vh-200px)] flex flex-col justify-center text-center text-white space-y-6 md:space-y-8 max-w-4xl mx-auto px-4 py-4">
        ...
        {showResult && (
          <div className="bg-white/10 backdrop-blur-md p-6 md:p-8 rounded-xl md:rounded-2xl border border-white/20 text-center">
            ...
            <h2 className="text-2xl font-bold text-white mb-6">Educational Aspirations Defined!</h2>
