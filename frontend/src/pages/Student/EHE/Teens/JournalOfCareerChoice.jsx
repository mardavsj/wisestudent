...
const JournalOfCareerChoice = () => {
  ...
  const stages = [
    {
      question: 'Write: "A career I want to explore is ___.',
      minLength: 10,
    },
    {
      question: 'Write: "This career interests me because ___.',
      minLength: 10,
    },
    {
      question: 'Write: "To learn more about this career, I could ___.',
      minLength: 10,
    },
    {
      question: 'Write: "Someone successful in this field is ___.',
      minLength: 10,
    },
    {
      question: 'Write: "In 5 years, I see myself ___.',
      minLength: 10,
    },
  ];
  ...
  useEffect(() => {
    if (showResult) {
      console.log(`🎮 Journal of Career Choice game completed! Score: ${finalScore}/${stages.length}, gameId: ${gameId}`);
    }
  ...
  return (
    <GameShell
      ...
      nextGamePathProp="/student/ehe/teens/simulation-career-fair"
      nextGameIdProp="ehe-teen-8">
          ...
          <div className="bg-white/10 backdrop-blur-md p-6 md:p-8 rounded-xl md:rounded-2xl border border-white/20 text-center">
            ...
            <div className="bg-gradient-to-r from-green-500/20 to-emerald-500/20 rounded-xl p-4 border border-green-400/30 mb-6">
              <p className="text-green-300 font-bold">
                🎉 Excellent! You've completed your career exploration journal entry!
              </p>
