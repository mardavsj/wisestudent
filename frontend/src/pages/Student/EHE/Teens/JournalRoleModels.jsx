...
const JournalRoleModels = () => {
  ...
  const stages = [
    {
      question: 'Write: "The teen entrepreneur who inspires me is ___.',
      minLength: 10,
    },
    {
      question: 'Write: "I admire this person because ___.',
      minLength: 10,
    },
    {
      question: 'Write: "A quality they have that I want to develop is ___.',
      minLength: 10,
    },
    {
      question: 'Write: "They overcame challenges by ___.',
      minLength: 10,
    },
    {
      question: 'Write: "I can apply their lessons by ___.',
      minLength: 10,
    },
  ];
  ...
  useEffect(() => {
    if (showResult) {
      console.log(`🎮 Journal of Role Models game completed! Score: ${finalScore}/${stages.length}, gameId: ${gameId}`);
    }
  ...
  return (
    <GameShell
      ...
      subtitle={!showResult ? `Question ${currentStage + 1} of ${stages.length}: Find inspiration in entrepreneurship!` : "Journal Complete!"}
      ...
      nextGamePathProp="/student/ehe/teens/simulation-teen-business"
      nextGameIdProp="ehe-teen-48">
      <div className="min-h-[calc(100vh-200px)] flex flex-col justify-center text-center text-white space-y-6 md:space-y-8 max-w-4xl mx-auto px-4 py-4">
        ...
        {showResult && (
          <div className="bg-white/10 backdrop-blur-md p-6 md:p-8 rounded-xl md:rounded-2xl border border-white/20 text-center">
            ...
            <h2 className="text-2xl font-bold text-white mb-6">Entrepreneurial Inspiration Complete!</h2>
