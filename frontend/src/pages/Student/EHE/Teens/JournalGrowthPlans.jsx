...
const JournalGrowthPlans = () => {
  ...
  const stages = [
    {
      question: 'Write: "One way I will keep learning is ___.',
      minLength: 10,
    },
    {
      question: 'Write: "This learning method works for me because ___.',
      minLength: 10,
    },
    {
      question: 'Write: "To make time for learning, I will ___.',
      minLength: 10,
    },
    {
      question: 'Write: "A mentor or resource that can help is ___.',
      minLength: 10,
    },
    {
      question: 'Write: "In 5 years, this learning will help me ___.',
      minLength: 10,
    },
  ];
  ...
  useEffect(() => {
    if (showResult) {
      console.log(`🎮 Journal of Growth Plans game completed! Score: ${finalScore}/${stages.length}, gameId: ${gameId}`);
    }
  ...
  return (
    <GameShell
      ...
      subtitle={!showResult ? `Question ${currentStage + 1} of ${stages.length}: Plan your lifelong learning!` : "Journal Complete!"}
      ...
      nextGamePathProp="/student/ehe/teens/simulation-career-upgrade"
      nextGameIdProp="ehe-teen-98">
      <div className="min-h-[calc(100vh-200px)] flex flex-col justify-center text-center text-white space-y-6 md:space-y-8 max-w-4xl mx-auto px-4 py-4">
        ...
        {showResult && (
          <div className="bg-white/10 backdrop-blur-md p-6 md:p-8 rounded-xl md:rounded-2xl border border-white/20 text-center">
            ...
            <h2 className="text-2xl font-bold text-white mb-6">Lifelong Learning Plan Complete!</h2>
            
            <div className="bg-gradient-to-r from-green-500/20 to-emerald-500/20 rounded-xl p-4 border border-green-400/30 mb-6">
              <p className="text-green-300 font-bold">
                🎉 Excellent! You've completed your growth plan journal entry!
              </p>
