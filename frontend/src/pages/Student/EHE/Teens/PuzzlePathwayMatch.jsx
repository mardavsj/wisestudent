...
const PuzzlePathwayMatch = () => {
  ...
  const correctMatches = [
    { careerId: 1, pathwayId: 1 }, // Lawyer → Law School
    { careerId: 2, pathwayId: 2 }, // Artist → Design College
    { careerId: 3, pathwayId: 3 }, // Engineer → Tech College
    { careerId: 4, pathwayId: 4 }, // Doctor → Medical School
  ...
  return (
    <GameShell
      ...
      totalXp={totalXp}
      nextGamePathProp="/student/ehe/teens/gap-year-story"
      nextGameIdProp="ehe-teen-55">
          ...
          <div className="bg-white/10 backdrop-blur-md rounded-2xl p-8 border border-white/20 text-center">
            {score >= 3 ? (
              <div>
                ...
                <h3 className="text-2xl font-bold text-white mb-4">Career Pathway Expert!</h3>
                ...
                <p className="text-white/80">
                  Lesson: Choosing the right educational pathway is crucial for career success!
                </p>
              </div>
            ) : (
              <div>
                ...
                <p className="text-white/80 text-sm">
                  Tip: Think about the skills and knowledge each career requires!
                </p>
              </div>
            )}
          </div>
