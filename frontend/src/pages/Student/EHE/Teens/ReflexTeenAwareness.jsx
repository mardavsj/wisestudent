...
const ReflexTeenAwareness = () => {
  ...
  const handleNext = () => {
    navigate("/student/ehe/teens/badge-higher-ed-ready-teen");
  };
  ...
  return (
    <GameShell
      ...
      subtitle={gameState === "playing" ? `Round ${currentRound}/${TOTAL_ROUNDS}: Educational awareness decisions!` : "Educational awareness decisions!"}
      onNext={handleNext}
      ...
      totalXp={totalXp}
      nextGamePathProp="/student/ehe/teens/badge-higher-ed-ready-teen"
      nextGameIdProp="ehe-teen-70">
        ...
        {gameState === "ready" && (
          <div className="bg-white/10 backdrop-blur-md rounded-2xl p-8 border border-white/20 text-center">
            ...
            <p className="text-white/90 text-lg mb-6">
              Educational awareness decisions!<br />
          ...
          <div className="space-y-8">
            ...
            <div className="bg-white/10 backdrop-blur-md p-8 rounded-2xl border border-white/20 text-center">
              <h3 className="text-2xl md:text-3xl font-bold mb-6 text-white">
                Is "{currentQuestion.action}" the right educational awareness action?
              </h3>
          ...
          <div className="bg-white/10 backdrop-blur-md rounded-2xl p-8 border border-white/20 text-center">
            ...
            <div className="bg-gradient-to-r from-purple-500/20 to-pink-500/20 rounded-xl p-4 border border-white/10">
              ...
              <p className="text-white/80">
                {finalScore >= 4 ? "Excellent job! You have great educational awareness skills!" : 
                 finalScore >= 3 ? "Good work! Keep developing your educational awareness!" : 
                 "Keep learning about educational awareness to improve!"}
              </p>
            </div>
          </div>
        )}
