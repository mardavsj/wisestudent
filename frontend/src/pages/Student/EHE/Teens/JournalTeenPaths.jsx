...
const JournalTeenPaths = () => {
  ...
  const stages = [
    {
      question: 'Write: "One career path I want to explore is ___.',
      minLength: 10,
    },
    {
      question: 'Write: "I am drawn to this career because ___.',
      minLength: 10,
    },
    {
      question: 'Write: "Skills I need to develop for this path are ___.',
      minLength: 10,
    },
    {
      question: 'Write: "To explore this career, I could ___.',
      minLength: 10,
    },
    {
      question: 'Write: "In 5 years on this path, I see myself ___.',
      minLength: 10,
    },
  ];
  ...
  useEffect(() => {
    if (showResult) {
      console.log(`🎮 Journal of Teen Paths game completed! Score: ${finalScore}/${stages.length}, gameId: ${gameId}`);
    }
  ...
  return (
    <GameShell
      ...
      subtitle={!showResult ? `Question ${currentStage + 1} of ${stages.length}: Chart your career journey!` : "Journal Complete!"}
      ...
      nextGamePathProp="/student/ehe/teens/simulation-career-decision"
      nextGameIdProp="ehe-teen-58">
      <div className="min-h-[calc(100vh-200px)] flex flex-col justify-center text-center text-white space-y-6 md:space-y-8 max-w-4xl mx-auto px-4 py-4">
        ...
        {showResult && (
          <div className="bg-white/10 backdrop-blur-md p-6 md:p-8 rounded-xl md:rounded-2xl border border-white/20 text-center">
            ...
            <h2 className="text-2xl font-bold text-white mb-6">Career Journey Mapping Complete!</h2>
            
            <div className="bg-gradient-to-r from-green-500/20 to-emerald-500/20 rounded-xl p-4 border border-green-400/30 mb-6">
              <p className="text-green-300 font-bold">
                🎉 Excellent! You've completed your career path journal entry!
              </p>
