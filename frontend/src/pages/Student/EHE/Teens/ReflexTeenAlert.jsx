...
const ReflexTeenAlert = () => {
  ...
  const handleNext = () => {
    navigate("/student/ehe/teens/badge-future-ready-teen");
  };
  ...
  return (
    <GameShell
      ...
      subtitle={gameState === "playing" ? `Round ${currentRound}/${TOTAL_ROUNDS}: Future readiness decisions!` : "Future readiness decisions!"}
      onNext={handleNext}
      ...
      totalXp={totalXp}
      nextGamePathProp="/student/ehe/teens/badge-future-ready-teen"
      nextGameIdProp="ehe-teen-80">
          ...
          <div className="space-y-8">
            ...
            <div className="bg-white/10 backdrop-blur-md p-8 rounded-2xl border border-white/20 text-center">
              <h3 className="text-2xl md:text-3xl font-bold mb-6 text-white">
                Is "{currentQuestion.action}" the right future readiness action?
              </h3>
          ...
          <div className="bg-white/10 backdrop-blur-md rounded-2xl p-8 border border-white/20 text-center">
            ...
            <div className="bg-gradient-to-r from-purple-500/20 to-pink-500/20 rounded-xl p-4 border border-white/10">
              ...
              <p className="text-white/80">
                {finalScore >= 4 ? "Excellent job! You have great future readiness skills!" : 
                 finalScore >= 3 ? "Good work! Keep developing your future readiness!" : 
                 "Keep learning about future readiness to improve!"}
              </p>
            </div>
          </div>
        )}
