...
const LEFT_ITEMS = [
  { id: "single-income", text: "Single income dependency" },
  { id: "diversified-income", text: "Diversified skill-based income" },
  { id: "relying-on-one-client", text: "Relying on one major client" },
  { id: "passive-streams", text: "Building passive income streams" },
  { id: "not-upgrading", text: "Not upgrading marketable skills" },
];

const RIGHT_ITEMS = [
  { id: "stagnant-earning", text: "Stagnant earning potential" },
  { id: "vulnerability", text: "Vulnerability to market shifts" },
  { id: "stability", text: "Improved financial stability" },
  { id: "resilience", text: "Financial resilience and growth" },
  { id: "high-risk", text: "High financial risk during downturns" },
];

const SOLUTIONS = {
  "single-income": "high-risk",
  "diversified-income": "stability",
  "relying-on-one-client": "vulnerability",
  "passive-streams": "resilience",
  "not-upgrading": "stagnant-earning",
};

const PuzzleMultipleIncomeSources = () => {
  ...
  const gameId = "ehe-young-adult-94";
  ...
  const handleRightSelect = (r) => {
    ...
    if (r.id === correctRight) {
      ...
      setOutcomeText("Mismatch! Think about how this impacts your financial security.");
    }
  ...
  return (
    <GameShell
      ...
      subtitle={
        showResult
          ? "Well done! You understand the importance of diversifying your income."
          : `Match income strategies to their financial impact: ${score}/${totalPairs} matched`
      }
...
export default PuzzleMultipleIncomeSources;
