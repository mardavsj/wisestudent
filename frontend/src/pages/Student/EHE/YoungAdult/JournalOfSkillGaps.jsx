...
const PROMPTS = [
  "Scenario: Your job requires certain software skills you do not fully possess. What is your initial, honest reaction to this challenge?",
  "Instead of hiding my weakness or blaming management, I will reduce my long-term career risk by creating a ___.",
  "Identify one specific resource (course, tutorial, colleague) you can use this week to start bridging this software skill gap.",
  "How will you communicate your learning progress to your manager to turn this weakness into a demonstration of initiative?",
  "Reflect on how overcoming this technical hurdle will boost your confidence and value in future projects.",
];

const MIN_LEN = 10;

const JournalOfSkillGaps = () => {
  ...
  const gameId = "ehe-young-adult-25";
  ...
  return (
    <GameShell
      ...
      subtitle={
        showResult
          ? "Journal complete! Acknowledging and addressing skill gaps builds career resilience."
          : `Stage ${progressLabel}`
      }
...
export default JournalOfSkillGaps;
