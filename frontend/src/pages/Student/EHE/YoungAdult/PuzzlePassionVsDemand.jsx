...
const LEFT_ITEMS = [
  { id: "passion-alone", text: "Passion alone" },
  { id: "market-demand", text: "Market demand analysis" },
  { id: "ignoring-feedback", text: "Ignoring customer feedback" },
  { id: "solving-pain", text: "Solving a real pain point" },
  { id: "following-hype", text: "Following trends without research" },
];

const RIGHT_ITEMS = [
  { id: "quick-failure", text: "Failing when the hype dies down" },
  { id: "wasted-capital", text: "Wasted time and capital" },
  { id: "sustainable", text: "Sustainable business viability" },
  { id: "high-adoption", text: "High chance of market adoption" },
  { id: "high-risk", text: "High risk of no sales" },
];

const SOLUTIONS = {
  "passion-alone": "high-risk",
  "market-demand": "sustainable",
  "ignoring-feedback": "wasted-capital",
  "solving-pain": "high-adoption",
  "following-hype": "quick-failure",
};

const PuzzlePassionVsDemand = () => {
  ...
  const gameId = "ehe-young-adult-32";
  ...
  const handleRightSelect = (r) => {
    ...
    if (r.id === correctRight) {
      ...
      setOutcomeText("Mismatch! Think about how this action impacts business viability.");
    }
  ...
  return (
    <GameShell
      ...
      subtitle={
        showResult
          ? "Well done! You understand the balance between passion and market demand."
          : `Match actions to their business outcomes: ${score}/${totalPairs} matched`
      }
...
export default PuzzlePassionVsDemand;
