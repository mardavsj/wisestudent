...
const LEFT_ITEMS = [
  { id: "mixing-funds", text: "Mixing personal savings & business revenue" },
  { id: "separate-accounts", text: "Keeping separate accounts" },
  { id: "paying-personal", text: "Paying personal bills from business income" },
  { id: "paying-yourself", text: "Paying yourself a fixed salary" },
  { id: "informal-loans", text: "Lending business money to friends informally" },
];

const RIGHT_ITEMS = [
  { id: "clarity", text: "Improved clarity and control" },
  { id: "lost-capital", text: "Lost working capital" },
  { id: "stability", text: "Predictable personal & business stability" },
  { id: "cashflow-crisis", text: "Business cash flow crisis" },
  { id: "confusion", text: "Financial confusion & tax issues" },
];

const SOLUTIONS = {
  "mixing-funds": "confusion",
  "separate-accounts": "clarity",
  "paying-personal": "cashflow-crisis",
  "paying-yourself": "stability",
  "informal-loans": "lost-capital",
};

const PuzzleMixingPersonalBusinessMoney = () => {
  ...
  const gameId = "ehe-young-adult-51";
  ...
  const handleRightSelect = (r) => {
    ...
    if (r.id === correctRight) {
      ...
      setOutcomeText("Mismatch! Think about how this action impacts financial boundaries.");
    }
  ...
  return (
    <GameShell
      ...
      subtitle={
        showResult
          ? "Well done! You understand the importance of separating finances."
          : `Match actions to their financial outcomes: ${score}/${totalPairs} matched`
      }
...
export default PuzzleMixingPersonalBusinessMoney;
