...
const PROMPTS = [
  "Scenario: You realize you have not defined your 5-year professional goals. What is the danger of moving forward without a long-term direction?",
  "To improve my focus and avoid random actions, I will establish written and measurable ___.",
  "Identify one specific, achievable professional goal you aim to reach within the next 5 years.",
  "How will defining this long-term goal change the daily decisions you make today?",
  "Reflect on why writing down your goals significantly increases your chances of actually achieving them.",
];

const MIN_LEN = 10;

const JournalOfLongTermGoals = () => {
  ...
  const gameId = "ehe-young-adult-98";
  ...
  return (
    <GameShell
      ...
      subtitle={
        showResult
          ? "Journal complete! Defined goals are the foundation of a focused career."
          : `Stage ${progressLabel}`
      }
...
export default JournalOfLongTermGoals;
