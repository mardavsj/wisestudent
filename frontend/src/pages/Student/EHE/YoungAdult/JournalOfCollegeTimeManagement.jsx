...
const PROMPTS = [
  "Scenario: You realize you've been focusing only on social activities. What is the long-term risk of neglecting your academics?",
  "To build long-term success, I will shift away from ignoring academics and build a balanced ___.",
  "Identify one specific academic goal you want to prioritize this week.",
  "How will balancing your time between social activities and studies improve your future career prospects?",
  "Reflect on why time management is one of the most critical skills to develop during college.",
];

const MIN_LEN = 10;

const JournalOfCollegeTimeManagement = () => {
  ...
  const gameId = "ehe-young-adult-67";
  ...
  return (
    <GameShell
      ...
      subtitle={
        showResult
          ? "Journal complete! A balanced approach leads to long-term success."
          : `Stage ${progressLabel}`
      }
...
export default JournalOfCollegeTimeManagement;
