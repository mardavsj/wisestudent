...
const PROMPTS = [
  "Scenario: You are currently operating without any defined short-term targets. What is the biggest risk of running a business day-to-day without a plan?",
  "To avoid directionless operations, I will create a business plan that focuses on ___.",
  "Identify one specific, measurable goal you want your business to achieve in the next 30 days.",
  "How will having this written business plan help you decide what to say 'no' to?",
  "Reflect on how a clear plan changes your daily stress levels as a business owner.",
];

const MIN_LEN = 10;

const JournalOfBusinessPlanning = () => {
  ...
  const gameId = "ehe-young-adult-59";
  ...
  return (
    <GameShell
      ...
      subtitle={
        showResult
          ? "Journal complete! A clear plan turns chaos into focused action."
          : `Stage ${progressLabel}`
      }
...
export default JournalOfBusinessPlanning;
