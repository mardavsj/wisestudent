...
const LEFT_ITEMS = [
  { id: "only-new", text: "Focusing only on new customers" },
  { id: "repeat-loyalty", text: "Building repeat customer loyalty" },
  { id: "ignoring-complaints", text: "Ignoring customer complaints" },
  { id: "reward-programs", text: "Implementing reward programs" },
  { id: "poor-service", text: "Providing poor post-sale service" },
];

const RIGHT_ITEMS = [
  { id: "stability", text: "Long-term stability & revenue" },
  { id: "lost-trust", text: "Lost trust and negative reviews" },
  { id: "high-cost", text: "High marketing cost" },
  { id: "churn", text: "High customer churn rate" },
  { id: "retention", text: "Increased customer lifetime value" },
];

const SOLUTIONS = {
  "only-new": "high-cost",
  "repeat-loyalty": "stability",
  "ignoring-complaints": "lost-trust",
  "reward-programs": "retention",
  "poor-service": "churn",
};

const PuzzleCustomerRetention = () => {
  ...
  const gameId = "ehe-young-adult-43";
  ...
  const handleRightSelect = (r) => {
    ...
    if (r.id === correctRight) {
      ...
      setOutcomeText("Mismatch! Think about how this action impacts customer loyalty.");
    }
  ...
  return (
    <GameShell
      ...
      subtitle={
        showResult
          ? "Well done! You understand the value of retaining customers."
          : `Match actions to their retention outcomes: ${score}/${totalPairs} matched`
      }
...
export default PuzzleCustomerRetention;
