...
const PROMPTS = [
  "Scenario: You consider taking up part-time work during college. What is the biggest risk of taking on too many work hours?",
  "To ensure I succeed at both, I will use ___ instead of overworking or ignoring academics.",
  "Identify one specific time-management technique that can help you balance work shifts and study time.",
  "How will clear communication with both your employer and professors prevent scheduling conflicts?",
  "Reflect on how maintaining a strict balance protects your mental health and prevents burnout.",
];

const MIN_LEN = 10;

const JournalOfBalancingWorkStudy = () => {
  ...
  const gameId = "ehe-young-adult-78";
  ...
  return (
    <GameShell
      ...
      subtitle={
        showResult
          ? "Journal complete! A healthy balance leads to success in both academics and work."
          : `Stage ${progressLabel}`
      }
...
export default JournalOfBalancingWorkStudy;
