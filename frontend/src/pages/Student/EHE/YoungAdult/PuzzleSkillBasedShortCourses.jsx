...
const LEFT_ITEMS = [
  { id: "brand-only", text: "6-month course + Brand name only" },
  { id: "industry-relevance", text: "6-month course + Industry relevance" },
  { id: "outdated-software", text: "Learning outdated legacy software" },
  { id: "no-projects", text: "Taking courses without hands-on projects" },
  { id: "building-portfolio", text: "Building a portfolio of real applications" },
];

const RIGHT_ITEMS = [
  { id: "high-value", text: "High practical value" },
  { id: "low-impact", text: "Low practical impact" },
  { id: "obsolete-skill", text: "Obsolete skill set" },
  { id: "proof-of-capability", text: "Proof of actual capability" },
  { id: "theory-only", text: "Theoretical knowledge only" },
];

const SOLUTIONS = {
  "brand-only": "low-impact",
  "industry-relevance": "high-value",
  "outdated-software": "obsolete-skill",
  "no-projects": "theory-only",
  "building-portfolio": "proof-of-capability",
};

const PuzzleSkillBasedShortCourses = () => {
  ...
  const gameId = "ehe-young-adult-64";
  ...
  const handleRightSelect = (r) => {
    ...
    if (r.id === correctRight) {
      ...
      setOutcomeText("Mismatch! Think about how this action impacts the practical relevance of your skills.");
    }
  ...
  return (
    <GameShell
      ...
      subtitle={
        showResult
          ? "Well done! You understand the true value of practical, relevant skills."
          : `Match actions to their career value: ${score}/${totalPairs} matched`
      }
...
export default PuzzleSkillBasedShortCourses;
