...
const LEFT_ITEMS = [
  { id: "job-hopping", text: "Changing jobs every 5 months" },
  { id: "staying-to-build", text: "Staying to build skills" },
  { id: "chasing-salary", text: "Leaving only for slightly higher pay" },
  { id: "learning-phase", text: "Completing a full project cycle" },
  { id: "quitting-hard", text: "Quitting when work gets difficult" },
];

const RIGHT_ITEMS = [
  { id: "instability", text: "Perceived instability by recruiters" },
  { id: "lack-resilience", text: "Demonstrates a lack of resilience" },
  { id: "proven-value", text: "Proves reliability and deep expertise" },
  { id: "stagnant-growth", text: "Short-term gain, long-term stagnation" },
  { id: "credibility", text: "Strong professional credibility" },
];

const SOLUTIONS = {
  "job-hopping": "instability",
  "staying-to-build": "credibility",
  "chasing-salary": "stagnant-growth",
  "learning-phase": "proven-value",
  "quitting-hard": "lack-resilience",
};

const PuzzleShortTermJobSwitching = () => {
  ...
  const gameId = "ehe-young-adult-21";
  ...
  const handleRightSelect = (r) => {
    ...
    if (r.id === correctRight) {
      ...
      setOutcomeText("Mismatch! Think about how this action impacts your career reputation.");
    }
  ...
  return (
    <GameShell
      ...
      subtitle={
        showResult
          ? "Well done! You understand the long-term impacts of job switching."
          : `Match actions to their career impacts: ${score}/${totalPairs} matched`
      }
...
export default PuzzleShortTermJobSwitching;
