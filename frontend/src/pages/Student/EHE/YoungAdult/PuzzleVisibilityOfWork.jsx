...
const LEFT_ITEMS = [
  { id: "remain-silent", text: "Remain silent about your achievements" },
  { id: "share-results", text: "Professionally share results" },
  { id: "oversell", text: "Oversell minor tasks" },
  { id: "document-impact", text: "Document metrics and impact" },
  { id: "complain-unnoticed", text: "Complain about being unnoticed" },
];

const RIGHT_ITEMS = [
  { id: "negative-image", text: "Creates a negative image" },
  { id: "lost-credibility", text: "Lost professional credibility" },
  { id: "recognition", text: "Measured visibility & recognition" },
  { id: "clear-value", text: "Clear proof of value for reviews" },
  { id: "unnoticed", text: "Unnoticed hard work" },
];

const SOLUTIONS = {
  "remain-silent": "unnoticed",
  "share-results": "recognition",
  "oversell": "lost-credibility",
  "document-impact": "clear-value",
  "complain-unnoticed": "negative-image",
};

const PuzzleVisibilityOfWork = () => {
  ...
  const gameId = "ehe-young-adult-14";
  ...
  const handleRightSelect = (r) => {
    ...
    if (r.id === correctRight) {
      ...
      setOutcomeText("Mismatch! Think about how this action affects your professional visibility.");
    }
  ...
  return (
    <GameShell
      ...
      subtitle={
        showResult
          ? "Well done! You understand how making your work visible impacts your career."
          : `Match actions to their visibility outcomes: ${score}/${totalPairs} matched`
      }
...
export default PuzzleVisibilityOfWork;
