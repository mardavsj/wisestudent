...
const PROMPTS = [
  "Scenario: You start earning a part-time income during college. What is the immediate temptation when you have extra cash on hand?",
  "To build stability instead of just increasing my lifestyle expenses, I will allocate a portion of my income to ___.",
  "Identify one essential academic or living expense you could cover directly with your part-time income.",
  "How will managing your part-time income effectively now prepare you for larger financial responsibilities later?",
  "Reflect on why viewing part-time income solely as 'fun money' can be a dangerous long-term mindset.",
];

const MIN_LEN = 10;

const JournalOfPartTimeIncome = () => {
  ...
  const gameId = "ehe-young-adult-87";
  ...
  return (
    <GameShell
      ...
      subtitle={
        showResult
          ? "Journal complete! Strategic income allocation builds early stability."
          : `Stage ${progressLabel}`
      }
...
export default JournalOfPartTimeIncome;
