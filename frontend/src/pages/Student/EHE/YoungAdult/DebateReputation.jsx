...
const DebateReputation = () => {
  ...
  const gameId = "ehe-young-adult-16";
  ...
  return (
    <GameShell
      ...
      subtitle={
        showResult
          ? "Debate concluded! Consistent performance is key to a strong reputation."
...
export default DebateReputation;
