...
const PROMPTS = [
  "Scenario: A higher role requires additional certification. What is your first step to understand the specific requirements?",
  "To increase my advancement chances, I will not wait for an automatic promotion but will invest in ___.",
  "How can acquiring a new certification or skill change the way your current manager perceives your value?",
  "Describe a daily or weekly habit you can build to consistently work towards upskilling while managing your current job.",
  "If your company doesn't pay for the certification, why might it still be worth the personal financial investment?",
];

const MIN_LEN = 10;

const JournalOfUpskilling = () => {
  ...
  const gameId = "ehe-young-adult-17";
  ...
  return (
    <GameShell
      ...
      subtitle={
        showResult
          ? "Journal complete! Upskilling accelerates your professional growth."
          : `Stage ${progressLabel}`
      }
...
export default JournalOfUpskilling;
