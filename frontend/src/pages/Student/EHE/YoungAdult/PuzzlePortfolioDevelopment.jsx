...
const LEFT_ITEMS = [
  { id: "no-portfolio", text: "Applying without a portfolio" },
  { id: "demonstrable-work", text: "Demonstrable project work" },
  { id: "only-courses", text: "Only listing courses taken" },
  { id: "real-world-apps", text: "Showcasing real-world applications" },
  { id: "no-work-samples", text: "No link to work samples" },
];

const RIGHT_ITEMS = [
  { id: "missed-opportunity", text: "Missed opportunity to stand out" },
  { id: "strong-credibility", text: "Strong credibility" },
  { id: "higher-interviews", text: "Higher interview chances" },
  { id: "lack-of-proof", text: "Lack of practical proof" },
  { id: "weak-application", text: "Weak application" },
];

const SOLUTIONS = {
  "no-portfolio": "weak-application",
  "demonstrable-work": "strong-credibility",
  "only-courses": "lack-of-proof",
  "real-world-apps": "higher-interviews",
  "no-work-samples": "missed-opportunity",
};

const PuzzlePortfolioDevelopment = () => {
  ...
  const gameId = "ehe-young-adult-74";
  ...
  const handleRightSelect = (r) => {
    ...
    showCorrectAnswerFeedback(1, true);
      ...
      setOutcomeText("Mismatch! Think about how this action impacts your application quality.");
    }
  ...
  return (
    <GameShell
      ...
      subtitle={
        showResult
          ? "Well done! You understand the power of a strong portfolio."
          : `Match actions to their application impact: ${score}/${totalPairs} matched`
      }
...
export default PuzzlePortfolioDevelopment;
