...
const PROMPTS = [
  "Scenario: Friends get jobs faster than you. What is your immediate reaction, and how can you channel it into preparation?",
  "Instead of blaming the system or panicking, I will focus on ___ to increase my selection chances. (Complete this thought)",
  "What specific skills or knowledge can you acquire right now to make your resume stand out?",
  "How can networking or seeking mentorship help you during this waiting period?",
  "Describe a daily routine that will keep you motivated and productive while job hunting.",
];

const MIN_LEN = 10;

const JournalOfPreparation = () => {
  ...
  const gameId = "ehe-young-adult-7";
  ...
  return (
    <GameShell
      ...
      subtitle={
        showResult
          ? "Journal complete! Being prepared increases your chances of success."
          : `Stage ${progressLabel}`
      }
...
export default JournalOfPreparation;
