...
const PROMPTS = [
  "Scenario: You realize you haven't been tracking daily expenses. What is the immediate impact of this lack of tracking on your financial awareness?",
  "To avoid financial confusion, I will maintain accurate daily records to improve my ___.",
  "Identify one simple tool or method you can start using today to track your expenses consistently.",
  "How does keeping accurate daily records help you make better financial decisions at the end of the month?",
  "Reflect on how this habit of record keeping will prevent future debt or financial stress.",
];

const MIN_LEN = 10;

const JournalOfRecordKeeping = () => {
  ...
  const gameId = "ehe-young-adult-39";
  ...
  return (
    <GameShell
      ...
      subtitle={
        showResult
          ? "Journal complete! Consistent record keeping is the foundation of financial health."
          : `Stage ${progressLabel}`
      }
...
export default JournalOfRecordKeeping;
