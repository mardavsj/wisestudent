...
const WhatIsFinancialLiteracy = () => {
  ...
  const baseKey = "financial-literacy.adults.what-is-financial-literacy";

  const gameContent = t(baseKey, { returnObjects: true });
  const gameData = getGameDataById(gameId);

  const STAGES = Array.isArray(gameContent?.stages)
    ? gameContent.stages
    : [];
  ...
  return (
    <GameShell
      title={gameContent?.title || "What Is Financial Literacy?"}
      subtitle={subtitle}
          ...
          <div className="flex justify-between items-center mb-4 text-sm uppercase tracking-[0.3em] text-white/60">
            ...
            <span>
              {t(`${baseKey}.scenarioValue`, {
                defaultValue: "Understanding money decisions",
              })}
            </span>
          </div>
            ...
            {showResult && (
              <>
                ...
                <p className="text-sm text-white/70">
                  ...
                  <strong>
                    {t(`${baseKey}.skillName`, {
                      defaultValue: "Knowing what financial literacy means",
                    })}
                  </strong>
                </p>
