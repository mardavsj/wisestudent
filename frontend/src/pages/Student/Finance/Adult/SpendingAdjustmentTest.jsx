...
const SpendingAdjustmentTest = () => {
  ...
  // 🔑 Base key
  const baseKey = "financial-literacy.adults.spending-adjustment-test";
  ...
  return (
    <GameShell
      title={gameContent?.title || "Spending Adjustment Test"}
      subtitle={subtitle}
          ...
          <div className="flex text-sm uppercase tracking-[0.3em] text-white/60 justify-between mb-4">
            ...
            <span>
              {t(`${baseKey}.scenarioValue`, {
                defaultValue: "Adjusting spending before borrowing",
              })}
            </span>
          </div>
              ...
              <>
                ...
                <p className="text-sm text-white/70">
                  ...
                  <strong>
                    {t(`${baseKey}.skillName`, {
                      defaultValue:
                        "Adjusting spending to close small gaps",
                    })}
                  </strong>
                </p>
