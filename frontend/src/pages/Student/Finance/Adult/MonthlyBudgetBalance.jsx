...
const MonthlyBudgetBalance = () => {
  ...
  const gameContent = t("financial-literacy.adults.monthly-budget-balance", {
    returnObjects: true,
  });
  ...
  const subtitle = t(
    "financial-literacy.adults.monthly-budget-balance.subtitleProgress",
    {
  ...
  return (
    <GameShell
      title={
        gameContent?.title || "Monthly Budget Balance"
      }
      subtitle={subtitle}
              ...
              return (
                ...
                >
                  <div className="text-sm text-white/70 mb-2">
                    {t(
                      "financial-literacy.adults.monthly-budget-balance.choiceLabel",
                      {
                        id: option.id,
              ...
              <>
                ...
                {!hasPassed && (
                  <p className="text-xs text-amber-300">
                    {t(
                      "financial-literacy.adults.monthly-budget-balance.fullRewardHint",
                      {
                        total: totalStages,
                        defaultValue:
