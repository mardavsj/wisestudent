...
const WhySaveEarly = () => {
  ...
  const gameContent = t("financial-literacy.young-adult.why-save-early", {
    returnObjects: true,
  });
  ...
  const subtitle = t(
    "financial-literacy.young-adult.why-save-early.subtitleProgress",
    {
              ...
              return (
                ...
                >
                  <div className="flex justify-between items-center mb-2 text-sm text-white/70">
                    <span>
                      {t(
                        "financial-literacy.young-adult.why-save-early.choiceLabel",
                ...
                <>
                  ...
                  {!hasPassed && (
                    <p className="text-xs text-amber-300">
                      {t(
                        "financial-literacy.young-adult.why-save-early.fullRewardHint",
                        { total: totalStages }
                      )}
                    </p>
                  )}
