...
const MultipleBankAccounts = () => {
  ...
  const gameContent = t("financial-literacy.young-adult.multiple-bank-accounts", { returnObjects: true });
  ...
  const gameData = getGameDataById("finance-young-adult-44");
  ...
  const subtitle = t("financial-literacy.young-adult.multiple-bank-accounts.subtitleProgress", {
              ...
              return (
                ...
                >
                  <div className="flex justify-between items-center mb-2 text-sm text-white/70">
                    <span>
                      {t("financial-literacy.young-adult.multiple-bank-accounts.choiceLabel", { id: String(option.id || "").toUpperCase() })}
                    </span>
                  </div>
                ...
                <>
                  ...
                  {!hasPassed && (
                    <p className="text-xs text-amber-300">
                      {t("financial-literacy.young-adult.multiple-bank-accounts.fullRewardHint", { total: totalStages })}
                    </p>
                  )}
                  {!hasPassed && (
                    <button
