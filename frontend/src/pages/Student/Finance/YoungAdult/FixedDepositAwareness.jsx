...
const FixedDepositAwareness = () => {
  ...
  const gameContent = t(
    "financial-literacy.young-adult.fixed-deposit-awareness",
    { returnObjects: true }
  );
  ...
  const subtitle = t(
    "financial-literacy.young-adult.fixed-deposit-awareness.subtitleProgress",
    {
              ...
              return (
                ...
                >
                  <div className="flex justify-between items-center mb-2 text-sm text-white/70">
                    <span>
                      {t(
                        "financial-literacy.young-adult.fixed-deposit-awareness.choiceLabel",
          ...
          {(showResult || showFeedback) && (
            <div className="bg-white/5 border border-white/20 rounded-3xl p-6 shadow-xl max-w-4xl mx-auto space-y-3">
              ...
              {!showResult &&
                ...
                canProceed && <div className="mt-4 flex justify-center"></div>}
              {showResult && (
                <>
                  ...
                  {!hasPassed && (
                    <p className="text-xs text-amber-300">
                      {t(
                        "financial-literacy.young-adult.fixed-deposit-awareness.fullRewardHint",
                        { total: totalStages }
                      )}
                    </p>
                  )}
