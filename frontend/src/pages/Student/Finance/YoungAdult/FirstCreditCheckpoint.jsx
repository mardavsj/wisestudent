...
const FirstCreditCheckpoint = () => {
  ...
  const gameContent = t("financial-literacy.young-adult.first-credit-checkpoint", { returnObjects: true });
  ...
  const gameData = getGameDataById("finance-young-adult-60");
  ...
  const subtitle = t("financial-literacy.young-adult.first-credit-checkpoint.subtitleProgress", {
              ...
              return (
                ...
                >
                  <div className="flex justify-between items-center mb-2 text-sm text-white/70">
                    <span>
                      {t("financial-literacy.young-adult.first-credit-checkpoint.choiceLabel", { id: String(option.id || "").toUpperCase() })}
                    </span>
                  </div>
                ...
                <>
                  ...
                  {!hasPassed && (
                    <p className="text-xs text-amber-300">
                      {t("financial-literacy.young-adult.first-credit-checkpoint.fullRewardHint", { total: totalStages })}
                    </p>
                  )}
                  {!hasPassed && (
                    <button
