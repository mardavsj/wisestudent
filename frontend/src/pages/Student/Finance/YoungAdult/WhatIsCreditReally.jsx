...
const WhatIsCreditReally = () => {
  ...
  const gameContent = t("financial-literacy.young-adult.what-is-credit-really", { returnObjects: true });
  ...
  const gameData = getGameDataById("finance-young-adult-51");
  ...
  const subtitle = t("financial-literacy.young-adult.what-is-credit-really.subtitleProgress", {
              ...
              return (
                ...
                >
                  <div className="flex justify-between items-center mb-2 text-sm text-white/70">
                    <span>
                      {t("financial-literacy.young-adult.what-is-credit-really.choiceLabel", { id: String(option.id || "").toUpperCase() })}
                    </span>
                  </div>
                ...
                <>
                  ...
                  {!hasPassed && (
                    <p className="text-xs text-amber-300">
                      {t("financial-literacy.young-adult.what-is-credit-really.fullRewardHint", { total: totalStages })}
                    </p>
                  )}
                  {!hasPassed && (
                    <button
