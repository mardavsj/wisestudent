...
const MinimumDueTrap = () => {
  ...
  const gameContent = t("financial-literacy.young-adult.minimum-due-trap", { returnObjects: true });
  ...
  const gameData = getGameDataById("finance-young-adult-55");
  ...
  const subtitle = t("financial-literacy.young-adult.minimum-due-trap.subtitleProgress", {
              ...
              return (
                ...
                >
                  <div className="flex justify-between items-center mb-2 text-sm text-white/70">
                    <span>
                      {t("financial-literacy.young-adult.minimum-due-trap.choiceLabel", { id: String(option.id || "").toUpperCase() })}
                    </span>
                  </div>
                ...
                <>
                  ...
                  {!hasPassed && (
                    <p className="text-xs text-amber-300">
                      {t("financial-literacy.young-adult.minimum-due-trap.fullRewardHint", { total: totalStages })}
                    </p>
                  )}
                  {!hasPassed && (
                    <button
