...
const PublicWifiRisk = () => {
  ...
  const gameContent = t("financial-literacy.young-adult.public-wifi-risk", { returnObjects: true });
  ...
  const gameData = getGameDataById("finance-young-adult-47");
  ...
  const subtitle = t("financial-literacy.young-adult.public-wifi-risk.subtitleProgress", {
              ...
              return (
                ...
                >
                  <div className="flex justify-between items-center mb-2 text-sm text-white/70">
                    <span>
                      {t("financial-literacy.young-adult.public-wifi-risk.choiceLabel", { id: String(option.id || "").toUpperCase() })}
                    </span>
                  </div>
                ...
                <>
                  ...
                  {!hasPassed && (
                    <p className="text-xs text-amber-300">
                      {t("financial-literacy.young-adult.public-wifi-risk.fullRewardHint", { total: totalStages })}
                    </p>
                  )}
                  {!hasPassed && (
                    <button
