...
const SalaryIsNotPocketMoney = () => {
  ...
  const gameContent = t("financial-literacy.young-adult.salary-is-not-pocket-money", { returnObjects: true });
  ...
  const subtitle = t("financial-literacy.young-adult.salary-is-not-pocket-money.subtitleProgress", {
              ...
              return (
                ...
                >
                  <div className="flex justify-between items-center mb-2 text-sm text-white/70">
                    <span>
                      {t("financial-literacy.young-adult.salary-is-not-pocket-money.choiceLabel", {
                ...
                <>
                  ...
                  {!hasPassed && (
                    <p className="text-xs text-amber-300">
                      {t("financial-literacy.young-adult.salary-is-not-pocket-money.fullRewardHint", {
                        total: totalStages,
                      })}
                    </p>
                  )}
