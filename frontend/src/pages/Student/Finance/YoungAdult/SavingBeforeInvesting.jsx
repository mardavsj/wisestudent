...
const SavingBeforeInvesting = () => {
  ...
  const gameContent = t(
    "financial-literacy.young-adult.saving-before-investing",
    { returnObjects: true }
  );
  ...
  const subtitle = t(
    "financial-literacy.young-adult.saving-before-investing.subtitleProgress",
    {
              ...
              return (
                ...
                >
                  <div className="flex justify-between items-center mb-2 text-sm text-white/70">
                    <span>
                      {t(
                        "financial-literacy.young-adult.saving-before-investing.choiceLabel",
                ...
                <>
                  ...
                  {!hasPassed && (
                    <p className="text-xs text-amber-300">
                      {t(
                        "financial-literacy.young-adult.saving-before-investing.fullRewardHint",
                        { total: totalStages }
                      )}
                    </p>
                  )}
