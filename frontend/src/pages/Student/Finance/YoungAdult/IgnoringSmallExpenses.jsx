...
const IgnoringSmallExpenses = () => {
  ...
  const gameContent = t("financial-literacy.young-adult.ignoring-small-expenses", { returnObjects: true });
  ...
  const subtitle = t("financial-literacy.young-adult.ignoring-small-expenses.subtitleProgress", {
              ...
              return (
                ...
                >
                  <div className="flex justify-between items-center mb-2 text-sm text-white/70">
                    <span>{t("financial-literacy.young-adult.ignoring-small-expenses.choiceLabel", { id: String(option.id || "").toUpperCase() })}</span>
                  </div>
                ...
                <>
                  ...
                  {!hasPassed && (
                    <p className="text-xs text-amber-300">
                      {t("financial-literacy.young-adult.ignoring-small-expenses.fullRewardHint", { total: totalStages })}
                    </p>
                  )}
                  {!hasPassed && (
                    <button
