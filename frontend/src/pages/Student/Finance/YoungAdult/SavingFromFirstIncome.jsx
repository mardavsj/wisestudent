...
const SavingFromFirstIncome = () => {
  ...
  const gameContent = t("financial-literacy.young-adult.saving-from-first-income", { returnObjects: true });
  ...
  const subtitle = t("financial-literacy.young-adult.saving-from-first-income.subtitleProgress", {
              ...
              return (
                ...
                >
                  <div className="flex justify-between items-center mb-2 text-sm text-white/70">
                    <span>
                      {t("financial-literacy.young-adult.saving-from-first-income.choiceLabel", {
                ...
                <>
                  ...
                  {!hasPassed && (
                    <p className="text-xs text-amber-300">
                      {t("financial-literacy.young-adult.saving-from-first-income.fullRewardHint", {
                        total: totalStages,
                      })}
                    </p>
                  )}
