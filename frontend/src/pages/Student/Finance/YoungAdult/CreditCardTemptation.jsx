...
const CreditCardTemptation = () => {
  ...
  const gameContent = t("financial-literacy.young-adult.credit-card-temptation", { returnObjects: true });
  ...
  const gameData = getGameDataById("finance-young-adult-54");
  ...
  const subtitle = t("financial-literacy.young-adult.credit-card-temptation.subtitleProgress", {
              ...
              return (
                ...
                >
                  <div className="flex justify-between items-center mb-2 text-sm text-white/70">
                    <span>
                      {t("financial-literacy.young-adult.credit-card-temptation.choiceLabel", { id: String(option.id || "").toUpperCase() })}
                    </span>
                  </div>
                ...
                <>
                  ...
                  {!hasPassed && (
                    <p className="text-xs text-amber-300">
                      {t("financial-literacy.young-adult.credit-card-temptation.fullRewardHint", { total: totalStages })}
                    </p>
                  )}
                  {!hasPassed && (
                    <button
