...
const BorrowingMoreThanNeeded = () => {
  ...
  const gameContent = t("financial-literacy.young-adult.borrowing-more-than-needed", { returnObjects: true });
  ...
  const gameData = getGameDataById("finance-young-adult-58");
  ...
  const subtitle = t("financial-literacy.young-adult.borrowing-more-than-needed.subtitleProgress", {
              ...
              return (
                ...
                >
                  <div className="flex justify-between items-center mb-2 text-sm text-white/70">
                    <span>
                      {t("financial-literacy.young-adult.borrowing-more-than-needed.choiceLabel", { id: String(option.id || "").toUpperCase() })}
                    </span>
                  </div>
                ...
                <>
                  ...
                  {!hasPassed && (
                    <p className="text-xs text-amber-300">
                      {t("financial-literacy.young-adult.borrowing-more-than-needed.fullRewardHint", { total: totalStages })}
                    </p>
                  )}
                  {!hasPassed && (
                    <button
