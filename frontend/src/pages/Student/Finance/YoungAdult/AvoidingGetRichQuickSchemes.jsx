...
const AvoidingGetRichQuickSchemes = () => {
  ...
  const gameContent = t(
    "financial-literacy.young-adult.avoiding-get-rich-quick-schemes",
    { returnObjects: true }
  );
  ...
  const subtitle = t(
    "financial-literacy.young-adult.avoiding-get-rich-quick-schemes.subtitleProgress",
    {
              ...
              return (
                ...
                >
                  <div className="flex justify-between items-center mb-2 text-sm text-white/70">
                    <span>
                      {t(
                        "financial-literacy.young-adult.avoiding-get-rich-quick-schemes.choiceLabel",
                ...
                <>
                  ...
                  {!hasPassed && (
                    <p className="text-xs text-amber-300">
                      {t(
                        "financial-literacy.young-adult.avoiding-get-rich-quick-schemes.fullRewardHint",
                        { total: totalStages }
                      )}
                    </p>
                  )}
