...
const FirstMonthSpendingPlan = () => {
  ...
  const gameContent = t("financial-literacy.young-adult.first-month-spending-plan", { returnObjects: true });
  ...
  const subtitle = t("financial-literacy.young-adult.first-month-spending-plan.subtitleProgress", {
              ...
              return (
                ...
                >
                  <div className="flex justify-between items-center mb-2 text-sm text-white/70">
                    <span>
                      {t("financial-literacy.young-adult.first-month-spending-plan.choiceLabel", {
                ...
                <>
                  ...
                  {!hasPassed && (
                    <p className="text-xs text-amber-300">
                      {t("financial-literacy.young-adult.first-month-spending-plan.fullRewardHint", {
                        total: totalStages,
                      })}
                    </p>
                  )}
