...
const PublicDeviceRisk = () => {
  ...
  const gameContent = isHindi
    ? hiFinancialLiteracyYoungAdultGameContent["public-device-risk"]
    : enFinancialLiteracyYoungAdultGameContent["public-device-risk"];
  ...
  const subtitle =
    gameContent?.subtitleProgress && totalStages > 0
      ? t("financial-literacy.young-adult.public-device-risk.subtitleProgress", {
  ...
  return (
    <GameShell
      title={
        gameContent?.title ||
        t(
          "financial-literacy.young-adult.public-device-risk.title",
          "Public Device Risk"
        )
      }
      subtitle={subtitle}
          ...
          <div className="flex justify-between items-center mb-4 text-sm uppercase tracking-[0.3em] text-white/60">
            <span>
              {gameContent?.scenarioLabel ||
                t(
                  "financial-literacy.young-adult.public-device-risk.scenarioLabel",
                  "Scenario"
                )}
            </span>
            <span>
              {gameContent?.scenarioValue ||
                t(
                  "financial-literacy.young-adult.public-device-risk.scenarioValue",
                  "Public Device Risk"
                )}
            </span>
          </div>
            ...
            <div className="bg-white/5 border border-white/20 rounded-3xl p-6 shadow-xl max-w-4xl mx-auto space-y-3">
              <h4 className="text-lg font-semibold text-white">
                {gameContent?.reflectionTitle ||
                  t(
                    "financial-literacy.young-adult.public-device-risk.reflectionTitle",
                    "Reflection"
                  )}
              </h4>
              {selectedReflection && (
                  ...
                  {canProceed ? (
                    ...
                    >
                      {gameContent?.continueButton ||
                        t(
                          "financial-literacy.young-adult.public-device-risk.continueButton",
                          "Continue"
                        )}
                    </button>
                  ) : (
                    <div className="py-2 px-6 text-white font-semibold">
                      {gameContent?.readingLabel ||
                        t(
                          "financial-literacy.young-adult.public-device-risk.readingLabel",
                          "Reading..."
                        )}
                    </div>
                  )}
                ...
                <>
                  ...
                  <p className="text-sm text-white/70">
                    {gameContent?.skillUnlockedLabel ||
                      t(
                        "financial-literacy.young-adult.public-device-risk.skillUnlockedLabel",
                        "Skill unlocked:"
                      )}{" "}
                    <strong>
                      {gameContent?.skillName ||
                        t(
                          "financial-literacy.young-adult.public-device-risk.skillName",
                  ...
                  {!hasPassed && (
                    ...
                    >
                      {gameContent?.tryAgainButton ||
                        t(
                          "financial-literacy.young-adult.public-device-risk.tryAgainButton",
                          "Try Again"
                        )}
                    </button>
                  )}
