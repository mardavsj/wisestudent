...
const LoanEligibilityBasics = () => {
  ...
  const gameContent = t("financial-literacy.young-adult.loan-eligibility-basics", { returnObjects: true });
  ...
  const gameData = getGameDataById("finance-young-adult-57");
  ...
  const subtitle = t("financial-literacy.young-adult.loan-eligibility-basics.subtitleProgress", {
              ...
              return (
                ...
                >
                  <div className="flex justify-between items-center mb-2 text-sm text-white/70">
                    <span>
                      {t("financial-literacy.young-adult.loan-eligibility-basics.choiceLabel", { id: String(option.id || "").toUpperCase() })}
                    </span>
                  </div>
                ...
                <>
                  ...
                  {!hasPassed && (
                    <p className="text-xs text-amber-300">
                      {t("financial-literacy.young-adult.loan-eligibility-basics.fullRewardHint", { total: totalStages })}
                    </p>
                  )}
                  {!hasPassed && (
                    <button
