...
const FreelancingBasics = () => {
  ...
  const gameContent = t(
    "financial-literacy.young-adult.freelancing-basics",
    { returnObjects: true }
  );
  ...
  return (
    <GameShell
      title={gameContent?.title || "Freelancing Basics"}
      subtitle={subtitle}
      ...
      <div className="space-y-5 text-white">
        <div className="bg-white/10 border border-white/20 rounded-3xl p-8 shadow-2xl max-w-4xl mx-auto">
          <div className="flex justify-between items-center mb-4 text-sm uppercase tracking-[0.3em] text-white/60">
            ...
            <span>{gameContent?.scenarioValue || "Freelancing"}</span>
          </div>
              ...
              {showResult && (
                <>
                  ...
                  <p className="text-sm text-white/70">
                    ...
                    <strong>{gameContent?.skillName || "Freelancing fundamentals"}</strong>
                  </p>
