...
const FirstJobReality = () => {
  ...
  const gameContent = t(
    "financial-literacy.young-adult.first-job-reality",
    { returnObjects: true }
  );
  ...
  const subtitle = t(
    "financial-literacy.young-adult.first-job-reality.subtitleProgress",
    {
              ...
              return (
                ...
                >
                  <div className="flex justify-between items-center mb-2 text-sm text-white/70">
                    <span>
                      {t(
                        "financial-literacy.young-adult.first-job-reality.choiceLabel",
                ...
                <>
                  ...
                  {!hasPassed && (
                    <p className="text-xs text-amber-300">
                      {t(
                        "financial-literacy.young-adult.first-job-reality.fullRewardHint",
                        { total: totalStages }
                      )}
                    </p>
                  )}
