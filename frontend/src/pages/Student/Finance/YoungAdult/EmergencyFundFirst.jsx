...
const EmergencyFundFirst = () => {
  ...
  const gameContent = t(
    "financial-literacy.young-adult.emergency-fund-first",
    { returnObjects: true }
  );
  ...
  const subtitle = t(
    "financial-literacy.young-adult.emergency-fund-first.subtitleProgress",
    {
              ...
              return (
                ...
                >
                  <div className="flex justify-between items-center mb-2 text-sm text-white/70">
                    <span>
                      {t(
                        "financial-literacy.young-adult.emergency-fund-first.choiceLabel",
                ...
                <>
                  ...
                  {!hasPassed && (
                    <p className="text-xs text-amber-300">
                      {t(
                        "financial-literacy.young-adult.emergency-fund-first.fullRewardHint",
                        { total: totalStages }
                      )}
                    </p>
                  )}
