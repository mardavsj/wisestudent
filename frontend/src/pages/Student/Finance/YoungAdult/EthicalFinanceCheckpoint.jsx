...
const EthicalFinanceCheckpoint = () => {
  ...
  const gameContent = isHindi
    ? hiFinancialLiteracyYoungAdultGameContent["ethical-finance-checkpoint"]
    : enFinancialLiteracyYoungAdultGameContent["ethical-finance-checkpoint"];
  ...
  const subtitle =
    gameContent?.subtitleProgress && totalStages > 0
      ? t("financial-literacy.young-adult.ethical-finance-checkpoint.subtitleProgress", {
  ...
  const hasPassed = successThreshold > 0 && finalScore === successThreshold;

  const maxScore = totalStages || 1;
  const currentLevel =
    totalStages > 0 ? Math.min(currentStage + 1, totalStages) : 1;
  ...
  return (
    <GameShell
      title={
        gameContent?.title ||
        t(
          "financial-literacy.young-adult.ethical-finance-checkpoint.title",
          "Ethical Finance Checkpoint"
        )
      }
      subtitle={subtitle}
          ...
          <div className="flex justify-between items-center mb-4 text-sm uppercase tracking-[0.3em] text-white/60">
            <span>
              {gameContent?.scenarioLabel ||
                t(
                  "financial-literacy.young-adult.ethical-finance-checkpoint.scenarioLabel",
                  "Task"
                )}
            </span>
            <span>
              {gameContent?.scenarioValue ||
                t(
                  "financial-literacy.young-adult.ethical-finance-checkpoint.scenarioValue",
                  "Ethical Finance Checkpoint"
                )}
            </span>
          </div>
            ...
            <div className="bg-white/5 border border-white/20 rounded-3xl p-6 shadow-xl max-w-4xl mx-auto space-y-3">
              <h4 className="text-lg font-semibold text-white">
                {gameContent?.reflectionTitle ||
                  t(
                    "financial-literacy.young-adult.ethical-finance-checkpoint.reflectionTitle",
                    "Reflection"
                  )}
              </h4>
              {selectedReflection && (
                  ...
                  {canProceed ? (
                    ...
                    >
                      {gameContent?.continueButton ||
                        t(
                          "financial-literacy.young-adult.ethical-finance-checkpoint.continueButton",
                          "Continue"
                        )}
                    </button>
                  ) : (
                    <div className="py-2 px-6 text-white font-semibold">
                      {gameContent?.readingLabel ||
                        t(
                          "financial-literacy.young-adult.ethical-finance-checkpoint.readingLabel",
                          "Reading..."
                        )}
                    </div>
                  )}
                ...
                <>
                  ...
                  <p className="text-sm text-white/70">
                    {gameContent?.skillUnlockedLabel ||
                      t(
                        "financial-literacy.young-adult.ethical-finance-checkpoint.skillUnlockedLabel",
                        "Skill unlocked:"
                      )}{" "}
                    <strong>
                      {gameContent?.skillName ||
                        t(
                          "financial-literacy.young-adult.ethical-finance-checkpoint.skillName",
                  ...
                  {!hasPassed && (
                    ...
                    >
                      {gameContent?.tryAgainButton ||
                        t(
                          "financial-literacy.young-adult.ethical-finance-checkpoint.tryAgainButton",
                          "Try Again"
                        )}
                    </button>
                  )}
          ...
          <div className="bg-white/5 border border-white/20 rounded-3xl p-6 shadow-xl max-w-4xl mx-auto space-y-3">
            <h4 className="text-lg font-semibold text-white">
              {gameContent?.reflectionPromptsTitle ||
                t(
                  "financial-literacy.young-adult.ethical-finance-checkpoint.reflectionPromptsTitle",
                  "Reflection Prompts"
                )}
            </h4>
            <ul className="text-sm list-disc list-inside space-y-1">
