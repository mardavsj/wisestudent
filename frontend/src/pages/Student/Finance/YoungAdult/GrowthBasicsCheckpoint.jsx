...
const GrowthBasicsCheckpoint = () => {
  ...
  const gameContent = t(
    "financial-literacy.young-adult.growth-basics-checkpoint",
    { returnObjects: true }
  );
  ...
  const subtitle = t(
    "financial-literacy.young-adult.growth-basics-checkpoint.subtitleProgress",
    {
      current: Math.min(currentStage + 1, totalStages || 1),
      total: totalStages || 1,
    }
  );
  const stage = stages[Math.min(currentStage, Math.max(totalStages - 1, 0))] || null;
              ...
              return (
                ...
                >
                  <div className="flex justify-between items-center mb-2 text-sm text-white/70">
                    <span>
                      {t(
                        "financial-literacy.young-adult.growth-basics-checkpoint.choiceLabel",
                ...
                <>
                  ...
                  {!hasPassed && (
                    <p className="text-xs text-amber-300">
                      {t(
                        "financial-literacy.young-adult.growth-basics-checkpoint.fullRewardHint",
                        { total: totalStages }
                      )}
                    </p>
                  )}
