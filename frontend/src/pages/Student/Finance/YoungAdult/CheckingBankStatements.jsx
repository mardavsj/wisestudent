...
const CheckingBankStatements = () => {
  ...
  const gameContent = t("financial-literacy.young-adult.checking-bank-statements", { returnObjects: true });
  ...
  const gameData = getGameDataById("finance-young-adult-46");
  ...
  const subtitle = t("financial-literacy.young-adult.checking-bank-statements.subtitleProgress", {
              ...
              return (
                ...
                >
                  <div className="flex justify-between items-center mb-2 text-sm text-white/70">
                    <span>
                      {t("financial-literacy.young-adult.checking-bank-statements.choiceLabel", { id: String(option.id || "").toUpperCase() })}
                    </span>
                  </div>
                ...
                <>
                  ...
                  {!hasPassed && (
                    <p className="text-xs text-amber-300">
                      {t("financial-literacy.young-adult.checking-bank-statements.fullRewardHint", { total: totalStages })}
                    </p>
                  )}
                  {!hasPassed && (
                    <button
