...
const CreditIsNotEmergencyFund = () => {
  ...
  const gameContent = t("financial-literacy.young-adult.credit-is-not-emergency-fund", { returnObjects: true });
  ...
  const gameData = getGameDataById("finance-young-adult-59");
  ...
  const handleChoice = (option) => {
    ...
    const updatedHistory = [...history, { stageId: currentStageData.id, isCorrect: option.isCorrect }];
    ...
    if (option.isCorrect) setCoins((prevCoins) => prevCoins + 1);
    ...
    showCorrectAnswerFeedback(option.isCorrect ? currentStageData.reward : 0, option.isCorrect);
  };
  ...
  const subtitle = t("financial-literacy.young-adult.credit-is-not-emergency-fund.subtitleProgress", {
              ...
              return (
                ...
                >
                  <div className="flex justify-between items-center mb-2 text-sm text-white/70">
                    <span>
                      {t("financial-literacy.young-adult.credit-is-not-emergency-fund.choiceLabel", { id: String(option.id || "").toUpperCase() })}
                    </span>
                  </div>
                ...
                <>
                  ...
                  {!hasPassed && (
                    <p className="text-xs text-amber-300">
                      {t("financial-literacy.young-adult.credit-is-not-emergency-fund.fullRewardHint", { total: totalStages })}
                    </p>
                  )}
                  {!hasPassed && (
                    <button
