...
const WhyBankAccountMatters = () => {
  ...
  const gameContent = t("financial-literacy.young-adult.why-bank-account-matters", { returnObjects: true });
  ...
  const subtitle = t("financial-literacy.young-adult.why-bank-account-matters.subtitleProgress", {
              ...
              return (
                ...
                >
                  <div className="flex justify-between items-center mb-2 text-sm text-white/70">
                    <span>
                      {t("financial-literacy.young-adult.why-bank-account-matters.choiceLabel", {
                ...
                <>
                  ...
                  {!hasPassed && (
                    <p className="text-xs text-amber-300">
                      {t("financial-literacy.young-adult.why-bank-account-matters.fullRewardHint", { total: totalStages })}
                    </p>
                  )}
                  {!hasPassed && (
                    <button
