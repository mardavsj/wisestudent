...
const WalletVsBank = () => {
  ...
  const gameContent = t("financial-literacy.young-adult.wallet-vs-bank", { returnObjects: true });
  ...
  const gameData = getGameDataById("finance-young-adult-45");
  ...
  const subtitle = t("financial-literacy.young-adult.wallet-vs-bank.subtitleProgress", {
              ...
              return (
                ...
                >
                  <div className="flex justify-between items-center mb-2 text-sm text-white/70">
                    <span>
                      {t("financial-literacy.young-adult.wallet-vs-bank.choiceLabel", { id: String(option.id || "").toUpperCase() })}
                    </span>
                  </div>
                ...
                <>
                  ...
                  {!hasPassed && (
                    <p className="text-xs text-amber-300">
                      {t("financial-literacy.young-adult.wallet-vs-bank.fullRewardHint", { total: totalStages })}
                    </p>
                  )}
                  {!hasPassed && (
                    <button
