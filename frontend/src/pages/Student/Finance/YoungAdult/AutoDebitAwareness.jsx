...
const AutoDebitAwareness = () => {
  ...
  const gameContent = t("financial-literacy.young-adult.auto-debit-awareness", { returnObjects: true });
  ...
  const gameData = getGameDataById("finance-young-adult-48");
  ...
  const subtitle = t("financial-literacy.young-adult.auto-debit-awareness.subtitleProgress", {
              ...
              return (
                ...
                >
                  <div className="flex justify-between items-center mb-2 text-sm text-white/70">
                    <span>
                      {t("financial-literacy.young-adult.auto-debit-awareness.choiceLabel", { id: String(option.id || "").toUpperCase() })}
                    </span>
                  </div>
                ...
                <>
                  ...
                  {!hasPassed && (
                    <p className="text-xs text-amber-300">
                      {t("financial-literacy.young-adult.auto-debit-awareness.fullRewardHint", { total: totalStages })}
                    </p>
                  )}
                  {!hasPassed && (
                    <button
