...
const IndependenceCheckpoint = () => {
  ...
  const gameContent = t("financial-literacy.young-adult.independence-checkpoint", { returnObjects: true });
  ...
  const subtitle = t("financial-literacy.young-adult.independence-checkpoint.subtitleProgress", {
              ...
              return (
                ...
                >
                  <div className="flex justify-between items-center mb-2 text-sm text-white/70">
                    <span>
                      {t("financial-literacy.young-adult.independence-checkpoint.choiceLabel", {
                ...
                <>
                  ...
                  {!hasPassed && (
                    <p className="text-xs text-amber-300">
                      {t("financial-literacy.young-adult.independence-checkpoint.fullRewardHint", {
                        total: totalStages,
                      })}
                    </p>
                  )}
