...
const IncomeComesFromSkills = () => {
  ...
  const gameContent = t(
    "financial-literacy.young-adult.income-comes-from-skills",
    { returnObjects: true }
  );
  ...
  const subtitle = t(
    "financial-literacy.young-adult.income-comes-from-skills.subtitleProgress",
    {
              ...
              return (
                ...
                >
                  <div className="flex justify-between items-center mb-2 text-sm text-white/70">
                    <span>
                      {t(
                        "financial-literacy.young-adult.income-comes-from-skills.choiceLabel",
                ...
                <>
                  ...
                  {!hasPassed && (
                    <p className="text-xs text-amber-300">
                      {t(
                        "financial-literacy.young-adult.income-comes-from-skills.fullRewardHint",
                        { total: totalStages }
                      )}
                    </p>
                  )}
