...
const MoneyAndIntegrity = () => {
  ...
  const gameContent = isHindi
    ? hiFinancialLiteracyYoungAdultGameContent["money-and-integrity"]
    : enFinancialLiteracyYoungAdultGameContent["money-and-integrity"];
  ...
  const subtitle =
    gameContent?.subtitleProgress && totalStages > 0
      ? t(
          "financial-literacy.young-adult.money-and-integrity.subtitleProgress",
          {
  ...
  return (
    <GameShell
      title={
        gameContent?.title ||
        t(
          "financial-literacy.young-adult.money-and-integrity.title",
          "Money and Integrity"
        )
      }
      subtitle={subtitle}
          ...
          <div className="flex justify-between items-center mb-4 text-sm uppercase tracking-[0.3em] text-white/60">
            <span>
              {gameContent?.scenarioLabel ||
                t(
                  "financial-literacy.young-adult.money-and-integrity.scenarioLabel",
                  "Scenario"
                )}
            </span>
            <span>
              {gameContent?.scenarioValue ||
                t(
                  "financial-literacy.young-adult.money-and-integrity.scenarioValue",
                  "Money and Integrity"
                )}
            </span>
          </div>
            ...
            <div className="bg-white/5 border border-white/20 rounded-3xl p-6 shadow-xl max-w-4xl mx-auto space-y-3">
              <h4 className="text-lg font-semibold text-white">
                {gameContent?.reflectionTitle ||
                  t(
                    "financial-literacy.young-adult.money-and-integrity.reflectionTitle",
                    "Reflection"
                  )}
              </h4>
              {selectedReflection && (
                  ...
                  {canProceed ? (
                    ...
                    >
                      {gameContent?.continueButton ||
                        t(
                          "financial-literacy.young-adult.money-and-integrity.continueButton",
                          "Continue"
                        )}
                    </button>
                  ) : (
                    <div className="py-2 px-6 text-white font-semibold">
                      {gameContent?.readingLabel ||
                        t(
                          "financial-literacy.young-adult.money-and-integrity.readingLabel",
                          "Reading..."
                        )}
                    </div>
                  )}
                ...
                <>
                  ...
                  <p className="text-sm text-white/70">
                    {gameContent?.skillUnlockedLabel ||
                      t(
                        "financial-literacy.young-adult.money-and-integrity.skillUnlockedLabel",
                        "Skill unlocked:"
                      )}{" "}
                    <strong>
                      {gameContent?.skillName ||
                        t(
                          "financial-literacy.young-adult.money-and-integrity.skillName",
                  ...
                  {!hasPassed && (
                    ...
                    >
                      {gameContent?.tryAgainButton ||
                        t(
                          "financial-literacy.young-adult.money-and-integrity.tryAgainButton",
                          "Try Again"
                        )}
                    </button>
                  )}
