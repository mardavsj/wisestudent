...
const UPIIsNotCash = () => {
  ...
  const gameContent = t("financial-literacy.young-adult.upi-is-not-cash", { returnObjects: true });
  ...
  const subtitle = t("financial-literacy.young-adult.upi-is-not-cash.subtitleProgress", {
              ...
              return (
                ...
                >
                  <div className="flex justify-between items-center mb-2 text-sm text-white/70">
                    <span>
                      {t("financial-literacy.young-adult.upi-is-not-cash.choiceLabel", {
                ...
                <>
                  ...
                  {!hasPassed && (
                    <p className="text-xs text-amber-300">
                      {t("financial-literacy.young-adult.upi-is-not-cash.fullRewardHint", { total: totalStages })}
                    </p>
                  )}
                  {!hasPassed && (
                    <button
