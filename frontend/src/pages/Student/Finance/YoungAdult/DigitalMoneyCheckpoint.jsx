...
const DigitalMoneyCheckpoint = () => {
  ...
  const gameContent = t("financial-literacy.young-adult.digital-money-checkpoint", { returnObjects: true });
  ...
  const gameData = getGameDataById("finance-young-adult-50");
  ...
  const subtitle = t("financial-literacy.young-adult.digital-money-checkpoint.subtitleProgress", {
              ...
              return (
                ...
                >
                  <div className="flex justify-between items-center mb-2 text-sm text-white/70">
                    <span>
                      {t("financial-literacy.young-adult.digital-money-checkpoint.choiceLabel", { id: String(option.id || "").toUpperCase() })}
                    </span>
                  </div>
                ...
                <>
                  ...
                  {!hasPassed && (
                    <p className="text-xs text-amber-300">
                      {t("financial-literacy.young-adult.digital-money-checkpoint.fullRewardHint", { total: totalStages })}
                    </p>
                  )}
                  {!hasPassed && (
                    <button
