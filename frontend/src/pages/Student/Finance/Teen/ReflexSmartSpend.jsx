...
const ReflexSmartSpend = () => {
  ...
  const gameContent = t("financial-literacy.teens.reflex-smart-spend", { returnObjects: true });
  ...
  return (
    <GameShell
      title={gameContent?.title || "Reflex Smart Spend"}
      subtitle={
        gameState === "playing" 
          ? t("financial-literacy.teens.reflex-smart-spend.subtitlePlaying", { 
              current: currentRound, 
              total: TOTAL_ROUNDS,
              defaultValue: `Round ${currentRound}/${TOTAL_ROUNDS}: Test your spending reflexes!`
            })
          : gameContent?.subtitleReady || "Test your spending reflexes!"
      }
      ...
      <div className="text-center text-white space-y-8">
        {gameState === "ready" && (
          <div className="bg-white/10 backdrop-blur-md rounded-2xl p-8 border border-white/20 text-center">
            ...
            <h3 className="text-2xl font-bold text-white mb-4">
              {gameContent?.readyHeader || "Ready to Test Your Spending Reflexes?"}
            </h3>
            <p className="text-white/90 text-lg mb-6">
              {gameContent?.readyDescription || "Answer questions about smart spending choices."}
            </p>
            <p className="text-white/80 mb-6">
              {t("financial-literacy.teens.reflex-smart-spend.readyTip", { 
                total: TOTAL_ROUNDS, 
                time: ROUND_TIME,
        ...
        {gameState === "finished" && (
          <div className="bg-white/10 backdrop-blur-md rounded-2xl p-8 border border-white/20 text-center">
            ...
            <p className="text-white/90 text-lg mb-6">
              {t("financial-literacy.teens.reflex-smart-spend.finalScore", { 
                score: finalScore, 
                total: TOTAL_ROUNDS,
