...
const ReflexEthicalChoice = () => {
  ...
  const gameContent = t("financial-literacy.teens.reflex-ethical-choice", { returnObjects: true });
  ...
  return (
    <GameShell
      title={gameContent?.title || "Reflex Ethical Choice"}
      subtitle={
        gameState === "playing" 
          ? t("financial-literacy.teens.reflex-ethical-choice.subtitlePlaying", { 
              current: currentRound, 
              total: TOTAL_ROUNDS, 
              defaultValue: `Round ${currentRound}/${TOTAL_ROUNDS}: Test your ethical decision-making reflexes!` 
            })
          : gameContent?.subtitleReady || "Test your ethical decision-making reflexes!"
      }
      ...
      <div className="text-center text-white space-y-8">
        {gameState === "ready" && (
          <div className="bg-white/10 backdrop-blur-md rounded-2xl p-8 border border-white/20 text-center">
            ...
            <h3 className="text-2xl font-bold text-white mb-4">
              {gameContent?.readyHeader || "Ready to Test Your Ethical Decision-Making Reflexes?"}
            </h3>
            <p className="text-white/90 text-lg mb-6">
              {gameContent?.readyDescription || "Answer questions about moral dilemmas and ethical choices."}
            </p>
            <p className="text-white/80 mb-6">
              {t("financial-literacy.teens.reflex-ethical-choice.readyTip", { 
                total: TOTAL_ROUNDS, 
                time: ROUND_TIME,
        ...
        {gameState === "finished" && (
          <div className="bg-white/10 backdrop-blur-md rounded-2xl p-8 border border-white/20 text-center">
            ...
            <p className="text-white/90 text-lg mb-6">
              {t("financial-literacy.teens.reflex-ethical-choice.finalScore", { 
                score: finalScore, 
                total: TOTAL_ROUNDS,
            ...
            <p className="text-white/80 mb-6">
              {gameContent?.ethicalSkills || "You're developing strong ethical decision-making skills!"}
            </p>
            <button
              onClick={startGame}
