...
const ReflexDecision = () => {
  ...
  const gameContent = t("financial-literacy.teens.reflex-decision", { returnObjects: true });
  ...
  return (
    <GameShell
      title={gameContent?.title || "Reflex Decision"}
      subtitle={
        gameState === "playing" 
          ? t("financial-literacy.teens.reflex-decision.subtitlePlaying", { 
              current: currentRound, 
              total: TOTAL_ROUNDS, 
              defaultValue: `Round ${currentRound}/${TOTAL_ROUNDS}: Test your financial decision skills!` 
            })
          : gameContent?.subtitleReady || "Test your financial decision skills!"
      }
      ...
      <div className="text-center text-white space-y-8">
        {gameState === "ready" && (
          <div className="bg-white/10 backdrop-blur-md rounded-2xl p-8 border border-white/20 text-center">
            ...
            <h3 className="text-2xl font-bold text-white mb-4">
              {gameContent?.readyHeader || "Ready to Test Your Financial Decisions?"}
            </h3>
            <p className="text-white/90 text-lg mb-6">
              {gameContent?.readyDescription || "Answer questions about smart financial choices."}
            </p>
            <p className="text-white/80 mb-6">
              {t("financial-literacy.teens.reflex-decision.readyTip", { 
                total: TOTAL_ROUNDS, 
                time: ROUND_TIME,
        ...
        {gameState === "finished" && (
          <div className="bg-white/10 backdrop-blur-md rounded-2xl p-8 border border-white/20 text-center">
            ...
            <p className="text-white/90 text-lg mb-6">
              {t("financial-literacy.teens.reflex-decision.finalScore", { 
                score: finalScore, 
                total: TOTAL_ROUNDS,
            ...
            <p className="text-white/80 mb-6">
              {gameContent?.developingSkills || "You're developing strong financial decision-making skills!"}
            </p>
            <button
              onClick={startGame}
