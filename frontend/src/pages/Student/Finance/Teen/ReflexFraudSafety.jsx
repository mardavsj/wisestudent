...
const ReflexFraudSafety = () => {
  ...
  const gameContent = t("financial-literacy.teens.reflex-fraud-safety", { returnObjects: true });
  ...
  return (
    <GameShell
      title={gameContent?.title || "Reflex Fraud Safety"}
      subtitle={
        gameState === "playing" 
          ? t("financial-literacy.teens.reflex-fraud-safety.subtitlePlaying", { 
              current: currentRound, 
              total: TOTAL_ROUNDS, 
              defaultValue: `Round ${currentRound}/${TOTAL_ROUNDS}: Test your fraud safety reflexes!` 
            })
          : gameContent?.subtitleReady || "Test your fraud safety reflexes!"
      }
      ...
      <div className="text-center text-white space-y-8">
        {gameState === "ready" && (
          <div className="bg-white/10 backdrop-blur-md rounded-2xl p-8 border border-white/20 text-center">
            ...
            <h3 className="text-2xl font-bold text-white mb-4">
              {gameContent?.readyHeader || "Ready to Test Your Fraud Safety Reflexes?"}
            </h3>
            <p className="text-white/90 text-lg mb-6">
              {gameContent?.readyDescription || "Answer questions about safe online practices."}
            </p>
            <p className="text-white/80 mb-6">
              {t("financial-literacy.teens.reflex-fraud-safety.readyTip", { 
                total: TOTAL_ROUNDS, 
                time: ROUND_TIME,
        ...
        {gameState === "finished" && (
          <div className="bg-white/10 backdrop-blur-md rounded-2xl p-8 border border-white/20 text-center">
            ...
            <p className="text-white/90 text-lg mb-6">
              {t("financial-literacy.teens.reflex-fraud-safety.finalScore", { 
                score: finalScore, 
                total: TOTAL_ROUNDS,
            ...
            <p className="text-white/80 mb-6">
              {gameContent?.fraudAwareness || "You're developing strong fraud safety awareness!"}
            </p>
            <button
              onClick={startGame}
