...
const ReflexSmartSaver = () => {
  ...
  const gameContent = t("financial-literacy.teens.reflex-smart-saver", { returnObjects: true });
  ...
  return (
    <GameShell
      title={gameContent?.title || "Reflex Smart Saver"}
      subtitle={
        gameState === "playing" 
          ? t("financial-literacy.teens.reflex-smart-saver.subtitlePlaying", { 
              current: currentRound, 
              total: TOTAL_ROUNDS,
              defaultValue: `Round ${currentRound}/${TOTAL_ROUNDS}: Test your smart saving reflexes!`
            })
          : gameContent?.subtitleReady || "Test your smart saving reflexes!"
      }
        ...
        {gameState === "ready" && (
          <div className="bg-white/10 backdrop-blur-md rounded-2xl p-8 border border-white/20 text-center">
            ...
            <p className="text-white/90 text-lg mb-6">
              {gameContent?.readyDescription || "Answer questions about smart saving habits!"}
            </p>
            <p className="text-white/80 mb-6">
              {t("financial-literacy.teens.reflex-smart-saver.readyTip", { 
                total: TOTAL_ROUNDS, 
                time: ROUND_TIME,
