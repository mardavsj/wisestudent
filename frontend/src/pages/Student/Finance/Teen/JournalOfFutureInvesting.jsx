...
const JournalOfFutureInvesting = () => {
  ...
  const gameContent = t("financial-literacy.teens.journal-of-future-investing", { returnObjects: true });
  ...
  return (
    <GameShell
      title={gameContent?.title || "Journal of Future Investing"}
      subtitle={!showResult 
        ? t("financial-literacy.teens.journal-of-future-investing.subtitleProgress", {
            ...
            <div className="bg-white/10 backdrop-blur-md rounded-2xl p-6 border border-white/20">
              <div className="flex justify-between items-center mb-4">
                <span className="text-white/80">
                  {t("financial-literacy.teens.journal-of-future-investing.entryLabel", {
                    current: currentStage + 1,
                    total: stages.length,
                ...
                <span className="text-yellow-400 font-bold">
                  {t("financial-literacy.teens.journal-of-future-investing.scoreLabel", {
                    score,
                    total: stages.length,
              ...
              <div className="mb-3">
                ...
                <div className="flex justify-between items-center mt-2 text-xs text-white/60">
                  <span>
                    {t("financial-literacy.teens.journal-of-future-investing.minCharsRequired", {
            ...
            {score >= 3 ? (
              <div>
                ...
                <p className="text-white/90 text-lg mb-4">
                  {t("financial-literacy.teens.journal-of-future-investing.result.winMessage", {
                    score,
                    total: stages.length,
                    defaultValue: "You completed {{score}} out of {{total}} entries! Great job planning your investment future!"
                  })}
                </p>
                <div className="bg-gradient-to-r from-yellow-500 to-orange-500 text-white py-3 px-6 rounded-full inline-flex items-center gap-2 mb-4">
                  <span>
                    {t("financial-literacy.teens.journal-of-future-investing.result.coinsEarned", {
                      score,
                ...
                <p className="text-white/80">
                  {gameContent?.result?.lesson || "Lesson: Planning your investment future helps you set goals, prepare, and make smart investment decisions when you're ready!"}
                </p>
              </div>
            ) : (
              <div>
                ...
                <p className="text-white/90 text-lg mb-4">
                  {t("financial-literacy.teens.journal-of-future-investing.result.loseMessage", {
                    score,
                    total: stages.length,
                    defaultValue: "You completed {{score}} out of {{total}} entries. Remember, planning your investment future helps you make better decisions!"
                  })}
                </p>
                <button
                  onClick={() => {
                ...
                <p className="text-white/80 text-sm">
                  {gameContent?.result?.tip || "Tip: Think about what investments you'd like to try, why you want to invest, and how you'll prepare for investing in the future!"}
                </p>
              </div>
            )}
          </div>
