...
const JournalMonthlyBudget = () => {
  ...
  const gameContent = t("financial-literacy.teens.journal-monthly-budget", { returnObjects: true });
  ...
  return (
    <GameShell
      title={gameContent?.title || "Journal of Planning"}
      subtitle={!showResult 
        ? t("financial-literacy.teens.journal-monthly-budget.subtitleProgress", {
            ...
            <div className="bg-white/10 backdrop-blur-md rounded-2xl p-6 border border-white/20">
              <div className="flex justify-between items-center mb-4">
                <span className="text-white/80">
                  {t("financial-literacy.teens.journal-monthly-budget.entryLabel", {
                    current: currentStage + 1,
                    total: stages.length,
                ...
                <span className="text-yellow-400 font-bold">
                  {t("financial-literacy.teens.journal-monthly-budget.scoreLabel", {
                    score,
                    total: stages.length,
              ...
              <div className="mb-3">
                ...
                <div className="flex justify-between items-center mt-2 text-xs text-white/60">
                  <span>
                    {t("financial-literacy.teens.journal-monthly-budget.minCharsRequired", {
            ...
            {score >= 3 ? (
              <div>
                ...
                <p className="text-white/90 text-lg mb-4">
                  {t("financial-literacy.teens.journal-monthly-budget.result.winMessage", {
                    score,
                    total: stages.length,
                    defaultValue: "You completed {{score}} out of {{total}} entries! Great job planning your monthly budget!"
                  })}
                </p>
                <div className="bg-gradient-to-r from-yellow-500 to-orange-500 text-white py-3 px-6 rounded-full inline-flex items-center gap-2 mb-4">
                  <span>
                    {t("financial-literacy.teens.journal-monthly-budget.result.coinsEarned", {
                      score,
                ...
                <p className="text-white/80">
                  {gameContent?.result?.lesson || "Lesson: Journaling helps you plan your finances and achieve your goals!"}
                </p>
              </div>
            ) : (
              <div>
                ...
                <p className="text-white/90 text-lg mb-4">
                  {t("financial-literacy.teens.journal-monthly-budget.result.loseMessage", {
                    score,
                    total: stages.length,
                    defaultValue: "You completed {{score}} out of {{total}} entries. Remember, planning your budget helps you achieve your financial goals!"
                  })}
                </p>
                <button
                  onClick={() => {
                ...
                <p className="text-white/80 text-sm">
                  {gameContent?.result?.tip || "Tip: Take time to think about your financial goals and how budgeting can help you achieve them."}
                </p>
              </div>
            )}
          </div>
...
export default JournalMonthlyBudget;