...
const JournalOfConsumerRights = () => {
  ...
  const gameContent = t("financial-literacy.teens.journal-of-consumer-rights", { returnObjects: true });
  ...
  return (
    <GameShell
      title={gameContent?.title || "Journal of Consumer Rights"}
      subtitle={!showResult 
        ? t("financial-literacy.teens.journal-of-consumer-rights.subtitleProgress", {
            ...
            <div className="bg-white/10 backdrop-blur-md rounded-2xl p-6 border border-white/20">
              <div className="flex justify-between items-center mb-4">
                <span className="text-white/80">
                  {t("financial-literacy.teens.journal-of-consumer-rights.entryLabel", {
                    current: currentStage + 1,
                    total: stages.length,
                ...
                <span className="text-yellow-400 font-bold">
                  {t("financial-literacy.teens.journal-of-consumer-rights.scoreLabel", {
                    score,
                    total: stages.length,
              ...
              <div className="mb-3">
                ...
                <div className="flex justify-between items-center mt-2 text-xs text-white/60">
                  <span>
                    {t("financial-literacy.teens.journal-of-consumer-rights.minCharsRequired", {
            ...
            {score >= 3 ? (
              <div>
                ...
                <p className="text-white/90 text-lg mb-4">
                  {t("financial-literacy.teens.journal-of-consumer-rights.result.winMessage", {
                    score,
                    total: stages.length,
                    defaultValue: "You completed {{score}} out of {{total}} entries! Great job reflecting on your consumer rights!"
                  })}
                </p>
                <div className="bg-gradient-to-r from-yellow-500 to-orange-500 text-white py-3 px-6 rounded-full inline-flex items-center gap-2 mb-4">
                  <span>
                    {t("financial-literacy.teens.journal-of-consumer-rights.result.coinsEarned", {
                      score,
                ...
                <p className="text-white/80">
                  {gameContent?.result?.lesson || "Lesson: Reflecting on consumer rights helps you protect yourself and make informed choices!"}
                </p>
              </div>
            ) : (
              <div>
                ...
                <p className="text-white/90 text-lg mb-4">
                  {t("financial-literacy.teens.journal-of-consumer-rights.result.loseMessage", {
                    score,
                    total: stages.length,
                    defaultValue: "You completed {{score}} out of {{total}} entries. Remember, knowing your consumer rights is key to protecting yourself!"
                  })}
                </p>
                <button
                  onClick={() => {
                ...
                <p className="text-white/80 text-sm">
                  {gameContent?.result?.tip || "Tip: Think about times when you had to use your consumer rights, and how that helped you get a fair deal!"}
                </p>
              </div>
            )}
          </div>
