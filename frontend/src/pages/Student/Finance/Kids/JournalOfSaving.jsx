...
const JournalOfSaving = () => {
  ...
  const stages = [
    {
      question: 'Write: "One thing I saved money for is ___."',
      minLength: 10,
    },
    {
      question: 'Write: "The best way I save money is by ___."',
      minLength: 10,
    },
    {
      question: 'Write: "When I save money, I feel ___."',
      minLength: 10,
    },
    {
      question: 'Write: "My savings goal for this month is ___."',
      minLength: 10,
    },
    {
      question: 'Write: "I will save money by ___."',
      minLength: 10,
    },
  ];
  ...
  return (
    <GameShell
      ...
      subtitle={!showResult ? `Question ${currentStage + 1} of ${stages.length}: Reflect on your saving habits!` : "Journal Complete!"}
