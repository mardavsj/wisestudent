...
const WrongPredictionQuiz = () => {
  ...
  const gameData = getGameDataById("ai-kids-58");
  const gameId = gameData?.id || "ai-kids-58";
            ...
            {finalScore >= 3 ? (
              <div>
                ...
                <p className="text-white/90 text-lg mb-4">
                  ...
                  You're learning that AI can make mistakes!
                </p>
                <div className="bg-gradient-to-r from-yellow-500 to-orange-500 text-white py-3 px-6 rounded-full inline-flex items-center gap-2 mb-4">
                  <span>+{coins} Coins</span>
                </div>
                <p className="text-white/80">
                  You understand that AI isn't perfect and can make errors!
                </p>
              </div>
            ) : (
              <div>
                ...
                <p className="text-white/80 text-sm">
                  Try to think about when AI predictions might be wrong.
                </p>
              </div>
            )}
          </div>
