...
const FriendlyAIQuiz = () => {
  ...
  const gameData = getGameDataById("ai-kids-18");
  const gameId = gameData?.id || "ai-kids-18";
            ...
            {finalScore >= 3 ? (
              <div>
                ...
                <p className="text-white/80">
                  You understand how AI should be helpful and ethical!
                </p>
              </div>
            ) : (
              <div>
                ...
                <p className="text-white/80 text-sm">
                  Try to think about how AI should help people fairly and safely.
                </p>
              </div>
            )}
          </div>
