...
const AITrainingBadge = () => {
  ...
  const challenges = [
    {
      id: 1,
      title: "AI Learning Stories",
      description: "Show you've completed AI learning!",
      icon: <Brain className="w-8 h-8" />,
      color: "bg-blue-500",
      question: "What helps you learn about AI?",
      options: [
        { 
          text: "Completing AI learning stories and games", 
          emoji: "📘", 
          isCorrect: true
        },
        { 
    ...
    },
    {
      id: 2,
      title: "Data Quality",
      description: "Prove you understand good vs bad data!",
      icon: <Zap className="w-8 h-8" />,
      color: "bg-yellow-500",
      question: "How do you identify good vs bad data for AI?",
      options: [
        { 
          text: "By trying games that teach data quality", 
          emoji: "🧩", 
          isCorrect: true
        },
        { 
        ...
        { 
          text: "By ignoring data completely", 
          emoji: "🙈", 
          isCorrect: false
        },
        { 
          text: "By using only bad data", 
          emoji: "❌", 
          isCorrect: false
        }
      ]
    },
    {
      ...
      description: "Demonstrate your robot teaching skills!",
      icon: <Target className="w-8 h-8" />,
      color: "bg-green-500",
      question: "How do you help fix a robot's wrong learning?",
      options: [
        { 
          text: "By ignoring the mistakes", 
          emoji: "🙈", 
          isCorrect: false
        },
        { 
          text: "By correcting mistakes and providing feedback", 
          emoji: "🤖", 
          isCorrect: true
        },
        { 
          text: "By letting robots learn wrong", 
          emoji: "❌", 
          isCorrect: false
        },
        { 
          text: "By never teaching robots", 
          emoji: "🚫", 
          isCorrect: false
        }
      ]
    ...
    {
      id: 4,
      title: "AI Training Mastery",
      description: "Master how AI improves with training!",
      icon: <Trophy className="w-8 h-8" />,
      color: "bg-purple-500",
      question: "How does AI improve with training?",
      options: [
        { 
          text: "By magic", 
          emoji: "✨", 
        ...
        { 
          text: "By never learning", 
          emoji: "🚫", 
          isCorrect: false
        },
        { 
          text: "By staying the same", 
          emoji: "🔄", 
          isCorrect: false
        },
        { 
          text: "By learning from data and feedback over time", 
          emoji: "📊", 
          isCorrect: true
        }
      ]
    ...
    {
      id: 5,
      title: "AI Training Hero",
      description: "Final challenge to earn your badge!",
      icon: <Star className="w-8 h-8" />,
      color: "bg-gradient-to-r from-yellow-400 to-orange-500",
      question: "What makes someone an AI Training Hero?",
      options: [
        { 
          text: "Never playing any games", 
          emoji: "🚫", 
          isCorrect: false
        },
        { 
        ...
        { 
          text: "Avoiding all AI training", 
          emoji: "🙈", 
          isCorrect: false
        },
        { 
          text: "Playing all AI training mini-games with focus", 
          emoji: "🎯", 
          isCorrect: true
        }
      ]
  ...
  useEffect(() => {
    if (showResult) {
      console.log(`🎮 AI Training Badge game completed! Score: ${score}/${challenges.length}, gameId: ${gameId}`);
    }
