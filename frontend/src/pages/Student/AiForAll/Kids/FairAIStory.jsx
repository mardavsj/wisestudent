...
const FairAIStory = () => {
  ...
  const gameData = getGameDataById("ai-kids-93");
  const gameId = gameData?.id || "ai-kids-93";
  ...
  const handleNext = () => {
    navigate("/student/ai-for-all/kids/ethics-decision-game");
  };
          ...
          <div className="bg-white/10 backdrop-blur-md rounded-2xl p-6 border border-white/20 text-center">
            {finalScore >= 3 ? (
              ...
              <div>
                ...
                <p className="text-white/90 text-lg mb-4">
                  You got {finalScore} out of {questions.length} questions correct.
                  Keep practicing to learn more about fair AI!
                </p>
                <button
