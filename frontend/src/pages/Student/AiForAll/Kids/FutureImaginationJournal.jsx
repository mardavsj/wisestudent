...
const FutureImaginationJournal = () => {
  ...
  const stages = [
    {
      question: 'Write: "How will AI help humans in 2050? ___"',
      minLength: 10,
    },
    {
      question: 'Write: "What AI-powered tool would make daily life easier? ___"',
      minLength: 10,
    },
    {
      question: 'Write: "How can AI improve education? ___"',
      minLength: 10,
    },
    {
      question: 'Write: "Imagine a safe AI robot that helps at home. What does it do? ___"',
      minLength: 10,
    },
    {
      question: 'Write: "Describe a futuristic AI invention you\'d like to see. ___"',
      minLength: 10,
    },
  ];
  ...
  useEffect(() => {
    if (showResult) {
      console.log(`🎮 Future Imagination Journal game completed! Score: ${finalScore}/${stages.length}, gameId: ${gameId}`);
    }
  }, [showResult, finalScore, gameId, stages.length]);

  return (
    <GameShell
      title="Journal: Future Imagination"
      subtitle={!showResult ? `Question ${currentStage + 1} of ${stages.length}: Reflect on AI's future!` : "Journal Complete!"}
