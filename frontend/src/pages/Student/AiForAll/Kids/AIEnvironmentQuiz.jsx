...
const AIEnvironmentQuiz = () => {
  ...
  const gameData = getGameDataById("ai-kids-92");
  const gameId = gameData?.id || "ai-kids-92";
  ...
  const handleNext = () => {
    navigate("/student/ai-for-all/kids/fair-ai-story");
  };
            ...
            {finalScore >= 3 ? (
              <div>
                ...
                <p className="text-white/90 text-lg mb-4">
                  ...
                  You're learning about AI and the environment!
                </p>
                <div className="bg-gradient-to-r from-yellow-500 to-orange-500 text-white py-3 px-6 rounded-full inline-flex items-center gap-2 mb-4">
                  <span>+{coins} Coins</span>
                </div>
                <p className="text-white/80">
                  You understand how AI can help protect our environment!
                </p>
              </div>
            ) : (
              <div>
                ...
                <p className="text-white/90 text-lg mb-4">
                  You got {finalScore} out of {questions.length} questions correct.
                  Keep practicing to learn more about AI and the environment!
                </p>
                <button
                ...
                <p className="text-white/80 text-sm">
                  Try to think about how AI can help save energy, water, and protect the environment.
                </p>
              </div>
            )}
          </div>
