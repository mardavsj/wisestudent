...
const CyberbullyStory = () => {
  ...
  const gameData = getGameDataById("ai-kids-84");
  const gameId = gameData?.id || "ai-kids-84";
  ...
  const handleNext = () => {
    navigate("/student/ai-for-all/kids/ai-rights-puzzle");
  };
            ...
            {finalScore >= 3 ? (
              <div>
                ...
                <p className="text-white/90 text-lg mb-4">
                  ...
                  You're learning about cyberbullying!
                </p>
                <div className="bg-gradient-to-r from-yellow-500 to-orange-500 text-white py-3 px-6 rounded-full inline-flex items-center gap-2 mb-4">
                  <span>+{coins} Coins</span>
                </div>
                <p className="text-white/80">
                  You understand how to report and stop cyberbullying!
                </p>
              </div>
            ) : (
              <div>
                ...
                <p className="text-white/90 text-lg mb-4">
                  You got {finalScore} out of {questions.length} questions correct.
                  Keep practicing to learn more about cyberbullying!
                </p>
                <button
                ...
                <p className="text-white/80 text-sm">
                  Try to think about how to report and stop cyberbullying.
                </p>
              </div>
            )}
          </div>
