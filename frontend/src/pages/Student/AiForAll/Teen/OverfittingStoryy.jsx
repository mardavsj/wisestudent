...
const OverfittingStoryy = () => {
  ...
  const { nextGamePath, nextGameId } = useMemo(() => {
    ...
    try {
      ...
      if (currentGame && currentGame.index !== undefined) {
        ...
        return {
          nextGamePath: nextGame ? nextGame.path : "/student/ai-for-all/teen/ai-mistake-reflex",
    ...
    return { nextGamePath: "/student/ai-for-all/teen/ai-mistake-reflex", nextGameId: null };
  ...
  const questions = [
    {
      id: 1,
      text: "The AI saw only red apples and predicts every fruit is red. What happened?",
      options: [
        { 
          id: "overfitting", 
          text: "Overfitting AI", 
    ...
    {
      id: 5,
      text: "Teen learns that AI needs diverse data. Outcome?",
      options: [
        { 
          id: "better", 
  ...
  useEffect(() => {
    if (showResult) {
      console.log(`🎮 Overfitting Story game completed! Score: ${finalScore}/${questions.length}, gameId: ${gameId}, nextGamePath: ${nextGamePath}, nextGameId: ${nextGameId}`);
          ...
          <div className="bg-white/10 backdrop-blur-md rounded-xl md:rounded-2xl p-6 md:p-8 border border-white/20 text-center flex-1 flex flex-col justify-center">
            {finalScore >= 3 ? (
              <div>
                ...
                <h3 className="text-xl md:text-2xl font-bold text-white mb-4">Overfitting Fixed!</h3>
                <p className="text-white/90 text-base md:text-lg mb-4">
                  You got {finalScore} out of {questions.length} questions correct!
                  You understand that adding variety improves AI learning and prevents overfitting!
                </p>
              ...
              <div>
                ...
                <p className="text-white/90 text-base md:text-lg mb-4">
                  You got {finalScore} out of {questions.length} questions correct.
                  Remember, AI can overfit if it sees limited data.
                </p>
                <button
                ...
                <p className="text-white/80 text-xs md:text-sm">
                  Try to choose the option that shows how data diversity prevents AI from becoming too specialized.
                </p>
              </div>
            )}
          </div>
