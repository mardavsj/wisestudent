...
const questions = [
  ...
  {
    id: 3,
    text: "Which action helps create a green future?",
    options: [
      { id: 'b', text: " Burn Trash", emoji: "🔥", isCorrect: false },
      { id: 'c', text: " Drive Alone", emoji: "🚗", isCorrect: false },
      { id: 'a', text: " Recycle Materials", emoji: "♻️", isCorrect: true },
      { id: 'd', text: " Litter", emoji: "🗑️", isCorrect: false }
    ]
  },
  {
    id: 4,
    text: "What's a green choice for transportation?",
    options: [
      { id: 'a', text: " Walk or Bike", emoji: "🚶", isCorrect: true },
      { id: 'b', text: " Drive Everywhere", emoji: "🚗", isCorrect: false },
  ...
  {
    id: 5,
    text: "Which helps ensure a green future?",
    options: [
      { id: 'b', text: " Pollute Air", emoji: "💨", isCorrect: false },
...
const ReflexGreenFuture = () => {
  const navigate = useNavigate();
  const location = useLocation();
  
  // Get game data from game category folder (source of truth)
  const gameId = "sustainability-kids-84";
  ...
  useEffect(() => {
    if (gameState === "finished") {
      console.log(`🎮 Reflex Green Future game completed! Score: ${score}/${TOTAL_ROUNDS}, gameId: ${gameId}, nextGamePath: ${nextGamePath}, nextGameId: ${nextGameId}`);
  ...
  return (
    <GameShell
      ...
      nextGamePathProp="/student/sustainability/kids/badge-climate-helper-kid"
      nextGameIdProp="sustainability-kids-85">
      <div className="space-y-8">
        {gameState === "ready" && (
          <div className="bg-white/10 backdrop-blur-md rounded-2xl p-8 border border-white/20 text-center">
            <h3 className="text-2xl font-bold text-white mb-4">Get Ready!</h3>
            <p className="text-white/80 mb-6 text-lg">Choose the green choice quickly! You have {ROUND_TIME} seconds per round</p>
            <button
              onClick={startGame}
...
export default ReflexGreenFuture;