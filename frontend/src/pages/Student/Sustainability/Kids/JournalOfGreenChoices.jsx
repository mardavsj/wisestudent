...
const JournalOfGreenChoices = () => {
  const navigate = useNavigate();
  const location = useLocation();
  const gameId = "sustainability-kids-82";
  ...
  useEffect(() => {
    if (gameFinished) {
      console.log(`🎮 Journal of Green Choices game completed! Score: ${coins}, gameId: ${gameId}, nextGamePath: ${nextGamePath}, nextGameId: ${nextGameId}`);
  ...
  const stages = [
    { question: 'Write: "One green choice I made is ___."', minLength: 10 },
    { question: 'Write: "I can help the climate by ___."', minLength: 10 },
    { question: 'Write: "One way to protect nature is ___."', minLength: 10 },
    { question: 'Write: "My favorite eco-friendly activity is ___."', minLength: 10 },
    { question: 'Write: "I feel happy when I help the environment because ___."', minLength: 10 }
  ];
  ...
  useEffect(() => {
    if (gameFinished) {
      console.log(`🎮 Journal of Green Choices game completed! Score: ${coins}/${stages.length}, gameId: ${gameId}`);
    }
  ...
  return (
    <GameShell
      ...
      nextGamePathProp="/student/sustainability/kids/carbon-story"
      nextGameIdProp="sustainability-kids-83">
...
export default JournalOfGreenChoices;