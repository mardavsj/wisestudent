...
const PosterClimateAction = () => {
  const location = useLocation();
  
  // Get game data from game category folder (source of truth)
  const gameId = "sustainability-kids-81";
  ...
  const stages = [
    {
      question: "Which poster best promotes climate action?",
      posters: [
        {
          id: 1,
      ...
      correctFeedback: "We Can Help the Earth is the best message for climate action!",
      explanation: "This poster reminds us that we can all take action to help our planet!"
    },
    {
      question: "Which poster encourages reducing carbon footprint?",
      posters: [
        {
          id: 1,
      ...
      correctFeedback: "Walk, Bike, Use Public Transport promotes reducing carbon footprint!",
      explanation: "Using low-carbon transport helps reduce emissions that cause climate change!"
    },
    {
      question: "Which poster best shows energy conservation?",
      posters: [
        {
          id: 1,
      ...
      correctFeedback: "Turn Off When Not Needed shows great energy conservation!",
      explanation: "Conserving energy helps reduce the carbon emissions that cause climate change!"
    },
    {
      question: "Which poster best promotes climate-friendly habits?",
      posters: [
         {
          id: 2,
      ...
      correctFeedback: "Reduce, Reuse, Recycle gives helpful climate guidance!",
      explanation: "These practices help reduce the resources and energy needed for production!"
    },
    {
      question: "Which poster best shows protecting our climate?",
      posters: [
        {
          id: 1,
          title: "Pollute More",
      ...
      correctFeedback: "Care for Our Climate is the right choice for our planet!",
      explanation: "Taking care of our climate helps preserve our beautiful planet for future generations!"
    }
  ];
            ...
            {isCorrect ? (
              ...
              <div>
                ...
                <p className="text-white/80 text-sm">
                  {currentStageData?.explanation || "Look for the poster that promotes good climate habits."}
                </p>
              </div>
            )}
          </div>
...
export default PosterClimateAction;