...
const JournalGreenHabits = () => {
  const navigate = useNavigate();
  const location = useLocation();
  const gameId = "sustainability-kids-17";
  ...
  useEffect(() => {
    if (gameFinished) {
      console.log(`🎮 Journal of Green Habits game completed! Score: ${coins}, gameId: ${gameId}, nextGamePath: ${nextGamePath}, nextGameId: ${nextGameId}`);
  ...
  const stages = [
    { question: 'Write: "One green habit I practice is ___."', minLength: 10 },
    { question: 'Write: "I help the planet by ___."', minLength: 10 },
    { question: 'Write: "I will start doing ___ to be more eco-friendly."', minLength: 10 },
    { question: 'Write: "My favorite way to help Earth is ___."', minLength: 10 },
    { question: 'Write: "I feel good when I ___ to protect nature."', minLength: 10 }
  ];
  ...
  useEffect(() => {
    if (gameFinished) {
      console.log(`🎮 Journal of Green Habits game completed! Score: ${coins}/${stages.length}, gameId: ${gameId}`);
    }
  ...
  return (
    <GameShell
      ...
      nextGamePathProp="/student/sustainability/kids/tree-planting-story"
      nextGameIdProp="sustainability-kids-18">
...
export default JournalGreenHabits;
