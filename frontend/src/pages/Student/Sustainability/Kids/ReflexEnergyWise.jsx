...
const questions = [
  {
    id: 1,
    text: "Tap for 'Save Energy,' avoid 'Waste Energy'",
    options: [
  ...
  {
    id: 3,
    text: "What's a good energy saving option?",
    options: [
  ...
  {
    id: 5,
    text: "What's the best energy choice for the environment?",
    options: [
        { id: 'b', text: " Energy Wasting", emoji: "❌", isCorrect: false },
        { id: 'c', text: " High Consumption", emoji: "⚡", isCorrect: false },
        { id: 'a', text: " Energy Efficient", emoji: "💡", isCorrect: true },
      { id: 'd', text: " Old Appliances", emoji: "🔧", isCorrect: false }
    ]
  }
];

const ReflexEnergyWise = () => {
  const navigate = useNavigate();
  const location = useLocation();
  
  // Get game data from game category folder (source of truth)
  const gameId = "sustainability-kids-54";
  ...
  useEffect(() => {
    if (gameState === "finished") {
      console.log(`🎮 Reflex Energy Wise game completed! Score: ${score}/${TOTAL_ROUNDS}, gameId: ${gameId}, nextGamePath: ${nextGamePath}, nextGameId: ${nextGameId}`);
  ...
  return (
    <GameShell
      ...
      nextGamePathProp="/student/sustainability/kids/badge-green-traveler-kid"
      nextGameIdProp="sustainability-kids-55">
      <div className="space-y-8">
        {gameState === "ready" && (
          <div className="bg-white/10 backdrop-blur-md rounded-2xl p-8 border border-white/20 text-center">
            <h3 className="text-2xl font-bold text-white mb-4">Get Ready!</h3>
            <p className="text-white/80 mb-6 text-lg">Choose the energy saving option quickly! You have {ROUND_TIME} seconds per round</p>
            <button
              onClick={startGame}
...
export default ReflexEnergyWise;