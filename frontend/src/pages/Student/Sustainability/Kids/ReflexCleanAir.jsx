...
const questions = [
  {
    id: 1,
    text: "Which action helps clean air?",
    options: [
      { id: 'a', text: " Ride a Bike", emoji: "🚲", isCorrect: true },
      { id: 'b', text: " Drive a Car", emoji: "🚗", isCorrect: false },
      { id: 'c', text: " Factory Smoke", emoji: "🏭", isCorrect: false },
      { id: 'd', text: " Smoke Cigarettes", emoji: "🚭", isCorrect: false }
    ]
  },
  {
    id: 2,
    text: "What improves air quality?",
    options: [
      { id: 'a', text: " Burn Garbage", emoji: "🧨", isCorrect: false },
      { id: 'b', text: " Plant Trees", emoji: "🌳", isCorrect: true },
      { id: 'c', text: " Create Smog", emoji: "🌫️", isCorrect: false },
      { id: 'd', text: " Burn Fossil Fuels", emoji: "🔥", isCorrect: false }
    ]
  },
  {
    id: 3,
    text: "Which energy source is clean?",
    options: [
      { id: 'a', text: " Solar Power", emoji: "☀️", isCorrect: false },
      { id: 'b', text: " Wind Energy", emoji: "💨", isCorrect: false },
      { id: 'c', text: " Renewable Energy", emoji: "⚡", isCorrect: true },
      { id: 'd', text: " Coal Power", emoji: "⛽", isCorrect: false }
    ]
  },
  {
    id: 4,
      ...
      <div className="space-y-8">
        {gameState === "ready" && (
          <div className="bg-white/10 backdrop-blur-md rounded-2xl p-8 border border-white/20 text-center">
            ...
            <p className="text-white/80 mb-6 text-lg">Choose the clean air action quickly! You have {ROUND_TIME} seconds per round</p>
            <button
              onClick={startGame}
