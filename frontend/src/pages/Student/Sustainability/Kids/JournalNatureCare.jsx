...
const JournalNatureCare = () => {
  const navigate = useNavigate();
  const location = useLocation();
  const gameId = "sustainability-kids-62";
  ...
  useEffect(() => {
    if (gameFinished) {
      console.log(`🎮 Journal of Nature Care game completed! Score: ${coins}, gameId: ${gameId}, nextGamePath: ${nextGamePath}, nextGameId: ${nextGameId}`);
  ...
  const stages = [
    { question: 'Write: "One way I help nature is ___."', minLength: 10 },
    { question: 'Write: "Protecting animals is important because ___."', minLength: 10 },
    { question: 'Write: "I can help forests by ___."', minLength: 10 },
    { question: 'Write: "My favorite nature activity is ___."', minLength: 10 },
    { question: 'Write: "I feel happy when I protect wildlife because ___."', minLength: 10 }
  ];
  ...
  useEffect(() => {
    if (gameFinished) {
      console.log(`🎮 Journal of Nature Care game completed! Score: ${coins}/${stages.length}, gameId: ${gameId}`);
    }
  ...
  return (
    <GameShell
      ...
      nextGamePathProp="/student/sustainability/kids/bee-story"
      nextGameIdProp="sustainability-kids-63">
...
export default JournalNatureCare;