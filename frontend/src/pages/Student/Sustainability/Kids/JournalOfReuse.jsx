...
const JournalOfReuse = () => {
  const navigate = useNavigate();
  const location = useLocation();
  const gameId = "sustainability-kids-72";
  ...
  useEffect(() => {
    if (gameFinished) {
      console.log(`🎮 Journal of Reuse game completed! Score: ${coins}, gameId: ${gameId}, nextGamePath: ${nextGamePath}, nextGameId: ${nextGameId}`);
  ...
  const stages = [
    { question: 'Write: "One thing I reused was ___."', minLength: 10 },
    { question: 'Write: "Upcycling helps the environment by ___."', minLength: 10 },
    { question: 'Write: "I can reuse items by ___."', minLength: 10 },
    { question: 'Write: "My favorite upcycled item is ___."', minLength: 10 },
    { question: 'Write: "I feel good when I reuse because ___."', minLength: 10 }
  ];
  ...
  useEffect(() => {
    if (gameFinished) {
      console.log(`🎮 Journal of Reuse game completed! Score: ${coins}/${stages.length}, gameId: ${gameId}`);
    }
  ...
  return (
    <GameShell
      ...
      nextGamePathProp="/student/sustainability/kids/donation-story"
      nextGameIdProp="sustainability-kids-73">
