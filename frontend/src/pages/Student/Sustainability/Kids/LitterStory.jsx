...
const LitterStory = () => {
  ...
  useEffect(() => {
    if (showResult) {
      console.log(`🎮 Litter Story game completed! Score: ${finalScore}, gameId: ${gameId}, nextGamePath: ${nextGamePath}, nextGameId: ${nextGameId}`);
  ...
  const questions = [
    {
      ...
      options: [
        { id: "bin", text: "Find a bin", emoji: "🗑️", isCorrect: true },
        { id: "ground", text: "Throw on ground", emoji: "😕", isCorrect: false },
        { id: "pocket", text: "Keep in pocket", emoji: "👖", isCorrect: false }
      ]
    },
    {
      id: 2,
      ...
      options: [
        ...
        { id: "pickup", text: "Pick it up", emoji: "🤲", isCorrect: true },
        { id: "complain", text: "Complain about it", emoji: "😠", isCorrect: false }
      ]
    },
    {
      id: 3,
      ...
      options: [
        { id: "throw", text: "Throw it anyway", emoji: "🗑️", isCorrect: false },
        { id: "hide", text: "Hide it somewhere", emoji: "🙈", isCorrect: false },
        { id: "keep", text: "Keep it until you find a bin", emoji: "👖", isCorrect: true }
      ]
    },
    {
      id: 4,
      ...
      options: [
        { id: "remind", text: "Remind them to pick it up", emoji: "💬", isCorrect: true },
        { id: "ignore", text: "Ignore it", emoji: "😶", isCorrect: false },
        { id: "cleanup", text: "Clean it up yourself", emoji: "🧹", isCorrect: false }
      ]
    },
    {
      id: 5,
      ...
      options: [
        { id: "litter", text: "Litter more often", emoji: "🗑️", isCorrect: false },
        { id: "reduce", text: "Reduce, reuse, and recycle", emoji: "♻️", isCorrect: true },
        { id: "complain", text: "Complain to neighbors", emoji: "😠", isCorrect: false }
      ]
    }
  ];
