...
const JournalOfWaterHabits = () => {
  const navigate = useNavigate();
  const location = useLocation();
  const gameId = "sustainability-kids-32";
  ...
  useEffect(() => {
    if (gameFinished) {
      console.log(`🎮 Journal of Water Habits game completed! Score: ${coins}, gameId: ${gameId}, nextGamePath: ${nextGamePath}, nextGameId: ${nextGameId}`);
  ...
  const stages = [
    { question: 'Write: "One way I save water is ___."', minLength: 10 },
    { question: 'Write: "I will use water more carefully by ___."', minLength: 10 },
    { question: 'Write: "Water is important because ___."', minLength: 10 },
    { question: 'Write: "My family can save water by ___."', minLength: 10 },
    { question: 'Write: "I feel proud when I conserve water because ___."', minLength: 10 }
  ];
  ...
  useEffect(() => {
    if (gameFinished) {
      console.log(`🎮 Journal of Water Habits game completed! Score: ${coins}/${stages.length}, gameId: ${gameId}`);
    }
  ...
  return (
    <GameShell
      ...
      nextGamePathProp="/student/sustainability/kids/plant-story"
      nextGameIdProp="sustainability-kids-33">
...
export default JournalOfWaterHabits;