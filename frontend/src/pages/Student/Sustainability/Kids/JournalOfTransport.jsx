...
const JournalOfTransport = () => {
  const navigate = useNavigate();
  const location = useLocation();
  const gameId = "sustainability-kids-52";
  ...
  useEffect(() => {
    if (gameFinished) {
      console.log(`🎮 Journal of Transport game completed! Score: ${coins}, gameId: ${gameId}, nextGamePath: ${nextGamePath}, nextGameId: ${nextGameId}`);
  ...
  const stages = [
    { question: 'Write: "One green way I travel is ___."', minLength: 10 },
    { question: 'Write: "I can reduce transport emissions by ___."', minLength: 10 },
    { question: 'Write: "Walking instead of driving helps because ___."', minLength: 10 },
    { question: 'Write: "My family can travel more sustainably by ___."', minLength: 10 },
    { question: 'Write: "I feel proud when I choose green transport because ___."', minLength: 10 }
  ];
  ...
  useEffect(() => {
    if (gameFinished) {
      console.log(`🎮 Journal of Transport game completed! Score: ${coins}/${stages.length}, gameId: ${gameId}`);
    }
  ...
  return (
    <GameShell
      ...
      nextGamePathProp="/student/sustainability/kids/bus-story"
      nextGameIdProp="sustainability-kids-53">
...
export default JournalOfTransport;