...
const JournalRecycling = () => {
  ...
  useEffect(() => {
    if (gameFinished) {
      console.log(`🎮 Journal of Recycling game completed! Score: ${coins}/${stages.length}, gameId: ${gameId}`);
    }
  ...
  return (
    <GameShell
      ...
      nextGamePathProp="/student/sustainability/kids/plastic-bag-story"
      nextGameIdProp="sustainability-kids-8">
