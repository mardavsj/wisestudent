...
const questions = [
  {
    id: 1,
    text: "Which action protects nature?",
    options: [
      { id: 'a', text: " Plant Trees", emoji: "🌱", isCorrect: true },
      { id: 'b', text: " Burn Forests", emoji: "🔥", isCorrect: false },
      { id: 'c', text: " Litter in Parks", emoji: "🗑️", isCorrect: false },
      { id: 'd', text: " Harm Animals", emoji: "🐾", isCorrect: false }
    ]
  },
  {
    id: 2,
  ...
  {
    id: 3,
    text: "Which reduces environmental harm?",
    options: [
      { id: 'a', text: " Ride Bicycle", emoji: "🚲", isCorrect: false },
      { id: 'b', text: " Use Plastic Bags", emoji: "🛍️", isCorrect: false },
      { id: 'c', text: " Recycle Waste", emoji: "♻️", isCorrect: true },
      { id: 'd', text: " Throw Cigarettes", emoji: "🚬", isCorrect: false }
    ]
  },
  {
    id: 4,
    text: "What conserves water?",
    options: [
      { id: 'a', text: " Take Short Showers", emoji: "🚿", isCorrect: false },
      { id: 'b', text: " Leave Faucets On", emoji: "💧", isCorrect: false },
      { id: 'c', text: " Pollute Rivers", emoji: "🌊", isCorrect: false },
      { id: 'd', text: " Fix Leaky Pipes", emoji: "💦", isCorrect: true }
    ]
  },
  {
    id: 5,
...
const ReflexNatureCare = () => {
  const navigate = useNavigate();
  const location = useLocation();
  const gameId = "sustainability-kids-19";
  ...
  useEffect(() => {
    if (gameState === "finished") {
      console.log(`🎮 Reflex Nature Care game completed! Score: ${score}/${TOTAL_ROUNDS}, gameId: ${gameId}, nextGamePath: ${nextGamePath}, nextGameId: ${nextGameId}`);
  ...
  return (
    <GameShell
      ...
      nextGamePathProp="/student/sustainability/kids/badge-planet-protector-kid"
      nextGameIdProp="sustainability-kids-20">
      <div className="space-y-8">
        {gameState === "ready" && (
          <div className="bg-white/10 backdrop-blur-md rounded-2xl p-8 border border-white/20 text-center">
            <h3 className="text-2xl font-bold text-white mb-4">Get Ready!</h3>
            <p className="text-white/80 mb-6 text-lg">Choose the nature-protecting action quickly! You have {ROUND_TIME} seconds per round</p>
            <button
              onClick={startGame}
...
export default ReflexNatureCare;