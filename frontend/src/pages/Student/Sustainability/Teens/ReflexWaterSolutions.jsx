...
const questions = [
  {
    ...
    options: [
      { id: 'b', text: " Basic sprinklers", emoji: "🚿", isCorrect: false },
      { id: 'c', text: " Manual watering", emoji: "🪣", isCorrect: false },
      { id: 'a', text: " Smart irrigation", emoji: "💧", isCorrect: true },
      { id: 'd', text: " Overhead systems", emoji: "🌧️", isCorrect: false }
    ]
  },
  {
    id: 2,
  ...
  },
  {
    ...
    options: [
      { id: 'b', text: " Basic meters", emoji: "🔢", isCorrect: false },
      { id: 'a', text: " Smart water meters", emoji: "📊", isCorrect: true },
      { id: 'c', text: " Manual checks", emoji: "🔧", isCorrect: false },
      { id: 'd', text: " Visual inspection", emoji: "👀", isCorrect: false }
    ]
  },
  {
    id: 4,
  ...
  },
  {
    ...
    options: [
      { id: 'b', text: " Constant pressure", emoji: "💧", isCorrect: false },
      { id: 'c', text: " Manual controls", emoji: "🔧", isCorrect: false },
      { id: 'd', text: " Fixed flow", emoji: "💧", isCorrect: false },
      { id: 'a', text: " Pressure sensors", emoji: "📊", isCorrect: true },
    ]
  }
];
...
const ReflexWaterSolutions = () => {
  ...
  useEffect(() => {
    if (gameState === "finished") {
      console.log(`🎮 Reflex Water Solutions game completed! Score: ${score}/${TOTAL_ROUNDS}, gameId: ${gameId}, nextGamePath: ${nextGamePath}, nextGameId: ${nextGameId}`);
