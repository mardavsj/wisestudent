...
const questions = [
  {
    id: 1,
    text: "Which food choice is most sustainable?",
    options: [
      { id: 'a', text: " Local Organic Vegetables", emoji: "🥬", isCorrect: true },
      { id: 'b', text: " Imported Beef", emoji: "🥩", isCorrect: false },
      { id: 'c', text: " Farmed Salmon", emoji: "🐟", isCorrect: false },
      { id: 'd', text: " Processed Snacks", emoji: "🍪", isCorrect: false }
    ]
  },
  {
    id: 2,
  ...
  {
    id: 3,
    text: "Which farming method is most sustainable?",
    options: [
      { id: 'a', text: " Monoculture", emoji: "🌾", isCorrect: false },
      { id: 'b', text: " Organic Polyculture", emoji: "🌱", isCorrect: true },
      { id: 'c', text: " Heavy Pesticide Use", emoji: "🧪", isCorrect: false },
      { id: 'd', text: " Intensive Irrigation", emoji: "💧", isCorrect: false }
    ]
  },
  {
    id: 4,
...
const ReflexFoodSystemThinker = () => {
  const location = useLocation();
  
  const gameData = getGameDataById("sustainability-teens-78");
  const gameId = gameData?.id || "sustainability-teens-78";
  ...
  useEffect(() => {
    if (gameState === "finished") {
      console.log(`🎮 Reflex Food System Thinker game completed! Score: ${score}/${TOTAL_ROUNDS}, gameId: ${gameId}, nextGamePath: ${nextGamePath}, nextGameId: ${nextGameId}`);
  ...
  return (
    <GameShell
      ...
      nextGamePathProp="/student/sustainability/teens/puzzle-food-chain-impact"
      nextGameIdProp="sustainability-teens-79">
      <div className="space-y-8">
        {gameState === "ready" && (
          <div className="bg-white/10 backdrop-blur-md rounded-2xl p-8 border border-white/20 text-center">
            <h3 className="text-2xl font-bold text-white mb-4">Get Ready!</h3>
            <p className="text-white/80 mb-6 text-lg">Choose the sustainable food choice quickly! You have {ROUND_TIME} seconds per round</p>
            <button
              onClick={startGame}
...
export default ReflexFoodSystemThinker;