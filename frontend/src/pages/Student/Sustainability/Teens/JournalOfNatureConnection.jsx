...
const JournalOfNatureConnection = () => {
  const location = useLocation();
  const navigate = useNavigate();
  const gameData = getGameDataById("sustainability-teens-62");
  const gameId = gameData?.id || "sustainability-teens-62";
  ...
  useEffect(() => {
    if (gameFinished) {
      console.log(`🎮 Journal of Nature Connection game completed! Score: ${coins}, gameId: ${gameId}, nextGamePath: ${nextGamePath}, nextGameId: ${nextGameId}`);
  ...
  const stages = [
    { question: 'Write: "The most beautiful natural place I have visited is ___."', minLength: 10 },
    { question: 'Write: "A moment when I felt connected to nature was ___."', minLength: 10 },
    { question: 'Write: "How can I spend more time in nature? ___."', minLength: 10 },
    { question: 'Write: "The wildlife I would like to protect is ___."', minLength: 10 },
    { question: 'Write: "I feel motivated to protect nature because ___."', minLength: 10 }
  ];
  ...
  useEffect(() => {
    if (gameFinished) {
      console.log(`🎮 Journal of Nature Connection game completed! Score: ${coins}/${stages.length}, gameId: ${gameId}`);
    }
  ...
  return (
    <GameShell
      ...
      nextGamePathProp="/student/sustainability/teens/simulation-wildlife-conservation-project"
      nextGameIdProp="sustainability-teens-63">
...
export default JournalOfNatureConnection;