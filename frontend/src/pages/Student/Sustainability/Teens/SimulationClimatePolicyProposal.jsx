...
const SimulationClimatePolicyProposal = () => {
  ...
  // Hardcode rewards to align with rule: 3 coins per question, 15 total coins, 10 total XP
  ...
  useEffect(() => {
    if (gameFinished) {
      console.log(`🎮 Simulation: Climate Policy Proposal game completed! Score: ${correctAnswers}, gameId: ${gameId}, nextGamePath: ${nextGamePath}, nextGameId: ${nextGameId}`);
