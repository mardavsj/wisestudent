...
const questions = [
  {
    id: 1,
    text: "Which action protects biodiversity?",
    options: [
      { id: 'a', text: " Deforestation", emoji: "🪓", isCorrect: false },
      { id: 'b', text: " Habitat preservation", emoji: "🏞️", isCorrect: true },
  ...
  {
    id: 4,
    text: "What's a threat to biodiversity?",
    options: [
      ...
      { id: 'd', text: " Habitat restoration", emoji: "🌱", isCorrect: false }
    ]
  },
  {
    id: 5,
...
const ReflexEcosystemDefender = () => {
  const location = useLocation();
  
  const gameData = getGameDataById("sustainability-teens-58");
  const gameId = gameData?.id || "sustainability-teens-58";
  ...
  useEffect(() => {
    if (gameState === "finished") {
      console.log(`🎮 Reflex Ecosystem Defender game completed! Score: ${score}/${TOTAL_ROUNDS}, gameId: ${gameId}, nextGamePath: ${nextGamePath}, nextGameId: ${nextGameId}`);
  ...
  return (
    <GameShell
      ...
      nextGamePathProp="/student/sustainability/teens/puzzle-ecosystem-balance"
      nextGameIdProp="sustainability-teens-59">
      <div className="space-y-8">
        {gameState === "ready" && (
          <div className="bg-white/10 backdrop-blur-md rounded-2xl p-8 border border-white/20 text-center">
            <h3 className="text-2xl font-bold text-white mb-4">Get Ready!</h3>
            <p className="text-white/80 mb-6 text-lg">Choose the ecosystem-protecting action quickly! You have {ROUND_TIME} seconds per round</p>
            <button
              onClick={startGame}
...
export default ReflexEcosystemDefender;