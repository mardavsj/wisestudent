...
const JournalOfEnergyUse = () => {
  const location = useLocation();
  const navigate = useNavigate();
  const gameData = getGameDataById("sustainability-teens-42");
  const gameId = gameData?.id || "sustainability-teens-42";
  ...
  useEffect(() => {
    if (gameFinished) {
      console.log(`🎮 Journal of Energy Use game completed! Score: ${coins}, gameId: ${gameId}, nextGamePath: ${nextGamePath}, nextGameId: ${nextGameId}`);
  ...
  const stages = [
    { question: 'Write: "My home uses energy from ___."', minLength: 10 },
    { question: 'Write: "One way I reduce energy consumption is ___."', minLength: 10 },
    { question: 'Write: "Renewable energy sources in my area include ___."', minLength: 10 },
    { question: 'Write: "Energy efficiency means ___."', minLength: 10 },
    { question: 'Write: "I feel motivated to save energy because ___."', minLength: 10 }
  ];
  ...
  useEffect(() => {
    if (gameFinished) {
      console.log(`🎮 Journal of Energy Use game completed! Score: ${coins}/${stages.length}, gameId: ${gameId}`);
    }
  ...
  return (
    <GameShell
      ...
      nextGamePathProp="/student/sustainability/teens/simulation-energy-audit"
      nextGameIdProp="sustainability-teens-43">
...
export default JournalOfEnergyUse;