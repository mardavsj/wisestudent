...
const questions = [
  {
    id: 1,
    text: "Which food source is most sustainable?",
    options: [
      { id: 'a', text: " Locally grown vegetables", emoji: "🥬", isCorrect: true },
      { id: 'b', text: " Imported exotic fruits", emoji: "🥭", isCorrect: false },
      { id: 'c', text: " Processed packaged meals", emoji: "🍽️", isCorrect: false },
      { id: 'd', text: " Industrial meat", emoji: "🍖", isCorrect: false }
    ]
  },
  {
    id: 2,
  ...
  },
  {
    ...
    options: [
      { id: 'a', text: " Meal planning", emoji: "📝", isCorrect: true },
      { id: 'b', text: " Buy more than needed", emoji: "🛒", isCorrect: false },
      { id: 'c', text: " Ignore expiration dates", emoji: "📅", isCorrect: false },
      { id: 'd', text: " Throw away leftovers", emoji: "🗑️", isCorrect: false }
    ]
  },
  {
    id: 5,
...
const ReflexSustainableFood = () => {
  const location = useLocation();
  
  const gameData = getGameDataById("sustainability-teens-84");
  const gameId = gameData?.id || "sustainability-teens-84";
  ...
  useEffect(() => {
    if (gameState === "finished") {
      console.log(`🎮 Reflex Sustainable Food game completed! Score: ${score}/${TOTAL_ROUNDS}, gameId: ${gameId}, nextGamePath: ${nextGamePath}, nextGameId: ${nextGameId}`);
  ...
  return (
    <GameShell
      ...
      nextGamePathProp="/student/sustainability/teens/badge-food-system-champion"
      nextGameIdProp="sustainability-teens-85">
      <div className="space-y-8">
        {gameState === "ready" && (
          <div className="bg-white/10 backdrop-blur-md rounded-2xl p-8 border border-white/20 text-center">
            <h3 className="text-2xl font-bold text-white mb-4">Get Ready!</h3>
            <p className="text-white/80 mb-6 text-lg">Choose the sustainable and ethical food choice quickly! You have {ROUND_TIME} seconds per round</p>
            <button
              onClick={startGame}
...
export default ReflexSustainableFood;