...
const JournalOfFoodEthics = () => {
  const location = useLocation();
  const navigate = useNavigate();
  const gameData = getGameDataById("sustainability-teens-82");
  const gameId = gameData?.id || "sustainability-teens-82";
  ...
  useEffect(() => {
    if (gameFinished) {
      console.log(`🎮 Journal of Food Ethics game completed! Score: ${coins}, gameId: ${gameId}, nextGamePath: ${nextGamePath}, nextGameId: ${nextGameId}`);
  ...
  const stages = [
    { question: 'Write: "My personal food ethics are based on ___."', minLength: 10 },
    { question: 'Write: "I believe it\'s important to consider animal welfare when choosing food because ___."', minLength: 10 },
    { question: 'Write: "The environmental impact of my food choices affects ___."', minLength: 10 },
    { question: 'Write: "Food justice means equal access to nutritious food for ___."', minLength: 10 },
    { question: 'Write: "I can improve my food ethics by ___."', minLength: 10 }
  ];
  ...
  useEffect(() => {
    if (gameFinished) {
      console.log(`🎮 Journal of Food Ethics game completed! Score: ${coins}/${stages.length}, gameId: ${gameId}`);
    }
  ...
  return (
    <GameShell
      ...
      nextGamePathProp="/student/sustainability/teens/simulation-farm-to-table-project"
      nextGameIdProp="sustainability-teens-83">
...
export default JournalOfFoodEthics;