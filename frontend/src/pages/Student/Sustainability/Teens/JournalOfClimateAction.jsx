...
const JournalOfClimateAction = () => {
  const location = useLocation();
  const navigate = useNavigate();
  const gameData = getGameDataById("sustainability-teens-72");
  const gameId = gameData?.id || "sustainability-teens-72";
  ...
  useEffect(() => {
    if (gameFinished) {
      console.log(`🎮 Journal of Climate Action game completed! Score: ${coins}, gameId: ${gameId}, nextGamePath: ${nextGamePath}, nextGameId: ${nextGameId}`);
  ...
  const stages = [
    { question: 'Write: "My first step to becoming a climate activist is ___."', minLength: 10 },
    { question: 'Write: "A climate action I can take in my community is ___."', minLength: 10 },
    { question: 'Write: "How can I inspire others to take climate action? ___."', minLength: 10 },
    { question: 'Write: "The climate issue I care most about is ___."', minLength: 10 },
    { question: 'Write: "My commitment to climate action is ___."', minLength: 10 }
  ];
  ...
  useEffect(() => {
    if (gameFinished) {
      console.log(`🎮 Journal of Climate Action game completed! Score: ${coins}/${stages.length}, gameId: ${gameId}`);
    }
  ...
  return (
    <GameShell
      ...
      nextGamePathProp="/student/sustainability/teens/simulation-climate-policy-proposal"
      nextGameIdProp="sustainability-teens-73">
...
export default JournalOfClimateAction;