...
const WasteReductionStory = () => {
  ...
  useEffect(() => {
    if (showResult) {
      console.log(`🎮 Waste Reduction Story game completed! Score: ${finalScore}, gameId: ${gameId}, nextGamePath: ${nextGamePath}, nextGameId: ${nextGameId}`);
  ...
  const questions = [
    {
      ...
      options: [
        { id: "plan", text: "Create a waste reduction plan", emoji: "📋", isCorrect: true },
        { id: "ignore", text: "Ignore the issue", emoji: "😐", isCorrect: false },
        { id: "wait", text: "Wait for others to act", emoji: "⏳", isCorrect: false }
      ]
    },
    {
      id: 2,
      ...
      options: [
        { id: "disposable", text: "Use more disposable items", emoji: "🥤", isCorrect: false },
        { id: "reusable", text: "Use reusable containers", emoji: "🍱", isCorrect: true },
    ...
    },
    {
      ...
      options: [
        { id: "recycle", text: "Only recycle", emoji: "♻️", isCorrect: false },
        { id: "landfill", text: "Use landfills", emoji: "🗑️", isCorrect: false },
        { id: "reduce", text: "Reduce consumption", emoji: "📉", isCorrect: true }
      ]
    },
    {
      id: 4,
      ...
      options: [
        { id: "fruit", text: "Apple cores", emoji: "🍎", isCorrect: false },
        { id: "plastic", text: "Plastic bags", emoji: "🛍️", isCorrect: true },
        { id: "paper", text: "Newspaper", emoji: "🗞️", isCorrect: false }
      ]
    },
    {
      id: 5,
      ...
      options: [
        { id: "trash", text: "Throw in regular trash", emoji: "🗑️", isCorrect: false },
        { id: "donate", text: "Donate or recycle properly", emoji: "♻️", isCorrect: true },
        { id: "hoard", text: "Store in garage", emoji: "🏠", isCorrect: false }
      ]
    }
  ];
