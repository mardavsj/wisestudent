...
const JournalOfGreenLiving = () => {
  ...
  useEffect(() => {
    if (gameFinished) {
      console.log(`🎮 Journal of Green Living game completed! Score: ${coins}, gameId: ${gameId}, nextGamePath: ${nextGamePath}, nextGameId: ${nextGameId}`);
  ...
  useEffect(() => {
    if (gameFinished) {
      console.log(`🎮 Journal of Green Living game completed! Score: ${coins}/${stages.length}, gameId: ${gameId}`);
    }
  ...
  return (
    <GameShell
      ...
      nextGamePathProp="/student/sustainability/teens/simulation-eco-friendly-city"
      nextGameIdProp="sustainability-teens-8">
